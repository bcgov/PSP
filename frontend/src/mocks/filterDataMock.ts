...
export const mockFlatBuildingProperty: IFlatProperty = {
  ...
  organization: 'Transportation & Infrastructure',
  organizationCode: 'TRAN',
  organizationId: 250,
  classification: 'Core Operational',
  classificationId: Classifications.CoreStrategic,
  ...
  province: 'British Columbia',
  rentableArea: 0,
  subOrganization: 'Insurance Corporation of BC',
  subOrganizationCode: 'ICBC',
  tenancy: '100% ICBC',
  transferLeaseOnSale: false,
};
