...
export const UPDATE_ORGANIZATION = 'UPDATE_USER';
export const SORT_ORGANIZATIONS = 'SORT_ORGANIZATIONS';
export const FILTER_ORGANIZATIONS = 'FILTER_ORGANIZATIONS';
export const SET_ORGANIZATIONS_PAGE_SIZE = 'SET_ORGANIZATIONS_PAGE_SIZE';
export const SET_ORGANIZATIONS_PAGE_INDEX = 'SET_ORGANIZATIONS_PAGE_INDEX';
export const GET_ORGANIZATION_DETAILS = 'GET_ORGANIZATION_DETAILS';
export const PUT_ORGANIZATION_DETAILS = 'PUT_ORGANIZATION_DETAILS';
