...
import ResearchFilter, { IResearchFilterProps } from './ResearchFilter';
...
const setup = (
  renderOptions: RenderOptions & IResearchFilterProps = { store: storeState, setFilter },
) => {
  const { filter, setFilter: setFilterFn, ...rest } = renderOptions;
  const utils = render(<ResearchFilter filter={filter} setFilter={setFilterFn} />, { ...rest });
