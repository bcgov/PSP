...
DELETE FROM PIMS_PROP_PROP_ACTIVITY WHERE PIMS_PROPERTY_ACTIVITY_ID IN (SELECT PIMS_PROPERTY_ACTIVITY_ID FROM PIMS_PROPERTY_ACTIVITY WHERE MANAGEMENT_FILE_ID IN (SELECT MANAGEMENT_FILE_ID FROM PIMS_MANAGEMENT_FILE WHERE APP_CREATE_USERID IN ('TRANPSP1', 'TRANPSP2')));
DELETE FROM PIMS_PROPERTY_ACTIVITY WHERE MANAGEMENT_FILE_ID IN (SELECT MANAGEMENT_FILE_ID FROM PIMS_MANAGEMENT_FILE WHERE APP_CREATE_USERID IN ('TRANPSP1', 'TRANPSP2'));
