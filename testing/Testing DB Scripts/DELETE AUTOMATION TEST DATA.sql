...
DELETE from PIMS_PROPERTY_ACQUISITION_FILE WHERE PROPERTY_ID IN (SELECT PROPERTY_ID FROM PIMS_PROPERTY WHERE PID IN (026063069, 008950504, 000346179, 000903574, 001031171, 001054945, 001054937, 025562959, 025562967, 023961139, 023961104, 023460491, 004424701, 005721172, 008949158, 003393640, 005723345, 028893140));
DELETE FROM PIMS_PROPERTY WHERE PID IN (026063069, 008950504, 000346179, 000903574, 001031171, 001054945, 001054937, 025562959, 025562967, 023961139, 023961104, 023460491, 004424701, 005721172, 008949158, 003393640, 005723345, 028893140);
...
UPDATE PIMS_PROPERTY SET IS_OWNED = 1, IS_RETIRED = 0, CONCURRENCY_CONTROL_NUMBER = CONCURRENCY_CONTROL_NUMBER + 1 WHERE PID IN (9117270, 17995345);
...
UPDATE PIMS_PROPERTY SET IS_OWNED = 1, IS_RETIRED = 0, CONCURRENCY_CONTROL_NUMBER = CONCURRENCY_CONTROL_NUMBER + 1 WHERE PID IN (014149478, 014151821, 014412942, 014412951, 028443969, 001282344, 008950504);
...
SELECT * FROM PIMS_PROPERTY WHERE PID IN (3799565, 8982961, 104698, 10087346, 99123677, 28753054, 1505360, 11126752, 1192396, 10598103, 10087346, 9483934, 10344250, 750166, 9583530, 14-083-736, 10087346, 8357412, 32214987, 8795932, 29210712,
10087346, 10344250, 10598103, 9483934, 10087346, 16689194)
