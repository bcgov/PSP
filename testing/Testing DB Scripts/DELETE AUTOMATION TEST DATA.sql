...
UPDATE PIMS_ACQUISITION_FILE_PERSON SET PERSON_ID = 1, CONCURRENCY_CONTROL_NUMBER = CONCURRENCY_CONTROL_NUMBER + 1 WHERE ACQUISITION_FILE_PERSON_ID IN (SELECT ACQUISITION_FILE_PERSON_ID FROM PIMS_ACQUISITION_FILE_PERSON WHERE PERSON_ID IN (SELECT PERSON_ID FROM PIMS_PERSON WHERE APP_CREATE_USERID IN ('TRANPSP1', 'TRANPSP2', 'SUTAIRAK','PRAVKUMA')))
...
UPDATE PIMS_INTEREST_HOLDER SET ORGANIZATION_ID = 1, CONCURRENCY_CONTROL_NUMBER = CONCURRENCY_CONTROL_NUMBER + 1 WHERE ORGANIZATION_ID IN (SELECT ORGANIZATION_ID FROM PIMS_ORGANIZATION WHERE APP_CREATE_USERID IN ('TRANPSP1', 'TRANPSP2', 'SUTAIRAK','PRAVKUMA'));
...
UPDATE PIMS_LEASE SET PROJECT_ID = 1091, CONCURRENCY_CONTROL_NUMBER = CONCURRENCY_CONTROL_NUMBER + 1 WHERE PROJECT_ID IN (SELECT ID FROM PIMS_PROJECT WHERE APP_CREATE_USERID IN ('TRANPSP1', 'TRANPSP2', 'SUTAIRAK','PRAVKUMA'));
...
UPDATE PIMS_ACQUISITION_FILE SET PRODUCT_ID = 10674, CONCURRENCY_CONTROL_NUMBER = CONCURRENCY_CONTROL_NUMBER + 1 WHERE PRODUCT_ID IN (SELECT PRODUCT_ID FROM PIMS_PRODUCT WHERE PARENT_PROJECT_ID IN (SELECT ID FROM PIMS_PROJECT WHERE APP_CREATE_USERID IN ('TRANPSP1', 'TRANPSP2', 'SUTAIRAK','PRAVKUMA')));
...
UPDATE PIMS_COMPENSATION_REQUISITION SET ALTERNATE_PROJECT_ID = 1091, CONCURRENCY_CONTROL_NUMBER = CONCURRENCY_CONTROL_NUMBER + 1 WHERE ALTERNATE_PROJECT_ID IN (SELECT ID FROM PIMS_PROJECT WHERE APP_CREATE_USERID IN ('TRANPSP1', 'TRANPSP2', 'SUTAIRAK','PRAVKUMA'))
