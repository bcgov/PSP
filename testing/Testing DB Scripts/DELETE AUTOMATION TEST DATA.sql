...
DELETE FROM PIMS_CONTACT_METHOD  WHERE APP_CREATE_USERID IN ('TRANPSP1', 'TRANPSP2');
DELETE FROM PIMS_COMP_REQ_LEASE_PAYEE WHERE LEASE_STAKEHOLDER_ID IN (SELECT LEASE_STAKEHOLDER_ID FROM PIMS_LEASE_STAKEHOLDER WHERE APP_CREATE_USERID IN ('TRANPSP1', 'TRANPSP2'));
DELETE FROM PIMS_LEASE_STAKEHOLDER WHERE APP_CREATE_USERID IN ('TRANPSP1', 'TRANPSP2');
...
DELETE FROM PIMS_MANAGEMENT_FILE_CONTACT WHERE PRIMARY_CONTACT_ID IN (SELECT PRIMARY_CONTACT_ID FROM PIMS_PERSON WHERE APP_CREATE_USERID IN ('TRANPSP1', 'TRANPSP2'));
DELETE FROM PIMS_COMP_REQ_LEASE_PAYEE WHERE LEASE_STAKEHOLDER_ID IN (SELECT LEASE_STAKEHOLDER_ID FROM PIMS_LEASE_STAKEHOLDER WHERE APP_CREATE_USERID IN ('TRANPSP1', 'TRANPSP2'));
UPDATE PIMS_LEASE_STAKEHOLDER SET PRIMARY_CONTACT_ID = 1, CONCURRENCY_CONTROL_NUMBER = CONCURRENCY_CONTROL_NUMBER + 1 WHERE PRIMARY_CONTACT_ID IN (SELECT PRIMARY_CONTACT_ID FROM PIMS_PERSON WHERE APP_CREATE_USERID IN ('TRANPSP1', 'TRANPSP2'));
DELETE FROM PIMS_CONTACT_METHOD WHERE PERSON_ID IN (SELECT PERSON_ID FROM PIMS_PERSON WHERE APP_CREATE_USERID IN ('TRANPSP1', 'TRANPSP2'));
DELETE FROM PIMS_PERSON_ADDRESS WHERE PERSON_ID IN (SELECT PERSON_ID FROM PIMS_PERSON WHERE APP_CREATE_USERID IN ('TRANPSP1', 'TRANPSP2'));
DELETE FROM PIMS_PERSON_ORGANIZATION WHERE PERSON_ID IN (SELECT PERSON_ID FROM PIMS_PERSON WHERE APP_CREATE_USERID IN ('TRANPSP1', 'TRANPSP2'));
...
UPDATE PIMS_LEASE_STAKEHOLDER SET ORGANIZATION_ID = 3, CONCURRENCY_CONTROL_NUMBER = CONCURRENCY_CONTROL_NUMBER + 1 WHERE ORGANIZATION_ID IN (SELECT ORGANIZATION_ID FROM PIMS_ORGANIZATION WHERE APP_CREATE_USERID IN ('TRANPSP1', 'TRANPSP2'));
...
DELETE FROM PIMS_SECURITY_DEPOSIT_HOLDER WHERE ORGANIZATION_ID IN (SELECT ORGANIZATION_ID FROM PIMS_ORGANIZATION WHERE APP_CREATE_USERID IN ('TRANPSP1', 'TRANPSP2'));
...
UPDATE PIMS_PROPERTY SET IS_OWNED = 1, CONCURRENCY_CONTROL_NUMBER = CONCURRENCY_CONTROL_NUMBER + 1 WHERE PID = 013215469;

DELETE FROM PIMS_DISPOSITION_FILE_PROPERTY WHERE PROPERTY_ID IN (SELECT PROPERTY_ID FROM PIMS_PROPERTY WHERE PID = 026172810);
DELETE from pims_property where pid = 026172810
select * from pims_property_vw where pid = 026172810
SELECT * FROM PIMS_PROPERTY WHERE PID = 1465201
select * from pims_property_vw where pid = 013215469
