...
export class ResearchViewFileDetails extends LayoutPage {
    ...
    constructor(page: Page) {
        ...
        this.researchProjectContent = page.locator("//label[text()='Ministry project']/parent::div/following-sibling::div");

        this.reseachRoadTitle = page.getByText('Roads', { exact: true });
        this.researchRoadNameLabel = page.locator('label:has-text("Road name:")');
        this.researchRoadNameContent = page.locator("//label[text()='Road name:']/parent::div/following-sibling::div");
        this.researchRoadAliasLabel = page.locator('label:has-text("Road alias:")');
        this.researchRoadAliasContent = page.locator("//label[text()='Road alias:']/parent::div/following-sibling::div");
        ...
        this.researchPurposeContent = page.locator("//label[text()='Research purpose:']/parent::div/following-sibling::div");
        this.researchRequestDateLabel = page.getByText('Request date:', { exact: true });
        this.researchRequestDateContent = page.locator("//label[text()='Request date:']/parent::div/following-sibling::div");
        this.researchSourceRequestLabel = page.getByText('Source of request:', { exact: true });
        this.researchSourceRequestContent = page.locator("//label[text()='Source of request:']/parent::div/following-sibling::div");
        this.researchRequesterLabel = page.locator('label:has-text("Requester:")');
        this.researchRequesterContent = page.locator("//label[text()='Source of request:']/parent::div/following-sibling::div");
        this.researchDescriptionLabel = page.locator('label:has-text("Requester:")');
        this.researchDescriptionContent = page.locator("//label[text()='Requester:']/parent::div/following-sibling::div");
