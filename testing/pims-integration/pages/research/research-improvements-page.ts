...
export class ResearchImprovementsPage extends LayoutPage {
    ...
    constructor(page: Page) {
        ...
        this.reseachImprovementsTooltip = page.locator('div').filter({ hasText: 'Improvements' }).first();
        this.reseachImprovementsInstructions = page.getByText('Click on a property to edit that property improvements in a new tab', { exact: true });
