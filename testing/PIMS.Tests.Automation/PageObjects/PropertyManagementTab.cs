    ...
    public class PropertyManagementTab : PageObjectBase
    {
        ...
        public void VerifyLastInsertedActivityTable(PropertyActivity activity)
        {
            ...
            foreach(string subType in activity.PropertyActivitySubType)
                AssertTrueElementContains(By.XPath("//div[contains(text(),'Activities List')]/parent::div/parent::div/parent::div/parent::h2/following-sibling::div/div[@data-testid='PropertyManagementActivitiesTable']/div[@class='tbody']/div[@class='tr-wrapper']["+ lastInsertedActivityIndex +"]/div/div[@role='cell'][2]"), subType);
