...
namespace PIMS.Tests.Automation.PageObjects
{
    public class DigitalDocuments : PageObjectBase
    {
        ...
        private By documentOtherTypeRoadNameLabel = By.XPath("//label[contains(text(),'Road name')]");
        ...
        private By documentDistrictRoadRegisterTypeRoadNameLabel = By.XPath("//label[contains(text(),'Road name')]");
        ...
        private By documentTransferAdmTypeRoadNameLabel = By.XPath("//label[contains(text(),'Road name')]");
        ...
        private By documentMinisterialOrderTypeRoadNameLabel = By.XPath("//label[contains(text(),'Road name')]");
        ...
        private By documentPhotosCorrespondenceTypeOwnerLabel = By.XPath("//label[contains(text(),'Owner')]");
        ...
        private By documentOICTypeRoadNameLabel = By.XPath("//label[contains(text(),'Road name')]");
        ...
        private By documentGazetteRoadNameLabel = By.XPath("//label[contains(text(),'Road name')]");
