...
Scenario: 03._Disposition_Offers_and_Sale_Tab
...
Scenario: 04._Disposition_File_Agreements_Tab
	...
	And I update an Agreement within a Disposition File from row number 17
...
Scenario: 06._Disposition_Files_Digital_Documents
...
Scenario: 07._Disposition_File_Notes
...
Scenario: 08._Disposition_File_from_Parcel
	Given I create a Disposition File from a pin on map from row number 12
	Then A new Disposition file is created successfully

Scenario: 09._Disposition_Files_List_View
...
Scenario: 10._Disposition_File_Main_Path
...
Scenario: 11._Disposition_File_Sales_Price_Error
...
Scenario: 12._Disposition_File_Not_Sold_Status_Error
	Given I create a new Disposition File from row number 14
	When I create Appraisal, Assessment, Offers and Sales Details within a Disposition File
	And I change status of the Disposition File
	Then Disposition File without SOLD Status error appears

Scenario: 13._Disposition_File_Non-Core_Inventory_Error
