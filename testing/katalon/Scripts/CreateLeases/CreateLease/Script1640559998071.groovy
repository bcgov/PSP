...
// Insert MOTI Contact
WebUI.setText(findTestObject('LeaseLicenses/createLease/inputMotiContact'), 'MOTI Test Contact')
...
WebUI.setText(findTestObject('LeaseLicenses/createLease/inputLocationDocuments'), 'Location of documents test')
...
// Insert description
WebUI.setText(findTestObject('LeaseLicenses/createLease/textareaDescription'), 'Description test')

// Insert notes
WebUI.setText(findTestObject('LeaseLicenses/createLease/textareaNotes'), 'Notes Test')
