...
WebUI.setText(findTestObject('Object Repository/Contacts/ContactFilterName'), "jonn")

// Search
WebUI.click(findTestObject('Object Repository/Contacts/FilterSearchButton'))

// Ensure corresponding contact appears after partial text search
WebUI.verifyTextPresent(GlobalVariable.contactEmail, false)
