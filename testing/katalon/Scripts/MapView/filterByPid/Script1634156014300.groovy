...
// Gather text contents of file to check data (treating text file as source of truth)
String currentDir = new File("Scripts/MapView/filterByPid").getAbsolutePath()
String file = new File("${currentDir}/propertyData.txt").text
