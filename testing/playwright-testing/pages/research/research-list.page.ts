...
export class ResearchListPage extends LayoutPage {
    ...
    constructor(page: Page) {
        ...
        this.researchNewButton = page.getByRole('button', { name: /Create a Research File/i });
        ...
        this.researchTableCreatedDateHeader = page.locator(':text-is("Created date")');
        this.researchTableOrderCreatedDate = page.getByTestId('sort-column-appCreateTimestamp')
        this.researchTableLastUpdatedByHeader = page.locator(':text-is("Last updated by")');
        ...
        this.researchTableContent = page.locator("div[data-testid='researchFilesTable'] div[class='tbody'] div[class='tr-wrapper']");

        this.researchTableEntriesSpan = page.locator("input[data-testid='input-page-size']");
        this.researchTablePagination5 = page.locator("div[class='Menu-options scrollable list-group'] div[title='menu-item-5']");
