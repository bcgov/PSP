...
export class HelpDeskPage extends LayoutPage {
  ...
  constructor(page: Page) {
    ...
    this.page = page;
    this.helpDeskTitle = page.locator("div[class='modal-title h4']", {
      hasText: "Help Desk",
    });
    this.helpDeskSubTitle = page.locator(
      "div[class='modal-body'] h3:first-child",
      { hasText: "Get started with PIMS" }
    );
    this.helpDeskInstructions = page
      .locator("div[class='modal-body'] p")
      .first();
    this.helpDeskPIMSResourcesLink = page.locator(
      "//a[contains(text(),'PIMS Training Materials')]"
    );
    this.helpDeskContactUsSubtitle = page.locator(
    ...
    this.helpDeskDescriptionLabel = page.locator(
    ...
    this.helpDeskFooterQuestion = page
      .locator("div[class='modal-body'] p")
      .last();
