...
class AcquisitionDetails {
  ...
  async navigateToAcquisitionFileListView() {
    ...
    await this.page.locator("//a[contains(text(),'Manage Acquisition Files')]").click();
  }
  ...
  async navigateToCreateNewAcquisitionFile() {
    ...
    await this.page.locator("//a[contains(text(),'Create an Acquisition File')]").click();
  }
  ...
  async verifyAcquisitionFileCreateForm() {
    ...
    await expect(this.page.locator("//label[contains(text(),'Ministry project')]")).toBeVisible();
    await expect(this.page.locator("#typeahead-project")).toBeVisible();
    await expect(this.page.locator("//label[contains(text(),'Funding')]")).toBeVisible();
    await expect(this.page.locator("#input-fundingTypeCode")).toBeVisible();

    await expect(this.page.locator("//h2/div/div[text()='Progress Statuses']")).toBeVisible();
    await expect(this.page.locator("//label[contains(text(),'File progress')]")).toBeVisible();
    await expect(this.page.locator("#multiselect-progressStatuses_input")).toBeVisible();
    await expect(this.page.locator("//label[contains(text(),'Appraisal')]")).toBeVisible();
    await expect(this.page.locator("#input-appraisalStatusType")).toBeVisible();
    await expect(this.page.locator("//label[contains(text(),'Legal survey')]")).toBeVisible();
    await expect(this.page.locator("#input-legalSurveyStatusType")).toBeVisible();
    await expect(this.page.locator("//label[contains(text(),'Type of taking')]")).toBeVisible();
    await expect(this.page.locator("#multiselect-takingStatuses_input")).toBeVisible();
    await expect(this.page.locator("//label[contains(text(),'Expropriation risk')]")).toBeVisible();
    await expect(this.page.locator("#input-expropiationRiskStatusType")).toBeVisible();

    await expect(this.page.locator("//h2/div/div[text()='Schedule']")).toBeVisible();
    await expect(this.page.locator("//label[contains(text(),'Assigned date')]")).toBeVisible();
    await expect(this.page.locator("#datepicker-assignedDate")).toBeVisible();
    await expect(this.page.locator("//label[contains(text(),'Delivery date')]")).toBeVisible();
    await expect(this.page.locator("#datepicker-deliveryDate")).toBeVisible();
    await expect(this.page.locator("//label[contains(text(),'Estimated date')]")).toBeVisible();
    await expect(this.page.locator("#datepicker-estimatedCompletionDate")).toBeVisible();
    await expect(this.page.locator("//label[contains(text(),'Possession date')]")).toBeVisible();
    ...
    await expect(this.page.locator("//p[contains(text(),'Select one or more properties that you want to include in this acquisition. You can choose a location from the map, or search by other criteria.')]")).toBeVisible();
    ...
    await expect(this.page.locator("//h2/div/div[text()='Acquisition Details']")).toBeVisible();
    await expect(this.page.locator("//label[contains(text(),'Acquisition file name')]")).toBeVisible();
    await expect(this.page.locator("#input-fileName")).toBeVisible();
    await expect(this.page.locator("//label[contains(text(),'Historical file number')]")).toBeVisible();
    await expect(this.page.locator("#input-legacyFileNumber")).toBeVisible();
    await expect(this.page.locator("//label[contains(text(),'Physical file status')]")).toBeVisible();
    await expect(this.page.locator("#input-acquisitionPhysFileStatusType")).toBeVisible();
    await expect(this.page.locator("//label[contains(text(),'Physical file details')]")).toBeVisible();
    await expect(this.page.locator("#input-physicalFileDetails")).toBeVisible();
    await expect(this.page.locator("//label[contains(text(),'Acquisition type')]")).toBeVisible();
    await expect(this.page.locator("#input-acquisitionType")).toBeVisible();
    await expect(this.page.locator("//label[contains(text(),'Ministry region')]")).toBeVisible();
    await expect(this.page.locator("#input-region")).toBeVisible();

    await expect(this.page.locator("//h2/div/div[text()='Acquisition Team']")).toBeVisible();
    await expect(this.page.getByTestId("add-team-member")).toBeVisible();

    await expect(this.page.locator("//h2/div/div[text()='Owners']")).toBeVisible();
    await expect(this.page.locator("//p[contains(text(),'Each property in this file should be owned by the owner(s) in this section')]")).toBeVisible();
    await expect(this.page.getByTestId("add-file-owner")).toBeVisible();

    await expect(this.page.locator("//label[contains(text(),'Owner solicitor')]")).toBeVisible();
    await expect(this.page.locator("#input-ownerSolicitor.contact.id")).toBeVisible();
    await expect(this.page.locator("//label[contains(text(),'Owner representative')]")).toBeVisible();
    await expect(this.page.locator("#input-ownerRepresentative.contact.id")).toBeVisible();
    await expect(this.page.locator("//label[contains(text(),'Comment')]")).toBeVisible();
    await expect(this.page.locator("#input-ownerRepresentative.comment")).toBeVisible();
    const contactManagerBttns = await this.page.locator("button[title='Select Contact']");
    expect(contactManagerBttns).toHaveCount(2);

    const tooltips = await this.page.getByTestId("tooltip-icon-section-field-tooltip");
  ...
  async verifyAcquisitionListView() {
    ...
    await expect(this.page.locator("//h1/div/div/span[contains(text(),'Acquisition Files')]")).toBeVisible();
    ...
    await expect(this.page.locator("#multiselect-acquisitionTeamMembers_input")).toBeVisible();
    await expect(this.page.locator("#input-ownerName")).toBeVisible();
    await expect(this.page.locator("#input-acquisitionFileStatusTypeCode")).toBeVisible();
    ...
    await expect(this.page.locator("//div[@role='table']/div[@class='thead thead-light']/div/div/div[contains(text(),'Acquisition file #')]")).toBeVisible();
    await expect(this.page.getByTestId("sort-column-fileNumber")).toBeVisible();
    await expect(this.page.locator("//div[@role='table']/div[@class='thead thead-light']/div/div/div[contains(text(),'Historical file #')]")).toBeVisible();
    await expect(this.page.getByTestId("sort-column-legacyFileNumber")).toBeVisible();
    await expect(this.page.locator("//div[@role='table']/div[@class='thead thead-light']/div/div/div[contains(text(),'Acquisition file name')]")).toBeVisible();
    await expect(this.page.getByTestId("sort-column-fileName")).toBeVisible();
    await expect(this.page.locator("//div[@role='table']/div[@class='thead thead-light']/div/div/div[contains(text(),'MOTT region')]")).toBeVisible();
    await expect(this.page.locator("//div[@role='table']/div[@class='thead thead-light']/div/div/div[contains(text(),'Projects')]")).toBeVisible();
    await expect(this.page.locator("//div[@role='table']/div[@class='thead thead-light']/div/div/div[contains(text(),'Team member')]")).toBeVisible();
    await expect(this.page.locator("//div[@role='table']/div[@class='thead thead-light']/div/div/div[contains(text(),'Owner')]")).toBeVisible();
    await expect(this.page.locator("//div[@role='table']/div[@class='thead thead-light']/div/div/div[contains(text(),'Civic Address / PID / PIN')]")).toBeVisible();
    await expect(this.page.locator("//div[@role='table']/div[@class='thead thead-light']/div/div/div[contains(text(),'Status')]")).toBeVisible();
    await expect(this.page.getByTestId("sort-column-acquisitionFileStatusTypeCode")).toBeVisible();

    const acquisitionTableCount =  await this.page.locator("div[data-testid='acquisitionFilesTable'] div[class='tbody'] div[class='tr-wrapper']");
