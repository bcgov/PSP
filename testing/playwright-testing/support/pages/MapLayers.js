...
class MapLayers {
  ...
  async verifyMapLayersForm() {
    await expect(
      this.page.locator("//div[contains(text(),'PIMS')]")
    ).toBeVisible();
    ...
    await expect(
      this.page.locator("label[for='administrative_group']")
    ).toBeVisible();
    await expect(this.page.locator("#administrative_group")).toBeVisible();
    await expect(
      this.page.locator("label[for='legalHighwayResearch']")
    ).toBeVisible();
    ...
    await expect(
      this.page.locator("label[for='federal_bc_parks']")
    ).toBeVisible();
