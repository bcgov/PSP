class SharedModal {
    ...
    async toastText()
    {
      return await this.page.locator("div[class='Toastify__toast-body']").textContent();
    }
    ...
    async modalText2()
    {
      return await this.page.locator("div[class='modal-body'] strong").textContent();
    }

    async modalParagraph1()
    {
      return await this.page.locator("div[class='modal-body'] p:first-child").textContent();
    }

    async modalParagraph2()
    {
      return await this.page.locator("div[class='modal-body'] p:last-child").textContent();
    }
    ...
    async cancelActionModal()
    {
        if (this.isModalContainerVisible()) {
            await expect(this.mainModalHeaderContent()).resolves.toBe("Confirm Changes");
            await expect(this.mainModalContent()).resolves.toBe("If you choose to cancel now, your changes will not be saved.");
            await expect(this.mainModalContent()).resolves.toContain("Do you want to proceed?");
