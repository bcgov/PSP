class SharedFileProperties {
  ...
  async verifyPropertiesToIncludeInFileInitForm() {
    ...
    await this.page.locator('div:has-text("Properties to include in this file")').isVisible();
    await this.page.locator('p:has-text("Select one or more properties that you want to include in this disposition. You can choose a location from the map, or search by other criteria.")').isVisible();
    ...
    await page.getByTestId('tooltip-icon-property-selector-tooltip').isVisible();
