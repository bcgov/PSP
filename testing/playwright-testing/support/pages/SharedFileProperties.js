...
class SharedFileProperties {
  ...
  async countInsertedPropertiesOnFilePropDetails() {
    const deleteBttns = await this.page.locator("button[data-testid*='delete-property']");
  ...
  async countInsertedPropertiesOnFileSideBar() {
    const propertiuesElements = await this.page.locator("div[data-testid*='menu-item-property']]");
