...
class LeaseLicence {
  ...
  async navigateCreateLease() {
    ...
    async verifyCreateLeaseForm() {
      ...
      await expect(this.page.locator("//h2/div/div[contains(text(),'Original Agreement')]")).toBeVisible();
      ...
      await expect(this.page.getByTestId("tooltip-icon-lease-status-tooltip")).toBeVisible();
      await expect(this.page.locator("#input-statusTypeCode")).toBeVisible();
      await expect(this.page.locator("//label[contains(text(),'Account type')]")).toBeVisible();
      await expect(this.page.locator("#input-paymentReceivableTypeCode")).toBeVisible();
      await expect(this.page.locator("//label[contains(text(),'Commencement')]")).toBeVisible();
      await expect(this.page.getByTestId("tooltip-icon-lease-commencement-tooltip")).toBeVisible();
      await expect(this.page.locator("#datepicker-startDate")).toBeVisible();
      await expect(this.page.locator("//label[contains(text(),'Expiry')]")).toBeVisible();
      await expect(this.page.getByTestId("tooltip-icon-lease-expiry-tooltip")).toBeVisible();
      ...
      await expect(this.page.locator("//div[contains(text(),'Select one or more properties that you want to include in this lease/licence file. You can choose a location from the map, or search by other criteria.')]")).toBeVisible();
      ...
      await expect(this.page.locator("//h2/div/div[contains(text(),'Administration')]")).toBeVisible();
      await expect(this.page.locator("//div[contains(text(),'Help with choosing the agreement Program, Type and Purpose')]")).toBeVisible();
      await expect(this.page.locator("//label[contains(text(),'MOTT contact')]")).toBeVisible();
      ...
      await expect(this.page.locator("//label[contains(text(),'Program')]")).toBeVisible();
      await expect(this.page.locator("#input-programTypeCode")).toBeVisible();
      await expect(this.page.locator("//label[contains(text(),'Type')]")).toBeVisible();
      await expect(this.page.locator("#input-leaseTypeCode")).toBeVisible();
      await expect(this.page.locator("//label[contains(text(),'Purpose')]")).toBeVisible();
      await expect(this.page.locator("#multiselect-purposes_input")).toBeVisible();
      await expect(this.page.locator("//label[contains(text(),'Initiator')]")).toBeVisible();
      await expect(this.page.locator("#input-initiatorTypeCode")).toBeVisible();
      await expect(this.page.locator("//label[contains(text(),'Responsibility')]")).toBeVisible();
      await expect(this.page.locator("#input-responsibilityTypeCode")).toBeVisible();
      await expect(this.page.locator("//label[contains(text(),'Effective date')]")).toBeVisible();
      await expect(this.page.locator("#datepicker-responsibilityEffectiveDate")).toBeVisible();
      await expect(this.page.locator("//label[contains(text(),'Intended use')]")).toBeVisible();
      await expect(this.page.locator("#input-description")).toBeVisible();
      await expect(this.page.locator("//label[contains(text(),'Primary arbitration city')]")).toBeVisible();
      await expect(this.page.locator("#input-primaryArbitrationCity")).toBeVisible();

      await expect(this.page.locator("//h2/div/div[contains(text(),'Lease & Licence Team')]")).toBeVisible();
      await expect(this.page.getByTestId("add-team-member")).toBeVisible();

      const tooltips = await this.page.getByTestId("tooltip-icon-lease-status-tooltip");
