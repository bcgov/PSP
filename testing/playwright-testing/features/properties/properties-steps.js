...
Given("I search for a property by PID from row number {int}", async function (rowNbr) {
...
Given("I search for a property by Plan number from row number {int}", async function (rowNbr) {
  searchPropertiesData = searchPropertiesJson[rowNbr];
});

Given("I search for a property by coordinates from row number {int}", async function (rowNbr) {
 searchPropertiesData = searchPropertiesJson[rowNbr];
});
