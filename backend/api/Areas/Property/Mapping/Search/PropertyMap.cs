    ...
    public class PropertyMap : IRegister
    {
        public void Register(TypeAdapterConfig config)
        {
            config.NewConfig<Entity.PimsProperty, Model.PropertyModel>()
                ...
                .Map(dest => dest.TenureId, src => src.PimsPropPropTenureTypes.FirstOrDefault())
                .Map(dest => dest.Tenure, src => src.PimsPropPropTenureTypes.FirstOrDefault() != null ? src.PimsPropPropTenureTypes.FirstOrDefault().PropertyTenureTypeCodeNavigation.Description : null)
