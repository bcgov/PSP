    ...
    public class LeaseMap : IRegister
    {
        public void Register(TypeAdapterConfig config)
        {
            config.NewConfig<Entity.PimsLease, Model.LeaseModel>()
                ...
                .Map(dest => dest.OtherPurposeType, src => src.OtherLeasePurposeType)
                .Map(dest => dest.OtherPurposeType, src => src.LeasePurposeOtherDesc)
            ...
            config.NewConfig<Model.LeaseModel, Entity.PimsLease>()
                ...
                .Map(dest => dest.RegionCode, src => src.Region.RegionCode)
