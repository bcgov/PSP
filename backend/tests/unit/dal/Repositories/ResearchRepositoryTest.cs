    ...
    public class ResearchRepositoryTest
    {
        ...
        public static IEnumerable<object[]> ResearchFilterData =>
            new List<object[]>
            {
                ...
                new object[] { new ResearchFilter() { CreatedOnStartDate = DateTime.Now.Date.AddDays(1) }, 0 },
                new object[] { new ResearchFilter() { UpdatedOnStartDate = DateTime.Now.Date }, 1 },
                new object[] { new ResearchFilter() { UpdatedOnStartDate = DateTime.Now.Date.AddDays(1) }, 0 },
                new object[] { new ResearchFilter() { CreatedOnEndDate = DateTime.Now.Date }, 1 },
