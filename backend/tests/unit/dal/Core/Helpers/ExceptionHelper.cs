    ...
    public class ExceptionHelperTest
    {
        ...
        public static IEnumerable<object[]> Data =>
            new List<object[]>
            {
                ...
                new object[] { new[] { new Entity.PropertyType("test1", ""), new Entity.PropertyType("test2", "") }, 10 }
            };
        #endregion
        ...
        {
            // Arrange
            static Entity.Property get() => throw new KeyNotFoundException();
        ...
        public void HandleKeyNotFound_WithDefaultInstance()
        {
            ...
            Assert.IsType<Entity.Property>(result);
        }
