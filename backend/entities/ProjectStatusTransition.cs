...
namespace Pims.Dal.Entities
{
    ...
    /// </summary>
    [MotiTable("PIMS_PROJ_STATUS_TRANSITION", "PRJSTR")]
    public class ProjectStatusTransition : BaseEntity
    {
        #region Properties
        /// <summary>
        /// get/set - Primary key to identity the project status transition.
        /// </summary>
        [Column("PROJECT_STATUS_TRANSITION_ID")]
        ...
        [ForeignKey("PIMS_WRPRST_PIMS_PRSTTX_FROM_FK")]
        public long FromWorkflowStatusId { get; set; }
        ...
        [ForeignKey("PIMS_WRPRST_PIMS_PRSTTX_TO_FK")]
        public long ToWorkflowStatusId { get; set; }
