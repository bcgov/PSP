...
{
    [Keyless]
    [Table("BCA_JURISDICTION_BCTRANSIT_VALUE")]
    [Index(nameof(JurisdictionCode), Name = "BCJTRV_JURISDICTION_CODE_IDX")]
    public partial class BcaJurisdictionBctransitValue
    {
