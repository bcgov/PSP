        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MUNICIPALITY_NAME = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true, comment: "The municipality location"),
                    POSTAL_CODE = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true, comment: "The postal code of the address"),
                    LATITUDE = table.Column<decimal>(type: "NUMERIC(8,6)", nullable: true, comment: "GIS latitude location"),
                    LONGITUDE = table.Column<decimal>(type: "NUMERIC(9,6)", nullable: true, comment: "GIS longitude location"),
                    CONCURRENCY_CONTROL_NUMBER = table.Column<long>(type: "BIGINT", nullable: false, defaultValue: 1L, comment: "Concurrency control number"),
                    APP_CREATE_TIMESTAMP = table.Column<DateTime>(type: "DATETIME", nullable: false, defaultValueSql: "GETUTCDATE()", comment: "When this record was created"),
                    APP_CREATE_USERID = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false, comment: "Reference to the username who created this record"),
                    APP_CREATE_USER_GUID = table.Column<Guid>(type: "uniqueidentifier", nullable: true, comment: "Reference to the user uid who created this record"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NAME_SUFFIX = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, comment: "Person's name suffix (Mr, Mrs, Miss)."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LOCATION = table.Column<Point>(type: "GEOMETRY", nullable: true, comment: "A geo-spatial point where the property is located"),
                    BOUNDARY = table.Column<Geometry>(type: "GEOMETRY", nullable: true, comment: "A geo-spatial description of the property boundary"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    POSITION = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true, comment: "The user's position or job title"),
                    ...
                    LAST_LOGIN = table.Column<DateTime>(type: "DATETIME", nullable: true, comment: "The date the user last logged in"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NOTE = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true, comment: "A note to describe the access request reason"),
                    CONCURRENCY_CONTROL_NUMBER = table.Column<long>(type: "BIGINT", nullable: false, defaultValue: 1L, comment: "Concurrency control number"),
                    APP_CREATE_TIMESTAMP = table.Column<DateTime>(type: "DATETIME", nullable: false, defaultValueSql: "GETUTCDATE()", comment: "When this record was created"),
                    APP_CREATE_USERID = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false, comment: "Reference to the username who created this record"),
                    APP_CREATE_USER_GUID = table.Column<Guid>(type: "uniqueidentifier", nullable: true, comment: "Reference to the user uid who created this record"),
