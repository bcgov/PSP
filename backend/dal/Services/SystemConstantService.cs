...
namespace Pims.Dal.Services
{
    ...
    /// </summary>
    public class SystemConstantService : BaseService<PimsStaticVariable>, ISystemConstantService
    {
        #region Constructors
        /// <summary>
        ...
        public SystemConstantService(PimsContext dbContext, ClaimsPrincipal user, IPimsService service, ILogger<SystemConstantService> logger, IMapper mapper) : base(dbContext, user, service, logger, mapper) { }
        #endregion
