...
namespace Pims.Dal.Repositories
{
    ...
    public class ActivityTemplateRepository : BaseRepository<PimsActivityTemplate>, IActivityTemplateRepository
    {
        ...
        public ActivityTemplateRepository(PimsContext dbContext, ClaimsPrincipal user, IPimsRepository service, ILogger<ResearchFileRepository> logger, IMapper mapper) : base(dbContext, user,  logger) { }
        #endregion
