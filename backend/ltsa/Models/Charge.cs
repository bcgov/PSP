...
namespace Pims.Ltsa.Models
{
    ...
    public partial class Charge
    {
        ...
        public Charge(string chargeNumber = default(string), string transactionType = default(string), DateTime? applicationReceivedDate = default(DateTime?), List<ChargeOwnershipGroup> chargeOwnershipGroups = default(List<ChargeOwnershipGroup>), List<CertificateOfCharge> certificatesOfCharge = default(List<CertificateOfCharge>), List<Altos1ChargeCorrection> correctionsAltos1 = default(List<Altos1ChargeCorrection>), List<ChargeCorrection> corrections = default(List<ChargeCorrection>))
        {
