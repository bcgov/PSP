...
namespace Pims.Ltsa.Models
{
    ...
    public partial class ChargeOwnershipGroupChargeOwner
    {
        ...
        public ChargeOwnershipGroupChargeOwner(string lastNameOrCorpName1 = default(string), string lastNameOrCorpName2 = default(string), string givenName = default(string), string incorporationNumber = default(string))
        {
