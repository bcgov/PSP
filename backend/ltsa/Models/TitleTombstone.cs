...
namespace Pims.Ltsa.Models
{
    ...
    public partial class TitleTombstone
    {
        ...
        public TitleTombstone(DateTime? applicationReceivedDate = default(DateTime?), DateTime? enteredDate = default(DateTime?), string titleRemarks = default(string), string rootOfTitle = default(string), DateTime? cancellationDate = default(DateTime?), string marketValueAmount = default(string), List<TitleIdentifier> fromTitles = default(List<TitleIdentifier>), List<NatureOfTransfer> natureOfTransfers = default(List<NatureOfTransfer>))
        {
