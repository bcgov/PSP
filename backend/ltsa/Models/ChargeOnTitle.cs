...
namespace Pims.Ltsa.Models
{
    ...
    public partial class ChargeOnTitle
    {
        ...
        public ChargeOnTitle(string chargeNumber = default(string), StatusEnum status = default(StatusEnum), CancellationTypeEnum? cancellationType = default(CancellationTypeEnum?), DateTime? enteredDate = default(DateTime?), InterAliaEnum interAlia = default(InterAliaEnum), string chargeRemarks = default(string), ChargeRelease chargeRelease = default(ChargeRelease), Charge charge = default(Charge))
        {
