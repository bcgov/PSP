...
namespace Pims.Ltsa.Models
{
    ...
    public partial class LegalNotation
    {
        ...
        public LegalNotation(DateTime? applicationReceivedDate = default(DateTime?), string originalLegalNotationNumber = default(string), string planIdentifier = default(string), string legalNotationText = default(string), List<Altos1LegalNotationCorrection> correctionsAltos1 = default(List<Altos1LegalNotationCorrection>), List<LegalNotationCorrection> corrections = default(List<LegalNotationCorrection>))
        {
