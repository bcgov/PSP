...
namespace Pims.Ltsa.Models
{
    ...
    public partial class Altos1TitleCorrection
    {
        ...
        public Altos1TitleCorrection(string number = default(string), string referenceDescription = default(string), DateTime? enteredDate = default(DateTime?), DateTime? correctionDate = default(DateTime?), string previousCorrectionNumber = default(string), string correctionText = default(string))
        {
