...
namespace Pims.Ltsa.Models
{
    ...
    public partial class StrataPlanCommonPropertyProduct : ProductParent
    {
        ...
        public StrataPlanCommonPropertyProduct(StrataPlanCommonProperty strataPlanCommonProperty = default(StrataPlanCommonProperty), string href = default(string)) : base(href)
        {
