...
namespace Pims.Ltsa.Models
{
    ...
    public partial class StateTitleCertificateOrderParameters
    {
        ...
        public StateTitleCertificateOrderParameters(string titleNumber = default(string), string pendingApplicationNumber = default(string), string ltoClientNumber = default(string), string recipientName = default(string), LandTitleDistrictCode landTitleDistrictCode = default(LandTitleDistrictCode), RecipientAddress recipientAddress = default(RecipientAddress))
        {
