...
namespace Pims.Ltsa.Models
{
    ...
    public partial class RecipientAddress
    {
        ...
        public RecipientAddress(string addressLine1 = default(string), string addressLine2 = default(string), string city = default(string), string province = default(string), string postalCode = default(string), string country = default(string))
        {
