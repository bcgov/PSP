...
namespace Pims.Ltsa.Models
{
    ...
    public partial class DocOrPlanSummary
    {
        ...
        public DocOrPlanSummary(string docOrPlanNumber = default(string), string documentDistrict = default(string), LandTitleDistrictCode documentDistrictCode = default(LandTitleDistrictCode), StatusEnum? status = default(StatusEnum?))
        {
