...
namespace Pims.Ltsa.Models
{
    ...
    public partial class Altos1ChargeCorrection
    {
        ...
        public Altos1ChargeCorrection(string number = default(string), string referenceDescription = default(string), DateTime? enteredDate = default(DateTime?), DateTime? correctionDate = default(DateTime?), string previousCorrectionNumber = default(string), string correctionText = default(string))
        {
