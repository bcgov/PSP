...
namespace Pims.Ltsa.Models
{
    ...
    public partial class ParcelInfo
    {
        ...
        public ParcelInfo(string parcelIdentifier = default(string), StatusEnum status = default(StatusEnum), int? registeredTitlesCount = default(int?), int? pendingApplicationCount = default(int?), string miscellaneousNotes = default(string), ParcelTombstone tombstone = default(ParcelTombstone), LegalDescription legalDescription = default(LegalDescription), List<AssociatedPlan> associatedPlans = default(List<AssociatedPlan>))
        {
