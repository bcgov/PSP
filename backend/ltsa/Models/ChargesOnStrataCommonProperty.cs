...
namespace Pims.Ltsa.Models
{
    ...
    public partial class ChargesOnStrataCommonProperty
    {
        ...
        public ChargesOnStrataCommonProperty(StatusEnum status = default(StatusEnum), CancellationTypeEnum? cancellationType = default(CancellationTypeEnum?), DateTime? enteredDate = default(DateTime?), bool? interAlia = default(bool?), string chargeNumber = default(string), string chargeRemarks = default(string), Charge charge = default(Charge), ChargeRelease chargeRelease = default(ChargeRelease))
        {
