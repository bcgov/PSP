...
namespace Pims.Ltsa.Models
{
    ...
    public partial class Altos1LegalNotationCorrection
    {
        ...
        public Altos1LegalNotationCorrection(string number = default(string), string referenceDescription = default(string), DateTime? enteredDate = default(DateTime?), DateTime? correctionDate = default(DateTime?), string previousCorrectionNumber = default(string), string correctionText = default(string))
        {
