...
namespace Pims.Ltsa.Models
{
    ...
    public partial class OwnerAddress
    {
        ...
        public OwnerAddress(string addressLine1 = default(string), string addressLine2 = default(string), string city = default(string), CanadianProvince province = default(CanadianProvince), string provinceName = default(string), string country = default(string), string postalCode = default(string))
        {
