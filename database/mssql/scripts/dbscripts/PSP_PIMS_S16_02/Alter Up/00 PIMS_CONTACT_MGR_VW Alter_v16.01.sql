...
'MAILING' code value for ADDRESS_USAGE_TYPE_CODE rather than the deprecated 
'MAILADDR' code value.
*******************************************************************************/
...
alter table PIMS_LEASE alter column LEASE_CATEGORY_TYPE_CODE NVARCHAR(20) NULL
alter table PIMS_LEASE alter column LEASE_INITIATOR_TYPE_CODE NVARCHAR(20) NULL
alter table PIMS_LEASE alter column LEASE_PMT_FREQ_TYPE_CODE NVARCHAR(20) NULL
alter table PIMS_LEASE alter column LEASE_RESPONSIBILITY_TYPE_CODE NVARCHAR(20) NULL
alter table PIMS_LEASE_HIST alter column LEASE_CATEGORY_TYPE_CODE NVARCHAR(20) NULL
alter table PIMS_LEASE_HIST alter column LEASE_INITIATOR_TYPE_CODE NVARCHAR(20) NULL
alter table PIMS_LEASE_HIST alter column LEASE_PMT_FREQ_TYPE_CODE NVARCHAR(20) NULL
