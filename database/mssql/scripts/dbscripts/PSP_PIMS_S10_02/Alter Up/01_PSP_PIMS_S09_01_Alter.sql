-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Fri Sep 03 17:03:33 PDT 2021
-- Execute this script on:
-- 		PIMS_S09_01/dbo - This database/schema will be modified
...
PRINT N'Create sequence dbo.PIMS_L_FILE_NO_SEQ'
GO
CREATE SEQUENCE [dbo].[PIMS_L_FILE_NO_SEQ]
	AS bigint
	START WITH 0
...
PRINT N'Create sequence dbo.PIMS_PROPERTY_LEASE_ID_SEQ'
GO
CREATE SEQUENCE [dbo].[PIMS_PROPERTY_LEASE_ID_SEQ]
	AS bigint
	START WITH 1
...
PRINT N'Create sequence dbo.PIMS_LEASE_ID_SEQ'
GO
CREATE SEQUENCE [dbo].[PIMS_LEASE_ID_SEQ]
	AS bigint
	START WITH 1
...
PRINT N'Create table dbo.PIMS_LEASE_PMT_FREQ_TYPE'
GO
CREATE TABLE [dbo].[PIMS_LEASE_PMT_FREQ_TYPE]  ( 
...
PRINT N'Create table dbo.PIMS_LEASE_PROGRAM_TYPE'
GO
CREATE TABLE [dbo].[PIMS_LEASE_PROGRAM_TYPE]  ( 
	[CONCURRENCY_CONTROL_NUMBER]	bigint NOT NULL DEFAULT ((1)),
	[DB_CREATE_TIMESTAMP]       	datetime NOT NULL DEFAULT (getutcdate()),
...
PRINT N'Create table dbo.PIMS_LEASE_PURPOSE_SUBTYPE'
GO
CREATE TABLE [dbo].[PIMS_LEASE_PURPOSE_SUBTYPE]  ( 
	[CONCURRENCY_CONTROL_NUMBER]	bigint NOT NULL DEFAULT ((1)),
	[DB_CREATE_TIMESTAMP]       	datetime NOT NULL DEFAULT (getutcdate()),
	...
	PRIMARY KEY CLUSTERED([LEASE_PURPOSE_SUBTYPE_CODE])
 ON [PRIMARY])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
PRINT N'Create table dbo.PIMS_LEASE_PURPOSE_TYPE'
GO
CREATE TABLE [dbo].[PIMS_LEASE_PURPOSE_TYPE]  ( 
	[CONCURRENCY_CONTROL_NUMBER]	bigint NOT NULL DEFAULT ((1)),
	[DB_CREATE_TIMESTAMP]       	datetime NOT NULL DEFAULT (getutcdate()),
...
PRINT N'Create table dbo.PIMS_LEASE'
GO
CREATE TABLE [dbo].[PIMS_LEASE]  ( 
	...
	[DB_LAST_UPDATE_TIMESTAMP]      	datetime NOT NULL DEFAULT (getutcdate()),
	[DB_LAST_UPDATE_USERID]         	nvarchar(30) NOT NULL DEFAULT (user_name()),
	[EXPIRED]                       	bit NOT NULL DEFAULT (CONVERT([bit],(0))),
...
PRINT N'Create table dbo.PIMS_PROPERTY_LEASE'
GO
CREATE TABLE [dbo].[PIMS_PROPERTY_LEASE]  ( 
	[APP_CREATE_TIMESTAMP]          	datetime NOT NULL DEFAULT (getutcdate()),
	[APP_CREATE_USER_DIRECTORY]     	nvarchar(30) NOT NULL DEFAULT (user_name()),
...
PRINT N'Create sequence dbo.PIMS_LEASE_ACTIVITY_ID_SEQ'
GO
CREATE SEQUENCE [dbo].[PIMS_LEASE_ACTIVITY_ID_SEQ]
	AS bigint
	START WITH 1
...
PRINT N'Create sequence dbo.PIMS_LEASE_ACTIVITY_PERIOD_ID_SEQ'
GO
CREATE SEQUENCE [dbo].[PIMS_LEASE_ACTIVITY_PERIOD_ID_SEQ]
	AS bigint
	START WITH 1
...
PRINT N'Create table dbo.PIMS_LEASE_ACTIVITY_PERIOD'
GO
CREATE TABLE [dbo].[PIMS_LEASE_ACTIVITY_PERIOD]  ( 
	[APP_CREATE_TIMESTAMP]          	datetime NOT NULL DEFAULT (getutcdate()),
	[APP_CREATE_USER_DIRECTORY]     	nvarchar(30) NOT NULL DEFAULT (user_name()),
	...
	[DB_LAST_UPDATE_TIMESTAMP]      	datetime NOT NULL DEFAULT (getutcdate()),
	[DB_LAST_UPDATE_USERID]         	nvarchar(30) NOT NULL DEFAULT (user_name()),
	[IS_CLOSED]                     	bit NULL DEFAULT (CONVERT([bit],(0))),
	[LEASE_ACTIVITY_PERIOD_ID]      	bigint NOT NULL DEFAULT (NEXT VALUE FOR [PIMS_LEASE_ACTIVITY_PERIOD_ID_SEQ]),
	[PERIOD_DATE]                   	datetime NOT NULL DEFAULT (dateadd(month,datediff(month,(0),getutcdate()),(0))),
	PRIMARY KEY CLUSTERED([LEASE_ACTIVITY_PERIOD_ID])
 ON [PRIMARY])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
PRINT N'Create table dbo.PIMS_LEASE_SUBTYPE'
GO
CREATE TABLE [dbo].[PIMS_LEASE_SUBTYPE]  ( 
	[CONCURRENCY_CONTROL_NUMBER]	bigint NOT NULL DEFAULT ((1)),
	[DB_CREATE_TIMESTAMP]       	datetime NOT NULL DEFAULT (getutcdate()),
	...
	PRIMARY KEY CLUSTERED([LEASE_SUBTYPE_CODE])
 ON [PRIMARY])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
PRINT N'Create table dbo.PIMS_LEASE_TYPE'
GO
CREATE TABLE [dbo].[PIMS_LEASE_TYPE]  ( 
	[CONCURRENCY_CONTROL_NUMBER]	bigint NOT NULL DEFAULT ((1)),
	[DB_CREATE_TIMESTAMP]       	datetime NOT NULL DEFAULT (getutcdate()),
	...
	PRIMARY KEY CLUSTERED([LEASE_TYPE_CODE])
 ON [PRIMARY])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
PRINT N'Create table dbo.PIMS_LEASE_ACTIVITY'
GO
CREATE TABLE [dbo].[PIMS_LEASE_ACTIVITY]  ( 
	...
	[DB_LAST_UPDATE_TIMESTAMP]      	datetime NOT NULL DEFAULT (getutcdate()),
	[DB_LAST_UPDATE_USERID]         	nvarchar(30) NOT NULL DEFAULT (user_name()),
	[LEASE_ACTIVITY_ID]             	bigint NOT NULL DEFAULT (NEXT VALUE FOR [PIMS_LEASE_ACTIVITY_ID_SEQ]),
	[LEASE_ACTIVITY_PERIOD_ID]      	bigint NOT NULL,
	[LEASE_ID]                      	bigint NOT NULL,
	[LEASE_SUBTYPE_CODE]            	nvarchar(20) NOT NULL,
	[LEASE_TYPE_CODE]               	smallint NOT NULL,
	PRIMARY KEY CLUSTERED([LEASE_ACTIVITY_ID])
 ON [PRIMARY])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
PRINT N'Create table dbo.PIMS_EXPECTED_AMOUNT'
GO
CREATE TABLE [dbo].[PIMS_EXPECTED_AMOUNT]  ( 
	[APP_CREATE_TIMESTAMP]          	datetime NOT NULL DEFAULT (getutcdate()),
	[APP_CREATE_USER_DIRECTORY]     	nvarchar(30) NOT NULL DEFAULT (user_name()),
	...
	[EXPECTED_AMOUNT_ID]            	bigint NOT NULL DEFAULT (NEXT VALUE FOR [PIMS_EXPECTED_AMOUNT_ID_SEQ]),
	[LEASE_ACTIVITY_PERIOD_ID]      	bigint NOT NULL,
	[LEASE_ID]                      	bigint NOT NULL,
	PRIMARY KEY CLUSTERED([EXPECTED_AMOUNT_ID])
 ON [PRIMARY])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_PROPERTY_SERVICE_FILE_HIST]
DROP CONSTRAINT [DF__PIMS_PROP___PROP__7C3A67EB]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_PROPERTY_SERVICE_FILE_HIST]
DROP CONSTRAINT [DF__PIMS_PROP__EFFEC__7D2E8C24]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1630713813725]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1630713813725]([_PROPERTY_PROPERTY_SERVICE_FILE_HIST_ID], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [EFFECTIVE_DATE_HIST], [END_DATE_HIST], [IS_DISABLED], [PROPERTY_ID], [PROPERTY_PROPERTY_SERVICE_FILE_ID], [PROPERTY_SERVICE_FILE_ID]) 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1630713813725]', N'PIMS_PROPERTY_PROPERTY_SERVICE_FILE_HIST', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_ACTIVITY_HIST]
DROP CONSTRAINT [DF__PIMS_ACTI___ACTI__20ACD28B]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_ACTIVITY_HIST]
DROP CONSTRAINT [DF__PIMS_ACTI__EFFEC__21A0F6C4]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1630713813726]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1630713813726]([_ACTIVITY_HIST_ID], [ACTIVITY_ID], [ACTIVITY_MODEL_ID], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [EFFECTIVE_DATE_HIST], [END_DATE_HIST], [PROJECT_ID], [WORKFLOW_ID]) 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1630713813726]', N'PIMS_ACTIVITY_HIST', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_ACCESS_REQUEST_HIST]
DROP CONSTRAINT [DF__PIMS_ACCE___ACCE__153B1FDF]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_ACCESS_REQUEST_HIST]
DROP CONSTRAINT [DF__PIMS_ACCE__EFFEC__162F4418]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1630713813727]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1630713813727]', N'PIMS_ACCESS_REQUEST_HIST', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_CLAIM_HIST]
DROP CONSTRAINT [DF__PIMS_CLAI___CLAI__31D75E8D]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_CLAIM_HIST]
DROP CONSTRAINT [DF__PIMS_CLAI__EFFEC__32CB82C6]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1630713813728]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1630713813728]', N'PIMS_CLAIM_HIST', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_TASK_TEMPLATE_HIST]
DROP CONSTRAINT [DF__PIMS_TASK___TASK__1E8F7FEF]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_TASK_TEMPLATE_HIST]
DROP CONSTRAINT [DF__PIMS_TASK__EFFEC__1F83A428]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1630713813729]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1630713813729]([_TASK_TEMPLATE_HIST_ID], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [EFFECTIVE_DATE_HIST], [END_DATE_HIST], [IS_DISABLED], [TASK_TEMPLATE_ID], [TASK_TEMPLATE_TYPE_CODE]) 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1630713813729]', N'PIMS_TASK_TEMPLATE_HIST', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_HIST]
DROP CONSTRAINT [DF__PIMS_PROP___PROP__70C8B53F]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_HIST]
DROP CONSTRAINT [DF__PIMS_PROP__EFFEC__71BCD978]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1630713813730]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1630713813730]', N'PIMS_PROPERTY_HIST', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_ACTIVITY_HIST]
DROP CONSTRAINT [DF__PIMS_PROP___PROP__65570293]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_ACTIVITY_HIST]
DROP CONSTRAINT [DF__PIMS_PROP__EFFEC__664B26CC]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1630713813731]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1630713813731]', N'PIMS_PROPERTY_ACTIVITY_HIST', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_ACCESS_REQUEST_ORGANIZATION_HIST]
DROP CONSTRAINT [DF__PIMS_ACCE___ACCE__1AF3F935]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_ACCESS_REQUEST_ORGANIZATION_HIST]
DROP CONSTRAINT [DF__PIMS_ACCE__EFFEC__1BE81D6E]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1630713813732]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1630713813732]', N'PIMS_ACCESS_REQUEST_ORGANIZATION_HIST', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_CONTACT_METHOD_HIST]
DROP CONSTRAINT [DF__PIMS_CONT___CONT__379037E3]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_CONTACT_METHOD_HIST]
DROP CONSTRAINT [DF__PIMS_CONT__EFFEC__38845C1C]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1630713813733]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1630713813733]', N'PIMS_CONTACT_METHOD_HIST', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_PROJECT_HIST]
DROP CONSTRAINT [DF__PIMS_PROJ___PROJ__4E739D3B]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROJECT_HIST]
DROP CONSTRAINT [DF__PIMS_PROJ__EFFEC__4F67C174]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1630713813734]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1630713813734]([_PROJECT_HIST_ID], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [EFFECTIVE_DATE_HIST], [END_DATE_HIST], [PROJECT_ID], [PROJECT_RISK_TYPE_CODE], [PROJECT_STATUS_TYPE_CODE], [PROJECT_TIER_TYPE_CODE], [PROJECT_TYPE_CODE]) 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1630713813734]', N'PIMS_PROJECT_HIST', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_PROJECT_NOTE_HIST]
DROP CONSTRAINT [DF__PIMS_PROJ___PROJ__542C7691]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROJECT_NOTE_HIST]
DROP CONSTRAINT [DF__PIMS_PROJ__EFFEC__55209ACA]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1630713813735]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1630713813735]([_PROJECT_NOTE_HIST_ID], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [EFFECTIVE_DATE_HIST], [END_DATE_HIST], [PROJECT_ID], [PROJECT_NOTE_ID]) 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1630713813735]', N'PIMS_PROJECT_NOTE_HIST', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_PROJECT_PROPERTY_HIST]
DROP CONSTRAINT [DF__PIMS_PROJ___PROJ__59E54FE7]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROJECT_PROPERTY_HIST]
DROP CONSTRAINT [DF__PIMS_PROJ__EFFEC__5AD97420]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1630713813736]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1630713813736]', N'PIMS_PROJECT_PROPERTY_HIST', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_TASK_HIST]
DROP CONSTRAINT [DF__PIMS_TASK___TASK__131DCD43]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_TASK_HIST]
DROP CONSTRAINT [DF__PIMS_TASK__EFFEC__1411F17C]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1630713813737]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1630713813737]([_TASK_HIST_ID], [ACTIVITY_ID], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [EFFECTIVE_DATE_HIST], [END_DATE_HIST], [TASK_ID], [TASK_TEMPLATE_ID], [USER_ID]) 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1630713813737]', N'PIMS_TASK_HIST', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_ORGANIZATION_HIST]
DROP CONSTRAINT [DF__PIMS_ORGA___ORGA__3D491139]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_ORGANIZATION_HIST]
DROP CONSTRAINT [DF__PIMS_ORGA__EFFEC__3E3D3572]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1630713813738]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1630713813738]([_ORGANIZATION_HIST_ID], [ADDRESS_ID], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [DISTRICT_CODE], [EFFECTIVE_DATE_HIST], [END_DATE_HIST], [IS_DISABLED], [ORG_IDENTIFIER_TYPE_CODE], [ORGANIZATION_ID], [ORGANIZATION_IDENTIFIER], [ORGANIZATION_NAME], [ORGANIZATION_TYPE_CODE], [PRNT_ORGANIZATION_ID], [REGION_CODE], [WEBSITE]) 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1630713813738]', N'PIMS_ORGANIZATION_HIST', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
PRINT N'Create sequence dbo.PIMS_LEASE_H_ID_SEQ'
GO
CREATE SEQUENCE [dbo].[PIMS_LEASE_H_ID_SEQ]
	AS bigint
	START WITH 1
...
PRINT N'Create table dbo.PIMS_LEASE_HIST'
GO
CREATE TABLE [dbo].[PIMS_LEASE_HIST]  ( 
...
GO
ALTER TABLE [dbo].[PIMS_USER_HIST]
DROP CONSTRAINT [DF__PIMS_USER___USER__24485945]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_USER_HIST]
DROP CONSTRAINT [DF__PIMS_USER__EFFEC__253C7D7E]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1630713813739]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1630713813739]([_USER_HIST_ID], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [APPROVED_BY_ID], [BUSINESS_IDENTIFIER_VALUE], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [EFFECTIVE_DATE_HIST], [END_DATE_HIST], [EXPIRY_DATE], [GUID_IDENTIFIER_VALUE], [IS_DISABLED], [ISSUE_DATE], [LAST_LOGIN], [NOTE], [PERSON_ID], [POSITION], [USER_ID]) 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1630713813739]', N'PIMS_USER_HIST', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_WORKFLOW_MODEL_HIST]
DROP CONSTRAINT [DF__PIMS_WORK___WORK__3572E547]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_WORKFLOW_MODEL_HIST]
DROP CONSTRAINT [DF__PIMS_WORK__EFFEC__36670980]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1630713813740]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1630713813740]([_WORKFLOW_MODEL_HIST_ID], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [EFFECTIVE_DATE_HIST], [END_DATE_HIST], [IS_DISABLED], [WORKFLOW_MODEL_ID], [WORKFLOW_MODEL_TYPE_CODE]) 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1630713813740]', N'PIMS_WORKFLOW_MODEL_HIST', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_ACTIVITY_MODEL_HIST]
DROP CONSTRAINT [DF__PIMS_ACTI___ACTI__2665ABE1]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_ACTIVITY_MODEL_HIST]
DROP CONSTRAINT [DF__PIMS_ACTI__EFFEC__2759D01A]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1630713813741]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1630713813741]([_ACTIVITY_MODEL_HIST_ID], [ACTIVITY_MODEL_ID], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [DESCRIPTION], [EFFECTIVE_DATE_HIST], [END_DATE_HIST], [IS_DISABLED]) 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1630713813741]', N'PIMS_ACTIVITY_MODEL_HIST', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_ROLE_CLAIM_HIST]
DROP CONSTRAINT [DF__PIMS_ROLE___ROLE__07AC1A97]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_ROLE_CLAIM_HIST]
DROP CONSTRAINT [DF__PIMS_ROLE__EFFEC__08A03ED0]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1630713813742]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1630713813742]([_ROLE_CLAIM_HIST_ID], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CLAIM_ID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [EFFECTIVE_DATE_HIST], [END_DATE_HIST], [IS_DISABLED], [ROLE_CLAIM_ID], [ROLE_ID]) 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1630713813742]', N'PIMS_ROLE_CLAIM_HIST', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_USER_ORGANIZATION_HIST]
DROP CONSTRAINT [DF__PIMS_USER___USER__2A01329B]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_USER_ORGANIZATION_HIST]
DROP CONSTRAINT [DF__PIMS_USER__EFFEC__2AF556D4]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1630713813743]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1630713813743]([_USER_ORGANIZATION_HIST_ID], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [EFFECTIVE_DATE_HIST], [END_DATE_HIST], [IS_DISABLED], [ORGANIZATION_ID], [ROLE_ID], [USER_ID], [USER_ORGANIZATION_ID]) 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1630713813743]', N'PIMS_USER_ORGANIZATION_HIST', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_PERSON_HIST]
DROP CONSTRAINT [DF__PIMS_PERS___PERS__4301EA8F]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PERSON_HIST]
DROP CONSTRAINT [DF__PIMS_PERS__EFFEC__43F60EC8]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1630713813744]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1630713813744]', N'PIMS_PERSON_HIST', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_SERVICE_FILE_HIST]
DROP CONSTRAINT [DF__PIMS_PROP___PROP__01F34141]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_SERVICE_FILE_HIST]
DROP CONSTRAINT [DF__PIMS_PROP__EFFEC__02E7657A]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1630713813745]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1630713813745]', N'PIMS_PROPERTY_SERVICE_FILE_HIST', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_ROLE_HIST]
DROP CONSTRAINT [DF__PIMS_ROLE___ROLE__0D64F3ED]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_ROLE_HIST]
DROP CONSTRAINT [DF__PIMS_ROLE__EFFEC__0E591826]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1630713813746]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1630713813746]([_ROLE_HIST_ID], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [DESCRIPTION], [EFFECTIVE_DATE_HIST], [END_DATE_HIST], [IS_DISABLED], [IS_PUBLIC], [KEYCLOAK_GROUP_ID], [NAME], [ROLE_ID], [ROLE_UID], [SORT_ORDER]) 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1630713813746]', N'PIMS_ROLE_HIST', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
PRINT N'Create sequence dbo.PIMS_PROPERTY_LEASE_H_ID_SEQ'
GO
CREATE SEQUENCE [dbo].[PIMS_PROPERTY_LEASE_H_ID_SEQ]
	AS bigint
	START WITH 1
...
PRINT N'Create table dbo.PIMS_PROPERTY_LEASE_HIST'
GO
CREATE TABLE [dbo].[PIMS_PROPERTY_LEASE_HIST]  ( 
...
-- Create unique constraint dbo.PIMS_PROPLS_H_UK
PRINT N'Create unique constraint dbo.PIMS_PROPLS_H_UK'
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_LEASE_HIST]
	ADD UNIQUE ([_PROPERTY_LEASE_HIST_ID], [END_DATE_HIST]) 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
GO
ALTER TABLE [dbo].[PIMS_TASK_TEMPLATE_ACTIVITY_MODEL_HIST]
DROP CONSTRAINT [DF__PIMS_TASK___TASK__18D6A699]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_TASK_TEMPLATE_ACTIVITY_MODEL_HIST]
DROP CONSTRAINT [DF__PIMS_TASK__EFFEC__19CACAD2]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1630713813747]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1630713813747]', N'PIMS_TASK_TEMPLATE_ACTIVITY_MODEL_HIST', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_ORGANIZATION_HIST]
DROP CONSTRAINT [DF__PIMS_PROP___PROP__76818E95]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_ORGANIZATION_HIST]
DROP CONSTRAINT [DF__PIMS_PROP__EFFEC__7775B2CE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1630713813748]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1630713813748]([_PROPERTY_ORGANIZATION_HIST_ID], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [EFFECTIVE_DATE_HIST], [END_DATE_HIST], [IS_DISABLED], [ORGANIZATION_ID], [PROPERTY_ID], [PROPERTY_ORGANIZATION_ID]) 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1630713813748]', N'PIMS_PROPERTY_ORGANIZATION_HIST', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_EVALUATION_HIST]
DROP CONSTRAINT [DF__PIMS_PROP___PROP__6B0FDBE9]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_EVALUATION_HIST]
DROP CONSTRAINT [DF__PIMS_PROP__EFFEC__6C040022]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1630713813749]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1630713813749]', N'PIMS_PROPERTY_EVALUATION_HIST', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_PROJECT_WORKFLOW_MODEL_HIST]
DROP CONSTRAINT [DF__PIMS_PROJ___PROJ__5F9E293D]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROJECT_WORKFLOW_MODEL_HIST]
DROP CONSTRAINT [DF__PIMS_PROJ__EFFEC__60924D76]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1630713813750]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1630713813750]([_PROJECT_WORKFLOW_MODEL_HIST_ID], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [EFFECTIVE_DATE_HIST], [END_DATE_HIST], [IS_DISABLED], [PROJECT_ID], [PROJECT_WORKFLOW_MODEL_ID], [WORKFLOW_MODEL_ID]) 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1630713813750]', N'PIMS_PROJECT_WORKFLOW_MODEL_HIST', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_PERSON_ORGANIZATION_HIST]
DROP CONSTRAINT [DF__PIMS_PERS___PERS__48BAC3E5]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PERSON_ORGANIZATION_HIST]
DROP CONSTRAINT [DF__PIMS_PERS__EFFEC__49AEE81E]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1630713813751]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1630713813751]([_PERSON_ORGANIZATION_HIST_ID], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [EFFECTIVE_DATE_HIST], [END_DATE_HIST], [IS_DISABLED], [ORGANIZATION_ID], [PERSON_ID], [PERSON_ORGANIZATION_ID]) 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1630713813751]', N'PIMS_PERSON_ORGANIZATION_HIST', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_USER_ROLE_HIST]
DROP CONSTRAINT [DF__PIMS_USER___USER__2FBA0BF1]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_USER_ROLE_HIST]
DROP CONSTRAINT [DF__PIMS_USER__EFFEC__30AE302A]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1630713813752]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1630713813752]([_USER_ROLE_HIST_ID], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [EFFECTIVE_DATE_HIST], [END_DATE_HIST], [IS_DISABLED], [ROLE_ID], [USER_ID], [USER_ROLE_ID]) 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1630713813752]', N'PIMS_USER_ROLE_HIST', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
PRINT N'Create table dbo.PIMS_LEASE_ACTIVITY_HIST'
GO
CREATE TABLE [dbo].[PIMS_LEASE_ACTIVITY_HIST]  ( 
...
-- Create unique constraint dbo.PIMS_LSACTV_H_UK
PRINT N'Create unique constraint dbo.PIMS_LSACTV_H_UK'
GO
ALTER TABLE [dbo].[PIMS_LEASE_ACTIVITY_HIST]
	ADD UNIQUE ([_LEASE_ACTIVITY_HIST_ID], [END_DATE_HIST]) 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
GO
ALTER TABLE [dbo].[PIMS_ADDRESS_HIST]
DROP CONSTRAINT [DF__PIMS_ADDR___ADDR__2C1E8537]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_ADDRESS_HIST]
DROP CONSTRAINT [DF__PIMS_ADDR__EFFEC__2D12A970]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1630713813753]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1630713813753]([_ADDRESS_HIST_ID], [ADDRESS_ID], [ADDRESS_USAGE_TYPE_CODE], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [COUNTRY_ID], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [DISTRICT_CODE], [EFFECTIVE_DATE_HIST], [END_DATE_HIST], [LATITUDE], [LONGITUDE], [MUNICIPALITY_NAME], [POSTAL_CODE], [PROVINCE_STATE_ID], [REGION_CODE], [STREET_ADDRESS_1], [STREET_ADDRESS_2], [STREET_ADDRESS_3]) 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1630713813753]', N'PIMS_ADDRESS_HIST', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
PRINT N'Create table dbo.PIMS_EXPECTED_AMOUNT_HIST'
GO
CREATE TABLE [dbo].[PIMS_EXPECTED_AMOUNT_HIST]  ( 
...
-- Create unique constraint dbo.PIMS_EXPAMT_H_UK
PRINT N'Create unique constraint dbo.PIMS_EXPAMT_H_UK'
GO
ALTER TABLE [dbo].[PIMS_EXPECTED_AMOUNT_HIST]
	ADD UNIQUE ([_EXPECTED_AMOUNT_HIST_ID], [END_DATE_HIST]) 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
PRINT N'Create table dbo.PIMS_LEASE_ACTIVITY_PERIOD_HIST'
GO
CREATE TABLE [dbo].[PIMS_LEASE_ACTIVITY_PERIOD_HIST]  ( 
...
-- Create unique constraint dbo.PIMS_LSACPR_H_UK
PRINT N'Create unique constraint dbo.PIMS_LSACPR_H_UK'
GO
ALTER TABLE [dbo].[PIMS_LEASE_ACTIVITY_PERIOD_HIST]
	ADD UNIQUE ([_LEASE_ACTIVITY_PERIOD_HIST_ID], [END_DATE_HIST]) 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
-- Create index dbo.LEASE_LEASE_PURPOSE_SUBTYPE_CODE_IDX
PRINT N'Create index dbo.LEASE_LEASE_PURPOSE_SUBTYPE_CODE_IDX'
GO
...
-- Create index dbo.LEASE_PROP_MGMT_ORG_ID_IDX
PRINT N'Create index dbo.LEASE_PROP_MGMT_ORG_ID_IDX'
GO
...
-- Create index dbo.LSACTV_LEASE_ID_IDX
PRINT N'Create index dbo.LSACTV_LEASE_ID_IDX'
GO
...
-- Create index dbo.EXPAMT_LEASE_ACTIVITY_PERIOD_ID_IDX
PRINT N'Create index dbo.EXPAMT_LEASE_ACTIVITY_PERIOD_ID_IDX'
GO
...
-- Create index dbo.LEASE_PROPERTY_MANAGER_ID_IDX
PRINT N'Create index dbo.LEASE_PROPERTY_MANAGER_ID_IDX'
GO
...
-- Create index dbo.LSACTV_LEASE_SUBTYPE_CODE_IDX
PRINT N'Create index dbo.LSACTV_LEASE_SUBTYPE_CODE_IDX'
GO
...
-- Create index dbo.LSACTV_LEASE_ACTIVITY_PERIOD_ID_IDX
PRINT N'Create index dbo.LSACTV_LEASE_ACTIVITY_PERIOD_ID_IDX'
GO
...
-- Create index dbo.LSACTV_LEASE_TYPE_CODE_IDX
PRINT N'Create index dbo.LSACTV_LEASE_TYPE_CODE_IDX'
GO
...
-- Create index dbo.EXPAMT_LEASE_ID_IDX
PRINT N'Create index dbo.EXPAMT_LEASE_ID_IDX'
GO
...
-- Create index dbo.LEASE_TENANT_ID_IDX
PRINT N'Create index dbo.LEASE_TENANT_ID_IDX'
GO
...
-- Create foreign key constraint dbo.PIM_LSSTSY_PIM_LEASE_FK
PRINT N'Create foreign key constraint dbo.PIM_LSSTSY_PIM_LEASE_FK'
GO
...
-- Create foreign key constraint dbo.PIM_PERSON_PIM_LEASE_TENANT_FK
PRINT N'Create foreign key constraint dbo.PIM_PERSON_PIM_LEASE_TENANT_FK'
GO
ALTER TABLE [dbo].[PIMS_LEASE]
...
-- Create foreign key constraint dbo.PIM_LSPRST_PIM_LEASE_FK
PRINT N'Create foreign key constraint dbo.PIM_LSPRST_PIM_LEASE_FK'
GO
ALTER TABLE [dbo].[PIMS_LEASE]
	ADD FOREIGN KEY([LEASE_PURPOSE_SUBTYPE_CODE])
...
-- Create foreign key constraint dbo.PIM_PERSON_PIM_LEASE_PM_CONTACT_FK
PRINT N'Create foreign key constraint dbo.PIM_PERSON_PIM_LEASE_PM_CONTACT_FK'
GO
ALTER TABLE [dbo].[PIMS_LEASE]
...
-- Create foreign key constraint dbo.PIM_ORG_PIM_LEASE_FK
PRINT N'Create foreign key constraint dbo.PIM_ORG_PIM_LEASE_FK'
GO
ALTER TABLE [dbo].[PIMS_LEASE]
...
-- Create foreign key constraint dbo.PIM_LSSTYP_PIM_LSACTV_FK
PRINT N'Create foreign key constraint dbo.PIM_LSSTYP_PIM_LSACTV_FK'
GO
ALTER TABLE [dbo].[PIMS_LEASE_ACTIVITY]
	ADD FOREIGN KEY([LEASE_SUBTYPE_CODE])
...
-- Create foreign key constraint dbo.PIM_LSACPR_PIM_LSACTV_FK
PRINT N'Create foreign key constraint dbo.PIM_LSACPR_PIM_LSACTV_FK'
GO
ALTER TABLE [dbo].[PIMS_LEASE_ACTIVITY]
	ADD FOREIGN KEY([LEASE_ACTIVITY_PERIOD_ID])
...
-- Create foreign key constraint dbo.PIM_LSTYPE_PIM_LSACTV_FK
PRINT N'Create foreign key constraint dbo.PIM_LSTYPE_PIM_LSACTV_FK'
GO
ALTER TABLE [dbo].[PIMS_LEASE_ACTIVITY]
	ADD FOREIGN KEY([LEASE_TYPE_CODE])
...
-- Create foreign key constraint dbo.PIM_LEASE_PIM_LSACTV_FK
PRINT N'Create foreign key constraint dbo.PIM_LEASE_PIM_LSACTV_FK'
GO
ALTER TABLE [dbo].[PIMS_LEASE_ACTIVITY]
	ADD FOREIGN KEY([LEASE_ID])
	REFERENCES [dbo].[PIMS_LEASE]([LEASE_ID])
...
-- Create foreign key constraint dbo.PIM_LEASE_PIM_EXPAMT_FK
PRINT N'Create foreign key constraint dbo.PIM_LEASE_PIM_EXPAMT_FK'
GO
...
-- Create foreign key constraint dbo.PIM_LSACPR_PIM_EXPAMT_FK
PRINT N'Create foreign key constraint dbo.PIM_LSACPR_PIM_EXPAMT_FK'
GO
ALTER TABLE [dbo].[PIMS_EXPECTED_AMOUNT]
	ADD FOREIGN KEY([LEASE_ACTIVITY_PERIOD_ID])
	REFERENCES [dbo].[PIMS_LEASE_ACTIVITY_PERIOD]([LEASE_ACTIVITY_PERIOD_ID])
...
-- Create trigger dbo.PIMS_LSTYPE_I_S_U_TR
PRINT N'Create trigger dbo.PIMS_LSTYPE_I_S_U_TR'
GO
...
-- Create trigger dbo.PIMS_LSTYPE_I_S_I_TR
PRINT N'Create trigger dbo.PIMS_LSTYPE_I_S_I_TR'
GO
...
-- Create trigger dbo.PIMS_LSACTV_I_S_I_TR
PRINT N'Create trigger dbo.PIMS_LSACTV_I_S_I_TR'
GO
...
-- Create trigger dbo.PIMS_EXPAMT_I_S_U_TR
PRINT N'Create trigger dbo.PIMS_EXPAMT_I_S_U_TR'
GO
...
-- Create trigger dbo.PIMS_LSACPR_I_S_U_TR
PRINT N'Create trigger dbo.PIMS_LSACPR_I_S_U_TR'
GO
...
-- Create trigger dbo.PIMS_LSSTSY_I_S_U_TR
PRINT N'Create trigger dbo.PIMS_LSSTSY_I_S_U_TR'
GO
...
-- Create trigger dbo.PIMS_EXPAMT_I_S_I_TR
PRINT N'Create trigger dbo.PIMS_EXPAMT_I_S_I_TR'
GO
...
-- Create trigger dbo.PIMS_LSACPR_I_S_I_TR
PRINT N'Create trigger dbo.PIMS_LSACPR_I_S_I_TR'
GO
...
-- Create trigger dbo.PIMS_LSACTV_I_S_U_TR
PRINT N'Create trigger dbo.PIMS_LSACTV_I_S_U_TR'
GO
...
-- Create trigger dbo.PIMS_LSSTSY_I_S_I_TR
PRINT N'Create trigger dbo.PIMS_LSSTSY_I_S_I_TR'
GO
...
-- Create trigger dbo.PIMS_LSACTV_A_S_IUD_TR
PRINT N'Create trigger dbo.PIMS_LSACTV_A_S_IUD_TR'
GO
...
-- Create trigger dbo.PIMS_EXPAMT_A_S_IUD_TR
PRINT N'Create trigger dbo.PIMS_EXPAMT_A_S_IUD_TR'
GO
...
-- Create trigger dbo.PIMS_LSACPR_A_S_IUD_TR
PRINT N'Create trigger dbo.PIMS_LSACPR_A_S_IUD_TR'
GO
