-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Wed Dec 22 14:32:23 PST 2021
-- Execute this script on:
-- 		PIMS_18_00/dbo - This database/schema will be modified
...
GO
ALTER TABLE [dbo].[PIMS_LEASE_TERM]
	ADD [TERM_RENEWAL_DATE] datetime NULL
GO
...
GO
ALTER TABLE [dbo].[PIMS_LEASE_TERM]
	DROP COLUMN [IS_GST_ELIGIBLE], [IS_TERM_EXERCISED], [LEASE_PMT_FREQ_TYPE_CODE], [PAYMENT_DUE_DATE], [PAYMENT_NOTE], [PAYMENT AMOUNT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_LEASE_PAYMENT]
	ADD [LEASE_PAYMENT_PERIOD_ID] bigint NOT NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_LEASE_PAYMENT]
...
GO
ALTER TABLE [dbo].[PIMS_SECURITY_DEPOSIT]
	ADD [ANNUAL_INTEREST_RATE] numeric(5,2) NULL, 
...
GO
ALTER TABLE [dbo].[PIMS_SECURITY_DEPOSIT_RETURN]
	ADD [CHEQUE_NUMBER] nvarchar(50) NOT NULL, 
...
GO
ALTER TABLE [dbo].[PIMS_SECURITY_DEPOSIT_HIST]
	ADD [ANNUAL_INTEREST_RATE] numeric(18,0) NULL, 
	[OTHER_DEP_HOLDER_TYPE_DESC] nvarchar(100) NULL, 
	[SEC_DEP_HOLDER_TYPE_CODE] nvarchar(20) NOT NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
