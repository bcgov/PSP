-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Wed May 25 14:45:19 PDT 2022
...
-- Drop foreign key constraint dbo.PIM_REGION_PIM_RGNUSR_FK
PRINT N'Drop foreign key constraint dbo.PIM_REGION_PIM_RGNUSR_FK'
GO
ALTER TABLE [dbo].[PIMS_REGION_USER]
	DROP CONSTRAINT [PIM_REGION_PIM_RGNUSR_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop foreign key constraint dbo.PIM_USER_PIM_RGNUSR_FK
PRINT N'Drop foreign key constraint dbo.PIM_USER_PIM_RGNUSR_FK'
GO
ALTER TABLE [dbo].[PIMS_REGION_USER]
	DROP CONSTRAINT [PIM_USER_PIM_RGNUSR_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop foreign key constraint dbo.PIM_REGION_PIM_ACRQST_FK
PRINT N'Drop foreign key constraint dbo.PIM_REGION_PIM_ACRQST_FK'
GO
ALTER TABLE [dbo].[PIMS_ACCESS_REQUEST]
	DROP CONSTRAINT [PIM_REGION_PIM_ACRQST_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop index dbo.RGNUSR_USER_ID_IDX
PRINT N'Drop index dbo.RGNUSR_USER_ID_IDX'
GO
...
-- Drop index dbo.RGNUSR_REGION_CODE_IDX
PRINT N'Drop index dbo.RGNUSR_REGION_CODE_IDX'
GO
...
-- Drop index dbo.ACRQST_REGION_CODE_IDX
PRINT N'Drop index dbo.ACRQST_REGION_CODE_IDX'
GO
...
-- Drop unique constraint dbo.PIMS_RGNUSR_H_UK
PRINT N'Drop unique constraint dbo.PIMS_RGNUSR_H_UK'
GO
ALTER TABLE [dbo].[PIMS_REGION_USER_HIST]
	DROP CONSTRAINT [PIMS_RGNUSR_H_UK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop primary key constraint dbo.PIMS_RGNUSR_H_PK
PRINT N'Drop primary key constraint dbo.PIMS_RGNUSR_H_PK'
GO
ALTER TABLE [dbo].[PIMS_REGION_USER_HIST]
	DROP CONSTRAINT [PIMS_RGNUSR_H_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop unique constraint dbo.RGNUSR_REGION_USER_TUC
PRINT N'Drop unique constraint dbo.RGNUSR_REGION_USER_TUC'
GO
ALTER TABLE [dbo].[PIMS_REGION_USER]
	DROP CONSTRAINT [RGNUSR_REGION_USER_TUC]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop primary key constraint dbo.RGNUSR_PK
PRINT N'Drop primary key constraint dbo.RGNUSR_PK'
GO
ALTER TABLE [dbo].[PIMS_REGION_USER]
	DROP CONSTRAINT [RGNUSR_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop table dbo.PIMS_REGION_USER
PRINT N'Drop table dbo.PIMS_REGION_USER'
GO
DROP TABLE [dbo].[PIMS_REGION_USER]
GO
IF @@ERROR <> 0 SET NOEXEC ON
...
GO
ALTER TABLE [dbo].[PIMS_ACCESS_REQUEST]
	DROP CONSTRAINT [ACRQST_REGION_CODE_DEF]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_ACCESS_REQUEST]
...
GO
ALTER TABLE [dbo].[PIMS_ACCESS_REQUEST_HIST]
	DROP CONSTRAINT [ACRQSTH_REGION_CODE_DEF]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_ACCESS_REQUEST_HIST]
...
-- Drop table dbo.PIMS_REGION_USER_HIST
PRINT N'Drop table dbo.PIMS_REGION_USER_HIST'
GO
DROP TABLE [dbo].[PIMS_REGION_USER_HIST]
GO
IF @@ERROR <> 0 SET NOEXEC ON
...
PRINT N'Drop sequence dbo.PIMS_REGION_USER_H_ID_SEQ'
GO
DROP SEQUENCE [dbo].[PIMS_REGION_USER_H_ID_SEQ]
GO
IF @@ERROR <> 0 SET NOEXEC ON
...
PRINT N'Drop sequence dbo.PIMS_REGION_USER_ID_SEQ'
GO
DROP SEQUENCE [dbo].[PIMS_REGION_USER_ID_SEQ]
GO
IF @@ERROR <> 0 SET NOEXEC ON
