-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Thu Jun 23 11:48:26 PDT 2022
...
GO
ALTER TABLE [dbo].[PIMS_DOCUMENT_TYPE]
...
PRINT N'Drop table dbo.PIMS_DOCUMENT_TYPE'
GO
DROP TABLE IF EXISTS [dbo].[PIMS_DOCUMENT_TYPE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
