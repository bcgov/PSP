...
ALTER TABLE [dbo].[PIMS_SECURITY_DEPOSIT_RETURN]
	...
	[SECURITY_DEPOSIT_TYPE_CODE] nvarchar(20) NOT NULL DEFAULT 'OTHER', 
	[PAYEE_NAME] nvarchar(100) NOT NULL DEFAULT 'Unknown', 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_ORGANIZATION] ADD DEFAULT 'OTHER' FOR [ORGANIZATION_TYPE_CODE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_ORGANIZATION] ADD DEFAULT 'OTHINCORPNO' FOR [ORG_IDENTIFIER_TYPE_CODE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_ORGANIZATION_HIST] ADD DEFAULT 'OTHER' FOR [ORGANIZATION_TYPE_CODE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_ORGANIZATION_HIST] ADD DEFAULT 'OTHINCORPNO' FOR [ORG_IDENTIFIER_TYPE_CODE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
