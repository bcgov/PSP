-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Mon Jan 10 20:44:50 PST 2022
...
GO
ALTER TABLE [dbo].[PIMS_SECURITY_DEPOSIT_RETURN]
	ADD [SECURITY_DEPOSIT_ID] bigint NOT NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_SECURITY_DEPOSIT_RETURN]
