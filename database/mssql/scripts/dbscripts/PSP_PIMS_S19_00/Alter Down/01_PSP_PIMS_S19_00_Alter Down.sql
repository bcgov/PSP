-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Tue Jan 11 00:22:48 PST 2022
...
GO
ALTER TABLE [dbo].[PIMS_LEASE_TERM]
	DROP COLUMN [LEASE_PMT_FREQ_TYPE_CODE], [PAYMENT AMOUNT], [PAYMENT_DUE_DATE], [PAYMENT_NOTE], [IS_GST_ELIGIBLE], [IS_TERM_EXERCISED]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_SECURITY_DEPOSIT]
	ADD [SEC_DEP_HOLDER_TYPE_CODE] nvarchar(20) NOT NULL, 
...
GO
ALTER TABLE [dbo].[PIMS_SECURITY_DEPOSIT_RETURN]
	ADD [DEPOSIT_TOTAL] money NOT NULL, 
