-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Thu Jan 13 16:55:44 PST 2022
...
GO
UPDATE [dbo].[PIMS_LEASE_TERM] SET [LEASE_TERM_STATUS_TYPE_CODE] = N'EXER' WHERE [LEASE_TERM_STATUS_TYPE_CODE] IS NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_LEASE_TERM] ALTER COLUMN [LEASE_TERM_STATUS_TYPE_CODE] nvarchar(20) NOT NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_LEASE_TERM] ADD DEFAULT N'EXER' FOR [LEASE_TERM_STATUS_TYPE_CODE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_LEASE_TERM]
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
UPDATE [dbo].[PIMS_LEASE_PAYMENT] SET [PAYMENT_AMOUNT_GST] = 0 WHERE [PAYMENT_AMOUNT_GST] IS NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_LEASE_PAYMENT] ALTER COLUMN [PAYMENT_AMOUNT_GST] money NOT NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_LEASE_PAYMENT] ADD DEFAULT 0 FOR [PAYMENT_AMOUNT_GST]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC sp_dropextendedproperty 
...
GO
UPDATE [dbo].[PIMS_LEASE_PAYMENT_HIST] SET [PAYMENT_AMOUNT_GST] = 0 WHERE [PAYMENT_AMOUNT_GST] IS NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_LEASE_PAYMENT_HIST] ALTER COLUMN [PAYMENT_AMOUNT_GST] money NOT NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_LEASE_PAYMENT_HIST] ADD DEFAULT 0 FOR [PAYMENT_AMOUNT_GST]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_LEASE_PAYMENT_HIST]
...
GO
UPDATE [dbo].[PIMS_LEASE_TERM_HIST] SET [LEASE_TERM_STATUS_TYPE_CODE] = N'EXER' WHERE [LEASE_TERM_STATUS_TYPE_CODE] IS NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_LEASE_TERM_HIST] ALTER COLUMN [LEASE_TERM_STATUS_TYPE_CODE] nvarchar(20) NOT NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_LEASE_TERM_HIST] ADD DEFAULT N'EXER' FOR [LEASE_TERM_STATUS_TYPE_CODE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_LEASE_TERM_HIST]
...
GO
ALTER TABLE [dbo].[PIMS_SECURITY_DEPOSIT_RETURN]
	ADD [DEPOSIT_TOTAL] money NOT NULL DEFAULT 0, 
	[CHEQUE_NUMBER] nvarchar(50) NOT NULL DEFAULT 0
GO
EXEC sp_addextendedproperty 
