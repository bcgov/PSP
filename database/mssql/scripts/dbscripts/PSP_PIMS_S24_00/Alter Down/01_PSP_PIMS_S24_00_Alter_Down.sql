-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Thu Mar 17 14:52:47 PDT 2022
-- Execute this script on:
-- 		PIMS_24_00/dbo - This database/schema will be modified
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY]
	ADD [PROPERTY_TENURE_TYPE_CODE] nvarchar(20) NOT NULL, 
...
-- Alter table dbo.BCA_ASSESSMENT_AREA
PRINT N'Alter table dbo.BCA_ASSESSMENT_AREA'
GO
ALTER TABLE [dbo].[BCA_ASSESSMENT_AREA]
	ADD CONSTRAINT [PK__BCA_ASSE__FC7CF8094B7DBA6B]
	PRIMARY KEY CLUSTERED ([AREA_CODE])  
	WITH (
...
-- Alter table dbo.BCA_JURISDICTION
PRINT N'Alter table dbo.BCA_JURISDICTION'
GO
ALTER TABLE [dbo].[BCA_JURISDICTION]
	ADD CONSTRAINT [PK__BCA_JURI__A318B2B5A46D67D0]
	PRIMARY KEY CLUSTERED ([JURISDICTION_CODE])  
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1647553907833]  ( 
...
EXEC sp_addextendedproperty 
	...
	@level0type = N'Schema', @level0name = N'dbo', 
	@level1type = N'Table', @level1name = N'ADS_SSDATA_1647553907833', 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1647553907833]', N'BCA_FOLIO_BCTRANSIT_VALUE', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1647553907843]  ( 
...
EXEC sp_addextendedproperty 
	...
	@level0type = N'Schema', @level0name = N'dbo', 
	@level1type = N'Table', @level1name = N'ADS_SSDATA_1647553907843', 
	@level2type = N'Column', @level2name = N'PROPERTY_CLASS_CODE'
GO
EXEC sp_addextendedproperty 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1647553907843]', N'BCA_AREA_GENERAL_VALUE', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1647553907844]  ( 
	[ROLL_NUMBER]                  	nvarchar(32) NULL,
	[PROPERTY_CLASS_CODE]          	nvarchar(16) NULL,
	[PROPERTY_CLASS_DESCRIPTION]   	nvarchar(16) NULL,
	[PROPERTY_SUBCLASS_CODE]       	nvarchar(16) NULL,
...
EXEC sp_addextendedproperty 
	@name = N'MS_Description', @value = N'A code indicating the jurisdiction class.' , 
	@level0type = N'Schema', @level0name = N'dbo', 
	@level1type = N'Table', @level1name = N'ADS_SSDATA_1647553907844', 
	@level2type = N'Column', @level2name = N'PROPERTY_CLASS_CODE'
GO
EXEC sp_addextendedproperty 
	@name = N'MS_Description', @value = N'The jurisdiction class description.' , 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1647553907844]([ROLL_NUMBER], [PROPERTY_CLASS_CODE], [PROPERTY_CLASS_DESCRIPTION], [PROPERTY_SUBCLASS_CODE], [PROPERTY_SUBCLASS_DESCRIPTION], [GROSS_LAND_VALUE], [GROSS_IMPROVEMENT_VALUE], [TAX_EXEMPT_LAND_VALUE], [TAX_EXEMPT_IMPROVEMENT_VALUE], [NET_LAND_VALUE], [NET_IMPROVEMENT_VALUE], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID]) 
	SELECT [ROLL_NUMBER], [PROPERTY_CLASS_CODE], SUBSTRING(PROPERTY_CLASS_DESCRIPTION,1,16), [PROPERTY_SUBCLASS_CODE], SUBSTRING(PROPERTY_SUBCLASS_DESCRIPTION,1,16), [GROSS_LAND_VALUE], [GROSS_IMPROVEMENT_VALUE], [TAX_EXEMPT_LAND_VALUE], [TAX_EXEMPT_IMPROVEMENT_VALUE], [NET_LAND_VALUE], [NET_IMPROVEMENT_VALUE], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID] 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1647553907844]', N'BCA_FOLIO_GENERAL_VALUE', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1647553907845]  ( 
	[AREA_CODE]                    	nvarchar(16) NULL,
	[PROPERTY_CLASS_CODE]          	nvarchar(16) NULL,
	[PROPERTY_CLASS_DESCRIPTION]   	nvarchar(16) NULL,
	[PROPERTY_SUBCLASS_CODE]       	nvarchar(16) NULL,
...
EXEC sp_addextendedproperty 
	@name = N'MS_Description', @value = N'A code indicating the area class.' , 
	@level0type = N'Schema', @level0name = N'dbo', 
	@level1type = N'Table', @level1name = N'ADS_SSDATA_1647553907845', 
	@level2type = N'Column', @level2name = N'PROPERTY_CLASS_CODE'
GO
EXEC sp_addextendedproperty 
	@name = N'MS_Description', @value = N'The area class description.' , 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1647553907845]([AREA_CODE], [PROPERTY_CLASS_CODE], [PROPERTY_CLASS_DESCRIPTION], [PROPERTY_SUBCLASS_CODE], [PROPERTY_SUBCLASS_DESCRIPTION], [GROSS_LAND_VALUE], [GROSS_IMPROVEMENT_VALUE], [TAX_EXEMPT_LAND_VALUE], [TAX_EXEMPT_IMPROVEMENT_VALUE], [NET_LAND_VALUE], [NET_IMPROVEMENT_VALUE], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID]) 
	SELECT [AREA_CODE], [PROPERTY_CLASS_CODE], SUBSTRING(PROPERTY_CLASS_DESCRIPTION,1,16), [PROPERTY_SUBCLASS_CODE], SUBSTRING(PROPERTY_SUBCLASS_DESCRIPTION,1,16), [GROSS_LAND_VALUE], [GROSS_IMPROVEMENT_VALUE], [TAX_EXEMPT_LAND_VALUE], [TAX_EXEMPT_IMPROVEMENT_VALUE], [NET_LAND_VALUE], [NET_IMPROVEMENT_VALUE], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID] 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1647553907845]', N'BCA_AREA_BCTRANSIT_VALUE', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1647553907852]  ( 
	[ROLL_NUMBER]                  	nvarchar(32) NULL,
	[PROPERTY_CLASS_CODE]          	nvarchar(16) NULL,
	[PROPERTY_CLASS_DESCRIPTION]   	nvarchar(16) NULL,
	[PROPERTY_SUBCLASS_CODE]       	nvarchar(16) NULL,
...
EXEC sp_addextendedproperty 
	@name = N'MS_Description', @value = N'A code indicating the jurisdiction class.' , 
	@level0type = N'Schema', @level0name = N'dbo', 
	@level1type = N'Table', @level1name = N'ADS_SSDATA_1647553907852', 
	@level2type = N'Column', @level2name = N'PROPERTY_CLASS_CODE'
GO
EXEC sp_addextendedproperty 
	@name = N'MS_Description', @value = N'The jurisdiction class description.' , 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1647553907852]([ROLL_NUMBER], [PROPERTY_CLASS_CODE], [PROPERTY_CLASS_DESCRIPTION], [PROPERTY_SUBCLASS_CODE], [PROPERTY_SUBCLASS_DESCRIPTION], [GROSS_LAND_VALUE], [GROSS_IMPROVEMENT_VALUE], [TAX_EXEMPT_LAND_VALUE], [TAX_EXEMPT_IMPROVEMENT_VALUE], [NET_LAND_VALUE], [NET_IMPROVEMENT_VALUE], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID]) 
	SELECT [ROLL_NUMBER], [PROPERTY_CLASS_CODE], SUBSTRING(PROPERTY_CLASS_DESCRIPTION,1,16), [PROPERTY_SUBCLASS_CODE], SUBSTRING(PROPERTY_SUBCLASS_DESCRIPTION,1,16), [GROSS_LAND_VALUE], [GROSS_IMPROVEMENT_VALUE], [TAX_EXEMPT_LAND_VALUE], [TAX_EXEMPT_IMPROVEMENT_VALUE], [NET_LAND_VALUE], [NET_IMPROVEMENT_VALUE], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID] 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1647553907852]', N'BCA_FOLIO_SCHOOL_VALUE', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1647553907853]  ( 
...
EXEC sp_addextendedproperty 
	...
	@level0type = N'Schema', @level0name = N'dbo', 
	@level1type = N'Table', @level1name = N'ADS_SSDATA_1647553907853', 
	@level2type = N'Column', @level2name = N'PROPERTY_CLASS_CODE'
GO
EXEC sp_addextendedproperty 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1647553907853]([DATA_ADVICE_ID], [PROPERTY_CLASS_CODE], [PROPERTY_CLASS_DESCRIPTION], [PROPERTY_SUBCLASS_CODE], [PROPERTY_SUBCLASS_DESCRIPTION], [GROSS_LAND_VALUE], [GROSS_IMPROVEMENT_VALUE], [TAX_EXEMPT_LAND_VALUE], [TAX_EXEMPT_IMPROVEMENT_VALUE], [NET_LAND_VALUE], [NET_IMPROVEMENT_VALUE], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID]) 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1647553907853]', N'BCA_DATA_ADVICE_SCHOOL_VALUE', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1647553907854]  ( 
	[AREA_CODE]                    	nvarchar(16) NULL,
	[PROPERTY_CLASS_CODE]          	nvarchar(16) NULL,
	[PROPERTY_CLASS_DESCRIPTION]   	nvarchar(16) NULL,
	[PROPERTY_SUBCLASS_CODE]       	nvarchar(16) NULL,
...
EXEC sp_addextendedproperty 
	@name = N'MS_Description', @value = N'A code indicating the area class.' , 
	@level0type = N'Schema', @level0name = N'dbo', 
	@level1type = N'Table', @level1name = N'ADS_SSDATA_1647553907854', 
	@level2type = N'Column', @level2name = N'PROPERTY_CLASS_CODE'
GO
EXEC sp_addextendedproperty 
	@name = N'MS_Description', @value = N'The area class description.' , 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1647553907854]([AREA_CODE], [PROPERTY_CLASS_CODE], [PROPERTY_CLASS_DESCRIPTION], [PROPERTY_SUBCLASS_CODE], [PROPERTY_SUBCLASS_DESCRIPTION], [GROSS_LAND_VALUE], [GROSS_IMPROVEMENT_VALUE], [TAX_EXEMPT_LAND_VALUE], [TAX_EXEMPT_IMPROVEMENT_VALUE], [NET_LAND_VALUE], [NET_IMPROVEMENT_VALUE], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID]) 
	SELECT [AREA_CODE], [PROPERTY_CLASS_CODE], SUBSTRING(PROPERTY_CLASS_DESCRIPTION,1,16), [PROPERTY_SUBCLASS_CODE], SUBSTRING(PROPERTY_SUBCLASS_DESCRIPTION,1,16), [GROSS_LAND_VALUE], [GROSS_IMPROVEMENT_VALUE], [TAX_EXEMPT_LAND_VALUE], [TAX_EXEMPT_IMPROVEMENT_VALUE], [NET_LAND_VALUE], [NET_IMPROVEMENT_VALUE], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID] 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1647553907854]', N'BCA_AREA_SCHOOL_VALUE', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1647553907855]  ( 
...
EXEC sp_addextendedproperty 
	@name = N'MS_Description', @value = N'A code indicating the jurisdiction class.' , 
	@level0type = N'Schema', @level0name = N'dbo', 
	@level1type = N'Table', @level1name = N'ADS_SSDATA_1647553907855', 
	@level2type = N'Column', @level2name = N'PROPERTY_CLASS_CODE'
GO
EXEC sp_addextendedproperty 
	@name = N'MS_Description', @value = N'The jurisdiction class description.' , 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1647553907855]([JURISDICTION_CODE], [PROPERTY_CLASS_CODE], [PROPERTY_CLASS_DESCRIPTION], [PROPERTY_SUBCLASS_CODE], [PROPERTY_SUBCLASS_DESCRIPTION], [GROSS_LAND_VALUE], [GROSS_IMPROVEMENT_VALUE], [TAX_EXEMPT_LAND_VALUE], [TAX_EXEMPT_IMPROVEMENT_VALUE], [NET_LAND_VALUE], [NET_IMPROVEMENT_VALUE], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID]) 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1647553907855]', N'BCA_JURISDICTION_BCTRANSIT_VALUE', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1647553907856]  ( 
	[DATA_ADVICE_ID]               	bigint NULL,
	[PROPERTY_CLASS_CODE]          	nvarchar(16) NULL,
	[PROPERTY_CLASS_DESCRIPTION]   	nvarchar(16) NULL,
	[PROPERTY_SUBCLASS_CODE]       	nvarchar(16) NULL,
...
EXEC sp_addextendedproperty 
	@name = N'MS_Description', @value = N'A code indicating the property class.' , 
	@level0type = N'Schema', @level0name = N'dbo', 
	@level1type = N'Table', @level1name = N'ADS_SSDATA_1647553907856', 
	@level2type = N'Column', @level2name = N'PROPERTY_CLASS_CODE'
GO
EXEC sp_addextendedproperty 
	@name = N'MS_Description', @value = N'The property class description.' , 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1647553907856]', N'BCA_DATA_ADVICE_GENERAL_VALUE', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1647553907857]  ( 
	[JURISDICTION_CODE]            	nvarchar(16) NULL,
	[PROPERTY_CLASS_CODE]          	nvarchar(16) NULL,
	[PROPERTY_CLASS_DESCRIPTION]   	nvarchar(16) NULL,
	[PROPERTY_SUBCLASS_CODE]       	nvarchar(16) NULL,
...
EXEC sp_addextendedproperty 
	@name = N'MS_Description', @value = N'A code indicating the jurisdiction class.' , 
	@level0type = N'Schema', @level0name = N'dbo', 
	@level1type = N'Table', @level1name = N'ADS_SSDATA_1647553907857', 
	@level2type = N'Column', @level2name = N'PROPERTY_CLASS_CODE'
GO
EXEC sp_addextendedproperty 
	@name = N'MS_Description', @value = N'The jurisdiction class description.' , 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1647553907857]', N'BCA_JURISDICTION_SCHOOL_VALUE', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1647553907858]  ( 
	[DATA_ADVICE_ID]               	bigint NULL,
	[PROPERTY_CLASS_CODE]          	nvarchar(16) NULL,
	[PROPERTY_CLASS_DESCRIPTION]   	nvarchar(16) NULL,
	[PROPERTY_SUBCLASS_CODE]       	nvarchar(16) NULL,
...
EXEC sp_addextendedproperty 
	@name = N'MS_Description', @value = N'A code indicating the property class.' , 
	@level0type = N'Schema', @level0name = N'dbo', 
	@level1type = N'Table', @level1name = N'ADS_SSDATA_1647553907858', 
	@level2type = N'Column', @level2name = N'PROPERTY_CLASS_CODE'
GO
EXEC sp_addextendedproperty 
	@name = N'MS_Description', @value = N'The property class description.' , 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1647553907858]', N'BCA_DATA_ADVICE_BCTRANSIT_VALUE', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1647553907859]  ( 
	[JURISDICTION_CODE]            	nvarchar(16) NULL,
	[PROPERTY_CLASS_CODE]          	nvarchar(16) NULL,
	[PROPERTY_CLASS_DESCRIPTION]   	nvarchar(16) NULL,
	[PROPERTY_SUBCLASS_CODE]       	nvarchar(16) NULL,
...
EXEC sp_addextendedproperty 
	@name = N'MS_Description', @value = N'A code indicating the jurisdiction class.' , 
	@level0type = N'Schema', @level0name = N'dbo', 
	@level1type = N'Table', @level1name = N'ADS_SSDATA_1647553907859', 
	@level2type = N'Column', @level2name = N'PROPERTY_CLASS_CODE'
GO
EXEC sp_addextendedproperty 
	@name = N'MS_Description', @value = N'The jurisdiction class description.' , 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1647553907859]([JURISDICTION_CODE], [PROPERTY_CLASS_CODE], [PROPERTY_CLASS_DESCRIPTION], [PROPERTY_SUBCLASS_CODE], [PROPERTY_SUBCLASS_DESCRIPTION], [GROSS_LAND_VALUE], [GROSS_IMPROVEMENT_VALUE], [TAX_EXEMPT_LAND_VALUE], [TAX_EXEMPT_IMPROVEMENT_VALUE], [NET_LAND_VALUE], [NET_IMPROVEMENT_VALUE], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID]) 
	SELECT [JURISDICTION_CODE], [PROPERTY_CLASS_CODE], SUBSTRING(PROPERTY_CLASS_DESCRIPTION,1,16), [PROPERTY_SUBCLASS_CODE], SUBSTRING(PROPERTY_SUBCLASS_DESCRIPTION,1,16), [GROSS_LAND_VALUE], [GROSS_IMPROVEMENT_VALUE], [TAX_EXEMPT_LAND_VALUE], [TAX_EXEMPT_IMPROVEMENT_VALUE], [NET_LAND_VALUE], [NET_IMPROVEMENT_VALUE], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID] 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1647553907859]', N'BCA_JURISDICTION_GENERAL_VALUE', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
