...
CREATE TABLE [dbo].[BCA_ASSESSMENT_AREA]  ( 
	...
	CONSTRAINT [PK__BCA_ASSE__FC7CF8094B7DBA6B] PRIMARY KEY CLUSTERED([AREA_CODE])
 ON [PRIMARY])
ON [PRIMARY]
	WITH (
		DATA_COMPRESSION = NONE
...
CREATE TABLE [dbo].[BCA_JURISDICTION]  ( 
	...
	CONSTRAINT [PK__BCA_JURI__A318B2B5A46D67D0] PRIMARY KEY CLUSTERED([JURISDICTION_CODE])
 ON [PRIMARY])
ON [PRIMARY]
	WITH (
		DATA_COMPRESSION = NONE
