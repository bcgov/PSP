/*
Script generated by Aqua Data Studio 22.1.2 on Apr-13-2022 10:49:03 AM
Database: PSP_PIMS_26_00
Schema: dbo
...
ALTER TABLE "dbo"."PIMS_ACCESS_REQUEST_ORGANIZATION"
	...
	UNIQUE ("ORGANIZATION_ID", "ACCESS_REQUEST_ID") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_PROJECT_WORKFLOW_MODEL"
	...
	UNIQUE ("PROJECT_ID", "WORKFLOW_MODEL_ID") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_INSURANCE"
	...
	UNIQUE ("INSURANCE_TYPE_CODE", "LEASE_ID") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_INSURANCE_HIST"
	...
	UNIQUE ("_INSURANCE_HIST_ID", "END_DATE_HIST") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_LEASE_HIST"
	...
	UNIQUE ("_LEASE_HIST_ID", "END_DATE_HIST") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_LEASE_PAYMENT_HIST"
	...
	UNIQUE ("_LEASE_PAYMENT_HIST_ID", "END_DATE_HIST") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_LEASE_TENANT_HIST"
	...
	UNIQUE ("_LEASE_TENANT_HIST_ID", "END_DATE_HIST") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_LEASE_TERM_HIST"
	...
	UNIQUE ("_LEASE_TERM_HIST_ID", "END_DATE_HIST") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_ORGANIZATION_ADDRESS"
	...
	UNIQUE ("ORGANIZATION_ID", "ADDRESS_ID", "ADDRESS_USAGE_TYPE_CODE") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_ORGANIZATION_ADDRESS_HIST"
	...
	UNIQUE ("_ORGANIZATION_ADDRESS_HIST_ID", "END_DATE_HIST") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_PERSON_ADDRESS"
	...
	UNIQUE ("PERSON_ID", "ADDRESS_ID", "ADDRESS_USAGE_TYPE_CODE") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_PERSON_ADDRESS_HIST"
	...
	UNIQUE ("_PERSON_ADDRESS_HIST_ID", "END_DATE_HIST") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_PERSON_ORGANIZATION"
	...
	UNIQUE ("ORGANIZATION_ID", "PERSON_ID") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_PRF_PROP_RESEARCH_PURPOSE_TYPE"
	...
	UNIQUE ("PROP_RESEARCH_PURPOSE_TYPE_CODE", "PROPERTY_RESEARCH_FILE_ID") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_PROJECT_PROPERTY"
	...
	UNIQUE ("PROPERTY_ID", "PROJECT_ID") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_PROPERTY_ACTIVITY"
	...
	UNIQUE ("PROPERTY_ID", "ACTIVITY_ID") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_PROPERTY_IMPROVEMENT"
	...
	UNIQUE ("LEASE_ID", "PROPERTY_IMPROVEMENT_TYPE_CODE") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_PROPERTY_IMPROVEMENT_HIST"
	...
	UNIQUE ("_PROPERTY_IMPROVEMENT_HIST_ID", "END_DATE_HIST") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_PROPERTY_LEASE_HIST"
	...
	UNIQUE ("_PROPERTY_LEASE_HIST_ID", "END_DATE_HIST") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_PROPERTY_ORGANIZATION"
	...
	UNIQUE ("PROPERTY_ID", "ORGANIZATION_ID") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_PROPERTY_PROPERTY_SERVICE_FILE"
	...
	UNIQUE ("PROPERTY_ID", "PROPERTY_SERVICE_FILE_ID") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_PROPERTY_RESEARCH_FILE_HIST"
	...
	UNIQUE ("_PROPERTY_RESEARCH_FILE_HIST_ID", "END_DATE_HIST") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_PROPERTY_TAX_HIST"
	...
	UNIQUE ("_PROPERTY_TAX_HIST_ID", "END_DATE_HIST") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_PROP_PROP_ADJACENT_LAND_TYPE"
	...
	UNIQUE ("PROPERTY_ADJACENT_LAND_TYPE_CODE", "PROPERTY_ID") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_PROP_PROP_ANOMALY_TYPE"
	...
	UNIQUE ("PROPERTY_ANOMALY_TYPE_CODE", "PROPERTY_ID") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_PROP_PROP_ROAD_TYPE"
	...
	UNIQUE ("PROPERTY_ROAD_TYPE_CODE", "PROPERTY_ID") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_RESEARCH_FILE_HIST"
	...
	UNIQUE ("_RESEARCH_FILE_HIST_ID", "END_DATE_HIST") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_RESEARCH_FILE_PURPOSE_HIST"
	...
	UNIQUE ("_RESEARCH_FILE_PURPOSE_HIST_ID", "END_DATE_HIST") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_ROLE_CLAIM"
	...
	UNIQUE ("ROLE_ID", "CLAIM_ID") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_SECURITY_DEPOSIT_HIST"
	...
	UNIQUE ("_SECURITY_DEPOSIT_HIST_ID", "END_DATE_HIST") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_SECURITY_DEPOSIT_HOLDER"
	...
	UNIQUE ("SECURITY_DEPOSIT_ID") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_SECURITY_DEPOSIT_HOLDER_HIST"
	...
	UNIQUE ("_SECURITY_DEPOSIT_HOLDER_HIST_ID", "END_DATE_HIST") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_SECURITY_DEPOSIT_RETURN_HIST"
	...
	UNIQUE ("_SECURITY_DEPOSIT_RETURN_HIST_ID", "END_DATE_HIST") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_SECURITY_DEPOSIT_RETURN_HOLDER"
	...
	UNIQUE ("SECURITY_DEPOSIT_RETURN_ID") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_SECURITY_DEPOSIT_RETURN_HOLDER_HIST"
	...
	UNIQUE ("_SECURITY_DEPOSIT_RETURN_HOLDER_HIST_ID", "END_DATE_HIST") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_STATIC_VARIABLE_HIST"
	...
	UNIQUE ("_STATIC_VARIABLE_HIST_ID", "END_DATE_HIST") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_TASK"
	...
	UNIQUE ("USER_ID", "ACTIVITY_ID", "TASK_TEMPLATE_ID") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_TASK_TEMPLATE_ACTIVITY_MODEL"
	...
	UNIQUE ("TASK_TEMPLATE_ID", "ACTIVITY_MODEL_ID") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_USER_ORGANIZATION"
	...
	UNIQUE ("ORGANIZATION_ID", "USER_ID", "ROLE_ID") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
ALTER TABLE "dbo"."PIMS_USER_ROLE"
	...
	UNIQUE ("USER_ID", "ROLE_ID") NOT ENFORCED 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
