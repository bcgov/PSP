-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Tue Aug 16 16:22:58 PDT 2022
...
-- Drop default constraint dbo.ACTINS_ACTIVITY_INSTANCE_STATUS_TYPE_CODE_DEF
PRINT N'Drop default constraint dbo.ACTINS_ACTIVITY_INSTANCE_STATUS_TYPE_CODE_DEF'
GO
ALTER TABLE [dbo].[PIMS_ACTIVITY_INSTANCE]
...
GO
ALTER TABLE [dbo].[PIMS_ACTIVITY_INSTANCE]
	DROP COLUMN IF EXISTS [ACTIVITY_INSTANCE_STATUS_TYPE_CODE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
