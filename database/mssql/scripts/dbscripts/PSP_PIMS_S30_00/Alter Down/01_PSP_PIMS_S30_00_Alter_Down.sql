-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Wed Jun 08 13:34:39 PDT 2022
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY]
	DROP COLUMN IF EXISTS [PPH_STATUS_UPDATE_USER_GUID]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
