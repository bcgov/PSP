...
CREATE TABLE [dbo].[PIMS_ACCESS_REQUEST_HIST] (
    [_ACCESS_REQUEST_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_ACCE___ACCE__46335CF5] DEFAULT NEXT VALUE FOR [PIMS_ACCESS_REQUEST_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_ACCE__EFFEC__4727812E] DEFAULT getutcdate() NOT NULL,
...
CREATE TABLE [dbo].[PIMS_ACCESS_REQUEST_ORGANIZATION_HIST] (
    [_ACCESS_REQUEST_ORGANIZATION_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_ACCE___ACCE__4BEC364B] DEFAULT NEXT VALUE FOR [PIMS_ACCESS_REQUEST_ORGANIZATION_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_ACCE__EFFEC__4CE05A84] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_ACTIVITY_HIST] (
    [_ACTIVITY_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_ACTI___ACTI__51A50FA1] DEFAULT NEXT VALUE FOR [PIMS_ACTIVITY_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_ACTI__EFFEC__529933DA] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_ACTIVITY_MODEL_HIST] (
    [_ACTIVITY_MODEL_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_ACTI___ACTI__575DE8F7] DEFAULT NEXT VALUE FOR [PIMS_ACTIVITY_MODEL_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_ACTI__EFFEC__58520D30] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
    [ACTIVITY_MODEL_ID] BIGINT NOT NULL,
    [DESCRIPTION] NVARCHAR(200) NOT NULL,
...
CREATE TABLE [dbo].[PIMS_ADDRESS_HIST] (
    [_ADDRESS_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_ADDR___ADDR__5D16C24D] DEFAULT NEXT VALUE FOR [PIMS_ADDRESS_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_ADDR__EFFEC__5E0AE686] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_CLAIM_HIST] (
    [_CLAIM_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_CLAI___CLAI__62CF9BA3] DEFAULT NEXT VALUE FOR [PIMS_CLAIM_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_CLAI__EFFEC__63C3BFDC] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_CONTACT_METHOD_HIST] (
    [_CONTACT_METHOD_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_CONT___CONT__688874F9] DEFAULT NEXT VALUE FOR [PIMS_CONTACT_METHOD_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_CONT__EFFEC__697C9932] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_INSURANCE_HIST] (
    [_INSURANCE_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_INSU___INSU__6E414E4F] DEFAULT NEXT VALUE FOR [PIMS_INSURANCE_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_INSU__EFFEC__6F357288] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_LEASE_HIST] (
    [_LEASE_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_LEAS___LEAS__73FA27A5] DEFAULT NEXT VALUE FOR [PIMS_LEASE_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_LEAS__EFFEC__74EE4BDE] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
    [LEASE_ID] BIGINT NOT NULL,
    [LEASE_PAY_RVBL_TYPE_CODE] NVARCHAR(20) NOT NULL,
    [LEASE_LICENSE_TYPE_CODE] NVARCHAR(20) NOT NULL,
...
CREATE TABLE [dbo].[PIMS_LEASE_TENANT_HIST] (
    [_LEASE_TENANT_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_LEAS___LEAS__0ADD8CFD] DEFAULT NEXT VALUE FOR [PIMS_LEASE_TENANT_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_LEAS__EFFEC__0BD1B136] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_ORGANIZATION_HIST] (
    [_ORGANIZATION_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_ORGA___ORGA__1C0818FF] DEFAULT NEXT VALUE FOR [PIMS_ORGANIZATION_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_ORGA__EFFEC__1CFC3D38] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_PERSON_HIST] (
    [_PERSON_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_PERS___PERS__2779CBAB] DEFAULT NEXT VALUE FOR [PIMS_PERSON_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_PERS__EFFEC__286DEFE4] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_PERSON_ORGANIZATION_HIST] (
    [_PERSON_ORGANIZATION_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_PERS___PERS__2D32A501] DEFAULT NEXT VALUE FOR [PIMS_PERSON_ORGANIZATION_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_PERS__EFFEC__2E26C93A] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_PROJECT_HIST] (
    [_PROJECT_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_PROJ___PROJ__32EB7E57] DEFAULT NEXT VALUE FOR [PIMS_PROJECT_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_PROJ__EFFEC__33DFA290] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_PROJECT_NOTE_HIST] (
    [_PROJECT_NOTE_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_PROJ___PROJ__38A457AD] DEFAULT NEXT VALUE FOR [PIMS_PROJECT_NOTE_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_PROJ__EFFEC__39987BE6] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_PROJECT_PROPERTY_HIST] (
    [_PROJECT_PROPERTY_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_PROJ___PROJ__3E5D3103] DEFAULT NEXT VALUE FOR [PIMS_PROJECT_PROPERTY_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_PROJ__EFFEC__3F51553C] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_PROJECT_WORKFLOW_MODEL_HIST] (
    [_PROJECT_WORKFLOW_MODEL_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_PROJ___PROJ__44160A59] DEFAULT NEXT VALUE FOR [PIMS_PROJECT_WORKFLOW_MODEL_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_PROJ__EFFEC__450A2E92] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_PROPERTY_ACTIVITY_HIST] (
    [_PROPERTY_ACTIVITY_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_PROP___PROP__49CEE3AF] DEFAULT NEXT VALUE FOR [PIMS_PROPERTY_ACTIVITY_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_PROP__EFFEC__4AC307E8] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_PROPERTY_EVALUATION_HIST] (
    [_PROPERTY_EVALUATION_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_PROP___PROP__4F87BD05] DEFAULT NEXT VALUE FOR [PIMS_PROPERTY_EVALUATION_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_PROP__EFFEC__507BE13E] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_PROPERTY_HIST] (
    [_PROPERTY_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_PROP___PROP__5540965B] DEFAULT NEXT VALUE FOR [PIMS_PROPERTY_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_PROP__EFFEC__5634BA94] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
    [PROPERTY_ID] BIGINT NOT NULL,
...
CREATE TABLE [dbo].[PIMS_PROPERTY_IMPROVEMENT_HIST] (
    [_PROPERTY_IMPROVEMENT_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_PROP___PROP__5AF96FB1] DEFAULT NEXT VALUE FOR [PIMS_PROPERTY_IMPROVEMENT_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_PROP__EFFEC__5BED93EA] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_PROPERTY_LEASE_HIST] (
    [_PROPERTY_LEASE_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_PROP___PROP__60B24907] DEFAULT NEXT VALUE FOR [PIMS_PROPERTY_LEASE_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_PROP__EFFEC__61A66D40] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_PROPERTY_ORGANIZATION_HIST] (
    [_PROPERTY_ORGANIZATION_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_PROP___PROP__666B225D] DEFAULT NEXT VALUE FOR [PIMS_PROPERTY_ORGANIZATION_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_PROP__EFFEC__675F4696] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_PROPERTY_PROPERTY_SERVICE_FILE_HIST] (
    [_PROPERTY_PROPERTY_SERVICE_FILE_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_PROP___PROP__6C23FBB3] DEFAULT NEXT VALUE FOR [PIMS_PROPERTY_PROPERTY_SERVICE_FILE_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_PROP__EFFEC__6D181FEC] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_PROPERTY_SERVICE_FILE_HIST] (
    [_PROPERTY_SERVICE_FILE_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_PROP___PROP__71DCD509] DEFAULT NEXT VALUE FOR [PIMS_PROPERTY_SERVICE_FILE_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_PROP__EFFEC__72D0F942] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
    [PROPERTY_SERVICE_FILE_ID] BIGINT NOT NULL,
    [PROPERTY_SERVICE_FILE_TYPE_CODE] NVARCHAR(20) NOT NULL,
    [CONCURRENCY_CONTROL_NUMBER] BIGINT NOT NULL,
...
CREATE TABLE [dbo].[PIMS_PROPERTY_TAX_HIST] (
    [_PROPERTY_TAX_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_PROP___PROP__7795AE5F] DEFAULT NEXT VALUE FOR [PIMS_PROPERTY_TAX_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_PROP__EFFEC__7889D298] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_ROLE_CLAIM_HIST] (
    [_ROLE_CLAIM_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_ROLE___ROLE__7D4E87B5] DEFAULT NEXT VALUE FOR [PIMS_ROLE_CLAIM_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_ROLE__EFFEC__7E42ABEE] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_ROLE_HIST] (
    [_ROLE_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_ROLE___ROLE__0307610B] DEFAULT NEXT VALUE FOR [PIMS_ROLE_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_ROLE__EFFEC__03FB8544] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
    [ROLE_ID] BIGINT NOT NULL,
    [ROLE_UID] UNIQUEIDENTIFIER NOT NULL,
    [KEYCLOAK_GROUP_ID] UNIQUEIDENTIFIER,
...
CREATE TABLE [dbo].[PIMS_SECURITY_DEPOSIT_HIST] (
    [_SECURITY_DEPOSIT_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_SECU___SECU__08C03A61] DEFAULT NEXT VALUE FOR [PIMS_SECURITY_DEPOSIT_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_SECU__EFFEC__09B45E9A] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
    [SECURITY_DEPOSIT_ID] BIGINT NOT NULL,
    [LEASE_ID] BIGINT NOT NULL,
    [SEC_DEP_HOLDER_TYPE_CODE] NVARCHAR(20) NOT NULL,
    [SECURITY_DEPOSIT_TYPE_CODE] NVARCHAR(20) NOT NULL,
    [OTHER_DEP_HOLDER_TYPE_DESC] NVARCHAR(100),
...
CREATE TABLE [dbo].[PIMS_SECURITY_DEPOSIT_RETURN_HIST] (
    [_SECURITY_DEPOSIT_RETURN_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_SECU___SECU__0E7913B7] DEFAULT NEXT VALUE FOR [PIMS_SECURITY_DEPOSIT_RETURN_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_SECU__EFFEC__0F6D37F0] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_TASK_HIST] (
    [_TASK_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_TASK___TASK__1431ED0D] DEFAULT NEXT VALUE FOR [PIMS_TASK_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_TASK__EFFEC__15261146] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_TASK_TEMPLATE_ACTIVITY_MODEL_HIST] (
    [_TASK_TEMPLATE_ACTIVITY_MODEL_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_TASK___TASK__19EAC663] DEFAULT NEXT VALUE FOR [PIMS_TASK_TEMPLATE_ACTIVITY_MODEL_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_TASK__EFFEC__1ADEEA9C] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_TASK_TEMPLATE_HIST] (
    [_TASK_TEMPLATE_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_TASK___TASK__1FA39FB9] DEFAULT NEXT VALUE FOR [PIMS_TASK_TEMPLATE_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_TASK__EFFEC__2097C3F2] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
    [TASK_TEMPLATE_ID] BIGINT NOT NULL,
    [TASK_TEMPLATE_TYPE_CODE] NVARCHAR(20) NOT NULL,
    [IS_DISABLED] BIT NOT NULL,
...
CREATE TABLE [dbo].[PIMS_USER_HIST] (
    [_USER_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_USER___USER__255C790F] DEFAULT NEXT VALUE FOR [PIMS_USER_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_USER__EFFEC__26509D48] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
    [USER_ID] BIGINT NOT NULL,
    [PERSON_ID] BIGINT NOT NULL,
...
CREATE TABLE [dbo].[PIMS_USER_ORGANIZATION_HIST] (
    [_USER_ORGANIZATION_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_USER___USER__2B155265] DEFAULT NEXT VALUE FOR [PIMS_USER_ORGANIZATION_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_USER__EFFEC__2C09769E] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_USER_ROLE_HIST] (
    [_USER_ROLE_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_USER___USER__30CE2BBB] DEFAULT NEXT VALUE FOR [PIMS_USER_ROLE_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_USER__EFFEC__31C24FF4] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_WORKFLOW_MODEL_HIST] (
    [_WORKFLOW_MODEL_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_WORK___WORK__36870511] DEFAULT NEXT VALUE FOR [PIMS_WORKFLOW_MODEL_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_WORK__EFFEC__377B294A] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
    [WORKFLOW_MODEL_ID] BIGINT NOT NULL,
    [WORKFLOW_MODEL_TYPE_CODE] NVARCHAR(20) NOT NULL,
    [IS_DISABLED] BIT NOT NULL,
...
CREATE TABLE [dbo].[PIMS_LEASE_PAYMENT_FORECAST_HIST] (
    [_LEASE_PAYMENT_FORECAST_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_LEAS___LEAS__79B300FB] DEFAULT NEXT VALUE FOR [PIMS_LEASE_PAYMENT_FORECAST_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_LEAS__EFFEC__7AA72534] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_LEASE_PAYMENT_HIST] (
    [_LEASE_PAYMENT_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_LEAS___LEAS__7F6BDA51] DEFAULT NEXT VALUE FOR [PIMS_LEASE_PAYMENT_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_LEAS__EFFEC__005FFE8A] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_LEASE_PAYMENT_PERIOD_HIST] (
    [_LEASE_PAYMENT_PERIOD_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_LEAS___LEAS__0524B3A7] DEFAULT NEXT VALUE FOR [PIMS_LEASE_PAYMENT_PERIOD_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_LEAS__EFFEC__0618D7E0] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
    [LEASE_PAYMENT_PERIOD_ID] BIGINT NOT NULL,
    [PERIOD_START_DATE] DATE NOT NULL,
...
CREATE TABLE [dbo].[PIMS_LEASE_TERM_HIST] (
    [_LEASE_TERM_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_LEAS___LEAS__10966653] DEFAULT NEXT VALUE FOR [PIMS_LEASE_TERM_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_LEAS__EFFEC__118A8A8C] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
    [LEASE_TERM_ID] BIGINT NOT NULL,
    [LEASE_ID] BIGINT NOT NULL,
    [LEASE_TERM_STATUS_TYPE_CODE] NVARCHAR(20) NOT NULL,
...
/* ---------------------------------------------------------------------- */
/* Add table "dbo.PIMS_ORGANIZATION_ADDRESS_HIST"                         */
/* ---------------------------------------------------------------------- */

CREATE TABLE [dbo].[PIMS_ORGANIZATION_ADDRESS_HIST] (
    [_ORGANIZATION_ADDRESS_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_ORGA___ORGA__164F3FA9] DEFAULT NEXT VALUE FOR [PIMS_ORGANIZATION_ADDRESS_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_ORGA__EFFEC__174363E2] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
    ...
    CONSTRAINT [PIMS_ORGADD_H_UK] UNIQUE ([_ORGANIZATION_ADDRESS_HIST_ID], [END_DATE_HIST])
)
GO


/* ---------------------------------------------------------------------- */
/* Add table "dbo.PIMS_PERSON_ADDRESS_HIST"                               */
/* ---------------------------------------------------------------------- */

CREATE TABLE [dbo].[PIMS_PERSON_ADDRESS_HIST] (
    [_PERSON_ADDRESS_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_PERS___PERS__21C0F255] DEFAULT NEXT VALUE FOR [PIMS_PERSON_ADDRESS_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_PERS__EFFEC__22B5168E] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
    ...
    CONSTRAINT [PIMS_PERADD_H_UK] UNIQUE ([_PERSON_ADDRESS_HIST_ID], [END_DATE_HIST])
)
GO
...
EXECUTE sp_addextendedproperty N'MS_Description', N'MoTI region associated with the lease', 'SCHEMA', N'dbo', 'TABLE', N'PIMS_LEASE', 'COLUMN', N'MOTI_REGION'
GO
...
-- --------------------------------------------------------------------------------------------
CREATE FUNCTION pims_ColumnExists(@TableName varchar(100), @ColumnName varchar(100))
RETURNS nvarchar(1)
AS
BEGIN
