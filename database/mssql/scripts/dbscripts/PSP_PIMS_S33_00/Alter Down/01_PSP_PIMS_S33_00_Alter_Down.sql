-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Tue Jul 26 14:59:18 PDT 2022
...
-- Drop foreign key constraint dbo.PIM_REGION_PIM_ACQNFL_FK
PRINT N'Drop foreign key constraint dbo.PIM_REGION_PIM_ACQNFL_FK'
GO
ALTER TABLE [dbo].[PIMS_ACQUISITION_FILE]
	DROP CONSTRAINT IF EXISTS [PIM_REGION_PIM_ACQNFL_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop index dbo.ACQNFL_REGION_CODE_IDX
PRINT N'Drop index dbo.ACQNFL_REGION_CODE_IDX'
GO
DROP INDEX IF EXISTS [dbo].[PIMS_ACQUISITION_FILE].[ACQNFL_REGION_CODE_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
