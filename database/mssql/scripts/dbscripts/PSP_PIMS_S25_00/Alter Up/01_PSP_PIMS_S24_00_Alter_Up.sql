-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Tue Mar 29 22:51:09 PDT 2022
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_RESEARCH_FILE] ADD DEFAULT 'ACTIVE' FOR [RESEARCH_FILE_STATUS_TYPE_CODE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_RESEARCH_FILE]
