-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Tue Mar 29 22:55:14 PDT 2022
...
GO
ALTER TABLE [dbo].[PIMS_RESEARCH_FILE] ADD CONSTRAINT [RESRCH_RESEARCH_FILE_STATUS_TYPE_CODE_DEF] DEFAULT ('ACTIVE') FOR [RESEARCH_FILE_STATUS_TYPE_CODE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_RESEARCH_FILE]
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROP_PROP_TENURE_TYPE] ADD DEFAULT 'UNKNOWN' FOR [PROPERTY_TENURE_TYPE_CODE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
