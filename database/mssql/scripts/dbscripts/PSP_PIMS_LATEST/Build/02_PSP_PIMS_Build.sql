/*
Script generated by Aqua Data Studio 22.1.3 on Aug-08-2022 03:13:39 PM
Database: PSP_PIMS_S34_00
Schema: dbo
...
CREATE TABLE [dbo].[PIMS_ACQUISITION_FILE]  ( 
	...
	[FILE_ID]                          	bigint NOT NULL CONSTRAINT [ACQNFL_FILE_ID_DEF]  DEFAULT ((-1)),
	[ACQUISITION_FILE_STATUS_TYPE_CODE]	nvarchar(20) NOT NULL,
	[ACQUISITION_TYPE_CODE]            	nvarchar(20) NOT NULL,
...
CREATE TABLE [dbo].[PIMS_ACTIVITY_INSTANCE]  ( 
	...
	[FILE_ID]                           	bigint NOT NULL CONSTRAINT [ACTINS_FILE_ID_DEF]  DEFAULT ((-1)),
...
CREATE TABLE [dbo].[PIMS_RESEARCH_FILE]  ( 
	...
	[FILE_ID]                       	bigint NOT NULL CONSTRAINT [RESRCH_FILE_ID_DEF]  DEFAULT ((-1)),
