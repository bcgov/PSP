/*
Script generated by Aqua Data Studio 22.1.3 on Sep-02-2022 11:19:51 AM
Database: PSP_PIMS_S36_01
Schema: dbo
...
CREATE TABLE [dbo].[PIMS_NOTE_HIST]  ( 
	...
	[IS_SYSTEM_GENERATED]           	bit NOT NULL CONSTRAINT NOTE_H_IS_SYSTEM_GENERATED_DEF DEFAULT (CONVERT([bit],(0))),
	[CONCURRENCY_CONTROL_NUMBER]    	bigint NOT NULL,
	[APP_CREATE_TIMESTAMP]          	datetime NOT NULL,
	[APP_CREATE_USERID]             	nvarchar(30) NOT NULL,
	[APP_CREATE_USER_GUID]          	uniqueidentifier NULL,
