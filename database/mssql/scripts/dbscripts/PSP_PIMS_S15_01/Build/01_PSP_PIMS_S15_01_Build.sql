...
CREATE TABLE [dbo].[PIMS_ACCESS_REQUEST_HIST] (
    [_ACCESS_REQUEST_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_ACCE___ACCE__4EC8A2F6] DEFAULT NEXT VALUE FOR [PIMS_ACCESS_REQUEST_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_ACCE__EFFEC__4FBCC72F] DEFAULT getutcdate() NOT NULL,
...
CREATE TABLE [dbo].[PIMS_ACCESS_REQUEST_ORGANIZATION_HIST] (
    [_ACCESS_REQUEST_ORGANIZATION_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_ACCE___ACCE__54817C4C] DEFAULT NEXT VALUE FOR [PIMS_ACCESS_REQUEST_ORGANIZATION_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_ACCE__EFFEC__5575A085] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_ACTIVITY_HIST] (
    [_ACTIVITY_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_ACTI___ACTI__5A3A55A2] DEFAULT NEXT VALUE FOR [PIMS_ACTIVITY_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_ACTI__EFFEC__5B2E79DB] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_ACTIVITY_MODEL_HIST] (
    [_ACTIVITY_MODEL_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_ACTI___ACTI__5FF32EF8] DEFAULT NEXT VALUE FOR [PIMS_ACTIVITY_MODEL_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_ACTI__EFFEC__60E75331] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
    [ACTIVITY_MODEL_ID] BIGINT NOT NULL,
    [DESCRIPTION] NVARCHAR(200) NOT NULL,
...
CREATE TABLE [dbo].[PIMS_ADDRESS_HIST] (
    [_ADDRESS_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_ADDR___ADDR__65AC084E] DEFAULT NEXT VALUE FOR [PIMS_ADDRESS_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_ADDR__EFFEC__66A02C87] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_CLAIM_HIST] (
    [_CLAIM_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_CLAI___CLAI__6B64E1A4] DEFAULT NEXT VALUE FOR [PIMS_CLAIM_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_CLAI__EFFEC__6C5905DD] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_CONTACT_METHOD_HIST] (
    [_CONTACT_METHOD_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_CONT___CONT__711DBAFA] DEFAULT NEXT VALUE FOR [PIMS_CONTACT_METHOD_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_CONT__EFFEC__7211DF33] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_INSURANCE_HIST] (
    [_INSURANCE_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_INSU___INSU__76D69450] DEFAULT NEXT VALUE FOR [PIMS_INSURANCE_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_INSU__EFFEC__77CAB889] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_LEASE_HIST] (
    [_LEASE_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_LEAS___LEAS__7C8F6DA6] DEFAULT NEXT VALUE FOR [PIMS_LEASE_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_LEAS__EFFEC__7D8391DF] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
    [LEASE_ID] BIGINT NOT NULL,
...
CREATE TABLE [dbo].[PIMS_LEASE_TENANT_HIST] (
    [_LEASE_TENANT_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_LEAS___LEAS__1372D2FE] DEFAULT NEXT VALUE FOR [PIMS_LEASE_TENANT_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_LEAS__EFFEC__1466F737] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_ORGANIZATION_HIST] (
    [_ORGANIZATION_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_ORGA___ORGA__249D5F00] DEFAULT NEXT VALUE FOR [PIMS_ORGANIZATION_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_ORGA__EFFEC__25918339] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_PERSON_HIST] (
    [_PERSON_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_PERS___PERS__300F11AC] DEFAULT NEXT VALUE FOR [PIMS_PERSON_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_PERS__EFFEC__310335E5] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_PERSON_ORGANIZATION_HIST] (
    [_PERSON_ORGANIZATION_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_PERS___PERS__35C7EB02] DEFAULT NEXT VALUE FOR [PIMS_PERSON_ORGANIZATION_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_PERS__EFFEC__36BC0F3B] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_PROJECT_HIST] (
    [_PROJECT_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_PROJ___PROJ__3B80C458] DEFAULT NEXT VALUE FOR [PIMS_PROJECT_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_PROJ__EFFEC__3C74E891] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_PROJECT_NOTE_HIST] (
    [_PROJECT_NOTE_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_PROJ___PROJ__41399DAE] DEFAULT NEXT VALUE FOR [PIMS_PROJECT_NOTE_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_PROJ__EFFEC__422DC1E7] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_PROJECT_PROPERTY_HIST] (
    [_PROJECT_PROPERTY_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_PROJ___PROJ__46F27704] DEFAULT NEXT VALUE FOR [PIMS_PROJECT_PROPERTY_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_PROJ__EFFEC__47E69B3D] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_PROJECT_WORKFLOW_MODEL_HIST] (
    [_PROJECT_WORKFLOW_MODEL_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_PROJ___PROJ__4CAB505A] DEFAULT NEXT VALUE FOR [PIMS_PROJECT_WORKFLOW_MODEL_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_PROJ__EFFEC__4D9F7493] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_PROPERTY_ACTIVITY_HIST] (
    [_PROPERTY_ACTIVITY_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_PROP___PROP__526429B0] DEFAULT NEXT VALUE FOR [PIMS_PROPERTY_ACTIVITY_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_PROP__EFFEC__53584DE9] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_PROPERTY_EVALUATION_HIST] (
    [_PROPERTY_EVALUATION_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_PROP___PROP__581D0306] DEFAULT NEXT VALUE FOR [PIMS_PROPERTY_EVALUATION_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_PROP__EFFEC__5911273F] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_PROPERTY_HIST] (
    [_PROPERTY_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_PROP___PROP__5DD5DC5C] DEFAULT NEXT VALUE FOR [PIMS_PROPERTY_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_PROP__EFFEC__5ECA0095] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
    [PROPERTY_ID] BIGINT NOT NULL,
...
CREATE TABLE [dbo].[PIMS_PROPERTY_IMPROVEMENT_HIST] (
    [_PROPERTY_IMPROVEMENT_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_PROP___PROP__638EB5B2] DEFAULT NEXT VALUE FOR [PIMS_PROPERTY_IMPROVEMENT_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_PROP__EFFEC__6482D9EB] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_PROPERTY_LEASE_HIST] (
    [_PROPERTY_LEASE_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_PROP___PROP__69478F08] DEFAULT NEXT VALUE FOR [PIMS_PROPERTY_LEASE_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_PROP__EFFEC__6A3BB341] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
    [PROPERTY_LEASE_ID] BIGINT NOT NULL,
    [PROPERTY_ID] BIGINT NOT NULL,
    [LEASE_ID] BIGINT NOT NULL,
...
CREATE TABLE [dbo].[PIMS_PROPERTY_ORGANIZATION_HIST] (
    [_PROPERTY_ORGANIZATION_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_PROP___PROP__6F00685E] DEFAULT NEXT VALUE FOR [PIMS_PROPERTY_ORGANIZATION_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_PROP__EFFEC__6FF48C97] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_PROPERTY_PROPERTY_SERVICE_FILE_HIST] (
    [_PROPERTY_PROPERTY_SERVICE_FILE_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_PROP___PROP__74B941B4] DEFAULT NEXT VALUE FOR [PIMS_PROPERTY_PROPERTY_SERVICE_FILE_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_PROP__EFFEC__75AD65ED] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_PROPERTY_SERVICE_FILE_HIST] (
    [_PROPERTY_SERVICE_FILE_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_PROP___PROP__7A721B0A] DEFAULT NEXT VALUE FOR [PIMS_PROPERTY_SERVICE_FILE_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_PROP__EFFEC__7B663F43] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
    [PROPERTY_SERVICE_FILE_ID] BIGINT NOT NULL,
    [PROPERTY_SERVICE_FILE_TYPE_CODE] NVARCHAR(20) NOT NULL,
    [CONCURRENCY_CONTROL_NUMBER] BIGINT NOT NULL,
...
CREATE TABLE [dbo].[PIMS_PROPERTY_TAX_HIST] (
    [_PROPERTY_TAX_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_PROP___PROP__002AF460] DEFAULT NEXT VALUE FOR [PIMS_PROPERTY_TAX_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_PROP__EFFEC__011F1899] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_ROLE_CLAIM_HIST] (
    [_ROLE_CLAIM_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_ROLE___ROLE__05E3CDB6] DEFAULT NEXT VALUE FOR [PIMS_ROLE_CLAIM_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_ROLE__EFFEC__06D7F1EF] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_ROLE_HIST] (
    [_ROLE_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_ROLE___ROLE__0B9CA70C] DEFAULT NEXT VALUE FOR [PIMS_ROLE_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_ROLE__EFFEC__0C90CB45] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
    [ROLE_ID] BIGINT NOT NULL,
    [ROLE_UID] UNIQUEIDENTIFIER NOT NULL,
    [KEYCLOAK_GROUP_ID] UNIQUEIDENTIFIER,
...
CREATE TABLE [dbo].[PIMS_SECURITY_DEPOSIT_HIST] (
    [_SECURITY_DEPOSIT_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_SECU___SECU__11558062] DEFAULT NEXT VALUE FOR [PIMS_SECURITY_DEPOSIT_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_SECU__EFFEC__1249A49B] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_SECURITY_DEPOSIT_RETURN_HIST] (
    [_SECURITY_DEPOSIT_RETURN_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_SECU___SECU__170E59B8] DEFAULT NEXT VALUE FOR [PIMS_SECURITY_DEPOSIT_RETURN_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_SECU__EFFEC__18027DF1] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_TASK_HIST] (
    [_TASK_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_TASK___TASK__1CC7330E] DEFAULT NEXT VALUE FOR [PIMS_TASK_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_TASK__EFFEC__1DBB5747] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_TASK_TEMPLATE_ACTIVITY_MODEL_HIST] (
    [_TASK_TEMPLATE_ACTIVITY_MODEL_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_TASK___TASK__22800C64] DEFAULT NEXT VALUE FOR [PIMS_TASK_TEMPLATE_ACTIVITY_MODEL_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_TASK__EFFEC__2374309D] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_TASK_TEMPLATE_HIST] (
    [_TASK_TEMPLATE_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_TASK___TASK__2838E5BA] DEFAULT NEXT VALUE FOR [PIMS_TASK_TEMPLATE_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_TASK__EFFEC__292D09F3] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
    [TASK_TEMPLATE_ID] BIGINT NOT NULL,
    [TASK_TEMPLATE_TYPE_CODE] NVARCHAR(20) NOT NULL,
    [IS_DISABLED] BIT NOT NULL,
...
CREATE TABLE [dbo].[PIMS_USER_HIST] (
    [_USER_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_USER___USER__2DF1BF10] DEFAULT NEXT VALUE FOR [PIMS_USER_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_USER__EFFEC__2EE5E349] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
    [USER_ID] BIGINT NOT NULL,
    [PERSON_ID] BIGINT NOT NULL,
...
CREATE TABLE [dbo].[PIMS_USER_ORGANIZATION_HIST] (
    [_USER_ORGANIZATION_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_USER___USER__33AA9866] DEFAULT NEXT VALUE FOR [PIMS_USER_ORGANIZATION_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_USER__EFFEC__349EBC9F] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_USER_ROLE_HIST] (
    [_USER_ROLE_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_USER___USER__396371BC] DEFAULT NEXT VALUE FOR [PIMS_USER_ROLE_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_USER__EFFEC__3A5795F5] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_WORKFLOW_MODEL_HIST] (
    [_WORKFLOW_MODEL_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_WORK___WORK__3F1C4B12] DEFAULT NEXT VALUE FOR [PIMS_WORKFLOW_MODEL_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_WORK__EFFEC__40106F4B] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
    [WORKFLOW_MODEL_ID] BIGINT NOT NULL,
    [WORKFLOW_MODEL_TYPE_CODE] NVARCHAR(20) NOT NULL,
    [IS_DISABLED] BIT NOT NULL,
...
/* ---------------------------------------------------------------------- */
/* Add table "etl.ETL_INTEREST_HOLDER_PERSON_LOG"                         */
/* ---------------------------------------------------------------------- */
...
CREATE TABLE [dbo].[PIMS_LEASE_PAYMENT_FORECAST_HIST] (
    [_LEASE_PAYMENT_FORECAST_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_LEAS___LEAS__024846FC] DEFAULT NEXT VALUE FOR [PIMS_LEASE_PAYMENT_FORECAST_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_LEAS__EFFEC__033C6B35] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_LEASE_PAYMENT_HIST] (
    [_LEASE_PAYMENT_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_LEAS___LEAS__08012052] DEFAULT NEXT VALUE FOR [PIMS_LEASE_PAYMENT_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_LEAS__EFFEC__08F5448B] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_LEASE_PAYMENT_PERIOD_HIST] (
    [_LEASE_PAYMENT_PERIOD_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_LEAS___LEAS__0DB9F9A8] DEFAULT NEXT VALUE FOR [PIMS_LEASE_PAYMENT_PERIOD_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_LEAS__EFFEC__0EAE1DE1] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
    [LEASE_PAYMENT_PERIOD_ID] BIGINT NOT NULL,
    [PERIOD_START_DATE] DATE NOT NULL,
...
CREATE TABLE [dbo].[PIMS_LEASE_TERM_HIST] (
    [_LEASE_TERM_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_LEAS___LEAS__192BAC54] DEFAULT NEXT VALUE FOR [PIMS_LEASE_TERM_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_LEAS__EFFEC__1A1FD08D] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
    [LEASE_TERM_ID] VARCHAR(40) NOT NULL,
    [LEASE_ID] BIGINT NOT NULL,
    [LEASE_TERM_STATUS_TYPE_CODE] NVARCHAR(20) NOT NULL,
...
/* ---------------------------------------------------------------------- */
/* Add table "etl.ETL_OPERATIONAL_SS_LOAD"                                */
/* ---------------------------------------------------------------------- */
...
/* ---------------------------------------------------------------------- */
/* Add table "etl.ETL_INTEREST_HOLDER_ORG_LOG"                            */
/* ---------------------------------------------------------------------- */
...
/* ---------------------------------------------------------------------- */
/* Add table "etl.ETL_DATA_SOURCE_TRACE"                                  */
/* ---------------------------------------------------------------------- */

CREATE TABLE [etl].[ETL_DATA_SOURCE_TRACE] (
    [DATA_SOURCE_TRACE_ID] BIGINT CONSTRAINT [SRCTRC_DATA_SOURCE_TRACE_ID_DEF] DEFAULT NEXT VALUE FOR [ETL_DATA_SOURCE_TRACE_ID_SEQ] NOT NULL,
    [DATA_SOURCE_TYPE_CODE] NVARCHAR(20) NOT NULL,
...
CREATE TABLE [dbo].[PIMS_ORGANIZATION_ADDRESS_HIST] (
    [_ORGANIZATION_ADDRESS_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_ORGA___ORGA__1EE485AA] DEFAULT NEXT VALUE FOR [PIMS_ORGANIZATION_ADDRESS_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_ORGA__EFFEC__1FD8A9E3] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
...
CREATE TABLE [dbo].[PIMS_PERSON_ADDRESS_HIST] (
    [_PERSON_ADDRESS_HIST_ID] BIGINT CONSTRAINT [DF__PIMS_PERS___PERS__2A563856] DEFAULT NEXT VALUE FOR [PIMS_PERSON_ADDRESS_H_ID_SEQ] NOT NULL,
    [EFFECTIVE_DATE_HIST] DATETIME CONSTRAINT [DF__PIMS_PERS__EFFEC__2B4A5C8F] DEFAULT getutcdate() NOT NULL,
    [END_DATE_HIST] DATETIME,
