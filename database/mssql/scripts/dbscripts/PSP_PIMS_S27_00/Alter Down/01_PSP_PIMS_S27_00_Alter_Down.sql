...
GO
UPDATE [dbo].[PIMS_LEASE] SET [HAS_PHYSICAL_FILE] = (CONVERT([bit],(0))) WHERE [HAS_PHYSICAL_FILE] IS NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
UPDATE [dbo].[PIMS_LEASE] SET [HAS_DIGITAL_FILE] = (CONVERT([bit],(0))) WHERE [HAS_DIGITAL_FILE] IS NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
UPDATE [dbo].[PIMS_LEASE] SET [HAS_PHYSICIAL_LICENSE] = (CONVERT([bit],(0))) WHERE [HAS_PHYSICIAL_LICENSE] IS NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
UPDATE [dbo].[PIMS_LEASE] SET [HAS_DIGITAL_LICENSE] = (CONVERT([bit],(0))) WHERE [HAS_DIGITAL_LICENSE] IS NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
--GO
--ALTER TABLE [dbo].[PIMS_RESEARCH_FILE_PURPOSE_HIST] varchar(40) NULL
--GO
--IF @@ERROR <> 0 SET NOEXEC ON
--GO
