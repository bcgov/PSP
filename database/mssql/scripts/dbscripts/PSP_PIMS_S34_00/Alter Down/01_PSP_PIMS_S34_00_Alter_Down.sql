...
ALTER TABLE [dbo].[PIMS_FILE_PROPERTY_RESEARCH]
	DROP CONSTRAINT [PIM_FILPRP_PIM_PRSCRC_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
ALTER TABLE [dbo].[PIMS_ACTIVITY_INSTANCE_PROPERTY]
	DROP CONSTRAINT [PIM_ACTINS_PIM_ACTINP_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_ACTIVITY_INSTANCE_PROPERTY]
	DROP CONSTRAINT [PIM_FILPRP_PIM_ACTINP_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
ALTER TABLE [dbo].[PIMS_FILE_PROPERTY]
	DROP CONSTRAINT [PIM_FILE_PIM_FILPRP_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_FILE_PERSON]
	DROP CONSTRAINT [PIM_FILE_PIM_FILPER_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_FILE_PERSON]
	DROP CONSTRAINT [PIM_FPRPRF_PIM_FILPER_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
ALTER TABLE [dbo].[PIMS_ACTIVITY_INSTANCE]
	DROP CONSTRAINT [PIM_FILE_PIM_ACTINS_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_ACTIVITY_INSTANCE]
	DROP CONSTRAINT [PIM_ACTIST_PIM_ACTINS_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
ALTER TABLE [dbo].[PIMS_RESEARCH_FILE]
	DROP CONSTRAINT [PIM_FILE_PIM_RESRCH_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
ALTER TABLE [dbo].[PIMS_ACQUISITION_FILE]
	DROP CONSTRAINT [PIM_FILE_PIM_ACQNFL_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
ALTER TABLE [dbo].[PIMS_FILE]
	DROP CONSTRAINT [PIM_FILTYP_PIM_FILE_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP INDEX [dbo].[PIMS_RESEARCH_FILE_PURPOSE].[RSFLPR_RESEARCH_PURPOSE_TUC]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP INDEX [dbo].[PIMS_ACTIVITY_INSTANCE_DOCUMENT].[ACTDOC_ACTV_INSTNC_DOC_TUC]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP INDEX [dbo].[PIMS_ACTIVITY_INSTANCE_NOTE].[ACTINN_ACTV_INSTNC_NOTE_TUC]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP INDEX [dbo].[PIMS_PRF_PROP_RESEARCH_PURPOSE_TYPE].[PRSPRP_RSRCH_FILE_PURPOSE_TUC]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP INDEX [dbo].[PIMS_RESEARCH_FILE].[RESRCH_FILE_ID_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP INDEX [dbo].[PIMS_ACQUISITION_FILE].[ACQNFL_FILE_ID_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP INDEX [dbo].[PIMS_ACTIVITY_INSTANCE].[ACTINS_FILE_ID_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP INDEX [dbo].[PIMS_ACTIVITY_INSTANCE].[ACTINS_ACTIVITY_INSTANCE_STATUS_TYPE_CODE_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP INDEX [dbo].[PIMS_FILE_PROPERTY_RESEARCH].[PRSCRC_RSRCH_FILE_PROP_TUC]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP INDEX [dbo].[PIMS_FILE_PROPERTY_RESEARCH].[PRSCRC_FILE_PROPERTY_ID_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP INDEX [dbo].[PIMS_ACTIVITY_INSTANCE_PROPERTY].[ACTINP_FILE_PROPERTY_ID_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP INDEX [dbo].[PIMS_ACTIVITY_INSTANCE_PROPERTY].[ACTINP_ACTVTY_INSTNC_PROP_TUC]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP INDEX [dbo].[PIMS_ACTIVITY_INSTANCE_PROPERTY].[ACTINP_ACTIVITY_INSTANCE_ID_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP INDEX [dbo].[PIMS_FILE_PROPERTY].[FILPRP_PROPERTY_ID_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP INDEX [dbo].[PIMS_FILE_PROPERTY].[FILPRP_FILE_PROPERTY_TUC]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP INDEX [dbo].[PIMS_FILE_PROPERTY].[FILPRP_FILE_ID_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP INDEX [dbo].[PIMS_FILE_PERSON].[FILPER_PERSON_ID_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP INDEX [dbo].[PIMS_FILE_PERSON].[FILPER_FILE_PERSON_PROFILE_TYPE_CODE_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP INDEX [dbo].[PIMS_FILE_PERSON].[FILPER_FILE_ID_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP INDEX [dbo].[PIMS_FILE].[FILE_FILE_TYPE_CODE_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
ALTER TABLE [dbo].[PIMS_ACTIVITY_INSTANCE_PROPERTY_HIST]
	DROP CONSTRAINT [PIMS_ACTINP_H_UK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_ACTIVITY_INSTANCE_PROPERTY_HIST]
	DROP CONSTRAINT [PIMS_ACTINP_H_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
ALTER TABLE [dbo].[PIMS_FILE_PROPERTY_HIST]
	DROP CONSTRAINT [PIMS_FILPRP_H_UK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_FILE_PROPERTY_HIST]
	DROP CONSTRAINT [PIMS_FILPRP_H_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
ALTER TABLE [dbo].[PIMS_FILE_PERSON_HIST]
	DROP CONSTRAINT [PIMS_FILPER_H_UK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_FILE_PERSON_HIST]
	DROP CONSTRAINT [PIMS_FILPER_H_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
ALTER TABLE [dbo].[PIMS_FILE_HIST]
	DROP CONSTRAINT [PIMS_FILE_H_UK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_FILE_HIST]
	DROP CONSTRAINT [PIMS_FILE_H_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_ACQUISITION_FILE]
	DROP CONSTRAINT [ACQNFL_FILE_ID_DEF]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_ACQUISITION_FILE]
...
GO
ALTER TABLE [dbo].[PIMS_RESEARCH_FILE]
	DROP CONSTRAINT [RESRCH_FILE_ID_DEF]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_RESEARCH_FILE]
...
GO
ALTER TABLE [dbo].[PIMS_ACTIVITY_INSTANCE]
	DROP CONSTRAINT [ACTINS_FILE_ID_DEF]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_ACTIVITY_INSTANCE]
	DROP CONSTRAINT [ACTINS_ACTIVITY_INSTANCE_STATUS_TYPE_CODE_DEF]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_ACTIVITY_INSTANCE]
	DROP COLUMN [FILE_ID], [ACTIVITY_INSTANCE_STATUS_TYPE_CODE], [DESCRIPTION]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
