...
namespace Pims.Api.Repositories.PropertyLookup
{
    public class PropertyPmbcRepository : IPropertyPmbcRepository
    {
        ...
        private readonly string _pmbcUrl;
            ...
            ILogger<PropertyPmbcRepository> logger)
        {
            ...
            _logger = logger;
            _pmbcUrl = configuration.GetValue<string>("PmbcLookup:Url");
        }
        ...
        {
            var url = QueryHelpers.AddQueryString(_pmbcUrl, "cql_filter", cqlFilter);
