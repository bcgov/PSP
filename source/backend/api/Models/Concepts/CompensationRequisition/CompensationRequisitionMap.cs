    ...
    public class CompensationRequisitionMap : IRegister
    {
        public void Register(TypeAdapterConfig config)
        {
            config.NewConfig<Entity.PimsCompensationRequisition, CompensationRequisitionModel>()
                ...
                .Map(dest => dest.ExpropiationNoticeServedDate, src => src.ExpropNoticeServedDt)
                .Map(dest => dest.ExpropiationVestingDate, src => src.ExpropVestingDt)
            ...
            config.NewConfig<CompensationRequisitionModel, Entity.PimsCompensationRequisition>()
                ...
                .Map(dest => dest.ExpropNoticeServedDt, src => src.ExpropiationNoticeServedDate)
                .Map(dest => dest.ExpropVestingDt, src => src.ExpropiationVestingDate)
