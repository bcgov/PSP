    ...
    public class DispositionFileMap : IRegister
    {
        public void Register(TypeAdapterConfig config)
        {
            ...
            config.NewConfig<DispositionFileModel, Entity.PimsDispositionFile>()
                ...
                .Map(dest => dest.RegionCodeNavigation, src => src.RegionCode)
                .Map(dest => dest.DspInitiatingBranchTypeCodeNavigation, src => src.InitiatingBranchTypeCode)
                .Map(dest => dest.DispositionInitiatingDocTypeCodeNavigation, src => src.InitiatingDocumentTypeCode)
