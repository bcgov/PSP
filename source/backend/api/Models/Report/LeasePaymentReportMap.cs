    ...
    public class LeasePaymentReportMap : IRegister
    {
        public void Register(TypeAdapterConfig config)
        {
            config.NewConfig<Entity.PimsLeasePayment, LeasePaymentReportModel>()
                ...
                .Map(dest => dest.Purpose, src => src.LeasePeriod.Lease.LeasePurposeTypeCode.ToUpper() == "OTHER" && !string.IsNullOrEmpty(src.LeasePeriod.Lease.OtherLeasePurposeType) ? $"{src.LeasePeriod.Lease.LeasePurposeTypeCodeNavigation.Description} - {src.LeasePeriod.Lease.OtherLeasePurposeType}" : src.LeasePeriod.Lease.LeasePurposeTypeCodeNavigation.Description)
