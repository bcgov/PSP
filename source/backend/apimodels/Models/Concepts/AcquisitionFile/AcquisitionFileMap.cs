    ...
    public class AcquisitionFileMap : IRegister
    {
        public void Register(TypeAdapterConfig config)
        {
            config.NewConfig<PimsAcquisitionFile, AcquisitionFileModel>()
                ...
                .Map(dest => dest.AcquisitionFileAppraisalStatusTypeCode, src => src.FileAppraisalTypeCodeNavigation)
                .Map(dest => dest.AcquisitionFileLegalSurveyStatusTypeCode, src => src.FileLglSrvyTypeCodeNavigation)
