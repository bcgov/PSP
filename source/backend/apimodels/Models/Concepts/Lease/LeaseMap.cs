    ...
    public class LeaseMap : IRegister
    {
        public void Register(TypeAdapterConfig config)
        {
            config.NewConfig<PimsLease, LeaseModel>()
                ...
                .Map(dest => dest.FileAppraisalStatusTypeCode, src => src.FileAppraisalTypeCodeNavigation)
                .Map(dest => dest.FileLegalSurveyStatusTypeCode, src => src.FileLglSrvyTypeCodeNavigation)
            ...
            config.NewConfig<LeaseModel, PimsLease>()
                ...
                .Map(dest => dest.FileAppraisalTypeCode, src => src.FileAppraisalStatusTypeCode.GetTypeId())
                .Map(dest => dest.FileLglSrvyTypeCode, src => src.FileLegalSurveyStatusTypeCode.GetTypeId())
            ...
            config.NewConfig<PimsLeaseHist, PimsLease>()
                ...
                .Map(dest => dest.FileAppraisalTypeCode, src => src.FileAppraisalTypeCode)
                .Map(dest => dest.FileLglSrvyTypeCode, src => src.FileLglSrvyTypeCode)
