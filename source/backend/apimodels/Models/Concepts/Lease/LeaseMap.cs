    ...
    public class LeaseMap : IRegister
    {
        public void Register(TypeAdapterConfig config)
        {
            config.NewConfig<PimsLease, LeaseModel>()
                ...
                //.Map(dest => dest.OtherCategoryType, src => src.LeaseCategoryOtherDesc) TODO: Fix mappings
            ...
            config.NewConfig<LeaseModel, PimsLease>()
                ...
                //.Map(dest => dest.LeaseCategoryOtherDesc, src => src.OtherCategoryType) TODO: fix mappings
