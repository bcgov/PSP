    ...
    public class LeaseTermMap : IRegister
    {
        public void Register(TypeAdapterConfig config)
        {
            config.NewConfig<Entity.PimsLeaseTerm, LeaseTermModel>()
                ...
                .Map(dest => dest.RenewalDate, src => src.TermRenewalDate.ToNullableDateOnly())
                .Map(dest => dest.ExpiryDate, src => src.TermExpiryDate.ToNullableDateOnly())
                .Map(dest => dest.StartDate, src => DateOnly.FromDateTime(src.TermStartDate))
            ...
            config.NewConfig<LeaseTermModel, Entity.PimsLeaseTerm>()
                ...
                .Map(dest => dest.LeaseId, src => src.LeaseId)
                .Map(dest => dest.TermRenewalDate, src => src.RenewalDate.ToNullableDateTime())
                .Map(dest => dest.TermExpiryDate, src => src.ExpiryDate.ToNullableDateTime())
                .Map(dest => dest.TermStartDate, src => src.StartDate.ToNullableDateTime())
