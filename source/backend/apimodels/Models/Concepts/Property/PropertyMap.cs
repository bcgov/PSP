...
namespace Pims.Api.Models.Concepts.Property
{
    public class PropertyMap : IRegister
    {
        ...
        {
            config
                .NewConfig<Entity.PimsProperty, PropertyModel>()
                ...
                .Map(
                    dest => dest.DataSourceEffectiveDateOnly,
                    src => src.PropertyDataSourceEffectiveDate
                )
            ...
            config
                .NewConfig<PropertyModel, Entity.PimsProperty>()
            ...
            config
                .NewConfig<Entity.PimsPropertyHist, Entity.PimsProperty>()
