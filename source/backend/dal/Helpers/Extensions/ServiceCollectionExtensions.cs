...
namespace Pims.Dal
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddPimsDalRepositories(this IServiceCollection repositories)
        {
            ...
            repositories.AddScoped<Repositories.IDocumentRelationshipRepository<PimsMgmtActivityDocument>, Repositories.ManagementActivityDocumentRepository>();
            ...
            repositories.AddScoped<Repositories.INotificationRepository, Repositories.NotificationRepository>();
            repositories.AddScoped<Repositories.INotificationInboxRepository, Repositories.NotificationInboxRepository>();
