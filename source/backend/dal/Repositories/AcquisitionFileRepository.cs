...
namespace Pims.Dal.Repositories
{
    ...
    public class AcquisitionFileRepository : BaseRepository<PimsAcquisitionFile>, IAcquisitionFileRepository
    {
        ...
        /// <returns></returns>
        public Paged<PimsAcquisitionFile> GetPageDeep(AcquisitionFilter filter, long? contractorPersonId = null)
        {
            ...
            IQueryable<PimsAcquisitionFile> query = GetCommonAcquisitionFileQueryDeep(filter, contractorPersonId);
        ...
        /// <returns></returns>
        public List<PimsAcquisitionFile> GetAcquisitionFileExportDeep(AcquisitionFilter filter, long? contractorPersonId = null)
        {
            // RECOMMENDED - use a log scope to group all potential SQL statements generated by EF for this method call
            using var scope = Logger.QueryScope();
        ...
        public List<PimsAcquisitionFile> GetAcquisitionSubFiles(long acquisitionFileId, long? contractorPersonId = null)
        {
        ...
        /// <param name="contractorPersonId"></param>
        /// <returns></returns>
        private IQueryable<PimsAcquisitionFile> GetCommonAcquisitionFileQueryDeep(AcquisitionFilter filter, long? contractorPersonId = null)
        {
            var predicate = PredicateBuilder.New<PimsAcquisitionFile>(acq => true);
