...
namespace Pims.Dal.Repositories
{
    ...
    public class AcquisitionFileRepository : BaseRepository<PimsAcquisitionFile>, IAcquisitionFileRepository
    {
        ...
        /// <returns></returns>
        public Paged<PimsAcquisitionFile> GetPageDeep(AcquisitionFilter filter, UserContextModel userContext = null)
        {
        ...
        /// <param name="userContext">The calling user context.</param>
        /// <returns></returns>
        public List<PimsAcquisitionFile> GetAcquisitionFileExportDeep(AcquisitionFilter filter, UserContextModel userContext = null)
        {
            // RECOMMENDED - use a log scope to group all potential SQL statements generated by EF for this method call
            using var scope = Logger.QueryScope();
        ...
        /// <param name="userContext">The calling user context.</param>
        /// <returns></returns>
        public List<PimsAcquisitionFileTeam> GetTeamMembers(UserContextModel userContext = null)
        {
        ...
        public List<PimsAcquisitionFile> GetAcquisitionSubFiles(long acquisitionFileId, UserContextModel userContext = null)
        {
        ...
        /// <returns></returns>
        private IQueryable<PimsAcquisitionFile> GetCommonAcquisitionFileQueryDeep(AcquisitionFilter filter, UserContextModel userContext = null)
        {
            var predicate = PredicateBuilder.New<PimsAcquisitionFile>(acq => true);
