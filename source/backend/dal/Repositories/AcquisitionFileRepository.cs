...
namespace Pims.Dal.Repositories
{
    ...
    public class AcquisitionFileRepository : BaseRepository<PimsAcquisitionFile>, IAcquisitionFileRepository
    {
        ...
        /// <returns></returns>
        public Paged<PimsAcquisitionFile> GetPageDeep(AcquisitionFilter filter, UserContextModel userContext)
        {
            ...
            IQueryable<PimsAcquisitionFile> query = GetCommonAcquisitionFileQueryDeep(filter, userContext);
        ...
        /// <param name="userContext">The calling user context.</param>
        /// <returns></returns>
        public List<PimsAcquisitionFile> GetAcquisitionFileExportDeep(AcquisitionFilter filter, UserContextModel userContext)
        {
            // RECOMMENDED - use a log scope to group all potential SQL statements generated by EF for this method call
            using var scope = Logger.QueryScope();
            ...
            return GetCommonAcquisitionFileQueryDeep(filter, userContext).ToList();
        }
        ...
        public PimsAcquisitionFile GetById(long id)
        {
            ...
            return Context.PimsAcquisitionFiles.AsNoTracking()
                ...
                .Include(s => s.FileAppraisalTypeCodeNavigation)
                .Include(s => s.FileLglSrvyTypeCodeNavigation)
        ...
        public LastUpdatedByModel GetLastUpdateBy(long id)
        {
            ...
            var ownersHistLastUpdatedBy = deletedOwners
                ...
                {
                    ParentId = id,
                    AppLastUpdateUserid = aoh.AppLastUpdateUserid,
                    AppLastUpdateUserGuid = aoh.AppLastUpdateUserGuid,
            ...
            var interestHolderHistLastUpdatedBy = deletedInterestHolders
              ...
              {
                  ParentId = id,
                  AppLastUpdateUserid = aihh.AppLastUpdateUserid,
                  AppLastUpdateUserGuid = aihh.AppLastUpdateUserGuid,
            ...
            var documentsHistoryLastUpdatedBy = deletedDocuments
                ...
                {
                    ParentId = id,
                    AppLastUpdateUserid = adh.AppLastUpdateUserid,
                    AppLastUpdateUserGuid = adh.AppLastUpdateUserGuid,
            ...
            {
                ParentId = id,
                AppLastUpdateUserid = acrh.AppLastUpdateUserid,
                AppLastUpdateUserGuid = acrh.AppLastUpdateUserGuid,
            ...
            {
                ParentId = id,
                AppLastUpdateUserid = aeph.AppLastUpdateUserid,
                AppLastUpdateUserGuid = aeph.AppLastUpdateUserGuid,
            ...
            {
                ParentId = id,
                AppLastUpdateUserid = aah.AppLastUpdateUserid,
                AppLastUpdateUserGuid = aah.AppLastUpdateUserGuid,
        ...
        /// <summary>
        /// Retrieves a list of acquisition file team members that the current user has access to.
        /// </summary>
        /// <param name="userContext">The calling user context.</param>
        /// <returns></returns>
        public List<PimsAcquisitionFileTeam> GetTeamMembers(UserContextModel userContext)
        {
        ...
        public PimsAcquisitionFile Update(PimsAcquisitionFile acquisitionFile)
        {
            ...
            {
                var subFiles = GetAcquisitionSubFiles(existingAcqFile.Internal_Id, userContext: null);
        ...
        public List<PimsAcquisitionFile> GetAcquisitionSubFiles(long acquisitionFileId, UserContextModel userContext)
        {
            ...
            {
                predicate = predicate.And(acq => acq.PimsAcquisitionFileTeams.Any(x => x.PersonId == userContext.PersonId));
            }
        ...
        private short GetNextSubFileSuffixValue(long parentAcquisitionFileId)
        {
            ...
            var existingSubFiles = GetAcquisitionSubFiles(parentAcquisitionFileId, userContext: null);
        ...
        /// <returns></returns>
        private IQueryable<PimsAcquisitionFile> GetCommonAcquisitionFileQueryDeep(AcquisitionFilter filter, UserContextModel userContext)
        {
            var predicate = PredicateBuilder.New<PimsAcquisitionFile>(acq => true);
