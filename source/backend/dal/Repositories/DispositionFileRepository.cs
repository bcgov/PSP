...
namespace Pims.Dal.Repositories
{
    ...
    public class DispositionFileRepository : BaseRepository<PimsDispositionFile>, IDispositionFileRepository
    {
        ...
        /// <returns></returns>
        public Paged<PimsDispositionFile> GetPageDeep(DispositionFilter filter, UserContextModel userContext = null)
        {
            using var scope = Logger.QueryScope();
        ...
        public List<PimsDispositionFileTeam> GetTeamMembers(UserContextModel userContext = null)
        {
        ...
        /// <param name="userContext">The calling user context.</param>
        /// <returns></returns>
        public List<PimsDispositionFile> GetDispositionFileExportDeep(DispositionFilter filter, UserContextModel userContext = null)
        {
        ...
        /// <param name="userContext">The calling user context.</param>
        /// <returns></returns>
        private IQueryable<PimsDispositionFile> GetCommonDispositionFileQueryDeep(DispositionFilter filter, UserContextModel userContext = null)
        {
            ...
            if (!string.IsNullOrWhiteSpace(filter.Pin))
            {
                ...
                predicate = predicate.And(disp => disp.PimsDispositionFileProperties.Any(pd => pd != null && EF.Functions.Like(pd.Property.Pin.ToString(), $"%{pinValue}%")));
            }
