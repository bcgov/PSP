...
namespace Pims.Dal.Test.Repositories
{
    ...
    public class YearlyFinancialCodeRepositoryTest
    {
        ...
        private YearlyFinancialCodeRepository CreateWithPermissions(params Permissions[] permissions)
        {
            ...
            return this._helper.CreateRepository<YearlyFinancialCodeRepository>(user);
        }
        ...
        {
            // Arrange
            var codeToAdd = new PimsYearlyFinancialCode()
            {
                Code = "FOO",
                Description = "Bar",
            ...
            result.Should().BeAssignableTo<PimsYearlyFinancialCode>();
