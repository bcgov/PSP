...
namespace Pims.Dal.Test.Repositories
{
    ...
    public class WorkActivityCodeRepositoryTest
    {
        ...
        private WorkActivityCodeRepository CreateWithPermissions(params Permissions[] permissions)
        {
            var user = PrincipalHelper.CreateForPermission(permissions);
            this._helper.CreatePimsContext(user, true);
            return this._helper.CreateRepository<WorkActivityCodeRepository>(user);
        }
        ...
        {
            // Arrange
            var codeToAdd = new PimsWorkActivityCode()
            {
                Code = "FOO",
                Description = "Bar",
            ...
            result.Should().BeAssignableTo<PimsWorkActivityCode>();
