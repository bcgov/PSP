...
namespace Pims.Dal.Test.Repositories
{
    ...
    public class LeaseRepositoryTest
    {
        ...
        public void Update_Lease_Properties_Update()
        {
            ...
            // Assert
            leaseRepository.Verify(x => x.Update(lease, false), Times.Once);
            leaseRepository.Verify(x => x.UpdatePropertyLeases(lease.Internal_Id, lease.ConcurrencyControlNumber, lease.PimsPropertyLeases, false), Times.Once);
        }
        ...
        public void Update_Lease_Improvements_Update()
        {
            ...
            var lease = EntityHelper.CreateLease(1);
            lease.PimsPropertyImprovements.Add(new Dal.Entities.PimsPropertyImprovement() { LeaseId = lease.LeaseId, Internal_Id = 1 });
            var context = helper.CreatePimsContext(user, true);
        ...
        public void Update_Lease_Improvements_AddRemove()
        {
            ...
            var addPropertyImprovement = new Dal.Entities.PimsPropertyImprovement() { LeaseId = lease.Internal_Id };
