...
namespace Pims.Dal.Test.Repositories
{
    ...
    public class BusinessFunctionCodeRepositoryTest
    {
        ...
        private BusinessFunctionCodeRepository CreateWithPermissions(params Permissions[] permissions)
        {
            var user = PrincipalHelper.CreateForPermission(permissions);
            this._helper.CreatePimsContext(user, true);
            return this._helper.CreateRepository<BusinessFunctionCodeRepository>(user);
        }
        ...
        {
            // Arrange
            var codeToAdd = new PimsBusinessFunctionCode()
            {
                Code = "FOO",
                Description = "Bar",
            ...
            result.Should().BeAssignableTo<PimsBusinessFunctionCode>();
