    ...
    public class ContactRepositoryTest
    {
        ...
        public static IEnumerable<object[]> ContactFilterData =>
            new List<object[]>
            {
                ...
                new object[] { new ContactFilter() { ActiveContactsOnly = true, SearchBy = ["pimsusers", "persons", "organizations"] }, "P1", 2 },
                new object[] { new ContactFilter() { ActiveContactsOnly = false, SearchBy = ["pimsusers", "persons", "organizations"] }, "P2", 3 },
                ...
                new object[] { new ContactFilter() { SearchBy = ["pimsusers", "persons", "organizations"] }, "P1", 2 },
                new object[] { new ContactFilter() { ActiveContactsOnly = false, SearchBy = ["pimsusers", "persons", "organizations"], Sort = new string[] { "FirstName asc" } }, "O1", 3 },
                new object[] { new ContactFilter() { ActiveContactsOnly = false, SearchBy = ["pimsusers", "persons", "organizations"], Sort = new string[] { "FirstName desc" } }, "P1", 3 },
                new object[] { new ContactFilter() { ActiveContactsOnly = false, SearchBy = ["pimsusers", "persons", "organizations"], Sort = new string[] { "Surname asc" } }, "P1", 3 },
                new object[] { new ContactFilter() { ActiveContactsOnly = false, SearchBy = ["pimsusers", "persons", "organizations"], Sort = new string[] { "Surname desc" } }, "P2", 3 },
                new object[] { new ContactFilter() { ActiveContactsOnly = false, SearchBy = ["pimsusers", "persons", "organizations"], Sort = new string[] { "OrganizationName asc" } }, "P1", 3 },
                new object[] { new ContactFilter() { ActiveContactsOnly = false, SearchBy = ["pimsusers", "persons", "organizations"], Sort = new string[] { "OrganizationName desc" } }, "O1", 3 },
                new object[] { new ContactFilter() { ActiveContactsOnly = false, SearchBy = ["pimsusers", "persons", "organizations"], Sort = new string[] { "MunicipalityName asc" } }, "P2", 3 },
                new object[] { new ContactFilter() { ActiveContactsOnly = false, SearchBy = ["pimsusers", "persons", "organizations"], Sort = new string[] { "MunicipalityName desc" } }, "O1", 3 },
                new object[] { new ContactFilter() { ActiveContactsOnly = false, SearchBy = ["pimsusers", "persons", "organizations"], Sort = new string[] { "Summary asc" } }, "P2", 3 },
                new object[] { new ContactFilter() { ActiveContactsOnly = false, SearchBy = ["pimsusers", "persons", "organizations"], Sort = new string[] { "Summary desc" } }, "O1", 3 },
            };
        #endregion
