...
namespace Pims.Api.Test.Services
{
    ...
    public class LeaseReportsServiceTest : IDisposable
    {
        ...
        public void GetAggregatedLeases_NotAuthorized()
        {
            ...
            this.leaseRepository.Setup(x => x.GetAllByFilter(It.IsAny<LeaseFilter>(), It.IsAny<UserContextModel>(), true)).Returns(new List<PimsLease>() { lease });
        ...
        public void GetAggregatedLeases_Success()
        {
            ...
            this.leaseRepository.Verify(x => x.GetAllByFilter(It.IsAny<LeaseFilter>(), It.IsAny<UserContextModel>(), true));
