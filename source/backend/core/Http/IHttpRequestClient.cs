...
namespace Pims.Core.Http
{
    public interface IHttpRequestClient : IDisposable
    {
        ...
        Task<HttpResponseMessage> PutJsonAsync<T>(string url, T data = null)
            where T : class;

        Task<HttpResponseMessage> DeleteJsonAsync<T>(string url, T data = null)
            where T : class;
        ...
        Task<HttpResponseMessage> SendJsonAsync<T>(Uri url, HttpMethod method = null, T data = null)
            where T : class;

        Task<HttpResponseMessage> SendJsonAsync<T>(Uri url, HttpMethod method, HttpRequestHeaders headers, T data = null)
            where T : class;

        Task<HttpResponseMessage> PostJsonAsync<T>(Uri url, T data = null)
            where T : class;

        Task<HttpResponseMessage> PutJsonAsync<T>(Uri url, T data = null)
            where T : class;

        Task<HttpResponseMessage> DeleteJsonAsync<T>(Uri url, T data = null)
            where T : class;
        ...
        Task<TModel> PostJsonAsync<TModel, T>(string url, T data = null)
            where T : class;

        Task<TModel> PutJsonAsync<TModel, T>(string url, T data = null)
            where T : class;

        Task<TModel> DeleteJsonAsync<TModel, T>(string url, T data = null)
            where T : class;
        ...
        Task<TModel> SendJsonAsync<TModel, T>(Uri url, HttpMethod method = null, T data = null, Func<HttpResponseMessage, bool> onError = null)
            where T : class;
        ...
        Task<TModel> PostJsonAsync<TModel, T>(Uri url, T data = null)
            where T : class;

        Task<TModel> PutJsonAsync<TModel, T>(Uri url, T data = null)
            where T : class;

        Task<TModel> DeleteJsonAsync<TModel, T>(Uri url, T data = null)
            where T : class;
