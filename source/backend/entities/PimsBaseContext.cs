...
namespace Pims.Dal
{
    public partial class PimsBaseContext : DbContext
    {
        ...
        public virtual DbSet<PimsDspChklstItemStatusType> PimsDspChklstItemStatusTypes { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PimsAcquisitionFile>(entity =>
            {
                ...
                entity.Property(e => e.TotalAllowableCompensation).HasComment("The maximum allowable coensation for the acquisition file.  This amount should be exceeded by the total of all assiciated H120's.");
            ...
            modelBuilder.Entity<PimsAcquisitionOwner>(entity =>
            {
                ...
                entity.Property(e => e.IsPrimaryOwner)
                    .HasDefaultValueSql("(CONVERT([bit],(0)))")
                    .HasComment("Indicates that this is the file's primary owner.");
            ...
            {
                entity.HasKey(e => e.AgreementHistId)
            ...
            {
                entity.HasKey(e => e.CompReqFinancialId)
                    .HasName("CRQFIN_PK");

                entity.HasComment("Table associating compensation requisitions related to work activities.");
                ...
                entity.HasOne(d => d.CompensationRequisition)
                    .WithMany(p => p.PimsCompReqFinancials)
            ...
            {
                entity.HasKey(e => e.CompReqFinancialHistId)
                    .HasName("PIMS_CRQFIN_H_PK");
            ...
            {
                entity.HasKey(e => e.CompensationRequisitionId)
                    .HasName("CMPREQ_PK");

                entity.HasComment("Table containing the compensation requisition data for the acquisition file.");
                ...
                entity.HasOne(d => d.InterestHolder)
                    ...
                    .HasConstraintName("PIM_INTHLD_PIM_CMPREQ_FK");
            ...
            {
                entity.HasKey(e => e.CompensationRequisitionHistId)
                    .HasName("PIMS_CMPREQ_H_PK");
            ...
            {
                entity.HasKey(e => e.DispositionChecklistItemId)
                    .HasName("DSPCKI_PK");
                ...
                entity.HasOne(d => d.DispositionFile)
                    .WithMany(p => p.PimsDispositionChecklistItems)
                    .HasForeignKey(d => d.DispositionFileId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("PIM_DISPFL_PIM_DSPCKI_FK");

                entity.HasOne(d => d.DspChklstItemStatusTypeCodeNavigation)
                    .WithMany(p => p.PimsDispositionChecklistItems)
                    .HasForeignKey(d => d.DspChklstItemStatusTypeCode)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("PIM_DSPCST_PIM_DSPCKI_FK");

                entity.HasOne(d => d.DspChklstItemTypeCodeNavigation)
                    .WithMany(p => p.PimsDispositionChecklistItems)
                    .HasForeignKey(d => d.DspChklstItemTypeCode)
                    .HasConstraintName("PIM_DSPCIT_PIM_DSPCKI_FK");
            });

            modelBuilder.Entity<PimsDispositionChecklistItemHist>(entity =>
            {
                entity.HasKey(e => e.DispositionChecklistItemHistId)
                    .HasName("PIMS_DSPCKI_H_PK");
            ...
            modelBuilder.Entity<PimsDispositionFile>(entity =>
            {
                ...
                entity.Property(e => e.AppaisedValue).HasComment("Appraised value of the disposition file.");
            ...
            {
                entity.HasKey(e => e.DispositionFileDocumentId)
                    .HasName("DSPDOC_PK");
                ...
                entity.HasOne(d => d.DispositionFile)
                    .WithMany(p => p.PimsDispositionFileDocuments)
                    .HasForeignKey(d => d.DispositionFileId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            {
                entity.HasKey(e => e.DispositionFileDocumentHistId)
                    .HasName("PIMS_DSPDOC_H_PK");
            ...
            {
                entity.HasKey(e => e.DispositionFileNoteId)
                    .HasName("DSPNOT_PK");
                ...
                entity.HasOne(d => d.DispositionFile)
                    .WithMany(p => p.PimsDispositionFileNotes)
                    .HasForeignKey(d => d.DispositionFileId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            {
                entity.HasKey(e => e.DispositionFileNoteHistId)
                    .HasName("PIMS_DSPNOT_H_PK");
            ...
            {
                entity.HasKey(e => e.DispositionFilePropertyId)
                    .HasName("DSPPRP_PK");
                ...
                entity.HasOne(d => d.DispositionFile)
                    .WithMany(p => p.PimsDispositionFileProperties)
                    .HasForeignKey(d => d.DispositionFileId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            {
                entity.HasKey(e => e.DispositionFilePropertyHistId)
                    .HasName("PIMS_DSPPRP_H_PK");
            ...
            modelBuilder.Entity<PimsDispositionFileTeam>(entity =>
            {
                ...
                entity.HasOne(d => d.PrimaryContact)
                    ...
                    .HasForeignKey(d => d.PrimaryContactId)
                    .HasConstraintName("PIM_PERSON_PIM_DSPFTM_CONTACT_FK");
            });
            ...
            {
                entity.HasKey(e => e.DispositionOfferId)
                    .HasName("DSPOFR_PK");

                entity.HasComment("Entity containing information regarding an disposition offer.");
                ...
                entity.HasOne(d => d.DispositionFile)
                    .WithMany(p => p.PimsDispositionOffers)
                    .HasForeignKey(d => d.DispositionFileId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("PIM_DISPFL_PIM_DSPOFR_FK");

                entity.HasOne(d => d.DispositionOfferStatusTypeCodeNavigation)
                    .WithMany(p => p.PimsDispositionOffers)
                    .HasForeignKey(d => d.DispositionOfferStatusTypeCode)
                    .HasConstraintName("PIM_DSPOFT_PIM_DSPOFR_FK");
            });

            modelBuilder.Entity<PimsDispositionOfferHist>(entity =>
            {
                entity.HasKey(e => e.DispositionOfferHistId)
                    .HasName("PIMS_DSPOFR_H_PK");
            ...
            {
                entity.HasKey(e => e.DispositionOfferStatusTypeCode)
                    .HasName("DSPOFT_PK");

                entity.HasComment("Codified values for the dispostion offer status.");
            ...
            {
                entity.HasKey(e => e.DispositionPurchaserId)
                    .HasName("DSPPUR_PK");

                entity.HasComment("Describes the purchaser of the disposition.  There may be multiple purchasers and the purchasers include organizations and individuals.  If an organization is a purchaser, a primary contact person must be provided.");
                ...
                entity.HasOne(d => d.DispositionSale)
                    .WithMany(p => p.PimsDispositionPurchasers)
                    .HasForeignKey(d => d.DispositionSaleId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                ...
                entity.HasOne(d => d.Organization)
                    .WithMany(p => p.PimsDispositionPurchasers)
                    .HasForeignKey(d => d.OrganizationId)
                    .HasConstraintName("PIM_ORG_PIM_DSPPUR_FK");

                entity.HasOne(d => d.Person)
                    .WithMany(p => p.PimsDispositionPurchaserPeople)
                    .HasForeignKey(d => d.PersonId)
                    .HasConstraintName("PIM_PERSON_PIM_DSPPUR_FK");

                entity.HasOne(d => d.PrimaryContact)
                    .WithMany(p => p.PimsDispositionPurchaserPrimaryContacts)
                    .HasForeignKey(d => d.PrimaryContactId)
                    .HasConstraintName("PIM_PERSON_PIM_DSPPUR_CONTACT_FK");
            });

            modelBuilder.Entity<PimsDispositionPurchaserHist>(entity =>
            {
                entity.HasKey(e => e.DispositionPurchaserHistId)
                    .HasName("PIMS_DSPPUR_H_PK");
            ...
            {
                entity.HasKey(e => e.DispositionSaleId)
                    .HasName("DSPSAL_PK");

                entity.HasComment("Entity containing information regarding an disposition sale.");
                ...
                entity.Property(e => e.FinalSaleAmt).HasComment("Value of the final sale.");

                entity.Property(e => e.GstCollectedAmt).HasComment("GST collected is calculated based upon Final Sales Price.");

                entity.Property(e => e.IsGstRequired)
                    .HasDefaultValueSql("(CONVERT([bit],(0)))")
                    .HasComment("Is GST required for this sale?");

                entity.Property(e => e.NetBookAmt).HasComment("The net book value of the disposition sale.");

                entity.Property(e => e.NetProceedsAfterSppAmt).HasComment("Net Proceeds after SPP Cost = Final Sales price, less Commissions, GST, Net Book Value, Total Cost of Sales,  and SPP Amount.");

                entity.Property(e => e.NetProceedsBeforeSppAmt).HasComment("Net Proceeds before Surplus Property Program (SPP) Cost = Final Sales price, less Commissions, GST Total Cost of Sales, and Net Book Value.");

                entity.Property(e => e.RealtorCommisissionAmt).HasComment("Amount paid to the realtor managing the sale.");
                ...
                entity.HasOne(d => d.DispositionFile)
                    .WithMany(p => p.PimsDispositionSales)
                    .HasForeignKey(d => d.DispositionFileId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            {
                entity.HasKey(e => e.DispositionSaleHistId)
                    .HasName("PIMS_DSPSAL_H_PK");
            ...
            {
                entity.HasKey(e => e.DocumentCategorySubtypeId)
                    .HasName("DCCTSB_PK");
                ...
                entity.HasOne(d => d.DocumentCategoryTypeCodeNavigation)
                    .WithMany(p => p.PimsDocumentCategorySubtypes)
                    .HasForeignKey(d => d.DocumentCategoryTypeCode)
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            {
                entity.HasKey(e => e.DocumentCategoryTypeCode)
                    .HasName("DOCCAT_PK");
            ...
            modelBuilder.Entity<PimsDspChklstItemStatusType>(entity =>
            {
                entity.HasKey(e => e.DspChklstItemStatusTypeCode)
                    .HasName("DSPCST_PK");

                entity.HasComment("Tables that contains the codes and associated descriptions of the disposition checklist item status types.");
            ...
            {
                entity.HasKey(e => e.DspChklstItemTypeCode)
                    .HasName("DSPCIT_PK");

                entity.HasComment("Table that contains the disposition checklist items that are presented to the user through dynamically building the input form.");
                ...
                entity.HasOne(d => d.DspChklstSectionTypeCodeNavigation)
                    .WithMany(p => p.PimsDspChklstItemTypes)
                    .HasForeignKey(d => d.DspChklstSectionTypeCode)
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            {
                entity.HasKey(e => e.DspChklstSectionTypeCode)
                    .HasName("DSPSCT_PK");

                entity.HasComment("Table that contains the disposition checklist sctions that are presented to the user through dynamically building the input form.");
            ...
            {
                entity.HasKey(e => e.DspPurchAgentId)
                    .HasName("DSPPAG_PK");

                entity.HasComment("Describes the agent associated with the sale of the disposition.  The agent may be an organizations or an individual.  If an organization is the agent, a primary contact person must be provided.");
                ...
                entity.HasOne(d => d.DispositionSale)
                    .WithMany(p => p.PimsDspPurchAgents)
                    .HasForeignKey(d => d.DispositionSaleId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                ...
                entity.HasOne(d => d.Organization)
                    .WithMany(p => p.PimsDspPurchAgents)
                    .HasForeignKey(d => d.OrganizationId)
                    .HasConstraintName("PIM_ORG_PIM_DSPPAG_FK");

                entity.HasOne(d => d.Person)
                    .WithMany(p => p.PimsDspPurchAgentPeople)
                    .HasForeignKey(d => d.PersonId)
                    .HasConstraintName("PIM_PERSON_PIM_DSPPAG_FK");

                entity.HasOne(d => d.PrimaryContact)
                    .WithMany(p => p.PimsDspPurchAgentPrimaryContacts)
                    .HasForeignKey(d => d.PrimaryContactId)
                    .HasConstraintName("PIM_PERSON_PIM_DSPPAG_CONTACT_FK");
            });

            modelBuilder.Entity<PimsDspPurchAgentHist>(entity =>
            {
                entity.HasKey(e => e.DspPurchAgentHistId)
                    .HasName("PIMS_DSPPAG_H_PK");
            ...
            modelBuilder.Entity<PimsDspPurchSolicitor>(entity =>
            {
                ...
                entity.HasComment("Describes the solicitor associated with the sale of the disposition.  The solicitor may be an organizations or an individual.  If an organization is the solicitor, a primary contact person must be provided.");
                ...
                entity.HasOne(d => d.DispositionSale)
                    .WithMany(p => p.PimsDspPurchSolicitors)
                    .HasForeignKey(d => d.DispositionSaleId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                ...
                entity.HasOne(d => d.Organization)
                    .WithMany(p => p.PimsDspPurchSolicitors)
                    .HasForeignKey(d => d.OrganizationId)
                    .HasConstraintName("PIM_ORG_PIM_DSPPSL_FK");

                entity.HasOne(d => d.Person)
                    .WithMany(p => p.PimsDspPurchSolicitorPeople)
                    .HasForeignKey(d => d.PersonId)
                    .HasConstraintName("PIM_PERSON_PIM_DSPPSL_FK");

                entity.HasOne(d => d.PrimaryContact)
                    .WithMany(p => p.PimsDspPurchSolicitorPrimaryContacts)
                    .HasForeignKey(d => d.PrimaryContactId)
                    .HasConstraintName("PIM_PERSON_PIM_DSPPSL_CONTACT_FK");
            });

            modelBuilder.Entity<PimsDspPurchSolicitorHist>(entity =>
            {
                entity.HasKey(e => e.DspPurchSolicitorHistId)
                    .HasName("PIMS_DSPPSL_H_PK");
            ...
            {
                entity.HasKey(e => e.ExpropPmtPmtItemId)
                    .HasName("XPMTITY_PK");

                entity.HasComment("Associative entity to connect expropriation forms (Form 8) to payment item types.  The supports the ability to associate multiple payment item types to a single expropriation form (Form 8).");
                ...
                entity.HasOne(d => d.ExpropriationPayment)
                    .WithMany(p => p.PimsExpropPmtPmtItems)
                    .HasForeignKey(d => d.ExpropriationPaymentId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("PIM_EXPPMT_PIM_XPMTITY_FK");

                entity.HasOne(d => d.PaymentItemTypeCodeNavigation)
                    .WithMany(p => p.PimsExpropPmtPmtItems)
                    .HasForeignKey(d => d.PaymentItemTypeCode)
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            {
                entity.HasKey(e => e.ExpropPmtPmtItemHistId)
                    .HasName("PIMS_XPMTIT_H_PK");
            ...
            {
                entity.HasKey(e => e.ExpropriationPaymentId)
                    .HasName("EXPPMT_PK");

                entity.HasComment("Entity continaing the details regarding a Form 8 (Notice of Advance Payment).");
                ...
                entity.HasOne(d => d.AcquisitionFile)
                    .WithMany(p => p.PimsExpropriationPayments)
                    .HasForeignKey(d => d.AcquisitionFileId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                ...
                entity.HasOne(d => d.AcquisitionOwner)
                    .WithMany(p => p.PimsExpropriationPayments)
                    .HasForeignKey(d => d.AcquisitionOwnerId)
                    .HasConstraintName("PIM_ACQOWN_PIM_FORM8_FK");

                entity.HasOne(d => d.ExpropriatingAuthorityNavigation)
                    .WithMany(p => p.PimsExpropriationPayments)
                    .HasForeignKey(d => d.ExpropriatingAuthority)
                    .HasConstraintName("PIM_ORG_PIM_FORM8_FK");

                entity.HasOne(d => d.InterestHolder)
                    .WithMany(p => p.PimsExpropriationPayments)
                    .HasForeignKey(d => d.InterestHolderId)
                    .HasConstraintName("PIM_INTHLD_PIM_FORM8_FK");
            });

            modelBuilder.Entity<PimsExpropriationPaymentHist>(entity =>
            {
                entity.HasKey(e => e.ExpropriationPaymentHistId)
                    .HasName("PIMS_EXPPMT_H_PK");
            ...
            {
                entity.HasKey(e => e.H120CategoryId)
                    .HasName("H120CT_PK");
                ...
                entity.HasOne(d => d.CostType)
                    .WithMany(p => p.PimsH120Categories)
                    .HasForeignKey(d => d.CostTypeId)
                    .HasConstraintName("PIM_COSTYP_PIM_H120CT_FK");

                entity.HasOne(d => d.FinancialActivity)
                    .WithMany(p => p.PimsH120Categories)
                    .HasForeignKey(d => d.FinancialActivityId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("PIM_FINACT_PIM_H120CT_FK");

                entity.HasOne(d => d.WorkActivity)
                    .WithMany(p => p.PimsH120Categories)
                    .HasForeignKey(d => d.WorkActivityId)
                    .HasConstraintName("PIM_WRKACT_PIM_H120CT_FK");
            });

            modelBuilder.Entity<PimsH120CategoryHist>(entity =>
            {
                entity.HasKey(e => e.H120CategoryHistId)
                    .HasName("PIMS_H120CT_H_PK");
            ...
            {
                entity.HasKey(e => e.InterestHolderId)
                    .HasName("INTHLD_PK");

                entity.HasComment("Documents the interest holders that have an stake in the acquisition.");
                ...
                entity.HasOne(d => d.AcquisitionFile)
                    .WithMany(p => p.PimsInterestHolders)
                    .HasForeignKey(d => d.AcquisitionFileId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("PIM_ACQNFL_PIM_INTHLD_FK");

                entity.HasOne(d => d.InterestHolderTypeCodeNavigation)
                    .WithMany(p => p.PimsInterestHolders)
                    .HasForeignKey(d => d.InterestHolderTypeCode)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                ...
                entity.HasOne(d => d.Organization)
                    .WithMany(p => p.PimsInterestHolders)
                    .HasForeignKey(d => d.OrganizationId)
                    .HasConstraintName("PIM_ORG_PIM_INTHLD_FK");

                entity.HasOne(d => d.Person)
                    .WithMany(p => p.PimsInterestHolderPeople)
                    .HasForeignKey(d => d.PersonId)
                    .HasConstraintName("PIM_PERSON_PIM_INTHLD_FK");

                entity.HasOne(d => d.PrimaryContact)
                    .WithMany(p => p.PimsInterestHolderPrimaryContacts)
                    .HasForeignKey(d => d.PrimaryContactId)
                    .HasConstraintName("PIM_PERSON_PIM_INTHLD_PRIMARY_FK");
            });

            modelBuilder.Entity<PimsInterestHolderHist>(entity =>
            {
                entity.HasKey(e => e.InterestHolderHistId)
                    .HasName("PIMS_INTHLD_H_PK");
            ...
            {
                entity.HasKey(e => e.InterestHolderInterestTypeCode)
                    .HasName("IHINTT_PK");

                entity.HasComment("Tables that contains the codes and associated descriptions of the interest holder interest types.");
            ...
            {
                entity.HasKey(e => e.InterestHolderTypeCode)
                    .HasName("INHLDT_PK");

                entity.HasComment("Tables that contains the codes and associated descriptions of the interest holder types, such as solicitors, representatives, and interest holders.");
            ...
            modelBuilder.Entity<PimsInthldrPropInterest>(entity =>
            {
                ...
                entity.HasOne(d => d.PropertyAcquisitionFile)
                    ...
                    .HasConstraintName("PIM_PRACQF_PIM_IHPRIN_FK");
            });

            modelBuilder.Entity<PimsInthldrPropInterestHist>(entity =>
            {
                entity.HasKey(e => e.InthldrPropInterestHistId)
                    .HasName("PIMS_IHPRIN_H_PK");
            ...
            {
                entity.HasKey(e => e.LandActTypeCode)
                    .HasName("LNDATY_PK");
            ...
            {
                entity.HasKey(e => e.PaymentItemTypeCode)
                    .HasName("PMTITM_PK");

                entity.HasComment("Table that contains the codes and associated descriptions of the payment item types, such as market value, temporary SRW, and disturbance damages.");
            ...
            modelBuilder.Entity<PimsProject>(entity =>
            {
                ...
                entity.Property(e => e.ProjectStatusTypeCode).HasDefaultValueSql("('AC')");
            ...
            {
                entity.HasKey(e => e.ProjectProductId)
                    .HasName("PRJPRD_PK");
                ...
                entity.HasOne(d => d.Product)
                    .WithMany(p => p.PimsProjectProducts)
                    .HasForeignKey(d => d.ProductId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            {
                entity.HasKey(e => e.ProjectProductHistId)
                    .HasName("PIMS_PRJPRD_H_PK");
            ...
            modelBuilder.Entity<PimsPropInthldrInterestType>(entity =>
            {
                ...
                entity.HasOne(d => d.PimsInthldrPropInterest)
                    .WithMany(p => p.PimsPropInthldrInterestTypes)
            ...
            {
                entity.HasKey(e => e.PropertyActivityDocumentId)
                    .HasName("PRACDO_PK");
                ...
                entity.HasOne(d => d.Document)
                    .WithMany(p => p.PimsPropertyActivityDocuments)
                    .HasForeignKey(d => d.DocumentId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                ...
                entity.HasOne(d => d.PimsPropertyActivity)
                    .WithMany(p => p.PimsPropertyActivityDocuments)
                    .HasForeignKey(d => d.PimsPropertyActivityId)
                    .HasConstraintName("PIM_PRPACT_PIM_PRACDO_FK");
            });

            modelBuilder.Entity<PimsPropertyActivityDocumentHist>(entity =>
            {
                entity.HasKey(e => e.PropertyActivityDocumentHistId)
                    .HasName("PIMS_PRACDO_H_PK");
            ...
            modelBuilder.Entity<PimsTake>(entity =>
            {
                ...
                entity.Property(e => e.IsAcquiredForInventory)
                    .HasDefaultValueSql("(CONVERT([bit],(0)))")
                    .HasComment("Is this being acquired for inventory? (default = TRUE)");

                entity.Property(e => e.IsNewHighwayDedication)
                    .HasDefaultValueSql("(CONVERT([bit],(0)))")
                    .HasComment("Is there a new right of way? (default = FALSE)");

                entity.Property(e => e.IsNewInterestInSrw)
                    .HasDefaultValueSql("(CONVERT([bit],(0)))")
                    .HasComment("Is there a statutory right of way? (default = FALSE)");

                entity.Property(e => e.IsNewLandAct)
                    .HasDefaultValueSql("(CONVERT([bit],(0)))")
                    .HasComment("Is there a Section 16? (default = FALSE)");

                entity.Property(e => e.IsNewLicenseToConstruct)
                    .HasDefaultValueSql("(CONVERT([bit],(0)))")
                    .HasComment("Is there a license to construct? (default = FALSE)");

                entity.Property(e => e.IsThereSurplus)
                    .HasDefaultValueSql("(CONVERT([bit],(0)))")
                ...
                entity.HasOne(d => d.LandActTypeCodeNavigation)
                    .WithMany(p => p.PimsTakes)
                    .HasForeignKey(d => d.LandActTypeCode)
                    .HasConstraintName("PIM_LNDATY_PIM_TAKE_FK");
