...
/// <summary>
/// Many-to-many entity that associates the security deposit return on a lease/license with a person or organization.
/// </summary>
[Table("PIMS_SECURITY_DEPOSIT_RETURN_HOLDER")]
[Index("OrganizationId", Name = "SCDPRH_ORGANIZATION_ID_IDX")]
[Index("PersonId", Name = "SCDPRH_PERSON_ID_IDX")]
[Index("SecurityDepositReturnId", Name = "SCDPRH_SECURITY_DEPOSIT_RETURN_ID_IDX")]
[Index("SecurityDepositReturnId", Name = "SCDPRH_SECURITY_DEPOSIT_RETURN_ID_TUC", IsUnique = true)]
public partial class PimsSecurityDepositReturnHolder
{
    ...
    /// <summary>
    /// Foreign key to the PIMS_SECURITY_DEPOSIT_RETURN table.
    /// </summary>
    ...
    [InverseProperty("PimsSecurityDepositReturnHolders")]
    ...
    [ForeignKey("SecurityDepositReturnId")]
    [InverseProperty("PimsSecurityDepositReturnHolder")]
