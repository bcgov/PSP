...
/// <summary>
/// Codified values for the dispostion initiating document type.
/// </summary>
[Table("PIMS_DISPOSITION_INITIATING_DOC_TYPE")]
public partial class PimsDispositionInitiatingDocType
{
    /// <summary>
    ...
    /// <summary>
    /// Description of the dispostion initiating document type.
    /// </summary>
    [Required]
    [Column("DESCRIPTION")]
    [StringLength(200)]
    ...
    [InverseProperty("DispositionInitiatingDocTypeCodeNavigation")]
