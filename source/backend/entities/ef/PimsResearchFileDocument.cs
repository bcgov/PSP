...
namespace Pims.Dal.Entities
{
    ...
    [Index(nameof(DocumentId), Name = "RSCDOC_DOCUMENT_ID_IDX")]
    [Index(nameof(DocumentId), nameof(ResearchFileId), Name = "RSCDOC_RESEARCH_FILE_DOCUMENT_TUC", IsUnique = true)]
    [Index(nameof(ResearchFileId), Name = "RSCDOC_RESEARCH_FILE_ID_IDX")]
