...
[Index("ResearchFileDocumentHistId", "EndDateHist", Name = "PIMS_RFLDOC_H_UK", IsUnique = true)]
public partial class PimsResearchFileDocumentHist
{
    [Key]
    [Column("_RESEARCH_FILE_DOCUMENT_HIST_ID")]
    public long ResearchFileDocumentHistId { get; set; }
