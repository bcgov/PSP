...
/// <summary>
/// Codified values for the dispostion type.
/// </summary>
[Table("PIMS_DISPOSITION_TYPE")]
public partial class PimsDispositionType
{
    /// <summary>
    ...
    /// <summary>
    /// Description of the dispostion type.
    /// </summary>
    [Required]
    [Column("DESCRIPTION")]
    [StringLength(200)]
    ...
    [InverseProperty("DispositionTypeCodeNavigation")]
