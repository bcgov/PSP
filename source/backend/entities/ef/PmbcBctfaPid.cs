...
[Table("PMBC_BCTFA_PID", Schema = "pmbc")]
public partial class PmbcBctfaPid
{
    ...
    /// <summary>
    /// Application code is responsible for retrieving the row and then incrementing the value of the CONCURRENCY_CONTROL_NUMBER column by one prior to issuing an update. If this is done then the update will succeed, provided that the row was not updated by any other application or user.
    /// </summary>
