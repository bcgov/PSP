...
[Index("PersonId", Name = "CNTMTH_PERSON_ID_IDX")]
public partial class PimsContactMethod
{
    ...
    /// <summary>
    /// Foreign key to the PIMS_CONTACT_METHOD_TYPE table.
    /// </summary>
    [Required]
    ...
    /// <summary>
    /// Foreign key to the PIMS_CONTACT_METHOD table.
    /// </summary>
    [Required]
    ...
    /// <summary>
    /// Indicates is this is the preferred method of contact.
    /// </summary>
    ...
    [ForeignKey("ContactMethodTypeCode")]
    [InverseProperty("PimsContactMethods")]
