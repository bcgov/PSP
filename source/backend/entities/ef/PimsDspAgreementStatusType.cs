...
/// </summary>
[Table("PIMS_DSP_AGREEMENT_STATUS_TYPE")]
public partial class PimsDspAgreementStatusType
{
    /// <summary>
    /// Code value of the disposition agreement status type.
    /// </summary>
    [Key]
    ...
    /// <summary>
    /// Description of the disposition agreement status type.
    /// </summary>
    [Required]
    [Column("DESCRIPTION")]
    [StringLength(200)]
    ...
    [InverseProperty("DspAgreementStatusTypeCodeNavigation")]
