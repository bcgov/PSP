...
/// <summary>
/// Codified values for the dispostion physical file status.
/// </summary>
[Table("PIMS_DSP_PHYS_FILE_STATUS_TYPE")]
public partial class PimsDspPhysFileStatusType
{
    /// <summary>
    ...
    /// <summary>
    /// Description of the dispostion physical file status.
    /// </summary>
    [Required]
    [Column("DESCRIPTION")]
    [StringLength(200)]
    ...
    [InverseProperty("DspPhysFileStatusTypeCodeNavigation")]
