...
/// <summary>
/// Codified values for the acquisition file take type.
/// </summary>
[Table("PIMS_ACQ_FILE_TAKE_TYPE")]
public partial class PimsAcqFileTakeType
{
    /// <summary>
    /// Code value of the acquisition file take type.
    /// </summary>
    [Key]
    ...
    /// <summary>
    /// Description of the acquisition file take type.
    /// </summary>
    [Required]
    [Column("DESCRIPTION")]
    [StringLength(200)]
    ...
    [InverseProperty("AcqFileTakeTypeCodeNavigation")]
