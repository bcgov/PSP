...
/// <summary>
/// Codified values for the dispostion file status.
/// </summary>
[Table("PIMS_DISPOSITION_FILE_STATUS_TYPE")]
public partial class PimsDispositionFileStatusType
{
    /// <summary>
    ...
    /// <summary>
    /// Description of the dispostion file status.
    /// </summary>
    [Required]
    [Column("DESCRIPTION")]
    [StringLength(200)]
    ...
    [InverseProperty("DispositionFileStatusTypeCodeNavigation")]
