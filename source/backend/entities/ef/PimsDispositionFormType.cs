...
/// </summary>
[Table("PIMS_DISPOSITION_FORM_TYPE")]
[Index("DocumentId", Name = "DSPFMT_DOCUMENT_ID_IDX")]
public partial class PimsDispositionFormType
{
    /// <summary>
    /// Code value of the disposition form type.
    /// </summary>
    [Key]
    ...
    [InverseProperty("PimsDispositionFormTypes")]
    public virtual PimsDocument Document { get; set; }

    [InverseProperty("DispositionFormTypeCodeNavigation")]
