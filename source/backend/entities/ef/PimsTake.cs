...
public partial class PimsTake
{
    ...
    /// <summary>
    /// Foreign key to the PIMS_PROPERTY_ACQUISITION_FILE table.
    /// </summary>
    [Column("PROPERTY_ACQUISITION_FILE_ID")]
    public long PropertyAcquisitionFileId { get; set; }

    /// <summary>
    /// Foreign key to the PIMS_TAKE_TYPE table.
    /// </summary>
    [Required]
    ...
    /// <summary>
    /// Foreign key to the PIMS_TAKE_STATUS_TYPE table.
    /// </summary>
    [Required]
    ...
    /// <summary>
    /// Foreign key to the PIMS_TAKE_SITE_CONTAM_TYPE table.
    /// </summary>
    ...
    /// <summary>
    /// Foreign key to the PIMS_AREA_UNIT_TYPE table.
    /// </summary>
    ...
    /// <summary>
    /// Foreign key to the PIMS_LAND_ACT_TYPE table.
    /// </summary>
