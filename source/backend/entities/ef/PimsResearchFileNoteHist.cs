...
[Index("ResearchFileNoteHistId", "EndDateHist", Name = "PIMS_RFLNOT_H_UK", IsUnique = true)]
public partial class PimsResearchFileNoteHist
{
    [Key]
    [Column("_RESEARCH_FILE_NOTE_HIST_ID")]
    public long ResearchFileNoteHistId { get; set; }
