...
/// <summary>
/// Codified values for the acquisition file progress type.
/// </summary>
[Table("PIMS_ACQ_FILE_PROGESS_TYPE")]
public partial class PimsAcqFileProgessType
{
    /// <summary>
    /// Code value of the acquisition file progress type.
    /// </summary>
    [Key]
    ...
    /// <summary>
    /// Description of the acquisition file progress type.
    /// </summary>
    [Required]
    [Column("DESCRIPTION")]
    [StringLength(200)]
    ...
    [InverseProperty("AcqFileProgessTypeCodeNavigation")]
