...
/// <summary>
/// Table contains the relationship between the management file and the associated notes.
/// </summary>
[Table("PIMS_MANAGEMENT_FILE_NOTE")]
[Index("ManagementFileId", Name = "MGMTNT_MANAGEMENT_FILE_ID_IDX")]
[Index("NoteId", Name = "MGMTNT_NOTE_ID_IDX")]
public partial class PimsManagementFileNote
{
    /// <summary>
    ...
    [InverseProperty("PimsManagementFileNotes")]
