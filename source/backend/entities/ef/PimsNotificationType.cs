...
/// <summary>
/// Codified description of the type of user notification  (e.g. email, PIMS application notification).
/// </summary>
[Table("PIMS_NOTIFICATION_TYPE")]
public partial class PimsNotificationType
{
    /// <summary>
    /// Code value of the notification type.
    /// </summary>
    [Key]
