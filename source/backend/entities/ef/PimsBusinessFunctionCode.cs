...
/// <summary>
/// Code and description of the business function codes.
/// </summary>
[Table("PIMS_BUSINESS_FUNCTION_CODE")]
[Index("Code", Name = "BIZFCN_CODE_IDX")]
public partial class PimsBusinessFunctionCode
{
    ...
    /// <summary>
    /// Code value of the business function  type.
    /// </summary>
    [Required]
    [Column("CODE")]
    [StringLength(20)]
    ...
    /// <summary>
    /// Description of the business function  type.
    /// </summary>
    [Required]
    [Column("DESCRIPTION")]
    [StringLength(200)]
    ...
    [InverseProperty("BusinessFunctionCode")]
