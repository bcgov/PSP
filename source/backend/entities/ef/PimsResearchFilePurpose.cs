...
[Index("ResearchPurposeTypeCode", "ResearchFileId", Name = "RSFLPR_RSRCH_FL_RSRCH_FL_PURP_TUC", IsUnique = true)]
public partial class PimsResearchFilePurpose
{
    ...
    /// <summary>
    /// Foreign key to the PIMS_RESEARCH_PURPOSE_TYPE table.
    /// </summary>
    [Required]
    ...
    [InverseProperty("PimsResearchFilePurposes")]
    public virtual PimsResearchFile ResearchFile { get; set; }

    [ForeignKey("ResearchPurposeTypeCode")]
    [InverseProperty("PimsResearchFilePurposes")]
