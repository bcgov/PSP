...
export const getMockManagementActivity = (
  id = 1,
  propertyId = 1,
...
export const getMockManagementActivityNotStarted = (
  id = 1,
  propertyId = 1,
): ApiGen_Concepts_ManagementActivity => ({
  ...emptyActivity,
...
export const getMockManagementActivityList = (): ApiGen_Concepts_ManagementActivity[] => [
  {
    ...emptyActivity,
    id: 1,
  },
