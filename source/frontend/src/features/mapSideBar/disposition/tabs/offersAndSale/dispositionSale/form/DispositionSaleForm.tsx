...
> = ({ dispositionSaleId }) => {
  ...
  return (
    <Section header="Sales Details">
      <SectionField label="Purchaser name(s)" labelWidth={{ xs: 5 }} contentWidth={{ xs: 7 }}>
        <DispositionSalePurchaserSubForm dispositionSaleId={dispositionSaleId} />
      </SectionField>

      <SectionField label="Purchaser agent" labelWidth={{ xs: 5 }} contentWidth={{ xs: 6 }}>
      ...
      {dispositionPurchaserAgent.contact?.organizationId &&
        !dispositionPurchaserAgent.contact?.personId && (
          <SectionField label="Primary contact" labelWidth={{ xs: 5 }} contentWidth={{ xs: 5 }}>
      ...
      <SectionField label="Purchaser solicitor" labelWidth={{ xs: 5 }} contentWidth={{ xs: 6 }}>
        <ContactInputContainer
      ...
      <SectionField label="Sale completion date" labelWidth={{ xs: 5 }} contentWidth={{ xs: 5 }}>
        <FastDatePicker field="saleCompletionDate" formikProps={formikProps} />
      </SectionField>
      <SectionField label="Fiscal year of sale" labelWidth={{ xs: 5 }} contentWidth={{ xs: 5 }}>
      ...
      <SectionField label="Realtor commission ($)" labelWidth={{ xs: 5 }} contentWidth={{ xs: 5 }}>
        <FastCurrencyInput formikProps={formikProps} field="realtorCommissionAmount" />
      </SectionField>

      <SectionField label="GST required" labelWidth={{ xs: 5 }} contentWidth={{ xs: 5 }}>
        <YesNoSelect
          field="isGstRequired"
          notNullable={true}
      ...
      <SectionField label="Net Book Value ($)" labelWidth={{ xs: 5 }} contentWidth={{ xs: 5 }}>
      ...
      <SectionField label="Remediation cost ($)" labelWidth={{ xs: 5 }} contentWidth={{ xs: 5 }}>
