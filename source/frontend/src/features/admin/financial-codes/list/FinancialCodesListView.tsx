...
import { IFinancialCodesFilter } from './interfaces';
import * as Styled from './styles';

/**
 * Page that displays acquisition files information.
 */
export const FinancialCodesListView: React.FunctionComponent<
...
> = () => {
  ...
  const {
    ...
    setPageSize,
    loading,
  } = useSearch<Api_AcquisitionFile, IFinancialCodesFilter>(
...
export default FinancialCodesListView;
