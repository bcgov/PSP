...
import { ILeaseDetailViewProps } from '../../features/leases/detail/LeasePages/details/LeaseDetailView';
import { FileTeamView } from './FileTeamView';
...
describe('LeaseTeamView component', () => {
  ...
  const setup = (
    ...
    const utils = render(
      <FileTeamView
        team={renderOptions?.props?.lease?.leaseTeam ?? getEmptyLease()?.leaseTeam}
        title="Lease Team"
      />,
      {
        ...renderOptions,
