...
export class Api_GenerateAcquisitionPropertyIntake {
  ...
  constructor(file: ApiGen_Concepts_AcquisitionFile, composedProperty: ComposedProperty) {
    this.user_full_name = 'Manuel Rodriguez';
    ...
    this.property_historical_lis = 'some good ol LIS';
  }
}
