...
export const emptyPropertyLite: PIMS_Property_Lite_View = {
  PROPERTY_ID: null,
  LOCATION: null,
  BOUNDARY: null,
  IS_OWNED: null,
...
// Source : Pims Geoserverview
// name: PIMS_PROPERTY_VW
export interface PIMS_Property_View {
  readonly PROPERTY_ID: number | null;
...
export const emptyProperty: PIMS_Property_View = {
  PROPERTY_ID: null,
  PID: null,
  PID_PADDED: null,
  PIN: null,
