...
// LINK: @backend/apimodels/Models/Concepts/File/FileChecklistItemTypeModel.cs
export interface ApiGen_Concepts_FileChecklistItemType extends ApiGen_Base_BaseConcurrent {
  code: string | null;
