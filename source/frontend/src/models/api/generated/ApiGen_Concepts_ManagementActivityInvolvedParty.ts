...
// LINK: @backend/apimodels/Models/Concepts/Property/ManagementActivityInvolvedPartyModel.cs
export interface ApiGen_Concepts_ManagementActivityInvolvedParty extends ApiGen_Base_BaseAudit {
  id: number;
