...
// LINK: @backend/apimodels/Models/Concepts/Property/PropertyTenureCleanupModel.cs
export interface ApiGen_Concepts_PropertyTenureCleanup extends ApiGen_Base_BaseAudit {
  id: number;
  propertyId: number;
  tenureCleanupTypeCode: ApiGen_Base_CodeType<string> | null;
}
