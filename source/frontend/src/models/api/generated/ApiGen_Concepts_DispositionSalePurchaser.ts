...
// LINK: @backend/apimodels/Models/Concepts/DispositionFile/DispositionSalePurchaserModel.cs
export interface ApiGen_Concepts_DispositionSalePurchaser extends ApiGen_Base_BaseConcurrent {
  id: number;
