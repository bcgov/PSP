...
// LINK: @backend/apimodels/Models/Concepts/ManagementActivity/ManagementActivitySubTypeModel.cs
export interface ApiGen_Concepts_ManagementActivitySubType extends ApiGen_Base_BaseAudit {
  id: number;
  managementActivityId: number;
  managementActivitySubtypeCode: ApiGen_Base_CodeType<string> | null;
}
