-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Tue Apr 07 11:35:38 PDT 2026
...
GO
ALTER TABLE [dbo].[PIMS_ACQUISITION_OWNER]
	ADD [IS_FROM_LTSA] bit NULL CONSTRAINT [ACQOWN_IS_FROM_LTSA_DEF] DEFAULT (CONVERT([bit],(0))), 
	[LTSA_PID] nvarchar(9) NULL, 
	[LTSA_SOURCED_DATE] datetime NULL
GO
EXEC sp_addextendedproperty 
	@name = N'MS_Description', @value = N'User Story: As a PIMS user, I need to pre-populate the owner name(s) from LTSA title, as I’m required to use the LTSA title owner as the owner for an Acquisition file, and having that populate automatically based on properties in the file saves me time an' , 
	@level0type = N'Schema', @level0name = N'dbo', 
	@level1type = N'Table', @level1name = N'PIMS_ACQUISITION_OWNER', 
	@level2type = N'Column', @level2name = N'IS_FROM_LTSA'
GO
EXEC sp_addextendedproperty 
	@name = N'MS_Description', @value = N'PID of the originating LTSA file.' , 
	@level0type = N'Schema', @level0name = N'dbo', 
	@level1type = N'Table', @level1name = N'PIMS_ACQUISITION_OWNER', 
	@level2type = N'Column', @level2name = N'LTSA_PID'
GO
EXEC sp_addextendedproperty 
	@name = N'MS_Description', @value = N'Date that LTSA data was imported into the PIMS system.' , 
	@level0type = N'Schema', @level0name = N'dbo', 
	@level1type = N'Table', @level1name = N'PIMS_ACQUISITION_OWNER', 
	@level2type = N'Column', @level2name = N'LTSA_SOURCED_DATE'
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
BEGIN TRY
  ...
  update PIMS_ACQUISITION_OWNER
    set "ACQUISITION_OWNER_ID" = inserted."ACQUISITION_OWNER_ID",
      ...
      "IS_FROM_LTSA" = inserted."IS_FROM_LTSA",
      "LTSA_PID" = inserted."LTSA_PID",
      "LTSA_SOURCED_DATE" = inserted."LTSA_SOURCED_DATE",
