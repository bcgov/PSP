-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Tue Oct 10 14:34:36 PDT 2023
...
ALTER TABLE [dbo].[PIMS_PROPERTY_EVALUATION]
	DROP CONSTRAINT IF EXISTS [PIM_PRPRTY_PIM_PRPEVL_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
ALTER TABLE [dbo].[PIMS_PROPERTY_TAX]
	DROP CONSTRAINT IF EXISTS [PIM_PRPRTY_PIM_PRPTAX_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_TAX]
	DROP CONSTRAINT IF EXISTS [PIM_PTRMTT_PIM_PRPTAX_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
ALTER TABLE [dbo].[PIMS_PROPERTY_PROPERTY_SERVICE_FILE]
	DROP CONSTRAINT IF EXISTS [PIM_PRPSVC_PIM_PRPRSF_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_PROPERTY_SERVICE_FILE]
	DROP CONSTRAINT IF EXISTS [PIM_PRPRTY_PIM_PRPRSF_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
ALTER TABLE [dbo].[PIMS_PROPERTY_SERVICE_FILE]
	DROP CONSTRAINT IF EXISTS [PIM_PRSVFT_PIM_PRPSVC_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP TRIGGER IF EXISTS [dbo].[PIMS_PRPSVC_A_S_IUD_TR]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP INDEX IF EXISTS [dbo].[PIMS_PROPERTY_SERVICE_FILE].[PRPSVC_PROPERTY_SERVICE_FILE_TYPE_CODE_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP TRIGGER IF EXISTS [dbo].[PIMS_PRPEVL_I_S_U_TR]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP TRIGGER IF EXISTS [dbo].[PIMS_PRPEVL_I_S_I_TR]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP TRIGGER IF EXISTS [dbo].[PIMS_PRPEVL_A_S_IUD_TR]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP INDEX IF EXISTS [dbo].[PIMS_PROPERTY_EVALUATION].[PRPEVL_PROPERTY_ID_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP TRIGGER IF EXISTS [dbo].[PIMS_PRPTAX_I_S_U_TR]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP TRIGGER IF EXISTS [dbo].[PIMS_PRPTAX_I_S_I_TR]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP TRIGGER IF EXISTS [dbo].[PIMS_PRPTAX_A_S_IUD_TR]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP INDEX IF EXISTS [dbo].[PIMS_PROPERTY_TAX].[PRPTAX_PROPERTY_TAX_REMIT_TYPE_CODE_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP INDEX IF EXISTS [dbo].[PIMS_PROPERTY_TAX].[PRPTAX_PROPERTY_ID_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP TRIGGER IF EXISTS [dbo].[PIMS_PTRMTT_I_S_U_TR]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP TRIGGER IF EXISTS [dbo].[PIMS_PTRMTT_I_S_I_TR]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP TRIGGER IF EXISTS [dbo].[PIMS_PRPRSF_I_S_U_TR]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP TRIGGER IF EXISTS [dbo].[PIMS_PRPRSF_I_S_I_TR]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP TRIGGER IF EXISTS [dbo].[PIMS_PRPRSF_A_S_IUD_TR]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP INDEX IF EXISTS [dbo].[PIMS_PROPERTY_PROPERTY_SERVICE_FILE].[PRPRSF_PROPERTY_SERVICE_FILE_ID_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP INDEX IF EXISTS [dbo].[PIMS_PROPERTY_PROPERTY_SERVICE_FILE].[PRPRSF_PROPERTY_ID_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP TRIGGER IF EXISTS [dbo].[PIMS_PRPSVC_I_S_U_TR]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP TRIGGER IF EXISTS [dbo].[PIMS_PRPSVC_I_S_I_TR]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP TRIGGER IF EXISTS [dbo].[PIMS_PRSVFT_I_S_U_TR]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP TRIGGER IF EXISTS [dbo].[PIMS_PRSVFT_I_S_I_TR]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
ALTER TABLE [dbo].[PIMS_PROPERTY_SERVICE_FILE_HIST]
	DROP CONSTRAINT IF EXISTS [PIMS_PRPSVC_H_UK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_SERVICE_FILE_HIST]
	DROP CONSTRAINT IF EXISTS [PIMS_PRPSVC_H_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
ALTER TABLE [dbo].[PIMS_PROPERTY_EVALUATION_HIST]
	DROP CONSTRAINT IF EXISTS [PIMS_PRPEVL_H_UK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_EVALUATION_HIST]
	DROP CONSTRAINT IF EXISTS [PIMS_PRPEVL_H_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_EVALUATION]
	DROP CONSTRAINT IF EXISTS [PRPEVL_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP TABLE IF EXISTS [dbo].[PIMS_PROPERTY_EVALUATION]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
ALTER TABLE [dbo].[PIMS_PROPERTY_TAX_HIST]
	DROP CONSTRAINT IF EXISTS [PIMS_PRPTAX_H_UK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_TAX_HIST]
	DROP CONSTRAINT IF EXISTS [PIMS_PRPTAX_H_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_TAX]
	DROP CONSTRAINT IF EXISTS [PRPTAX_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP TABLE IF EXISTS [dbo].[PIMS_PROPERTY_TAX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
ALTER TABLE [dbo].[PIMS_PROPERTY_TAX_REMIT_TYPE]
	DROP CONSTRAINT IF EXISTS [PTRMTT_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
ALTER TABLE [dbo].[PIMS_PROPERTY_PROPERTY_SERVICE_FILE_HIST]
	DROP CONSTRAINT IF EXISTS [PIMS_PRPRSF_H_UK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_PROPERTY_SERVICE_FILE_HIST]
	DROP CONSTRAINT IF EXISTS [PIMS_PRPRSF_H_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_PROPERTY_SERVICE_FILE]
	DROP CONSTRAINT IF EXISTS [PRPRSF_PROPERTY_SERVICE_FILE_TUC]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_PROPERTY_SERVICE_FILE]
	DROP CONSTRAINT IF EXISTS [PRPRSF_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop table dbo.PIMS_PROPERTY_PROPERTY_SERVICE_FILE
PRINT N'Drop table dbo.PIMS_PROPERTY_PROPERTY_SERVICE_FILE'
GO
DROP TABLE IF EXISTS [dbo].[PIMS_PROPERTY_PROPERTY_SERVICE_FILE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_SERVICE_FILE]
	DROP CONSTRAINT IF EXISTS [PRPSVC_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop table dbo.PIMS_PROPERTY_SERVICE_FILE
PRINT N'Drop table dbo.PIMS_PROPERTY_SERVICE_FILE'
GO
DROP TABLE IF EXISTS [dbo].[PIMS_PROPERTY_SERVICE_FILE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop primary key constraint dbo.PRSVFT_PK
PRINT N'Drop primary key constraint dbo.PRSVFT_PK'
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_SERVICE_FILE_TYPE]
	DROP CONSTRAINT IF EXISTS [PRSVFT_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_PERSON]
	ADD [PIMS_PROPERTY_ACTIVITY_ID] bigint NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
PRINT N'Create sequence dbo.PIMS_ACQUISITION_FILE_TEAM_ID_SEQ'
GO
CREATE SEQUENCE [dbo].[PIMS_ACQUISITION_FILE_TEAM_ID_SEQ]
	AS bigint
	START WITH 1
...
PRINT N'Create table dbo.PIMS_ACQ_FL_TEAM_PROFILE_TYPE'
GO
CREATE TABLE [dbo].[PIMS_ACQ_FL_TEAM_PROFILE_TYPE]  ( 
...
PRINT N'Create table dbo.PIMS_ACQUISITION_FILE_TEAM'
GO
CREATE TABLE [dbo].[PIMS_ACQUISITION_FILE_TEAM]  ( 
...
PRINT N'Create sequence dbo.PIMS_PROP_PROP_ACTIVITY_ID_SEQ'
GO
CREATE SEQUENCE [dbo].[PIMS_PROP_PROP_ACTIVITY_ID_SEQ]
	AS bigint
	START WITH 1
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY]
	ADD [BAND_NAME] nvarchar(80) NULL, 
...
GO
EXEC dbo.sp_rename N'dbo.PIMS_COMPENSATION_REQUISITION.ACQUISITION_FILE_PERSON_ID' , N'ACQUISITION_FILE_TEAM_ID', 'COLUMN'
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_ACQUISITION_FILE_NOTE]
	DROP CONSTRAINT IF EXISTS [ACQNOT_IS_DISABLED_DEF]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_ACQUISITION_FILE_NOTE]
...
GO
ALTER TABLE [dbo].[PIMS_RESEARCH_FILE_PROJECT]
	DROP CONSTRAINT IF EXISTS [RFLPRJ_IS_DISABLED_DEF]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_RESEARCH_FILE_PROJECT]
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_ACQUISITION_FILE]
	DROP CONSTRAINT IF EXISTS [PRACQF_IS_DISABLED_DEF]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_ACQUISITION_FILE]
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_RESEARCH_FILE]
	DROP CONSTRAINT IF EXISTS [PRSCRC_IS_DISABLED_DEF]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_RESEARCH_FILE]
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_ACTIVITY_HIST] DROP CONSTRAINT IF EXISTS [DF__PIMS_PROP___PROP__29820FAE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_ACTIVITY_HIST] DROP CONSTRAINT IF EXISTS [DF__PIMS_PROP__EFFEC__2A7633E7]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
UPDATE [dbo].[PIMS_PROPERTY_ACTIVITY_HIST] SET [PROP_MGMT_ACTIVITY_STATUS_TYPE_CODE] = 'NOTSTARTED' WHERE [PROP_MGMT_ACTIVITY_STATUS_TYPE_CODE] IS NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_ACTIVITY_HIST] ALTER COLUMN [PROP_MGMT_ACTIVITY_STATUS_TYPE_CODE] nvarchar(20) NOT NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
--ALTER TABLE [dbo].[PIMS_PROPERTY_ACTIVITY_HIST] ADD DEFAULT 'NOTSTARTED' FOR [PROP_MGMT_ACTIVITY_STATUS_TYPE_CODE]
--GO
--IF @@ERROR <> 0 SET NOEXEC ON
--GO
ALTER TABLE [dbo].[PIMS_PROPERTY_ACTIVITY_HIST] ALTER COLUMN [DESCRIPTION] nvarchar(2000) NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_ACTIVITY_HIST] ALTER COLUMN [IS_DISABLED] bit NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'dbo.PIMS_PROPERTY_ACTIVITY_HIST.MINISTRY_CONTACT_ID' , N'SERVICE_PROVIDER_PERSON_ID', 'COLUMN'
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'dbo.PIMS_PROPERTY_ACTIVITY_HIST.VENDOR_ID' , N'SERVICE_PROVIDER_ORG_ID', 'COLUMN'
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'dbo.PIMS_PROPERTY_ACTIVITY_HIST.REQUEST_RECEIVED_DT' , N'REQUEST_ADDED_DT', 'COLUMN'
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
UPDATE [dbo].[PIMS_PROPERTY_ACTIVITY_HIST] SET [REQUEST_ADDED_DT] = convert(datetime,0) WHERE [REQUEST_ADDED_DT] IS NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_ACTIVITY_HIST] ALTER COLUMN [REQUEST_ADDED_DT] date NOT NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
--ALTER TABLE [dbo].[PIMS_PROPERTY_ACTIVITY_HIST] ADD DEFAULT convert(datetime,0) FOR [REQUEST_ADDED_DT]
--GO
--IF @@ERROR <> 0 SET NOEXEC ON
--GO
ALTER TABLE [dbo].[PIMS_PROPERTY_ACTIVITY_HIST]
	DROP COLUMN IF EXISTS [PROPERTY_ID], [INVOLVED_PARTY]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_INTHLDR_PROP_INTEREST]
	DROP CONSTRAINT IF EXISTS [IHPRIN_IS_DISABLED_DEF]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_INTHLDR_PROP_INTEREST]
...
GO
EXEC dbo.sp_rename N'dbo.PIMS_COMPENSATION_REQUISITION_HIST.ACQUISITION_FILE_PERSON_ID' , N'ACQUISITION_FILE_TEAM_ID', 'COLUMN'
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_PROP_INTHLDR_INTEREST_TYPE]
	DROP CONSTRAINT IF EXISTS [PIHITY_IS_DISABLED_DEF]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROP_INTHLDR_INTEREST_TYPE]
...
GO
ALTER TABLE [dbo].[PIMS_PERSON_ADDRESS]
	DROP CONSTRAINT IF EXISTS [PERADD_IS_DISABLED_DEF]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PERSON_ADDRESS]
...
GO
ALTER TABLE [dbo].[PIMS_REGION_USER]
	DROP CONSTRAINT IF EXISTS [RGNUSR_IS_DISABLED_DEF]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_REGION_USER]
...
GO
ALTER TABLE [dbo].[PIMS_USER_ORGANIZATION]
	DROP CONSTRAINT IF EXISTS [USRORG_IS_DISABLED_DEF]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_USER_ORGANIZATION]
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_CONTACT] ADD CONSTRAINT [PRPCNT_PURPOSE_DEF] DEFAULT ('Unknown') FOR [PURPOSE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_CONTACT]
	DROP CONSTRAINT IF EXISTS [PRPCNT_IS_DISABLED_DEF]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_CONTACT]
...
GO
ALTER TABLE [dbo].[PIMS_PROJECT_NOTE]
	DROP CONSTRAINT IF EXISTS [PRJNOT_IS_DISABLED_DEF]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROJECT_NOTE]
...
GO
ALTER TABLE [dbo].[PIMS_PERSON_ORGANIZATION]
	DROP CONSTRAINT IF EXISTS [PERORG_IS_DISABLED_DEF]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PERSON_ORGANIZATION]
...
GO
ALTER TABLE [dbo].[PIMS_RESEARCH_FILE_NOTE]
	DROP CONSTRAINT IF EXISTS [RFLNOT_IS_DISABLED_DEF]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_RESEARCH_FILE_NOTE]
...
GO
ALTER TABLE [dbo].[PIMS_ORGANIZATION_ADDRESS]
	DROP CONSTRAINT IF EXISTS [ORGADD_IS_DISABLED_DEF]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_ORGANIZATION_ADDRESS]
...
GO
UPDATE [dbo].[PIMS_PROP_PROP_PURPOSE] SET [PROPERTY_PURPOSE_TYPE_CODE] = 'OTHER' WHERE [PROPERTY_PURPOSE_TYPE_CODE] IS NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROP_PROP_PURPOSE] ALTER COLUMN [PROPERTY_PURPOSE_TYPE_CODE] nvarchar(20) NOT NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
--ALTER TABLE [dbo].[PIMS_PROP_PROP_PURPOSE] ADD DEFAULT 'OTHER' FOR [PROPERTY_PURPOSE_TYPE_CODE]
--GO
--IF @@ERROR <> 0 SET NOEXEC ON
--GO
ALTER TABLE [dbo].[PIMS_PROP_PROP_PURPOSE]
	DROP CONSTRAINT IF EXISTS [PRPRPU_IS_DISABLED_DEF]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROP_PROP_PURPOSE]
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_ORGANIZATION]
	DROP CONSTRAINT IF EXISTS [PRPORG_IS_DISABLED_DEF]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_ORGANIZATION]
...
PRINT N'Create sequence dbo.PIMS_ACQUISITION_FILE_TEAM_H_ID_SEQ'
GO
CREATE SEQUENCE [dbo].[PIMS_ACQUISITION_FILE_TEAM_H_ID_SEQ]
	AS bigint
	START WITH 1
...
PRINT N'Create table dbo.PIMS_ACQUISITION_FILE_TEAM_HIST'
GO
CREATE TABLE [dbo].[PIMS_ACQUISITION_FILE_TEAM_HIST]  ( 
...
-- Create unique constraint dbo.PIMS_ACQNTM_H_UK
PRINT N'Create unique constraint dbo.PIMS_ACQNTM_H_UK'
GO
...
GO
UPDATE [dbo].[PIMS_PROP_PROP_PURPOSE_HIST] SET [PROPERTY_PURPOSE_TYPE_CODE] = 'OTHER' WHERE [PROPERTY_PURPOSE_TYPE_CODE] IS NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROP_PROP_PURPOSE_HIST] ALTER COLUMN [PROPERTY_PURPOSE_TYPE_CODE] nvarchar(20) NOT NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
--ALTER TABLE [dbo].[PIMS_PROP_PROP_PURPOSE_HIST] ADD DEFAULT 'OTHER' FOR [PROPERTY_PURPOSE_TYPE_CODE]
--GO
--IF @@ERROR <> 0 SET NOEXEC ON
--GO
ALTER TABLE [dbo].[PIMS_PROP_PROP_PURPOSE_HIST]
...
-- Create index dbo.ACQNTM_ORGANIZATION_ID_IDX
PRINT N'Create index dbo.ACQNTM_ORGANIZATION_ID_IDX'
GO
...
-- Create index dbo.ACQNTM_PRIMARY_CONTACT_ID_IDX
PRINT N'Create index dbo.ACQNTM_PRIMARY_CONTACT_ID_IDX'
GO
...
-- Create trigger dbo.PIMS_ACQNTM_I_S_I_TR
PRINT N'Create trigger dbo.PIMS_ACQNTM_I_S_I_TR'
GO
...
-- Create trigger dbo.PIMS_AQTPPT_I_S_I_TR
PRINT N'Create trigger dbo.PIMS_AQTPPT_I_S_I_TR'
GO
...
-- Create trigger dbo.PIMS_ACQNTM_A_S_IUD_TR
PRINT N'Create trigger dbo.PIMS_ACQNTM_A_S_IUD_TR'
GO
...
-- Create foreign key constraint dbo.PIM_PERSON_PIM_ACQNTM_FK
PRINT N'Create foreign key constraint dbo.PIM_PERSON_PIM_ACQNTM_FK'
GO
ALTER TABLE [dbo].[PIMS_ACQUISITION_FILE_TEAM]
...
-- Create foreign key constraint dbo.PIM_ORG_PIM_ACQNTM_FK
PRINT N'Create foreign key constraint dbo.PIM_ORG_PIM_ACQNTM_FK'
GO
ALTER TABLE [dbo].[PIMS_ACQUISITION_FILE_TEAM]
...
GO
DROP TABLE IF EXISTS [dbo].[PIMS_PROPERTY_SERVICE_FILE_HIST]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP SEQUENCE IF EXISTS [dbo].[PIMS_PROPERTY_SERVICE_FILE_H_ID_SEQ]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP TABLE IF EXISTS [dbo].[PIMS_PROPERTY_EVALUATION_HIST]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP SEQUENCE IF EXISTS [dbo].[PIMS_PROPERTY_EVALUATION_H_ID_SEQ]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP TABLE IF EXISTS [dbo].[PIMS_PROPERTY_TAX_HIST]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP SEQUENCE IF EXISTS [dbo].[PIMS_PROPERTY_TAX_H_ID_SEQ]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP TABLE IF EXISTS [dbo].[PIMS_PROPERTY_TAX_REMIT_TYPE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP TABLE IF EXISTS [dbo].[PIMS_PROPERTY_PROPERTY_SERVICE_FILE_HIST]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP SEQUENCE IF EXISTS [dbo].[PIMS_PROPERTY_PROPERTY_SERVICE_FILE_H_ID_SEQ]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop table dbo.PIMS_PROPERTY_SERVICE_FILE_TYPE
PRINT N'Drop table dbo.PIMS_PROPERTY_SERVICE_FILE_TYPE'
GO
DROP TABLE IF EXISTS [dbo].[PIMS_PROPERTY_SERVICE_FILE_TYPE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
