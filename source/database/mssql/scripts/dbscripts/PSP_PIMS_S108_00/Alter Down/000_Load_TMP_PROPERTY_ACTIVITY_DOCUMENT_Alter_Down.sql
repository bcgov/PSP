/* -----------------------------------------------------------------------------
Create and populate the temporary TMP_PROPERTY_ACTIVITY_DOCUMENT table.
. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
Author        Date         Comment
------------  -----------  -----------------------------------------------------
...
GO
CREATE TABLE dbo.TMP_PROPERTY_ACTIVITY_DOCUMENT (
...
-- Migrate the PIMS_MGMT_ACTIVITY_DOCUMENT data to the TMP_PROPERTY_ACTIVITY_DOCUMENT table
PRINT N'Migrate the PIMS_MGMT_ACTIVITY_DOCUMENT data to the TMP_PROPERTY_ACTIVITY_DOCUMENT table'
GO
INSERT INTO dbo.TMP_PROPERTY_ACTIVITY_DOCUMENT (PROPERTY_ACTIVITY_DOCUMENT_ID, PIMS_MANAGEMENT_ACTIVITY_ID, DOCUMENT_ID, CONCURRENCY_CONTROL_NUMBER, APP_CREATE_TIMESTAMP, APP_CREATE_USERID, APP_CREATE_USER_GUID, APP_CREATE_USER_DIRECTORY, APP_LAST_UPDATE_TIMESTAMP, APP_LAST_UPDATE_USERID, APP_LAST_UPDATE_USER_GUID, APP_LAST_UPDATE_USER_DIRECTORY, DB_CREATE_TIMESTAMP, DB_CREATE_USERID, DB_LAST_UPDATE_TIMESTAMP, DB_LAST_UPDATE_USERID)
