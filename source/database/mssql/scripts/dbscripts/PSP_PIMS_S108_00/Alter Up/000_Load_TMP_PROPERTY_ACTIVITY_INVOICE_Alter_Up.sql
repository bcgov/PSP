...
-- Migrate the PIMS_PROPERTY_ACTIVITY_INVOICE data to the TMP_PROPERTY_ACTIVITY_INVOICE table
PRINT N'Migrate the PIMS_PROPERTY_ACTIVITY_INVOICE data to the TMP_PROPERTY_ACTIVITY_INVOICE table'
GO
