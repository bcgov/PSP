...
-- Migrate the PIMS_PROP_ACT_MIN_CONTACT_HIST data to the TMP_PROP_ACT_MIN_CONTACT table
PRINT N'Migrate the PIMS_PROP_ACT_MIN_CONTACT_HIST data to the TMP_PROP_ACT_MIN_CONTACT table'
GO
