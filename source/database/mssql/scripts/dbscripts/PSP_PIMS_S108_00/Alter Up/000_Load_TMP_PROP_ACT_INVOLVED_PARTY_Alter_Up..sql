...
-- Migrate the PIMS_PROP_ACT_INVOLVED_PARTY data to the TMP_PROP_ACT_INVOLVED_PARTY table
PRINT N'Migrate the PIMS_PROP_ACT_INVOLVED_PARTY data to the TMP_PROP_ACT_INVOLVED_PARTY table'
GO
