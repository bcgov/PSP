...
DELETE FROM [dbo].[PIMS_CLAIM] WHERE CLAIM_ID = @projectView;
DELETE FROM [dbo].[PIMS_CLAIM] WHERE CLAIM_ID = @projectAdd;
DELETE FROM [dbo].[PIMS_CLAIM] WHERE CLAIM_ID = @projectEdit;
DELETE FROM [dbo].[PIMS_CLAIM] WHERE CLAIM_ID = @projectDelete;
GO
