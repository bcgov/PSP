...
SELECT @acgrdon, USER_ID, 'db-migration', 'db-migration', 'db-migration', 'db-migration'
FROM PIMS_USER_ROLE
WHERE ROLE_ID in (@finance, @restricted, @readOnly)
INSERT INTO PIMS_USER_ROLE (ROLE_ID, USER_ID, APP_CREATE_USERID, APP_LAST_UPDATE_USERID, APP_CREATE_USER_DIRECTORY, APP_LAST_UPDATE_USER_DIRECTORY) 
SELECT @llrdon, USER_ID, 'db-migration', 'db-migration', 'db-migration', 'db-migration'
FROM PIMS_USER_ROLE
WHERE ROLE_ID in (@finance, @restricted, @readOnly)
INSERT INTO PIMS_USER_ROLE (ROLE_ID, USER_ID, APP_CREATE_USERID, APP_LAST_UPDATE_USERID, APP_CREATE_USER_DIRECTORY, APP_LAST_UPDATE_USER_DIRECTORY) 
SELECT @prjrdon, USER_ID, 'db-migration', 'db-migration', 'db-migration', 'db-migration'
FROM PIMS_USER_ROLE
WHERE ROLE_ID in (@finance, @restricted, @readOnly)
INSERT INTO PIMS_USER_ROLE (ROLE_ID, USER_ID, APP_CREATE_USERID, APP_LAST_UPDATE_USERID, APP_CREATE_USER_DIRECTORY, APP_LAST_UPDATE_USER_DIRECTORY) 
SELECT @resrdon, USER_ID, 'db-migration', 'db-migration', 'db-migration', 'db-migration'
FROM PIMS_USER_ROLE
WHERE ROLE_ID in (@finance, @restricted, @readOnly)
