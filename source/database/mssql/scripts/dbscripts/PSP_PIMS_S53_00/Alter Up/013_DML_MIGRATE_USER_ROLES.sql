-- migrate old roles to new roles. After migration, delete all user_roles related to old role values.
SET XACT_ABORT ON
GO
...
SELECT DISTINCT @acgrdon, USER_ID, 'db-migration', 'db-migration', 'db-migration', 'db-migration'
FROM PIMS_USER_ROLE
WHERE ROLE_ID in (@finance, @restricted, @readOnly)
INSERT INTO PIMS_USER_ROLE (ROLE_ID, USER_ID, APP_CREATE_USERID, APP_LAST_UPDATE_USERID, APP_CREATE_USER_DIRECTORY, APP_LAST_UPDATE_USER_DIRECTORY) 
SELECT DISTINCT @llrdon, USER_ID, 'db-migration', 'db-migration', 'db-migration', 'db-migration'
FROM PIMS_USER_ROLE
WHERE ROLE_ID in (@finance, @restricted, @readOnly)
INSERT INTO PIMS_USER_ROLE (ROLE_ID, USER_ID, APP_CREATE_USERID, APP_LAST_UPDATE_USERID, APP_CREATE_USER_DIRECTORY, APP_LAST_UPDATE_USER_DIRECTORY) 
SELECT DISTINCT @prjrdon, USER_ID, 'db-migration', 'db-migration', 'db-migration', 'db-migration'
FROM PIMS_USER_ROLE
WHERE ROLE_ID in (@finance, @restricted, @readOnly)
INSERT INTO PIMS_USER_ROLE (ROLE_ID, USER_ID, APP_CREATE_USERID, APP_LAST_UPDATE_USERID, APP_CREATE_USER_DIRECTORY, APP_LAST_UPDATE_USER_DIRECTORY) 
SELECT DISTINCT @resrdon, USER_ID, 'db-migration', 'db-migration', 'db-migration', 'db-migration'
FROM PIMS_USER_ROLE
WHERE ROLE_ID in (@finance, @restricted, @readOnly)

INSERT INTO PIMS_USER_ROLE (ROLE_ID, USER_ID, APP_CREATE_USERID, APP_LAST_UPDATE_USERID, APP_CREATE_USER_DIRECTORY, APP_LAST_UPDATE_USER_DIRECTORY) 
SELECT @acqfunc, USER_ID, 'db-migration', 'db-migration', 'db-migration', 'db-migration'
FROM PIMS_USER_ROLE
WHERE (ROLE_ID = @functional)
INSERT INTO PIMS_USER_ROLE (ROLE_ID, USER_ID, APP_CREATE_USERID, APP_LAST_UPDATE_USERID, APP_CREATE_USER_DIRECTORY, APP_LAST_UPDATE_USER_DIRECTORY) 
SELECT @llfunc, USER_ID, 'db-migration', 'db-migration', 'db-migration', 'db-migration'
FROM PIMS_USER_ROLE
WHERE (ROLE_ID = @functional)
INSERT INTO PIMS_USER_ROLE (ROLE_ID, USER_ID, APP_CREATE_USERID, APP_LAST_UPDATE_USERID, APP_CREATE_USER_DIRECTORY, APP_LAST_UPDATE_USER_DIRECTORY) 
SELECT @prjfunc, USER_ID, 'db-migration', 'db-migration', 'db-migration', 'db-migration'
FROM PIMS_USER_ROLE
WHERE (ROLE_ID = @functional)
INSERT INTO PIMS_USER_ROLE (ROLE_ID, USER_ID, APP_CREATE_USERID, APP_LAST_UPDATE_USERID, APP_CREATE_USER_DIRECTORY, APP_LAST_UPDATE_USER_DIRECTORY) 
SELECT @resfunc, USER_ID, 'db-migration', 'db-migration', 'db-migration', 'db-migration'
FROM PIMS_USER_ROLE
WHERE (ROLE_ID = @functional)
