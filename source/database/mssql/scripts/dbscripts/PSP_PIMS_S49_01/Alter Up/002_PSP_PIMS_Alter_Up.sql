-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Wed Mar 08 11:54:37 PST 2023
...
GO
ALTER TABLE [dbo].[PIMS_ACQ_CHKLST_SECTION_TYPE] ALTER COLUMN [DISPLAY_ORDER] int NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_ACQ_CHKLST_ITEM_TYPE] ALTER COLUMN [DISPLAY_ORDER] int NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_ACQ_CHKLST_ITEM_TYPE]
	ADD [HINT] nvarchar(200) NULL
GO
