...
VALUES
  ...
  (N'SCTN6XPRP', N'EXPROPFORM1',  N'Notice of Expropriation (Form 1)',         38,  N'The signed Form 1 is required'),
  (N'SCTN6XPRP', N'EXPROPFORM5',  N'Approval of Expropriation (Form 5)',       39,  N'The signed Form 5 is required'),
  (N'SCTN6XPRP', N'ADVPAYMENT8',  N'Notice of Advanced Payment (Form 8)',      40,  N'The signed Form 8 is required'),
  (N'SCTN6XPRP', N'VESTNOTICE',   N'Vesting Notice (Form 9)',                  41,  N'The signed Form 9 is required'),
  (N'SCTN6XPRP', N'SVCAFFADAV',   N'Copies of Affidavits of Service',          42,  NULL),
  (N'SCTN6XPRP', N'S6CHEQCOPY',   N'Copy of cheque to owner(s)',               43,  NULL),
  (N'SCTN6XPRP', N'S6APPRCOPY',   N'Copy of appraisal to owner(s)',            44,  NULL),
  (N'SCTN6XPRP', N'CLAIMRELSS6',  N'Release of Claims',                        45,  NULL),
  (N'SCTN6XPRP', N'EASEMENTCPY',  N'Copy of Easement',                         46,  NULL),
  (N'ACQCOMPAC', N'PIMSUPDTFIL',  N'File data entered into PIMS',              47,  N'Data is complete in this system');
GO
