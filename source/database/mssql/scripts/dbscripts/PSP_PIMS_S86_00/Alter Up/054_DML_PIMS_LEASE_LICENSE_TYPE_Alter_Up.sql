...
-- Insert/Enable the "LIOCCTELE" type
PRINT N'Insert/Enable the "LIOCCTELE" type'
GO
...
ELSE
  INSERT INTO PIMS_LEASE_LICENSE_TYPE (LEASE_LICENSE_TYPE_CODE, DESCRIPTION)
    VALUES (N'LIOCCTELE',  N'Licence of Occupation Telecommunications (BCTFA fee simple)');
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
