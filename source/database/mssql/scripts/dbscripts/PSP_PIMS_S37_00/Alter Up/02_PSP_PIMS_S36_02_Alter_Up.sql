-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Wed Sep 14 16:14:21 PDT 2022
-- Execute this script on:
-- 		PSP_PIMS_S36_02/dbo - This database/schema will be modified
...
PRINT N'Create sequence dbo.PIMS_ACQUISITION_FILE_NO_SEQ'
GO
CREATE SEQUENCE [dbo].[PIMS_ACQUISITION_FILE_NO_SEQ]
	AS int
	START WITH 1
...
GO
UPDATE [dbo].[PIMS_ACQUISITION_FILE] SET [FILE_NUMBER] = ('<Empty>') WHERE [FILE_NUMBER] IS NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_ACQUISITION_FILE] ALTER COLUMN [FILE_NUMBER] nvarchar(18) NOT NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_ACQUISITION_FILE]
	ADD [FILE_NO] int NOT NULL CONSTRAINT [ACQNFL_FILE_NO_DEF] DEFAULT (NEXT VALUE FOR [PIMS_ACQUISITION_FILE_NO_SEQ])
GO
...
GO
ALTER TABLE [dbo].[PIMS_NOTE_HIST] ALTER COLUMN [IS_SYSTEM_GENERATED] bit NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_NOTE_HIST] DROP CONSTRAINT IF EXISTS [NOTE_H_IS_SYSTEM_GENERATED_DEF]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
