...
Doug Filteau  2024-Oct-21  Corrected DESCRPTION for LIPPUBHWY code.
----------------------------------------------------------------------------- */
...
IF @@ROWCOUNT = 1
  ...
  SET    DESCRIPTION                = N'Licence of Prov Public Highway'
       , CONCURRENCY_CONTROL_NUMBER = CONCURRENCY_CONTROL_NUMBER + 1
  WHERE  LEASE_LICENSE_TYPE_CODE = @CurrCd;
ELSE
  INSERT INTO PIMS_LEASE_LICENSE_TYPE (LEASE_LICENSE_TYPE_CODE, DESCRIPTION)
    VALUES (N'LIPPUBHWY',  N'Licence of Prov Public Highway');
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
