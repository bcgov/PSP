-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Wed Sep 17 17:35:20 PDT 2025
-- Execute this script on:
-- 		PSP_PIMS_S111_00/dbo - This database/schema will be modified
-- to synchronize it with MS SQL Server 2016:
-- 		PSP_PIMS_S110_00/dbo
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PRF_PROP_RESEARCH_PURPOSE_TYP] ALTER COLUMN [PROPERTY_RESEARCH_FILE_ID] bigint NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC sp_dropextendedproperty 
...
GO
ALTER TABLE [dbo].[PIMS_PRF_PROP_RESEARCH_PURPOSE_TYP_HIST] ALTER COLUMN [PROPERTY_RESEARCH_FILE_ID] bigint NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
--1 Alter table dbo.PIMS_DOCUMENT_FORMAT_TYPE
