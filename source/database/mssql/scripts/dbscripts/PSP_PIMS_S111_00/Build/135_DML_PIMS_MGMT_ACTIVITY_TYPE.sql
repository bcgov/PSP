...
Doug Filteau  2025-Jul-17  PIMS_PROP_MGMT_ACTIVITY_TYPE table renamed to 
                           PIMS_MGMT_ACTIVITY_TYPE.
----------------------------------------------------------------------------- */

DELETE FROM PIMS_MGMT_ACTIVITY_TYPE
GO

INSERT INTO PIMS_MGMT_ACTIVITY_TYPE (MGMT_ACTIVITY_TYPE_CODE, DESCRIPTION)
VALUES
...
-- --------------------------------------------------------------
INSERT INTO PIMS_MGMT_ACTIVITY_TYPE (MGMT_ACTIVITY_TYPE_CODE, DESCRIPTION, IS_DISABLED)
VALUES
...
FROM   PIMS_MGMT_ACTIVITY_TYPE pmat JOIN
       (SELECT MGMT_ACTIVITY_TYPE_CODE
             , ROW_NUMBER() OVER (ORDER BY DESCRIPTION) AS ROW_NUM
        FROM   PIMS_MGMT_ACTIVITY_TYPE) seq  ON seq.MGMT_ACTIVITY_TYPE_CODE = pmat.MGMT_ACTIVITY_TYPE_CODE
GO
