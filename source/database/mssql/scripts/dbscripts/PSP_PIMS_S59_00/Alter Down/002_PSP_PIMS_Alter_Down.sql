-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Thu Jul 27 15:09:29 PDT 2023
-- Execute this script on:
-- 		PSP_PIMS_S59_00/dbo - This database/schema will be modified
...
GO
ALTER TABLE [dbo].[PIMS_ACQUISITION_FILE]
	DROP COLUMN IF EXISTS [LEGACY_STAKEHOLDER]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_COMPENSATION_REQUISITION]
	DROP COLUMN IF EXISTS [FINALIZED_DATE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
