-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Thu Jan 30 09:49:29 PST 2025
...
PRINT N'Drop sequence dbo.PIMS_LEASE_LICENSE_TEAM_ID_SEQ'
GO
DROP SEQUENCE IF EXISTS [dbo].[PIMS_LEASE_LICENSE_TEAM_ID_SEQ]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
