-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Tue Dec 05 15:51:15 GMT-08:00 2023
...
CREATE TABLE [dbo].[PIMS_DISPOSITION_FILE]  ( 
	...
	[APPAISED_VALUE]                      	money NULL,
	[APPRAISAL_DT]                        	date NULL,
	[BCA_VALUE_AMT]                       	money NULL,
	[BCA_ROLL_YEAR]                       	nvarchar(4) NULL,
...
EXEC sp_addextendedproperty 
	...
	@level0type = N'Schema', @level0name = N'dbo', 
	@level1type = N'Table', @level1name = N'PIMS_DISPOSITION_FILE', 
	@level2type = N'Column', @level2name = N'APPAISED_VALUE'
GO
EXEC sp_addextendedproperty 
...
CREATE TABLE [dbo].[PIMS_DISPOSITION_SALE]  ( 
	...
	[SALE_FISCAL_YEAR]              	nvarchar(4) NULL,
	[FINAL_SALE_AMT]                	money NULL,
	[REALTOR_COMMISISSION_AMT]      	money NULL,
	...
	[NET_PROCEEDS_BEFORE_SPP_AMT]   	money NULL,
	[NET_PROCEEDS_AFTER_SPP_AMT]    	money NULL,
	[SPP_AMT]                       	money NULL,
...
EXEC sp_addextendedproperty 
	...
	@level0type = N'Schema', @level0name = N'dbo', 
	@level1type = N'Table', @level1name = N'PIMS_DISPOSITION_SALE', 
	@level2type = N'Column', @level2name = N'FINAL_SALE_AMT'
GO
EXEC sp_addextendedproperty 
	@name = N'MS_Description', @value = N'Amount paid to the realtor managing the sale.' , 
	@level0type = N'Schema', @level0name = N'dbo', 
	@level1type = N'Table', @level1name = N'PIMS_DISPOSITION_SALE', 
	@level2type = N'Column', @level2name = N'REALTOR_COMMISISSION_AMT'
GO
EXEC sp_addextendedproperty 
...
GO
EXEC sp_addextendedproperty 
	@name = N'MS_Description', @value = N'Net Proceeds before Surplus Property Program (SPP) Cost = Final Sales price, less Commissions, GST Total Cost of Sales, and Net Book Value.' , 
	@level0type = N'Schema', @level0name = N'dbo', 
	@level1type = N'Table', @level1name = N'PIMS_DISPOSITION_SALE', 
	@level2type = N'Column', @level2name = N'NET_PROCEEDS_BEFORE_SPP_AMT'
GO
EXEC sp_addextendedproperty 
	@name = N'MS_Description', @value = N'Net Proceeds after SPP Cost = Final Sales price, less Commissions, GST, Net Book Value, Total Cost of Sales,  and SPP Amount.' , 
	@level0type = N'Schema', @level0name = N'dbo', 
	@level1type = N'Table', @level1name = N'PIMS_DISPOSITION_SALE', 
	@level2type = N'Column', @level2name = N'NET_PROCEEDS_AFTER_SPP_AMT'
GO
EXEC sp_addextendedproperty 
...
-- Create unique constraint dbo.DSPFTM_%column%_TUC
PRINT N'Create unique constraint dbo.DSPFTM_%column%_TUC'
GO
ALTER TABLE [dbo].[PIMS_DISPOSITION_FILE_TEAM]
	ADD CONSTRAINT [DSPFTM_%column%_TUC]
...
GO
CREATE TABLE [dbo].[PIMS_DSP_PURCH_SOLICITOR]  ( 
	[DSP_PURCH_AGENT_ID]            	bigint NOT NULL CONSTRAINT [DSPPSL_DSP_PURCH_AGENT_ID_DEF]  DEFAULT (NEXT VALUE FOR [PIMS_DSP_PURCH_SOLICITOR_ID_SEQ]),
	[DISPOSITION_SALE_ID]           	bigint NOT NULL,
	[PERSON_ID]                     	bigint NULL,
	[ORGANIZATION_ID]               	bigint NULL,
	[PRIMARY_CONTACT_ID]            	bigint NULL,
	...
	CONSTRAINT [DSPPSL_PK] PRIMARY KEY CLUSTERED([DSP_PURCH_AGENT_ID])
 ON [PRIMARY])
GO
EXEC sp_addextendedproperty 
	@name = N'MS_Description', @value = N'Unique auto-generated surrogate primary key' , 
...
BEGIN TRY
  ...
  update PIMS_DISPOSITION_FILE
    set "DISPOSITION_FILE_ID" = inserted."DISPOSITION_FILE_ID",
      ...
      "APPAISED_VALUE" = inserted."APPAISED_VALUE",
...
BEGIN TRY
  ...
  update PIMS_DSP_PURCH_SOLICITOR
    ...
    inner join inserted
    on (PIMS_DSP_PURCH_SOLICITOR.DSP_PURCH_AGENT_ID = inserted.DSP_PURCH_AGENT_ID);
...
SET @curr_date = getutcdate();
  ...
  IF EXISTS(SELECT * FROM inserted)
    insert into PIMS_DISPOSITION_SALE_HIST ([DISPOSITION_SALE_ID], [DISPOSITION_FILE_ID], [FINAL_CONDITION_REMOVAL_DT], [SALE_COMPLETION_DT], [SALE_FISCAL_YEAR], [FINAL_SALE_AMT], [REALTOR_COMMISISSION_AMT], [IS_GST_REQUIRED], [GST_COLLECTED_AMT], [NET_BOOK_AMT], [TOTAL_COST_AMT], [NET_PROCEEDS_BEFORE_SPP_AMT], [NET_PROCEEDS_AFTER_SPP_AMT], [SPP_AMT], [REMEDIATION_AMT], [CONCURRENCY_CONTROL_NUMBER], [APP_CREATE_TIMESTAMP], [APP_CREATE_USERID], [APP_CREATE_USER_GUID], [APP_CREATE_USER_DIRECTORY], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USERID], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USER_DIRECTORY], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], _DISPOSITION_SALE_HIST_ID, END_DATE_HIST, EFFECTIVE_DATE_HIST)
...
BEGIN TRY
  ...
  insert into PIMS_DISPOSITION_SALE ("DISPOSITION_SALE_ID",
      ...
      "SALE_FISCAL_YEAR",
      "FINAL_SALE_AMT",
      "REALTOR_COMMISISSION_AMT",
      "IS_GST_REQUIRED",
      "GST_COLLECTED_AMT",
      "NET_BOOK_AMT",
      "TOTAL_COST_AMT",
      "NET_PROCEEDS_BEFORE_SPP_AMT",
      "NET_PROCEEDS_AFTER_SPP_AMT",
      "SPP_AMT",
      "REMEDIATION_AMT",
      "CONCURRENCY_CONTROL_NUMBER",
      "APP_CREATE_TIMESTAMP",
...
SET @curr_date = getutcdate();
  ...
  -- historical
  IF EXISTS(SELECT * FROM deleted)
    update PIMS_DSP_PURCH_SOLICITOR_HIST set END_DATE_HIST = @curr_date where DSP_PURCH_AGENT_ID in (select DSP_PURCH_AGENT_ID from deleted) and END_DATE_HIST is null;
  
  IF EXISTS(SELECT * FROM inserted)
    insert into PIMS_DSP_PURCH_SOLICITOR_HIST ([DSP_PURCH_AGENT_ID], [DISPOSITION_SALE_ID], [PERSON_ID], [ORGANIZATION_ID], [PRIMARY_CONTACT_ID], [IS_DISABLED], [CONCURRENCY_CONTROL_NUMBER], [APP_CREATE_TIMESTAMP], [APP_CREATE_USERID], [APP_CREATE_USER_GUID], [APP_CREATE_USER_DIRECTORY], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USERID], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USER_DIRECTORY], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], _DSP_PURCH_SOLICITOR_HIST_ID, END_DATE_HIST, EFFECTIVE_DATE_HIST)
...
BEGIN TRY
  ...
  insert into PIMS_DSP_PURCH_SOLICITOR ("DSP_PURCH_AGENT_ID",
      "DISPOSITION_SALE_ID",
      "PERSON_ID",
      "ORGANIZATION_ID",
      "PRIMARY_CONTACT_ID",
...
BEGIN TRY
  ...
  update PIMS_DISPOSITION_SALE
    set "DISPOSITION_SALE_ID" = inserted."DISPOSITION_SALE_ID",
      ...
      "FINAL_SALE_AMT" = inserted."FINAL_SALE_AMT",
      "REALTOR_COMMISISSION_AMT" = inserted."REALTOR_COMMISISSION_AMT",
      ...
      "NET_PROCEEDS_BEFORE_SPP_AMT" = inserted."NET_PROCEEDS_BEFORE_SPP_AMT",
      "NET_PROCEEDS_AFTER_SPP_AMT" = inserted."NET_PROCEEDS_AFTER_SPP_AMT",
