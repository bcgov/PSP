...
VALUES
  ...
  -- Sale Information
  (N'SALEINFO', N'SGNDLSTAGRE', N'Signed Listing agreement',                          24,  N'Copy of documentation to show completion of, or exemption from, this referral.'),
  (N'SALEINFO', N'LWYRASSGND',  N'Lawyer assigned by Attorney General',               25,  NULL),
  (N'SALEINFO', N'ACCOFFRRECD', N'Accepted offer recorded',                           26,  N'Accepted offer details have been recorded and corresponding documentation has been uploaded.'),
  (N'SALEINFO', N'LTRINTNTPRP', N'Letter of intent prepared by the lawyer',           27,  N'Letter has been prepared and final version has been uploaded.'),
  (N'SALEINFO', N'PSAPREPPED',  N'PSA prepared by the lawyer',                        28,  N'Purchase and Sale Agreement (PSA) has been prepared'),
  (N'SALEINFO', N'PSAEXECUTED', N'PSA fully executed',                                29,  N'Purchase and Sale Agreement (PSA) has been executed.'),
  (N'SALEINFO', N'FNLCNDRMVD',  N'Final conditions have been removed',                30,  NULL),
  (N'SALEINFO', N'XFRPLNREGD',  N'Transfer/plan registered with LTSA',                31,  N'Property transfer, or update plan ( for road closures) has been registered with the Land Title office.'),
  (N'SALEINFO', N'SALESPRCRCV', N'Sales proceeds received',                           32,  N'Sale proceeds, if any, have been documented and corresponding documentation has been added to the file'),
  (N'SALEINFO', N'FINRPTGCMPL', N'Financial reporting completed',                     33,  N'Financial reporting, if required, has been completed.'),
  (N'SALEINFO', N'CHQSNTBCTFA', N'Cheque sent to BCTFA',                              34,  NULL);
GO
