-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Mon May 26 12:54:34 PDT 2025
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_ACTIVITY]
	DROP COLUMN IF EXISTS [PROP_MGMT_ACTIVITY_TYPE_CODE], [PROP_MGMT_ACTIVITY_SUBTYPE_CODE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
EXEC sp_addextendedproperty 
	@name = N'MS_Description', @value = N'Foreign key to the PROP_MGMT_ACTIVITY_TYPE table.' , 
	@level0type = N'Schema', @level0name = N'dbo', 
	@level1type = N'Table', @level1name = N'PIMS_PROP_ACTIVITY_MGMT_ACTIVITY', 
...
ALTER TABLE [dbo].[PIMS_PROP_ACTIVITY_MGMT_ACTIVITY]
	...
	UNIQUE ([PIMS_PROPERTY_ACTIVITY_ID], [PROP_MGMT_ACTIVITY_TYPE_CODE], [PROP_MGMT_ACTIVITY_SUBTYPE_CODE]) 
	WITH (
...
-- Create index dbo.PACMAC_PROP_MGMT_ACTIVITY_TYPE_CODE_IDX
PRINT N'Create index dbo.PACMAC_PROP_MGMT_ACTIVITY_TYPE_CODE_IDX'
GO
CREATE NONCLUSTERED INDEX [PACMAC_PROP_MGMT_ACTIVITY_TYPE_CODE_IDX]
	ON [dbo].[PIMS_PROP_ACTIVITY_MGMT_ACTIVITY]([PROP_MGMT_ACTIVITY_TYPE_CODE])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
SET @curr_date = getutcdate();
  ...
  IF EXISTS(SELECT * FROM inserted)
    insert into PIMS_PROP_ACTIVITY_MGMT_ACTIVITY_HIST ([PROP_ACTVTY_MGMT_ACTVTY_TYP_ID], [PIMS_PROPERTY_ACTIVITY_ID], [PROP_MGMT_ACTIVITY_TYPE_CODE], [PROP_MGMT_ACTIVITY_SUBTYPE_CODE], [CONCURRENCY_CONTROL_NUMBER], [APP_CREATE_TIMESTAMP], [APP_CREATE_USERID], [APP_CREATE_USER_GUID], [APP_CREATE_USER_DIRECTORY], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USERID], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USER_DIRECTORY], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], _PROP_ACTIVITY_MGMT_ACTIVITY_HIST_ID, END_DATE_HIST, EFFECTIVE_DATE_HIST)
      select [PROP_ACTVTY_MGMT_ACTVTY_TYP_ID], [PIMS_PROPERTY_ACTIVITY_ID], [PROP_MGMT_ACTIVITY_TYPE_CODE], [PROP_MGMT_ACTIVITY_SUBTYPE_CODE], [CONCURRENCY_CONTROL_NUMBER], [APP_CREATE_TIMESTAMP], [APP_CREATE_USERID], [APP_CREATE_USER_GUID], [APP_CREATE_USER_DIRECTORY], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USERID], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USER_DIRECTORY], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], (next value for [dbo].[PIMS_PROP_ACTIVITY_MGMT_ACTIVITY_H_ID_SEQ]) as [_PROP_ACTIVITY_MGMT_ACTIVITY_HIST_ID], null as [END_DATE_HIST], @curr_date as [EFFECTIVE_DATE_HIST] from inserted;
...
-- Create foreign key constraint dbo.PIM_PRACTY_PIM_PACMAC_FK
PRINT N'Create foreign key constraint dbo.PIM_PRACTY_PIM_PACMAC_FK'
GO
ALTER TABLE [dbo].[PIMS_PROP_ACTIVITY_MGMT_ACTIVITY]
	ADD CONSTRAINT [PIM_PRACTY_PIM_PACMAC_FK]
