-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Mon May 26 14:10:25 PDT 2025
...
-- Drop foreign key constraint dbo.PIM_PRACTY_PIM_PACMAC_FK
PRINT N'Drop foreign key constraint dbo.PIM_PRACTY_PIM_PACMAC_FK'
GO
ALTER TABLE [dbo].[PIMS_PROP_ACTIVITY_MGMT_ACTIVITY]
	DROP CONSTRAINT IF EXISTS [PIM_PRACTY_PIM_PACMAC_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Drop index dbo.PACMAC_PROP_MGMT_ACTIVITY_TYPE_CODE_IDX
PRINT N'Drop index dbo.PACMAC_PROP_MGMT_ACTIVITY_TYPE_CODE_IDX'
GO
DROP INDEX IF EXISTS [dbo].[PIMS_PROP_ACTIVITY_MGMT_ACTIVITY].[PACMAC_PROP_MGMT_ACTIVITY_TYPE_CODE_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_ACTIVITY]
	ADD [PROP_MGMT_ACTIVITY_TYPE_CODE] nvarchar(20) NOT NULL CONSTRAINT [PRPACT_PROP_MGMT_ACTIVITY_TYPE_CODE_DEF] DEFAULT ('UNKNOWN'), 
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_ACTIVITY_HIST]
	ADD [PROP_MGMT_ACTIVITY_TYPE_CODE] nvarchar(20) NOT NULL DEFAULT 'PROPERTYMGMT', 
	[PROP_MGMT_ACTIVITY_SUBTYPE_CODE] nvarchar(20) NOT NULL DEFAULT 'PROPADMIN'
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
SET @defName = (SELECT obj.NAME
                ...
                WHERE  obj.XTYPE = 'D'
                   ...
                   AND col.NAME = 'PROP_MGMT_ACTIVITY_TYPE_CODE')
