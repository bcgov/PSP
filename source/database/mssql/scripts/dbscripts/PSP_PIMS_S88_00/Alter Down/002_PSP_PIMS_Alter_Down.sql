-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Thu Aug 22 15:39:15 PDT 2024
...
-- Drop foreign key constraint dbo.PIM_PRODCT_PIM_LEASE_FK
PRINT N'Drop foreign key constraint dbo.PIM_PRODCT_PIM_LEASE_FK'
GO
ALTER TABLE [dbo].[PIMS_LEASE]
	DROP CONSTRAINT IF EXISTS [PIM_PRODCT_PIM_LEASE_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop index dbo.LEASE_PRODUCT_ID_IDX
PRINT N'Drop index dbo.LEASE_PRODUCT_ID_IDX'
GO
DROP INDEX IF EXISTS [dbo].[PIMS_LEASE].[LEASE_PRODUCT_ID_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
