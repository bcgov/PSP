-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Fri Jan 26 13:38:20 GMT-08:00 2024
...
-- Drop foreign key constraint dbo.PIM_DSPPSL_PIM_DSPSAL_FK
PRINT N'Drop foreign key constraint dbo.PIM_DSPPSL_PIM_DSPSAL_FK'
GO
ALTER TABLE [dbo].[PIMS_DISPOSITION_SALE]
	DROP CONSTRAINT IF EXISTS [PIM_DSPPSL_PIM_DSPSAL_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop foreign key constraint dbo.PIM_DSPPAG_PIM_DSPSAL_FK
PRINT N'Drop foreign key constraint dbo.PIM_DSPPAG_PIM_DSPSAL_FK'
GO
ALTER TABLE [dbo].[PIMS_DISPOSITION_SALE]
	DROP CONSTRAINT IF EXISTS [PIM_DSPPAG_PIM_DSPSAL_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop foreign key constraint dbo.PIM_PRODCT_PIM_DISPFL_FK
PRINT N'Drop foreign key constraint dbo.PIM_PRODCT_PIM_DISPFL_FK'
GO
ALTER TABLE [dbo].[PIMS_DISPOSITION_FILE]
	DROP CONSTRAINT IF EXISTS [PIM_PRODCT_PIM_DISPFL_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop foreign key constraint dbo.PIM_PROJCT_PIM_DISPFL_FK
PRINT N'Drop foreign key constraint dbo.PIM_PROJCT_PIM_DISPFL_FK'
GO
ALTER TABLE [dbo].[PIMS_DISPOSITION_FILE]
	DROP CONSTRAINT IF EXISTS [PIM_PROJCT_PIM_DISPFL_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Drop index dbo.DSPSAL_DSP_PURCH_SOLICITOR_ID_IDX
PRINT N'Drop index dbo.DSPSAL_DSP_PURCH_SOLICITOR_ID_IDX'
GO
DROP INDEX IF EXISTS [dbo].[PIMS_DISPOSITION_SALE].[DSPSAL_DSP_PURCH_SOLICITOR_ID_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop index dbo.DSPSAL_DSP_PURCH_AGENT_ID_IDX
PRINT N'Drop index dbo.DSPSAL_DSP_PURCH_AGENT_ID_IDX'
GO
DROP INDEX IF EXISTS [dbo].[PIMS_DISPOSITION_SALE].[DSPSAL_DSP_PURCH_AGENT_ID_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Drop index dbo.DISPFL_PROJECT_ID_IDX
PRINT N'Drop index dbo.DISPFL_PROJECT_ID_IDX'
GO
DROP INDEX IF EXISTS [dbo].[PIMS_DISPOSITION_FILE].[DISPFL_PROJECT_ID_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop index dbo.DISPFL_PRODUCT_ID_IDX
PRINT N'Drop index dbo.DISPFL_PRODUCT_ID_IDX'
GO
DROP INDEX IF EXISTS [dbo].[PIMS_DISPOSITION_FILE].[DISPFL_PRODUCT_ID_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_DISPOSITION_SALE]
	DROP COLUMN IF EXISTS [DSP_PURCH_AGENT_ID], [DSP_PURCH_SOLICITOR_ID]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_DSP_PURCH_AGENT]
	ADD [DISPOSITION_SALE_ID] bigint --NOT NULL
GO
...
SET @defName = (SELECT obj.NAME
                ...
                WHERE  obj.XTYPE = 'D'
                   AND tbl.NAME = 'PIMS_DSP_PURCH_AGENT' 
                   AND col.NAME = 'DISPOSITION_SALE_ID')
SET @sqlQry = 'ALTER TABLE [dbo].[PIMS_DSP_PURCH_AGENT] DROP CONSTRAINT IF EXISTS [' + @defName + ']'
EXEC (@sqlQry)
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
SET @defName = (SELECT obj.NAME
                FROM   SYSOBJECTS obj                          INNER JOIN
                       ...
                       SYSOBJECTS tbl on col.ID = tbl.ID
                WHERE  obj.XTYPE = 'D'
                   AND tbl.NAME = 'PIMS_DSP_PURCH_SOLICITOR' 
                   AND col.NAME = 'DISPOSITION_SALE_ID')
SET @sqlQry = 'ALTER TABLE [dbo].[PIMS_DSP_PURCH_SOLICITOR] DROP CONSTRAINT IF EXISTS [' + @defName + ']'
EXEC (@sqlQry)
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY]
	DROP CONSTRAINT IF EXISTS [PRPRTY_IS_OTHER_INTEREST_DEF]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROPERTY]
	DROP COLUMN IF EXISTS [IS_OTHER_INTEREST]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Create check constraint dbo.PRPRTY_IS_OWNED_OR_DISPOSED_TCC
PRINT N'Create check constraint dbo.PRPRTY_IS_OWNED_OR_DISPOSED_TCC'
GO
ALTER TABLE [dbo].[PIMS_PROPERTY]
	ADD CONSTRAINT [PRPRTY_IS_OWNED_OR_DISPOSED_TCC] CHECK (NOT ([IS_OWNED]=(1) AND [IS_DISPOSED]=(1)))
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
SET @defName = (SELECT obj.NAME
                FROM   SYSOBJECTS obj                          INNER JOIN
                       ...
                       SYSOBJECTS tbl on col.ID = tbl.ID
                WHERE  obj.XTYPE = 'D'
                   AND tbl.NAME = 'PIMS_DSP_PURCH_SOLICITOR_HIST' 
                   AND col.NAME = 'DISPOSITION_SALE_ID')
SET @sqlQry = 'ALTER TABLE [dbo].[PIMS_DSP_PURCH_SOLICITOR_HIST] DROP CONSTRAINT IF EXISTS [' + @defName + ']'
EXEC (@sqlQry)
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
SET @defName = (SELECT obj.NAME
                FROM   SYSOBJECTS obj                          INNER JOIN
                       ...
                       SYSOBJECTS tbl on col.ID = tbl.ID
                WHERE  obj.XTYPE = 'D'
                   AND tbl.NAME = 'PIMS_DSP_PURCH_AGENT_HIST' 
                   AND col.NAME = 'DISPOSITION_SALE_ID')
SET @sqlQry = 'ALTER TABLE [dbo].[PIMS_DSP_PURCH_AGENT_HIST] DROP CONSTRAINT IF EXISTS [' + @defName + ']'
EXEC (@sqlQry)
IF @@ERROR <> 0 SET NOEXEC ON
GO
