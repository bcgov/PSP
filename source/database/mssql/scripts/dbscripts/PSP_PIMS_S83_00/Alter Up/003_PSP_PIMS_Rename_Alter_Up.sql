...
--GO
--exec sp_rename 'dbo.PIMS_LEASE_PERIOD_HIST._LEASE_TERM_HIST_ID', '_LEASE_PERIOD_HIST_ID', 'INDEX';
--GO
--IF @@ERROR <> 0 SET NOEXEC ON
--GO
--
---- Drop default constraint dbo.LSTERM_L​EASE_TER​M_ID_DEF​
--PRINT N'Drop foreign key constraint dbo.LSTERM_L​EASE_TER​M_ID_DEF​'
--GO
--ALTER TABLE [dbo].[PIMS_LEASE_PERIOD]
--	DROP CONSTRAINT IF EXISTS [LSTERM_L​EASE_TER​M_ID_DEF​]
--GO
--IF @@ERROR <> 0 SET NOEXEC ON
--GO
--
---- Create default constraint dbo.LSTERM_L​EASE_PERIOD_ID_DEF​
--PRINT N'Create default constraint dbo.LSTERM_L​EASE_PERIOD_ID_DEF​'
--GO
--ALTER TABLE [dbo].[PIMS_LEASE_PERIOD]
--	ADD CONSTRAINT [LSTERM_L​EASE_PERIOD_ID_DEF​]
--    DEFAULT (NEXT VALUE FOR [PIMS_LEASE_TERM_ID_SEQ]),
--GO
--IF @@ERROR <> 0 SET NOEXEC ON
--GO
--
...
--                   AND col.NAME = ' _LEA​SE_PERIO​D_HIST_I​D')
...
--GO
--
---- Create default constraint for dbo.PIMS_LEASE_PERIOD_HIST._LEA​SE_PERIO​D_HIST_I​D
--PRINT N'Create default constraint dbo.PIMS_LEASE_PERIOD_HIST._LEA​SE_PERIO​D_HIST_I​D'
--GO
--ALTER TABLE [dbo].[PIMS_LEASE_PERIOD_HIST]
--	ADD CONSTRAINT  DEFAULT (NEXT VALUE FOR [PI​MS_LEASE​_TERM_H_​ID_SEQ]),
--GO
--IF @@ERROR <> 0 SET NOEXEC ON
--GO
