-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Mon Nov 10 18:34:52 PST 2025
...
-- Drop foreign key constraint dbo.PIM_PRPRTY_PIM_PIMPRV_FK
PRINT N'Drop foreign key constraint dbo.PIM_PRPRTY_PIM_PIMPRV_FK'
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_IMPROVEMENT]
	DROP CONSTRAINT IF EXISTS [PIM_PRPRTY_PIM_PIMPRV_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Drop index dbo.PIMPRV_PROPERTY_ID_IDX
PRINT N'Drop index dbo.PIMPRV_PROPERTY_ID_IDX'
GO
DROP INDEX IF EXISTS [dbo].[PIMS_PROPERTY_IMPROVEMENT].[PIMPRV_PROPERTY_ID_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
ALTER TABLE [dbo].[PIMS_RESEARCH_FILE_HIST]
	DROP CONSTRAINT IF EXISTS [PIMS_RESRCH_H_UK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DELETE FROM [dbo].[PIMS_PROPERTY_IMPROVEMENT]
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_IMPROVEMENT]
	ADD [LEASE_ID] bigint NOT NULL DEFAULT (-1)
GO
...
GO
ALTER TABLE [dbo].[PIMS_RESEARCH_FILE_HIST] ALTER COLUMN [REQUEST_DESCRIPTION] nvarchar(3000) NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_RESEARCH_FILE_HIST] ALTER COLUMN [RESEARCH_RESULT] nvarchar(2000) NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_SECURITY_DEPOSIT_HIST] ALTER COLUMN [AMOUNT_PAID] money NOT NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_SECURITY_DEPOSIT] ALTER COLUMN [AMOUNT_PAID] money NOT NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
