...
DELETE FROM [dbo].[PIMS_CLAIM] WHERE CLAIM_ID = @acqCompRequisitionView;
DELETE FROM [dbo].[PIMS_CLAIM] WHERE CLAIM_ID = @acqCompRequisitionEdit;
DELETE FROM [dbo].[PIMS_CLAIM] WHERE CLAIM_ID = @acqCompRequisitionAdd;
DELETE FROM [dbo].[PIMS_CLAIM] WHERE CLAIM_ID = @acqCompRequisitionDelete;
