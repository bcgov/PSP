...
Doug Filteau  2025-Jul-17  PIMS_PROP_MGMT_ACTIVITY_SUBTYPE table renamed to 
                           PIMS_MGMT_ACTIVITY_SUBTYPE.
----------------------------------------------------------------------------- */

DELETE FROM PIMS_MGMT_ACTIVITY_SUBTYPE
GO

INSERT INTO PIMS_MGMT_ACTIVITY_SUBTYPE (MGMT_ACTIVITY_TYPE_CODE, MGMT_ACTIVITY_SUBTYPE_CODE, DESCRIPTION)
VALUES
...
-- --------------------------------------------------------------
INSERT INTO PIMS_MGMT_ACTIVITY_SUBTYPE (MGMT_ACTIVITY_TYPE_CODE, MGMT_ACTIVITY_SUBTYPE_CODE, DESCRIPTION, IS_DISABLED)
VALUES
...
FROM   PIMS_MGMT_ACTIVITY_SUBTYPE pmas JOIN
       (SELECT MGMT_ACTIVITY_SUBTYPE_CODE
             , ROW_NUMBER() OVER (ORDER BY DESCRIPTION) AS ROW_NUM
        FROM   PIMS_MGMT_ACTIVITY_SUBTYPE) seq  ON seq.MGMT_ACTIVITY_SUBTYPE_CODE = pmas.MGMT_ACTIVITY_SUBTYPE_CODE
GO
