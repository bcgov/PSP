-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Thu Sep 29 11:01:41 PDT 2022
...
GO
ALTER TABLE [dbo].[PIMS_ACQUISITION_FILE]
	DROP COLUMN IF EXISTS [PAIMS_ACQUISITION_FILE_ID]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
