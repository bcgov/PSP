-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Wed Aug 02 21:44:06 PDT 2023
...
PRINT N'Create sequence dbo.PIMS_EXPROPRIATION_PAYMENT_ID_SEQ'
GO
CREATE SEQUENCE [dbo].[PIMS_EXPROPRIATION_PAYMENT_ID_SEQ]
	AS bigint
	START WITH 1
...
GO
ALTER TABLE [dbo].[PIMS_ACQUISITION_FILE]
	ADD [LEGACY_STAKEHOLDER] nvarchar(4000) NULL, 
	[ALTERNATE_PROJECT] bigint NULL
GO
...
PRINT N'Create table dbo.PIMS_EXPROPRIATION_PAYMENT'
GO
CREATE TABLE [dbo].[PIMS_EXPROPRIATION_PAYMENT]  ( 
...
PRINT N'Create sequence dbo.PIMS_COMP_REQ_FINANCIAL_ID_SEQ'
GO
CREATE SEQUENCE [dbo].[PIMS_COMP_REQ_FINANCIAL_ID_SEQ]
	AS bigint
	START WITH 1
...
PRINT N'Create table dbo.PIMS_COMP_REQ_FINANCIAL'
GO
CREATE TABLE [dbo].[PIMS_COMP_REQ_FINANCIAL]  ( 
...
PRINT N'Create sequence dbo.PIMS_EXPROP_PMT_PMT_ITEM_ID_SEQ'
GO
CREATE SEQUENCE [dbo].[PIMS_EXPROP_PMT_PMT_ITEM_ID_SEQ]
	AS bigint
	START WITH 1
...
PRINT N'Create table dbo.PIMS_EXPROP_PMT_PMT_ITEM'
GO
CREATE TABLE [dbo].[PIMS_EXPROP_PMT_PMT_ITEM]  ( 
	...
	[CONCURRENCY_CONTROL_NUMBER]    	bigint NOT NULL CONSTRAINT [XPMTITY_CONCURRENCY_CONTROL_NUMBER_DEF]  DEFAULT ((1)),
...
-- Create unique constraint dbo.XPMTITY_EXPROP_PMT_PMT_TYPE_TUC
PRINT N'Create unique constraint dbo.XPMTITY_EXPROP_PMT_PMT_TYPE_TUC'
GO
...
PRINT N'Create sequence dbo.PIMS_COMP_REQ_FINANCIAL_H_ID_SEQ'
GO
CREATE SEQUENCE [dbo].[PIMS_COMP_REQ_FINANCIAL_H_ID_SEQ]
	AS bigint
	START WITH 1
...
PRINT N'Create table dbo.PIMS_COMP_REQ_FINANCIAL_HIST'
GO
CREATE TABLE [dbo].[PIMS_COMP_REQ_FINANCIAL_HIST]  ( 
...
-- Create unique constraint dbo.PIMS_CRQFIN_H_UK
PRINT N'Create unique constraint dbo.PIMS_CRQFIN_H_UK'
GO
...
PRINT N'Create sequence dbo.PIMS_EXPROP_PMT_PMT_ITEM_H_ID_SEQ'
GO
CREATE SEQUENCE [dbo].[PIMS_EXPROP_PMT_PMT_ITEM_H_ID_SEQ]
	AS bigint
	START WITH 1
...
PRINT N'Create table dbo.PIMS_EXPROP_PMT_PMT_ITEM_HIST'
GO
CREATE TABLE [dbo].[PIMS_EXPROP_PMT_PMT_ITEM_HIST]  ( 
...
-- Create unique constraint dbo.PIMS_XPMTIT_H_UK
PRINT N'Create unique constraint dbo.PIMS_XPMTIT_H_UK'
GO
...
PRINT N'Create sequence dbo.PIMS_EXPROPRIATION_PAYMENT_H_ID_SEQ'
GO
CREATE SEQUENCE [dbo].[PIMS_EXPROPRIATION_PAYMENT_H_ID_SEQ]
	AS bigint
	START WITH 1
...
PRINT N'Create table dbo.PIMS_EXPROPRIATION_PAYMENT_HIST'
GO
CREATE TABLE [dbo].[PIMS_EXPROPRIATION_PAYMENT_HIST]  ( 
...
-- Create unique constraint dbo.PIMS_EXPPMT_H_UK
PRINT N'Create unique constraint dbo.PIMS_EXPPMT_H_UK'
GO
...
ALTER TABLE [dbo].[PIMS_INTEREST_HOLDER_HIST] DROP CONSTRAINT IF EXISTS [DF__PIMS_INTE__INTER__613C58EC]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_INTEREST_HOLDER_HIST] ADD DEFAULT N'INTHLD​R' FOR [INTEREST_HOLDER_TYPE_CODE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
-- Create index dbo.EXPPMT_ACQUISITION_FILE_ID_IDX
PRINT N'Create index dbo.EXPPMT_ACQUISITION_FILE_ID_IDX'
GO
...
-- Create index dbo.EXPPMT_ACQUISITION_OWNER_ID_IDX
PRINT N'Create index dbo.EXPPMT_ACQUISITION_OWNER_ID_IDX'
GO
...
-- Create index dbo.EXPPMT_EXPROPRIATING_AUTHORITY_IDX
PRINT N'Create index dbo.EXPPMT_EXPROPRIATING_AUTHORITY_IDX'
GO
...
-- Create index dbo.EXPPMT_INTEREST_HOLDER_ID_IDX
PRINT N'Create index dbo.EXPPMT_INTEREST_HOLDER_ID_IDX'
GO
...
-- Create index dbo.XPMTITY_PAYMENT_ITEM_TYPE_CODE_IDX
PRINT N'Create index dbo.XPMTITY_PAYMENT_ITEM_TYPE_CODE_IDX'
GO
...
-- Create index dbo.XPMTITY_EXPROPRIATION_PAYMENT_ID_IDX
PRINT N'Create index dbo.XPMTITY_EXPROPRIATION_PAYMENT_ID_IDX'
GO
...
-- Create trigger dbo.PIMS_XPMTITY_I_S_I_TR
PRINT N'Create trigger dbo.PIMS_XPMTITY_I_S_I_TR'
GO
...
-- Create trigger dbo.PIMS_CRQFIN_A_S_IUD_TR
PRINT N'Create trigger dbo.PIMS_CRQFIN_A_S_IUD_TR'
GO
...
-- Create trigger dbo.PIMS_XPMTITY_A_S_IUD_TR
PRINT N'Create trigger dbo.PIMS_XPMTITY_A_S_IUD_TR'
GO
...
-- Create trigger dbo.PIMS_CRQFIN_I_S_I_TR
PRINT N'Create trigger dbo.PIMS_CRQFIN_I_S_I_TR'
GO
...
-- Create foreign key constraint dbo.PIM_PMTITM_PIM_XPMTITY_FK
PRINT N'Create foreign key constraint dbo.PIM_PMTITM_PIM_XPMTITY_FK'
GO
ALTER TABLE [dbo].[PIMS_EXPROP_PMT_PMT_ITEM]
...
-- Create foreign key constraint dbo.PIM_EXPPMT_PIM_XPMTITY_FK
PRINT N'Create foreign key constraint dbo.PIM_EXPPMT_PIM_XPMTITY_FK'
GO
ALTER TABLE [dbo].[PIMS_EXPROP_PMT_PMT_ITEM]
