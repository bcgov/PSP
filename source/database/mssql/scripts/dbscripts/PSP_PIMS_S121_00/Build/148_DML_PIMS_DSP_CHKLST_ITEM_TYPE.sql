...
-- Doug Filteau  2024-Jan-10  N/A        Added 'SGNDXFRPPH' checklist item.
-- Doug Filteau  2025-Dec-08  N/A        Added 'UTILCOAPP', 'ADJLOREF', and 'ADCOMPLT' 
--                                       checklist items.
-- Doug Filteau  2025-Dec-08  N/A        Disabled 'STRNTHCLM' checklist item.
-- Doug Filteau  2026-Jan-21  PSP-11131  Edited description of XFRPLNREGD.
-- ---------------------------------------------------------------------------------------
...
VALUES
  ...
  (N'SALEINFO', N'XFRPLNREGD',  N'Transfer/plan/SRW registered with LTSA',            35, N'Property transfer, or update plan ( for road closures) has been registered with the Land Title office.'),
