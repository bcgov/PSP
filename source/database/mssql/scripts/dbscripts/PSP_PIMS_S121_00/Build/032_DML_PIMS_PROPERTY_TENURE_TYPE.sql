...
VALUES
  ...
  (N'TM',        N'Titled Land - MoTT',                    CONVERT([bit],(1))),
  ...
  (N'FSMOTI',    N'Fee Simple - MoTT',                     CONVERT([bit],(0))),
  (N'FSBCTFA',   N'Fee Simple - BCTFA',                    CONVERT([bit],(0))),
  (N'FSPRIVAT',  N'Fee Simple - Private',                  CONVERT([bit],(0))),
  (N'FSCROWN',   N'Fee Simple - Crown (Non-MoTT)',         CONVERT([bit],(0))),
  (N'NSRWMOTI',  N'Non-SRW Interests - MoTT',              CONVERT([bit],(0))),
  (N'NSRWBCTFA', N'Non-SRW Interests - BCTFA',             CONVERT([bit],(0))),
  (N'SRWMOTI',   N'Statutory Right of Way (SRW) - MoTT',   CONVERT([bit],(0))),
