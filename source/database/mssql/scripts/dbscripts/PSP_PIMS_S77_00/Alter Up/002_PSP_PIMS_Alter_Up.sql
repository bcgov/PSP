-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Fri Apr 05 14:31:57 PDT 2024
...
GO
ALTER TABLE [dbo].[PIMS_TAKE]
	ADD [ACTIVE_LEASE_AREA] real NULL, 
...
ALTER TABLE [dbo].[PIMS_TAKE_HIST]
	...
	[ACTIVE_LEASE_END_DT] date NULL, 
	[COMPLETION_DT] date NULL, 
	[IS_ACTIVE_LEASE] bit NOT NULL DEFAULT (CONVERT([bit],(0)))
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
     ...
     , IIF(EXISTS (SELECT 1                        
                   FROM   PIMS_PROPERTY_ACQUISITION_FILE PRAF JOIN
                          PIMS_ACQUISITION_FILE          ACQF   ON ACQF.ACQUISITION_FILE_ID = PRAF.ACQUISITION_FILE_ID
                                                               AND PRAF.PROPERTY_ID         = PROP.PROPERTY_ID
                   WHERE  ACQF.ACQUISITION_FILE_STATUS_TYPE_CODE IN (N'DRAFT', N'COMPLT')), CONVERT([bit],(1)), CONVERT([bit],(0))) AS HAS_ACTIVE_ACQUISITION_FILE
     , IIF(EXISTS (SELECT 1
