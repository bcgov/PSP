-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Wed Apr 03 12:01:36 PDT 2024
...
GO
UPDATE [dbo].[PIMS_PROPERTY_HIST] SET [IS_DISPOSED] = CONVERT([bit],(0)) WHERE [IS_DISPOSED] IS NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_HIST] ALTER COLUMN [IS_DISPOSED] bit NOT NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_HIST] ADD DEFAULT CONVERT([bit],(0)) FOR [IS_DISPOSED]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
UPDATE [dbo].[PIMS_PROPERTY_HIST] SET [IS_OTHER_INTEREST] = CONVERT([bit],(0)) WHERE [IS_OTHER_INTEREST] IS NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_HIST] ALTER COLUMN [IS_OTHER_INTEREST] bit NOT NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_HIST] ADD DEFAULT CONVERT([bit],(0)) FOR [IS_OTHER_INTEREST]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
UPDATE [dbo].[PIMS_PROPERTY_HIST] SET [IS_PROPERTY_OF_INTEREST] = CONVERT([bit],(0)) WHERE [IS_PROPERTY_OF_INTEREST] IS NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_HIST] ALTER COLUMN [IS_PROPERTY_OF_INTEREST] bit NOT NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_HIST] ADD DEFAULT CONVERT([bit],(0)) FOR [IS_PROPERTY_OF_INTEREST]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_TAKE]
	DROP COLUMN IF EXISTS [COMPLETION_DT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
