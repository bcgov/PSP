-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Tue Jan 16 12:52:12 GMT-08:00 2024
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_HIST]
	ADD [IS_DISPOSED] bit NOT NULL DEFAULT CONVERT([bit],(0))
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
