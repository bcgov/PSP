-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Tue Jan 16 12:58:06 GMT-08:00 2024
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY]
	DROP COLUMN IF EXISTS [IS_DISPOSED]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
