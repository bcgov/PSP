...
-- ------------------------------------------------------------------
-- Insert or enable the NOTAPP in the PIMS_LEASE_CHECKLIST_ITEM table
-- ------------------------------------------------------------------
...
-- ----------------------------------------------------------------
-- Update the PIMS_LEASE_CHECKLIST_ITEMs that reference the NA code
-- ----------------------------------------------------------------
UPDATE PIMS_LEASE_CHECKLIST_ITEM
SET    LEASE_CHKLST_ITEM_STATUS_TYPE_CODE = N'NOTAPP'
     , CONCURRENCY_CONTROL_NUMBER         = CONCURRENCY_CONTROL_NUMBER + 1
...
-- ----------------------------------------------------------
-- Disable the NA code in the PIMS_LEASE_CHECKLIST_ITEM table
-- ----------------------------------------------------------
UPDATE PIMS_LEASE_CHKLST_ITEM_STATUS_TYPE
SET    IS_DISABLED                = 1
     , CONCURRENCY_CONTROL_NUMBER = CONCURRENCY_CONTROL_NUMBER + 1
