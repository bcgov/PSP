...
-- Migrate the PIMS_PROP_MGMT_ACTIVITY_TYPE data to the TMP_PROP_MGMT_ACTIVITY_TYPE table
PRINT N'Migrate the PIMS_PROP_MGMT_ACTIVITY_TYPE data to the TMP_PROP_MGMT_ACTIVITY_TYPE table'
GO
INSERT INTO dbo.TMP_PROP_MGMT_ACTIVITY_TYPE (PROP_MGMT_ACTIVITY_TYPE_CODE, DESCRIPTION, IS_DISABLED, DISPLAY_ORDER, CONCURRENCY_CONTROL_NUMBER, DB_CREATE_TIMESTAMP, DB_CREATE_USERID, DB_LAST_UPDATE_TIMESTAMP, DB_LAST_UPDATE_USERID)
  ...
  FROM   dbo.PIMS_PROP_MGMT_ACTIVITY_TYPE
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
