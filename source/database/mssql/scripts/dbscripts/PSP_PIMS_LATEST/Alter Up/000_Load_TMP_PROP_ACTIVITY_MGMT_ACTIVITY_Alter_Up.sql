...
-- Migrate the PIMS_PROP_ACTIVITY_MGMT_ACTIVITY data to the TMP_PROP_ACTIVITY_MGMT_ACTIVITY table
PRINT N'Migrate the PIMS_PROPERTY_ACTIVITY data to the TMP_PROP_ACTIVITY_MGMT_ACTIVITY table'
GO
