-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Mon Nov 18 12:48:02 PST 2024
...
GO
ALTER TABLE [dbo].[PIMS_ACQUISITION_FILE]
	DROP CONSTRAINT IF EXISTS [ACQNFL_FILE_NUMBER_DEF]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_ACQUISITION_FILE]
	ADD [FILE_NUM_SUFFIX] nvarchar(2) NOT NULL CONSTRAINT [ACQNFL_FILE_NUM_SUFFIX_DEF] DEFAULT ('00')
GO
...
GO
ALTER TABLE [dbo].[PIMS_DOCUMENT_QUEUE]
	ADD [FILE_NAME] nvarchar(500) NOT NULL DEFAULT 9999999
GO
EXEC sp_addextendedproperty 
...
GO
ALTER TABLE [dbo].[PIMS_ACQUISITION_FILE_HIST]
	ADD [FILE_NUM_SUFFIX] nvarchar(2) NOT NULL DEFAULT '00'
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
