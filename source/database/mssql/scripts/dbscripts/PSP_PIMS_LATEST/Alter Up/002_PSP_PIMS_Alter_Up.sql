-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Mon Aug 12 16:08:45 PDT 2024
...
GO
DROP TRIGGER IF EXISTS [dbo].[PIMS_PRPCLT_I_S_U_TR]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP TRIGGER IF EXISTS [dbo].[PIMS_PRPCLT_I_S_I_TR]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Drop primary key constraint dbo.PRPCLT_PK
PRINT N'Drop primary key constraint dbo.PRPCLT_PK'
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_CLASSIFICATION_TYPE]
	DROP CONSTRAINT IF EXISTS [PRPCLT_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_LEASE_STAKEHOLDER_COMP_REQ]
	DROP CONSTRAINT IF EXISTS [LSKCRQ_IS_DISABLED_DEF]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_LEASE_STAKEHOLDER_COMP_REQ]
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY]
	DROP CONSTRAINT IF EXISTS [PRPRTY_PROPERTY_CLASSIFICATION_TYPE_CODE_DEF]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROPERTY]
	DROP CONSTRAINT IF EXISTS [PRPRTY_IS_VISIBLE_TO_OTHER_AGENCIES_DEF]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROPERTY]
	DROP CONSTRAINT IF EXISTS [PRPRTY_IS_SENSITIVE_DEF]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROPERTY]
	DROP COLUMN IF EXISTS [PROPERTY_CLASSIFICATION_TYPE_CODE], [NAME], [DESCRIPTION], [ENCUMBRANCE_REASON], [IS_VISIBLE_TO_OTHER_AGENCIES], [IS_SENSITIVE], [IS_PROVINCIAL_PUBLIC_HWY], [ZONING], [ZONING_POTENTIAL]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_HIST] ALTER COLUMN [PROPERTY_CLASSIFICATION_TYPE_CODE] nvarchar(20) NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_HIST] ALTER COLUMN [IS_VISIBLE_TO_OTHER_AGENCIES] bit NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_HIST] ALTER COLUMN [IS_SENSITIVE] bit NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_PROP_LEASE_COMP_REQ]
	DROP CONSTRAINT IF EXISTS [PLCMRQ_IS_DISABLED_DEF]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROP_LEASE_COMP_REQ]
...
-- Create index dbo.LESCON_PERSON_ID_IDX
PRINT N'Create index dbo.LESCON_PERSON_ID_IDX'
GO
...
-- Create index dbo.LESCON_PRIMARY_CONTACT_ID_IDX
PRINT N'Create index dbo.LESCON_PRIMARY_CONTACT_ID_IDX'
GO
...
-- Create index dbo.LESCON_ORGANIZATION_ID_IDX
PRINT N'Create index dbo.LESCON_ORGANIZATION_ID_IDX'
GO
...
-- Create foreign key constraint dbo.PIM_ORG_PIM_LESCON_FK
PRINT N'Create foreign key constraint dbo.PIM_ORG_PIM_LESCON_FK'
GO
ALTER TABLE [dbo].[PIMS_LEASE_CONSULTATION]
...
-- Create foreign key constraint dbo.PIM_PERSON_PIM_LESCON_ORGCON_FK
PRINT N'Create foreign key constraint dbo.PIM_PERSON_PIM_LESCON_ORGCON_FK'
GO
ALTER TABLE [dbo].[PIMS_LEASE_CONSULTATION]
...
-- Create foreign key constraint dbo.PIM_PERSON_PIM_LESCON_FK
PRINT N'Create foreign key constraint dbo.PIM_PERSON_PIM_LESCON_FK'
GO
ALTER TABLE [dbo].[PIMS_LEASE_CONSULTATION]
...
PRINT N'Drop table dbo.PIMS_PROPERTY_CLASSIFICATION_TYPE'
GO
DROP TABLE IF EXISTS [dbo].[PIMS_PROPERTY_CLASSIFICATION_TYPE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
