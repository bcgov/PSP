/*******************************************************************************
Obtain the current value for the PIMS_ACQUISITION_FILE_TEAM_ID_SEQ sequence to 
apply to the PIMS_ACQUISITION_FILE_PERSON_ID_SEQ sequence pre-Alter_Down.
. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
Author        Date         Comment
------------  -----------  -----------------------------------------------------
...
INSERT INTO [dbo].[TMP_ACQUISITION_FILE_SEQ_VAL] (SEQ_VAL)
  ...
  FROM   SYS.SEQUENCES
  WHERE  NAME = 'PIMS_ACQUISITION_FILE_TEAM_ID_SEQ'
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
