/* -----------------------------------------------------------------------------
Create and populate the temporary TMP_PROP_ACT_INVOLVED_PARTY table.
. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
Author        Date         Comment
------------  -----------  -----------------------------------------------------
...
GO
  CREATE TABLE dbo.TMP_PROP_ACT_INVOLVED_PARTY (
...
-- Migrate the PIMS_MGMT_ACT_INVOLVED_PARTY data to the TMP_PROP_ACT_INVOLVED_PARTY table
PRINT N'Migrate the PIMS_MGMT_ACT_INVOLVED_PARTY data to the TMP_PROP_ACT_INVOLVED_PARTY table'
GO
INSERT INTO dbo.TMP_PROP_ACT_INVOLVED_PARTY (PROP_ACT_INVOLVED_PARTY_ID, PIMS_MANAGEMENT_ACTIVITY_ID, PERSON_ID, ORGANIZATION_ID, CONCURRENCY_CONTROL_NUMBER, APP_CREATE_TIMESTAMP, APP_CREATE_USERID, APP_CREATE_USER_GUID, APP_CREATE_USER_DIRECTORY, APP_LAST_UPDATE_TIMESTAMP, APP_LAST_UPDATE_USERID, APP_LAST_UPDATE_USER_GUID, APP_LAST_UPDATE_USER_DIRECTORY, DB_CREATE_TIMESTAMP, DB_CREATE_USERID, DB_LAST_UPDATE_TIMESTAMP, DB_LAST_UPDATE_USERID)
  SELECT MGMT_ACT_INVOLVED_PARTY_ID
