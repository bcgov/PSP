-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Tue May 07 09:49:17 PDT 2024
...
-- Drop foreign key constraint dbo.PIM_PRPRTY_PIM_HFLNUM_FK
PRINT N'Drop foreign key constraint dbo.PIM_PRPRTY_PIM_HFLNUM_FK'
GO
ALTER TABLE [dbo].[PIMS_HISTORICAL_FILE_NUMBER]
	DROP CONSTRAINT IF EXISTS [PIM_PRPRTY_PIM_HFLNUM_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop foreign key constraint dbo.PIM_HFLNMT_PIM_HFLNUM_FK
PRINT N'Drop foreign key constraint dbo.PIM_HFLNMT_PIM_HFLNUM_FK'
GO
ALTER TABLE [dbo].[PIMS_HISTORICAL_FILE_NUMBER]
	DROP CONSTRAINT IF EXISTS [PIM_HFLNMT_PIM_HFLNUM_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop foreign key constraint dbo.PIM_PIDSRT_PIM_HFLNUM_FK
PRINT N'Drop foreign key constraint dbo.PIM_PIDSRT_PIM_HFLNUM_FK'
GO
ALTER TABLE [dbo].[PIMS_HISTORICAL_FILE_NUMBER]
	DROP CONSTRAINT IF EXISTS [PIM_PIDSRT_PIM_HFLNUM_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Drop trigger dbo.PIMS_HFLNUM_I_S_I_TR
PRINT N'Drop trigger dbo.PIMS_HFLNUM_I_S_I_TR'
GO
DROP TRIGGER IF EXISTS [dbo].[PIMS_HFLNUM_I_S_I_TR]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop trigger dbo.PIMS_HFLNUM_A_S_IUD_TR
PRINT N'Drop trigger dbo.PIMS_HFLNUM_A_S_IUD_TR'
GO
DROP TRIGGER IF EXISTS [dbo].[PIMS_HFLNUM_A_S_IUD_TR]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop index dbo.HFLNUM_PROPERTY_ID_IDX
PRINT N'Drop index dbo.HFLNUM_PROPERTY_ID_IDX'
GO
DROP INDEX IF EXISTS [dbo].[PIMS_HISTORICAL_FILE_NUMBER].[HFLNUM_PROPERTY_ID_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop index dbo.HFLNUM_HISTORICAL_FILE_NUMBER_IDX
PRINT N'Drop index dbo.HFLNUM_HISTORICAL_FILE_NUMBER_IDX'
GO
DROP INDEX IF EXISTS [dbo].[PIMS_HISTORICAL_FILE_NUMBER].[HFLNUM_HISTORICAL_FILE_NUMBER_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop index dbo.HFLNUM_DATA_SOURCE_TYPE_CODE_IDX
PRINT N'Drop index dbo.HFLNUM_DATA_SOURCE_TYPE_CODE_IDX'
GO
DROP INDEX IF EXISTS [dbo].[PIMS_HISTORICAL_FILE_NUMBER].[HFLNUM_DATA_SOURCE_TYPE_CODE_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Drop trigger dbo.PIMS_HFLNMT_I_S_I_TR
PRINT N'Drop trigger dbo.PIMS_HFLNMT_I_S_I_TR'
GO
DROP TRIGGER IF EXISTS [dbo].[PIMS_HFLNMT_I_S_I_TR]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
PRINT N'Drop view dbo.PIMS_HISTORICAL_FILE_NUMBER_VW'
GO
...
-- Drop unique constraint dbo.PIMS_HFLNUM_H_UK
PRINT N'Drop unique constraint dbo.PIMS_HFLNUM_H_UK'
GO
ALTER TABLE [dbo].[PIMS_HISTORICAL_FILE_NUMBER_HIST]
	DROP CONSTRAINT IF EXISTS [PIMS_HFLNUM_H_UK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop primary key constraint dbo.PIMS_HFLNUM_H_PK
PRINT N'Drop primary key constraint dbo.PIMS_HFLNUM_H_PK'
GO
ALTER TABLE [dbo].[PIMS_HISTORICAL_FILE_NUMBER_HIST]
	DROP CONSTRAINT IF EXISTS [PIMS_HFLNUM_H_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop primary key constraint dbo.HFLNUM_PK
PRINT N'Drop primary key constraint dbo.HFLNUM_PK'
GO
ALTER TABLE [dbo].[PIMS_HISTORICAL_FILE_NUMBER]
	DROP CONSTRAINT IF EXISTS [HFLNUM_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop table dbo.PIMS_HISTORICAL_FILE_NUMBER
PRINT N'Drop table dbo.PIMS_HISTORICAL_FILE_NUMBER'
GO
DROP TABLE IF EXISTS [dbo].[PIMS_HISTORICAL_FILE_NUMBER]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop primary key constraint dbo.HFLNMT_PK
PRINT N'Drop primary key constraint dbo.HFLNMT_PK'
GO
ALTER TABLE [dbo].[PIMS_HISTORICAL_FILE_NUMBER_TYPE]
	DROP CONSTRAINT IF EXISTS [HFLNMT_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_LEASE]
	DROP COLUMN IF EXISTS [CANCELLATION_REASON], [TERMINATION_REASON]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Drop table dbo.PIMS_HISTORICAL_FILE_NUMBER_HIST
PRINT N'Drop table dbo.PIMS_HISTORICAL_FILE_NUMBER_HIST'
GO
DROP TABLE IF EXISTS [dbo].[PIMS_HISTORICAL_FILE_NUMBER_HIST]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop sequence dbo.PIMS_HISTORICAL_FILE_NUMBER_H_ID_SEQ
PRINT N'Drop sequence dbo.PIMS_HISTORICAL_FILE_NUMBER_H_ID_SEQ'
GO
DROP SEQUENCE IF EXISTS [dbo].[PIMS_HISTORICAL_FILE_NUMBER_H_ID_SEQ]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop table dbo.PIMS_HISTORICAL_FILE_NUMBER_TYPE
PRINT N'Drop table dbo.PIMS_HISTORICAL_FILE_NUMBER_TYPE'
GO
DROP TABLE IF EXISTS [dbo].[PIMS_HISTORICAL_FILE_NUMBER_TYPE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop sequence dbo.PIMS_HISTORICAL_FILE_NUMBER_ID_SEQ
PRINT N'Drop sequence dbo.PIMS_HISTORICAL_FILE_NUMBER_ID_SEQ'
GO
DROP SEQUENCE IF EXISTS [dbo].[PIMS_HISTORICAL_FILE_NUMBER_ID_SEQ]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
