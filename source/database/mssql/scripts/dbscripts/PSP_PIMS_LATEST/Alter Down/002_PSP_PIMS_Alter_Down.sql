-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Mon Dec 23 11:40:47 PST 2024
...
-- Drop trigger dbo.PIMS_PROJTM_I_S_U_TR
PRINT N'Drop trigger dbo.PIMS_PROJTM_I_S_U_TR'
GO
DROP TRIGGER IF EXISTS [dbo].[PIMS_PROJTM_I_S_U_TR]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop trigger dbo.PIMS_PROJTM_I_S_I_TR
PRINT N'Drop trigger dbo.PIMS_PROJTM_I_S_I_TR'
GO
DROP TRIGGER IF EXISTS [dbo].[PIMS_PROJTM_I_S_I_TR]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop trigger dbo.PIMS_PROJTM_A_S_IUD_TR
PRINT N'Drop trigger dbo.PIMS_PROJTM_A_S_IUD_TR'
GO
DROP TRIGGER IF EXISTS [dbo].[PIMS_PROJTM_A_S_IUD_TR]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop foreign key constraint dbo.PIM_PROJCT_PIM_PROJTM_FK
PRINT N'Drop foreign key constraint dbo.PIM_PROJCT_PIM_PROJTM_FK'
GO
ALTER TABLE [dbo].[PIMS_PROJECT_TEAM]
	DROP CONSTRAINT IF EXISTS [PIM_PROJCT_PIM_PROJTM_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop foreign key constraint dbo.PIM_PERSON_PIM_PROJTM_FK
PRINT N'Drop foreign key constraint dbo.PIM_PERSON_PIM_PROJTM_FK'
GO
ALTER TABLE [dbo].[PIMS_PROJECT_TEAM]
	DROP CONSTRAINT IF EXISTS [PIM_PERSON_PIM_PROJTM_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Drop index dbo.PROJTM_PROJECT_ID_IDX
PRINT N'Drop index dbo.PROJTM_PROJECT_ID_IDX'
GO
DROP INDEX IF EXISTS [dbo].[PIMS_PROJECT_TEAM].[PROJTM_PROJECT_ID_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop index dbo.PROJTM_PERSON_ID_IDX
PRINT N'Drop index dbo.PROJTM_PERSON_ID_IDX'
GO
DROP INDEX IF EXISTS [dbo].[PIMS_PROJECT_TEAM].[PROJTM_PERSON_ID_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Drop primary key constraint dbo.PROJTM_PK
PRINT N'Drop primary key constraint dbo.PROJTM_PK'
GO
ALTER TABLE [dbo].[PIMS_PROJECT_TEAM]
	DROP CONSTRAINT IF EXISTS [PROJTM_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop table dbo.PIMS_PROJECT_TEAM
PRINT N'Drop table dbo.PIMS_PROJECT_TEAM'
GO
DROP TABLE IF EXISTS [dbo].[PIMS_PROJECT_TEAM]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop unique constraint dbo.PIMS_PROJTM_H_UK
PRINT N'Drop unique constraint dbo.PIMS_PROJTM_H_UK'
GO
ALTER TABLE [dbo].[PIMS_PROJECT_TEAM_HIST]
	DROP CONSTRAINT IF EXISTS [PIMS_PROJTM_H_UK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop primary key constraint dbo.PIMS_PROJTM_H_PK
PRINT N'Drop primary key constraint dbo.PIMS_PROJTM_H_PK'
GO
ALTER TABLE [dbo].[PIMS_PROJECT_TEAM_HIST]
	DROP CONSTRAINT IF EXISTS [PIMS_PROJTM_H_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Drop table dbo.PIMS_PROJECT_TEAM_HIST
PRINT N'Drop table dbo.PIMS_PROJECT_TEAM_HIST'
GO
DROP TABLE IF EXISTS [dbo].[PIMS_PROJECT_TEAM_HIST]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop sequence dbo.PIMS_PROJECT_TEAM_H_ID_SEQ
PRINT N'Drop sequence dbo.PIMS_PROJECT_TEAM_H_ID_SEQ'
GO
DROP SEQUENCE IF EXISTS [dbo].[PIMS_PROJECT_TEAM_H_ID_SEQ]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
