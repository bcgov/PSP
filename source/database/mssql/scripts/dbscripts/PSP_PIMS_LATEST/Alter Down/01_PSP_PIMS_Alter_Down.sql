...
GO
UPDATE [dbo].[PIMS_PROJECT_HIST] SET [PROJECT_STATUS_TYPE_CODE] = 'AC', CONCURRENCY_CONTROL_NUMBER = CONCURRENCY_CONTROL_NUMBER + 1 WHERE [PROJECT_STATUS_TYPE_CODE] IS NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
