-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Tue Dec 20 12:25:28 PST 2022
...
-- Drop index dbo.ACQNFL_LEGACY_FILE_NUMBER_IDX
PRINT N'Drop index dbo.ACQNFL_LEGACY_FILE_NUMBER_IDX'
GO
DROP INDEX IF EXISTS [dbo].[PIMS_ACQUISITION_FILE].[ACQNFL_LEGACY_FILE_NUMBER_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_ACQUISITION_FILE]
	DROP COLUMN IF EXISTS [LEGACY_FILE_NUMBER]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
