...
-- Create foreign key constraint dbo.PIM_PRACTY_PIM_MGMTAC_FK
PRINT N'Create foreign key constraint dbo.PIM_PRACTY_PIM_MGMTAC_FK'
GO
ALTER TABLE [dbo].[PIMS_MANAGEMENT_ACTIVITY]
	ADD CONSTRAINT [PIM_PRACTY_PIM_MGMTAC_FK]
