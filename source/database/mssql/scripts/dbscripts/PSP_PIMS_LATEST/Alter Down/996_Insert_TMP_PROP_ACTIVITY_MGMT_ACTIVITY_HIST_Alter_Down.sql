...
-- Migrate the TMP_PROP_ACTIVITY_MGMT_ACTIVITY_HIST data to the PIMS_PROP_ACTIVITY_MGMT_ACTIVITY_HIST table
PRINT N'Migrate the TMP_PROP_ACTIVITY_MGMT_ACTIVITY_HIST data to the PIMS_PROP_ACTIVITY_MGMT_ACTIVITY_HIST table'
GO
INSERT INTO dbo.PIMS_PROP_ACTIVITY_MGMT_ACTIVITY_HIST (_PROP_ACTIVITY_MGMT_ACTIVITY_HIST_ID, EFFECTIVE_DATE_HIST, END_DATE_HIST, PROP_ACTVTY_MGMT_ACTVTY_TYP_ID, PIMS_MANAGEMENT_ACTIVITY_ID, PROP_MGMT_ACTIVITY_SUBTYPE_CODE, CONCURRENCY_CONTROL_NUMBER, APP_CREATE_TIMESTAMP, APP_CREATE_USERID, APP_CREATE_USER_GUID, APP_CREATE_USER_DIRECTORY, APP_LAST_UPDATE_TIMESTAMP, APP_LAST_UPDATE_USERID, APP_LAST_UPDATE_USER_GUID, APP_LAST_UPDATE_USER_DIRECTORY, DB_CREATE_TIMESTAMP, DB_CREATE_USERID, DB_LAST_UPDATE_TIMESTAMP, DB_LAST_UPDATE_USERID)
