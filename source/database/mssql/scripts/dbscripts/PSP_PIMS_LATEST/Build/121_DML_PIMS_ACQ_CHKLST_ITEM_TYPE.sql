...
VALUES
  ...
  (N'FILEMGMT',  N'LEGALDOCS',   N'Instructions or documents sent to lawyer',                 14, getutcdate(), ''),
  (N'FILEMGMT',  N'OWNERCOMP',   N'Copy of owners'' compensation cheque(s)',                  15, getutcdate(), ''),
  (N'FILEMGMT',  N'ENTRYCOND',   N'Conditions of Entry (H0443)',                              16, getutcdate(), ''),
  ...
  (N'FILEMGMT',  N'BCTFANOTIF',  N'If this a total take with a surplus, then BCTFA notified', 20, getutcdate(), ''),
  ...
  (N'SCTN6XPRP', N'EXPROPAPPRV', N'Copy of expropriation approval packages',                  28, getutcdate(), 'Executive and case summaries'),
  (N'SCTN6XPRP', N'EXPROPFORM1', N'Notice of Expropriation (Form 1)',                         29, getutcdate(), 'The signed Form 1 is required'),
  (N'SCTN6XPRP', N'EXPROPFORM5', N'Approval of Expropriation (Form 5)',                       30, getutcdate(), 'The signed Form 5 is required'),
  (N'SCTN6XPRP', N'VESTNOTICE',  N'Vesting Notice (Form 9)',                                  31, getutcdate(), 'The signed Form 5 is required'),
  (N'SCTN6XPRP', N'SVCAFFADAV',  N'Copies of Affidavits of Service',                          32, getutcdate(), ''),
  (N'SCTN6XPRP', N'CLAIMRELSS6', N'Release of Claims',                                        33, getutcdate(), ''),
  (N'ACQCOMPAC', N'PIMSUPDTFIL', N'File data entered into PIMS',                              34, getutcdate(), 'Data is complete in this system');
GO
