...
VALUES
  ...
  (N'FILEMGMT',  N'BCTFANOTIF',  N'If this a total take with a surplus, then BCTFA notified', 20, getutcdate(), NULL),
  ...
  (N'SCTN3AGR',  N'SGNDAGRMNT',  N'Signed Agreement',                                         24, getutcdate(), NULL),
  ...
  (N'SCTN6XPRP', N'SVCAFFADAV',  N'Copies of Affidavits of Service',                          32, getutcdate(), NULL),
  (N'SCTN6XPRP', N'CLAIMRELSS6', N'Release of Claims',                                        33, getutcdate(), NULL),
