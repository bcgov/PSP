...
-- Add/Enable the "MOTIUSE" type.
PRINT N'Alter the "MOTIUSE" type.'
GO
...
FROM   PIMS_LEASE_PROGRAM_TYPE biz JOIN
       (SELECT LEASE_PROGRAM_TYPE_CODE
             , ROW_NUMBER() OVER (ORDER BY DESCRIPTION) AS ROW_NUM
        FROM   PIMS_LEASE_PROGRAM_TYPE) seq  ON seq.LEASE_PROGRAM_TYPE_CODE = biz.LEASE_PROGRAM_TYPE_CODE;
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
