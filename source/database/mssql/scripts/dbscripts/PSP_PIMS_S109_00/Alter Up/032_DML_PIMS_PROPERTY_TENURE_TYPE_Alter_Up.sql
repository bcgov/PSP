...
IF @@ROWCOUNT = 1
  ...
  SET    DESCRIPTION                = N'Fee Simple - MoTT'
...
IF @@ROWCOUNT = 1
  UPDATE PIMS_PROPERTY_TENURE_TYPE
  SET    DESCRIPTION                = N'Fee Simple - Crown (Non-MoTT)'
       , CONCURRENCY_CONTROL_NUMBER = CONCURRENCY_CONTROL_NUMBER + 1
  WHERE  PROPERTY_TENURE_TYPE_CODE = @CurrCd;
GO
IF @@ERROR <> 0 SET NOEXEC ON
...
IF @@ROWCOUNT = 1
  UPDATE PIMS_PROPERTY_TENURE_TYPE
  SET    DESCRIPTION                = N'Non-SRW Interests - MoTT'
       , CONCURRENCY_CONTROL_NUMBER = CONCURRENCY_CONTROL_NUMBER + 1
  WHERE  PROPERTY_TENURE_TYPE_CODE = @CurrCd;
GO
IF @@ERROR <> 0 SET NOEXEC ON
...
IF @@ROWCOUNT = 1
  UPDATE PIMS_PROPERTY_TENURE_TYPE
  SET    DESCRIPTION                = N'Statutory Right of Way (SRW) - MoTT'
       , CONCURRENCY_CONTROL_NUMBER = CONCURRENCY_CONTROL_NUMBER + 1
  WHERE  PROPERTY_TENURE_TYPE_CODE = @CurrCd;
GO
IF @@ERROR <> 0 SET NOEXEC ON
