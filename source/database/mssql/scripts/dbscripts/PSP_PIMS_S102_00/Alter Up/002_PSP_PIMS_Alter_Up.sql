-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Mon Mar 24 18:01:45 PDT 2025
...
GO
EXEC sp_addextendedproperty 
	@name = N'MS_Description', @value = N'Foreign key to the PIMS_ACQUISITION_FILE file.' , 
	@level0type = N'Schema', @level0name = N'dbo', 
	@level1type = N'Table', @level1name = N'PIMS_EXPROP_OWNER_HISTORY', 
...
-- Create foreign key constraint dbo.PIM_PERSON_PIM_XPOWNH_PER_FK
PRINT N'Create foreign key constraint dbo.PIM_PERSON_PIM_XPOWNH_PER_FK'
GO
ALTER TABLE [dbo].[PIMS_EXPROP_OWNER_HISTORY]
	ADD CONSTRAINT [PIM_PERSON_PIM_XPOWNH_PER_FK]
...
-- Create foreign key constraint dbo.PIM_PERSON_PIM_XPOWNH_PRM_FK
PRINT N'Create foreign key constraint dbo.PIM_PERSON_PIM_XPOWNH_PRM_FK'
GO
ALTER TABLE [dbo].[PIMS_EXPROP_OWNER_HISTORY]
	ADD CONSTRAINT [PIM_PERSON_PIM_XPOWNH_PRM_FK]
...
-- Create foreign key constraint dbo.PIM_ORG_PIM_XPOWNH_FK
PRINT N'Create foreign key constraint dbo.PIM_ORG_PIM_XPOWNH_FK'
GO
ALTER TABLE [dbo].[PIMS_EXPROP_OWNER_HISTORY]
	ADD CONSTRAINT [PIM_ORG_PIM_XPOWNH_FK]
