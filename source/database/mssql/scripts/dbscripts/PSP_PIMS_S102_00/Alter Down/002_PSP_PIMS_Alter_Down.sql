-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Mon Mar 24 18:02:16 PDT 2025
...
-- Drop foreign key constraint dbo.PIM_ORG_PIM_XPOWNH_FK
PRINT N'Drop foreign key constraint dbo.PIM_ORG_PIM_XPOWNH_FK'
GO
ALTER TABLE [dbo].[PIMS_EXPROP_OWNER_HISTORY]
	DROP CONSTRAINT IF EXISTS [PIM_ORG_PIM_XPOWNH_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop foreign key constraint dbo.PIM_PERSON_PIM_XPOWNH_PRM_FK
PRINT N'Drop foreign key constraint dbo.PIM_PERSON_PIM_XPOWNH_PRM_FK'
GO
ALTER TABLE [dbo].[PIMS_EXPROP_OWNER_HISTORY]
	DROP CONSTRAINT IF EXISTS [PIM_PERSON_PIM_XPOWNH_PRM_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Drop foreign key constraint dbo.PIM_PERSON_PIM_XPOWNH_PER_FK
PRINT N'Drop foreign key constraint dbo.PIM_PERSON_PIM_XPOWNH_PER_FK'
GO
ALTER TABLE [dbo].[PIMS_EXPROP_OWNER_HISTORY]
	DROP CONSTRAINT IF EXISTS [PIM_PERSON_PIM_XPOWNH_PER_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
