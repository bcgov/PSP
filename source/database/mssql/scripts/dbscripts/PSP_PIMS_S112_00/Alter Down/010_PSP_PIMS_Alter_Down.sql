...
-- Drop foreign key constraint dbo.PIM_REGION_PIM_MGMTFL_FK
PRINT N'Drop foreign key constraint dbo.PIM_REGION_PIM_MGMTFL_FK'
GO
ALTER TABLE [dbo].[PIMS_MANAGEMENT_FILE]
	DROP CONSTRAINT IF EXISTS [PIM_REGION_PIM_MGMTFL_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop foreign key constraint dbo.PIM_FLLSVT_PIM_LEASE_FK
PRINT N'Drop foreign key constraint dbo.PIM_FLLSVT_PIM_LEASE_FK'
GO
ALTER TABLE [dbo].[PIMS_LEASE]
	DROP CONSTRAINT IF EXISTS [PIM_FLLSVT_PIM_LEASE_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop foreign key constraint dbo.PIM_FLAPPT_PIM_LEASE_FK
PRINT N'Drop foreign key constraint dbo.PIM_FLAPPT_PIM_LEASE_FK'
GO
ALTER TABLE [dbo].[PIMS_LEASE]
	DROP CONSTRAINT IF EXISTS [PIM_FLAPPT_PIM_LEASE_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop foreign key constraint dbo.PIM_FLLSVT_PIM_ACQNFL_FK
PRINT N'Drop foreign key constraint dbo.PIM_FLLSVT_PIM_ACQNFL_FK'
GO
ALTER TABLE [dbo].[PIMS_ACQUISITION_FILE]
	DROP CONSTRAINT IF EXISTS [PIM_FLLSVT_PIM_ACQNFL_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop foreign key constraint dbo.PIM_FLAPPT_PIM_ACQNFL_FK
PRINT N'Drop foreign key constraint dbo.PIM_FLAPPT_PIM_ACQNFL_FK'
GO
ALTER TABLE [dbo].[PIMS_ACQUISITION_FILE]
	DROP CONSTRAINT IF EXISTS [PIM_FLAPPT_PIM_ACQNFL_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop index dbo.LEASE_FILE_LGL_SRVY_TYPE_CODE_IDX
PRINT N'Drop index dbo.LEASE_FILE_LGL_SRVY_TYPE_CODE_IDX'
GO
DROP INDEX IF EXISTS [dbo].[PIMS_LEASE].[LEASE_FILE_LGL_SRVY_TYPE_CODE_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop index dbo.LEASE_FILE_APPRAISAL_TYPE_CODE_IDX
PRINT N'Drop index dbo.LEASE_FILE_APPRAISAL_TYPE_CODE_IDX'
GO
DROP INDEX IF EXISTS [dbo].[PIMS_LEASE].[LEASE_FILE_APPRAISAL_TYPE_CODE_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Drop index dbo.MGMTFL_REGION_CODE_IDX
PRINT N'Drop index dbo.MGMTFL_REGION_CODE_IDX'
GO
DROP INDEX IF EXISTS [dbo].[PIMS_MANAGEMENT_FILE].[MGMTFL_REGION_CODE_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Drop trigger dbo.PIMS_FLAPPT_I_S_U_TR
PRINT N'Drop trigger dbo.PIMS_FLAPPT_I_S_U_TR'
GO
DROP TRIGGER IF EXISTS [dbo].[PIMS_FLAPPT_I_S_U_TR]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop trigger dbo.PIMS_FLAPPT_I_S_I_TR
PRINT N'Drop trigger dbo.PIMS_FLAPPT_I_S_I_TR'
GO
DROP TRIGGER IF EXISTS [dbo].[PIMS_FLAPPT_I_S_I_TR]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop trigger dbo.PIMS_FLLSVT_I_S_U_TR
PRINT N'Drop trigger dbo.PIMS_FLLSVT_I_S_U_TR'
GO
DROP TRIGGER IF EXISTS [dbo].[PIMS_FLLSVT_I_S_U_TR]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop trigger dbo.PIMS_FLLSVT_I_S_I_TR
PRINT N'Drop trigger dbo.PIMS_FLLSVT_I_S_I_TR'
GO
DROP TRIGGER IF EXISTS [dbo].[PIMS_FLLSVT_I_S_I_TR]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Drop primary key constraint dbo.FLAPPT_PK
PRINT N'Drop primary key constraint dbo.FLAPPT_PK'
GO
ALTER TABLE [dbo].[PIMS_FILE_APPRAISAL_TYPE]
	DROP CONSTRAINT IF EXISTS [FLAPPT_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop primary key constraint dbo.FLLSVT_PK
PRINT N'Drop primary key constraint dbo.FLLSVT_PK'
GO
ALTER TABLE [dbo].[PIMS_FILE_LGL_SRVY_TYPE]
	DROP CONSTRAINT IF EXISTS [FLLSVT_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
EXEC dbo.sp_rename N'dbo.PIMS_ACQUISITION_FILE.FILE_APPRAISAL_TYPE_CODE' , N'ACQ_FILE_APPRAISAL_TYPE_CODE', 'COLUMN'
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'dbo.PIMS_ACQUISITION_FILE.FILE_LGL_SRVY_TYPE_CODE' , N'ACQ_FILE_LGL_SRVY_TYPE_CODE', 'COLUMN'
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_LEASE]
	DROP COLUMN IF EXISTS [FILE_APPRAISAL_TYPE_CODE], [FILE_LGL_SRVY_TYPE_CODE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
EXEC dbo.sp_rename N'dbo.PIMS_ACQUISITION_FILE_HIST.FILE_APPRAISAL_TYPE_CODE' , N'ACQ_FILE_APPRAISAL_TYPE_CODE', 'COLUMN'
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'dbo.PIMS_ACQUISITION_FILE_HIST.FILE_LGL_SRVY_TYPE_CODE' , N'ACQ_FILE_LGL_SRVY_TYPE_CODE', 'COLUMN'
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_SECURITY_DEPOSIT_HIST] ALTER COLUMN [DESCRIPTION] nvarchar(2000) NOT NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_SECURITY_DEPOSIT_HIST] ALTER COLUMN [DEPOSIT_DATE] date NOT NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_SECURITY_DEPOSIT] ALTER COLUMN [DESCRIPTION] nvarchar(2000) NOT NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_SECURITY_DEPOSIT] ALTER COLUMN [DEPOSIT_DATE] date NOT NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
PRINT N'Drop table dbo.PIMS_FILE_APPRAISAL_TYPE'
GO
DROP TABLE IF EXISTS [dbo].[PIMS_FILE_APPRAISAL_TYPE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop table dbo.PIMS_FILE_LGL_SRVY_TYPE
PRINT N'Drop table dbo.PIMS_FILE_LGL_SRVY_TYPE'
GO
DROP TABLE IF EXISTS [dbo].[PIMS_FILE_LGL_SRVY_TYPE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
