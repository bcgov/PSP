...
-- Add/Enable the "OWNSOL" type.
PRINT N'Add/Enable the "OWNSOL" type.'
GO
...
IF @@ROWCOUNT = 1
  ...
  WHERE  LEASE_STAKEHOLDER_TYPE_CODE = @CurrCd;
ELSE
  INSERT INTO PIMS_LEASE_STAKEHOLDER_TYPE (LEASE_STAKEHOLDER_TYPE_CODE, DESCRIPTION)
  VALUES (N'OWNSOL', N'Owner Solicitor');  
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
