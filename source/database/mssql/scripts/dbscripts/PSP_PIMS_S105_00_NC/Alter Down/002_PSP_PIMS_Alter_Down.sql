-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Thu Jun 12 16:48:33 PDT 2025
-- Execute this script on:
-- 		PSP_PIMS_S105_00_NC/dbo - This database/schema will be modified
-- to synchronize it with MS SQL Server 2016:
-- 		PSP_PIMS_S104_00_NC/dbo
...
GO
UPDATE [dbo].[PIMS_PROPERTY_ACTIVITY_HIST] SET [PROP_MGMT_ACTIVITY_TYPE_CODE] = 'PROPERTYMGMT' WHERE [PROP_MGMT_ACTIVITY_TYPE_CODE] IS NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_ACTIVITY_HIST]
	ADD [PROP_MGMT_ACTIVITY_SUBTYPE_CODE] nvarchar(20) NOT NULL DEFAULT 'PROPADMIN'
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
