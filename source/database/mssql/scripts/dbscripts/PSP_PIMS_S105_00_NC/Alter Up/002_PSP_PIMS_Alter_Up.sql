-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Wed Jun 11 12:54:40 PDT 2025
-- Execute this script on:
-- 		PSP_PIMS_S104_00_NC/dbo - This database/schema will be modified
-- to synchronize it with MS SQL Server 2016:
-- 		PSP_PIMS_S105_00_NC/dbo
...
GO
UPDATE [dbo].[PIMS_MANAGEMENT_FILE] SET [MANAGEMENT_FILE_PURPOSE_TYPE_CODE] = 'UTILITY' WHERE [MANAGEMENT_FILE_PURPOSE_TYPE_CODE] IS NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_MANAGEMENT_FILE_PROPERTY_HIST]
	ADD [IS_ACTIVE] bit NOT NULL DEFAULT (CONVERT([bit],(1))), 
	[DISPLAY_ORDER] int NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
UPDATE [dbo].[PIMS_MANAGEMENT_FILE_HIST] SET [MANAGEMENT_FILE_PURPOSE_TYPE_CODE] = 'UTILITY' WHERE [MANAGEMENT_FILE_PURPOSE_TYPE_CODE] IS NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
UPDATE [dbo].[PIMS_ACQUISITION_FILE_TEAM] SET [ACQ_FL_TEAM_PROFILE_TYPE_CODE] = 'MOTILEAD' WHERE [ACQ_FL_TEAM_PROFILE_TYPE_CODE] IS NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
UPDATE [dbo].[PIMS_MANAGEMENT_FILE_TEAM] SET [MANAGEMENT_FILE_PROFILE_TYPE_CODE] = 'MINSTAFF' WHERE [MANAGEMENT_FILE_PROFILE_TYPE_CODE] IS NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
UPDATE [dbo].[PIMS_ACQUISITION_FILE_TEAM_HIST] SET [ACQ_FL_TEAM_PROFILE_TYPE_CODE] = 'MOTILEAD' WHERE [ACQ_FL_TEAM_PROFILE_TYPE_CODE] IS NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
UPDATE [dbo].[PIMS_MANAGEMENT_FILE_TEAM_HIST] SET [MANAGEMENT_FILE_PROFILE_TYPE_CODE] = 'MINSTAFF' WHERE [MANAGEMENT_FILE_PROFILE_TYPE_CODE] IS NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
