-- *****************************************************************************
-- Drop and recreate the trigger PIMS_PRPACT_A_S_IUD_TR to accomodate preserving 
-- the first 4000 bytes of the DESCRIPTION column in the history table.
-- *****************************************************************************

-- Drop the PIMS_PRPACT_A_S_IUD_TR trigger
PRINT 'Drop the PIMS_PRPACT_A_S_IUD_TR trigger'
GO
DROP TRIGGER [dbo].[PIMS_PRPACT_A_S_IUD_TR]
GO

-- Create the PIMS_PRPACT_A_S_IUD_TR trigger
PRINT 'Create the PIMS_PRPACT_A_S_IUD_TR trigger'
GO
