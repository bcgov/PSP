-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Wed Nov 27 11:32:42 PST 2024
...
-- Drop index dbo.ACQNFL_FILE_NUMBER_IDX
PRINT N'Drop index dbo.ACQNFL_FILE_NUMBER_IDX'
GO
DROP INDEX IF EXISTS [dbo].[PIMS_ACQUISITION_FILE].[ACQNFL_FILE_NUMBER_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_ACQUISITION_FILE] ADD DEFAULT '<Empty>' FOR [FILE_NUMBER]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
ALTER TABLE [dbo].[PIMS_ACQUISITION_FILE]
	ADD [FILE_NO_SUFFIX] smallint NOT NULL CONSTRAINT [ACQNFL_FILE_NO_SUFFIX_DEF] DEFAULT ((1))
GO
EXEC sp_addextendedproperty 
	...
	@level2type = N'Column', @level2name = N'FILE_NO_SUFFIX'
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_DOCUMENT] ALTER COLUMN [MAYAN_ID] bigint NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_DOCUMENT_QUEUE]
	ADD [FILE_NAME] nvarchar(500) NOT NULL DEFAULT '<Empty>'
GO
...
GO
ALTER TABLE [dbo].[PIMS_ACQUISITION_FILE_HIST]
	ADD [FILE_NO_SUFFIX] smallint NOT NULL DEFAULT 0
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_DOCUMENT_HIST] ALTER COLUMN [MAYAN_ID] bigint NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Create index dbo.ACQNFL_FILE_NO_IDX
PRINT N'Create index dbo.ACQNFL_FILE_NO_IDX'
GO
