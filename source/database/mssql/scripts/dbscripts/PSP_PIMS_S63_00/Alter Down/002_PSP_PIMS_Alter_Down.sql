-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Thu Sep 14 15:05:57 PDT 2023
-- Execute this script on:
-- 		PSP_PIMS_S63_00/dbo - This database/schema will be modified
...
-- Drop foreign key constraint dbo.PIM_PRPRTY_PIM_PRPRCL_FK
PRINT N'Drop foreign key constraint dbo.PIM_PRPRTY_PIM_PRPRCL_FK'
GO
ALTER TABLE [dbo].[PIMS_PROP_PROP_CLASSIFICATION]
	DROP CONSTRAINT IF EXISTS [PIM_PRPRTY_PIM_PRPRCL_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop foreign key constraint dbo.PIM_PRPCLT_PIM_PRPRCL_FK
PRINT N'Drop foreign key constraint dbo.PIM_PRPCLT_PIM_PRPRCL_FK'
GO
ALTER TABLE [dbo].[PIMS_PROP_PROP_CLASSIFICATION]
	DROP CONSTRAINT IF EXISTS [PIM_PRPCLT_PIM_PRPRCL_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Drop trigger dbo.PIMS_PRPRCL_I_S_U_TR
PRINT N'Drop trigger dbo.PIMS_PRPRCL_I_S_U_TR'
GO
DROP TRIGGER IF EXISTS [dbo].[PIMS_PRPRCL_I_S_U_TR]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop trigger dbo.PIMS_PRPRCL_I_S_I_TR
PRINT N'Drop trigger dbo.PIMS_PRPRCL_I_S_I_TR'
GO
DROP TRIGGER IF EXISTS [dbo].[PIMS_PRPRCL_I_S_I_TR]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop trigger dbo.PIMS_PRPRCL_A_S_IUD_TR
PRINT N'Drop trigger dbo.PIMS_PRPRCL_A_S_IUD_TR'
GO
DROP TRIGGER IF EXISTS [dbo].[PIMS_PRPRCL_A_S_IUD_TR]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop index dbo.PRPRCL_PROPERTY_ID_IDX
PRINT N'Drop index dbo.PRPRCL_PROPERTY_ID_IDX'
GO
DROP INDEX IF EXISTS [dbo].[PIMS_PROP_PROP_CLASSIFICATION].[PRPRCL_PROPERTY_ID_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop index dbo.PRPRCL_PROPERTY_CLASSIFICATION_TYPE_CODE_IDX
PRINT N'Drop index dbo.PRPRCL_PROPERTY_CLASSIFICATION_TYPE_CODE_IDX'
GO
DROP INDEX IF EXISTS [dbo].[PIMS_PROP_PROP_CLASSIFICATION].[PRPRCL_PROPERTY_CLASSIFICATION_TYPE_CODE_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Drop index dbo.PRPACT_VENDOR_ID_IDX
PRINT N'Drop index dbo.PRPACT_VENDOR_ID_IDX'
GO
DROP INDEX IF EXISTS [dbo].[PIMS_PROPERTY_ACTIVITY].[PRPACT_VENDOR_ID_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Drop index dbo.PRPACT_MINISTRY_CONTACT_ID_IDX
PRINT N'Drop index dbo.PRPACT_MINISTRY_CONTACT_ID_IDX'
GO
DROP INDEX IF EXISTS [dbo].[PIMS_PROPERTY_ACTIVITY].[PRPACT_MINISTRY_CONTACT_ID_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Drop unique constraint dbo.PRPRCL_PROP_PROP_CLASSIFICATION_TUC
PRINT N'Drop unique constraint dbo.PRPRCL_PROP_PROP_CLASSIFICATION_TUC'
GO
ALTER TABLE [dbo].[PIMS_PROP_PROP_CLASSIFICATION]
	DROP CONSTRAINT IF EXISTS [PRPRCL_PROP_PROP_CLASSIFICATION_TUC]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop primary key constraint dbo.PRPRCL_PK
PRINT N'Drop primary key constraint dbo.PRPRCL_PK'
GO
ALTER TABLE [dbo].[PIMS_PROP_PROP_CLASSIFICATION]
	DROP CONSTRAINT IF EXISTS [PRPRCL_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop table dbo.PIMS_PROP_PROP_CLASSIFICATION
PRINT N'Drop table dbo.PIMS_PROP_PROP_CLASSIFICATION'
GO
DROP TABLE IF EXISTS [dbo].[PIMS_PROP_PROP_CLASSIFICATION]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY]
	ADD [PROPERTY_CLASSIFICATION_TYPE_CODE] nvarchar(20) --NOT NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROPERTY]
	DROP COLUMN IF EXISTS [ADDITIONAL_DETAILS], [IS_PAID_UTILITIES], [IS_TAXES_PAID]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
