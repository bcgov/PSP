-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Thu Dec 01 16:14:03 PST 2022
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_LESSOR_TYPE] ADD DEFAULT 'UNK' FOR [LESSOR_TYPE_CODE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC sp_dropextendedproperty 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_LESSOR_TYPE] ADD DEFAULT 'Unknown' FOR [DESCRIPTION]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC sp_dropextendedproperty 
