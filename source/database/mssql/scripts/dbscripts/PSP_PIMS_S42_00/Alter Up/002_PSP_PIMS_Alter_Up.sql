-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Thu Dec 01 16:11:20 PST 2022
...
SET @defName = (SELECT obj.NAME
                ...
                WHERE  obj.XTYPE = 'D'
                   AND tbl.NAME = 'PIMS_LESSOR_TYPE' 
                   AND col.NAME = 'LESSOR_TYPE_CODE')
SET @sqlQry = 'ALTER TABLE [dbo].[PIMS_LESSOR_TYPE] DROP CONSTRAINT IF EXISTS [' + @defName + ']'
EXEC (@sqlQry)
IF @@ERROR <> 0 SET NOEXEC ON
GO
