-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Wed Mar 29 17:09:32 PDT 2023
...
GO
UPDATE [dbo].[PIMS_PROJECT] SET [PROJECT_STATUS_TYPE_CODE] = ('AC') WHERE [PROJECT_STATUS_TYPE_CODE] IS NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1680111147808]  ( 
...
EXEC sp_addextendedproperty 
	...
	@level1type = N'Table', @level1name = N'ADS_SSDATA_1680111147808', 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1680111147808]', N'PIMS_DOCUMENT', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1680111147802]  ( 
...
EXEC sp_addextendedproperty 
	...
	@level0type = N'Schema', @level0name = N'dbo', 
	@level1type = N'Table', @level1name = N'ADS_SSDATA_1680111147802', 
	@level2type = N'Column', @level2name = N'MAYAN_ID'
GO
EXEC sp_addextendedproperty 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1680111147802]([DOCUMENT_TYPE_ID], [MAYAN_ID], [DOCUMENT_TYPE], [DISPLAY_ORDER], [CONCURRENCY_CONTROL_NUMBER], [APP_CREATE_TIMESTAMP], [APP_CREATE_USERID], [APP_CREATE_USER_GUID], [APP_CREATE_USER_DIRECTORY], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USERID], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USER_DIRECTORY], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID]) 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1680111147802]', N'PIMS_DOCUMENT_TYP', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
CREATE TABLE [dbo].[ADS_SSDATA_1680111147803]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1680111147803]', N'PIMS_DOCUMENT_TYP_HIST', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
