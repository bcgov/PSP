...
-- Migrate the PIMS_MANAGEMENT_ACTIVITY_PROPERTY data to the TMP_PROP_PROP_ACTIVITY table
PRINT N'Migrate the PIMS_MANAGEMENT_ACTIVITY_PROPERTY data to the TMP_PROP_PROP_ACTIVITY table'
GO
