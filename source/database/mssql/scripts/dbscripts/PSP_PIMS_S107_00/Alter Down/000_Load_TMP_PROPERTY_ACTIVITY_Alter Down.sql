/* -----------------------------------------------------------------------------
Create and populate the temporary TMP_PROPERTY_ACTIVITY table.  This data will
be migrated to the PIMS_MANAGEMENT_ACTIVITY table in IS-107.
. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
Author        Date         Comment
------------  -----------  -----------------------------------------------------
...
-- Migrate the PIMS_MANAGEMENT_ACTIVITY data to the TMP_PROPERTY_ACTIVITY table
PRINT N'Migrate the PIMS_MANAGEMENT_ACTIVITY data to the TMP_PROPERTY_ACTIVITY table'
GO
INSERT INTO dbo.TMP_PROPERTY_ACTIVITY (PIMS_PROPERTY_ACTIVITY_ID, PROP_MGMT_ACTIVITY_STATUS_TYPE_CODE, SERVICE_PROVIDER_PERSON_ID, SERVICE_PROVIDER_ORG_ID, MANAGEMENT_FILE_ID, PROP_MGMT_ACTIVITY_TYPE_CODE, REQUEST_ADDED_DT, COMPLETION_DT, DESCRIPTION, REQUEST_SOURCE, IS_DISABLED, CONCURRENCY_CONTROL_NUMBER, APP_CREATE_TIMESTAMP, APP_CREATE_USERID, APP_CREATE_USER_GUID, APP_CREATE_USER_DIRECTORY, APP_LAST_UPDATE_TIMESTAMP, APP_LAST_UPDATE_USERID, APP_LAST_UPDATE_USER_GUID, APP_LAST_UPDATE_USER_DIRECTORY, DB_CREATE_TIMESTAMP, DB_CREATE_USERID, DB_LAST_UPDATE_TIMESTAMP, DB_LAST_UPDATE_USERID)
