...
-- Migrate the PIMS_PROPERTY_ACTIVITY_HIST data to the TMP_PROPERTY_ACTIVITY_HIST table
PRINT N'Migrate the PIMS_PROPERTY_ACTIVITY_HIST data to the TMP_PROPERTY_ACTIVITY_HIST table'
GO
