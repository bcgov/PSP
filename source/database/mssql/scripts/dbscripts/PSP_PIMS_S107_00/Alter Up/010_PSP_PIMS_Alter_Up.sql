-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Mon Jul 07 09:52:14 PDT 2025
...
-- Create sequence dbo.PIMS_MANAGEMENT_ACTIVITY_ID_SEQ
PRINT N'Create sequence dbo.PIMS_MANAGEMENT_ACTIVITY_ID_SEQ'
GO
CREATE SEQUENCE [dbo].[PIMS_MANAGEMENT_ACTIVITY_ID_SEQ]
	AS bigint
	START WITH 1
...
-- Create table dbo.PIMS_MANAGEMENT_ACTIVITY
PRINT N'Create table dbo.PIMS_MANAGEMENT_ACTIVITY'
GO
CREATE TABLE [dbo].[PIMS_MANAGEMENT_ACTIVITY]  ( 
	[PIMS_MANAGEMENT_ACTIVITY_ID]        	bigint NOT NULL CONSTRAINT [MGMTAC_PIMS_MANAGEMENT_ACTIVITY_ID_DEF]  DEFAULT (NEXT VALUE FOR [PIMS_MANAGEMENT_ACTIVITY_ID_SEQ]),
	[PROP_MGMT_ACTIVITY_STATUS_TYPE_CODE]	nvarchar(20) NOT NULL CONSTRAINT [MGMTAC_PROP_MGMT_ACTIVITY_STATUS_TYPE_CODE_DEF]  DEFAULT ('NOTSTARTED'),
	...
	[IS_DISABLED]                        	bit NULL CONSTRAINT [MGMTAC_IS_DISABLED_DEF]  DEFAULT (CONVERT([bit],(0))),
	[CONCURRENCY_CONTROL_NUMBER]         	bigint NOT NULL CONSTRAINT [MGMTAC_CONCURRENCY_CONTROL_NUMBER_DEF]  DEFAULT ((1)),
	[APP_CREATE_TIMESTAMP]               	datetime NOT NULL CONSTRAINT [MGMTAC_APP_CREATE_TIMESTAMP_DEF]  DEFAULT (getutcdate()),
	[APP_CREATE_USERID]                  	nvarchar(30) NOT NULL CONSTRAINT [MGMTAC_APP_CREATE_USERID_DEF]  DEFAULT (user_name()),
	[APP_CREATE_USER_GUID]               	uniqueidentifier NULL,
	[APP_CREATE_USER_DIRECTORY]          	nvarchar(30) NOT NULL CONSTRAINT [MGMTAC_APP_CREATE_USER_DIRECTORY_DEF]  DEFAULT (user_name()),
	[APP_LAST_UPDATE_TIMESTAMP]          	datetime NOT NULL CONSTRAINT [MGMTAC_APP_LAST_UPDATE_TIMESTAMP_DEF]  DEFAULT (getutcdate()),
	[APP_LAST_UPDATE_USERID]             	nvarchar(30) NOT NULL CONSTRAINT [MGMTAC_APP_LAST_UPDATE_USERID_DEF]  DEFAULT (user_name()),
	[APP_LAST_UPDATE_USER_GUID]          	uniqueidentifier NULL,
	[APP_LAST_UPDATE_USER_DIRECTORY]     	nvarchar(30) NOT NULL CONSTRAINT [MGMTAC_APP_LAST_UPDATE_USER_DIRECTORY_DEF]  DEFAULT (user_name()),
	[DB_CREATE_TIMESTAMP]                	datetime NOT NULL CONSTRAINT [MGMTAC_DB_CREATE_TIMESTAMP_DEF]  DEFAULT (getutcdate()),
	[DB_CREATE_USERID]                   	nvarchar(30) NOT NULL CONSTRAINT [MGMTAC_DB_CREATE_USERID_DEF]  DEFAULT (user_name()),
	[DB_LAST_UPDATE_TIMESTAMP]           	datetime NOT NULL CONSTRAINT [MGMTAC_DB_LAST_UPDATE_TIMESTAMP_DEF]  DEFAULT (getutcdate()),
	[DB_LAST_UPDATE_USERID]              	nvarchar(30) NOT NULL CONSTRAINT [MGMTAC_DB_LAST_UPDATE_USERID_DEF]  DEFAULT (user_name()),
	CONSTRAINT [MGMTAC_PK] PRIMARY KEY CLUSTERED([PIMS_MANAGEMENT_ACTIVITY_ID])
 ON [PRIMARY])
GO
...
GO
EXEC dbo.sp_rename N'dbo.PIMS_PROPERTY_ACTIVITY_INVOICE.PIMS_PROPERTY_ACTIVITY_ID' , N'PIMS_MANAGEMENT_ACTIVITY_ID', 'COLUMN'
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
EXEC dbo.sp_rename N'dbo.PIMS_PROPERTY_ACTIVITY_DOCUMENT.PIMS_PROPERTY_ACTIVITY_ID' , N'PIMS_MANAGEMENT_ACTIVITY_ID', 'COLUMN'
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Create sequence dbo.PIMS_MANAGEMENT_FILE_CONTACT_ID_SEQ
PRINT N'Create sequence dbo.PIMS_MANAGEMENT_FILE_CONTACT_ID_SEQ'
GO
CREATE SEQUENCE [dbo].[PIMS_MANAGEMENT_FILE_CONTACT_ID_SEQ]
	AS bigint
	START WITH 1
...
-- Create table dbo.PIMS_MANAGEMENT_FILE_CONTACT
PRINT N'Create table dbo.PIMS_MANAGEMENT_FILE_CONTACT'
GO
CREATE TABLE [dbo].[PIMS_MANAGEMENT_FILE_CONTACT]  ( 
	[MANAGEMENT_FILE_CONTACT_ID]    	bigint NOT NULL CONSTRAINT [MFFLCN_MANAGEMENT_FILE_CONTACT_ID_DEF]  DEFAULT (NEXT VALUE FOR [PIMS_MANAGEMENT_FILE_CONTACT_ID_SEQ]),
	[MANAGEMENT_FILE_ID]            	bigint NULL,
	[PERSON_ID]                     	bigint NULL,
	[ORGANIZATION_ID]               	bigint NULL,
	[PRIMARY_CONTACT_ID]            	bigint NULL,
	[PURPOSE]                       	nvarchar(500) NOT NULL CONSTRAINT [MFFLCN_PURPOSE_DEF]  DEFAULT ('Unknown'),
	[CONCURRENCY_CONTROL_NUMBER]    	bigint NOT NULL CONSTRAINT [MFFLCN_CONCURRENCY_CONTROL_NUMBER_DEF]  DEFAULT ((1)),
	[APP_CREATE_TIMESTAMP]          	datetime NOT NULL CONSTRAINT [MFFLCN_APP_CREATE_TIMESTAMP_DEF]  DEFAULT (getutcdate()),
	[APP_CREATE_USERID]             	nvarchar(30) NOT NULL CONSTRAINT [MFFLCN_APP_CREATE_USERID_DEF]  DEFAULT (user_name()),
	[APP_CREATE_USER_GUID]          	uniqueidentifier NULL,
	[APP_CREATE_USER_DIRECTORY]     	nvarchar(30) NOT NULL CONSTRAINT [MFFLCN_APP_CREATE_USER_DIRECTORY_DEF]  DEFAULT (user_name()),
	[APP_LAST_UPDATE_TIMESTAMP]     	datetime NOT NULL CONSTRAINT [MFFLCN_APP_LAST_UPDATE_TIMESTAMP_DEF]  DEFAULT (getutcdate()),
	[APP_LAST_UPDATE_USERID]        	nvarchar(30) NOT NULL CONSTRAINT [MFFLCN_APP_LAST_UPDATE_USERID_DEF]  DEFAULT (user_name()),
	[APP_LAST_UPDATE_USER_GUID]     	uniqueidentifier NULL,
	[APP_LAST_UPDATE_USER_DIRECTORY]	nvarchar(30) NOT NULL CONSTRAINT [MFFLCN_APP_LAST_UPDATE_USER_DIRECTORY_DEF]  DEFAULT (user_name()),
	[DB_CREATE_TIMESTAMP]           	datetime NOT NULL CONSTRAINT [MFFLCN_DB_CREATE_TIMESTAMP_DEF]  DEFAULT (getutcdate()),
	[DB_CREATE_USERID]              	nvarchar(30) NOT NULL CONSTRAINT [MFFLCN_DB_CREATE_USERID_DEF]  DEFAULT (user_name()),
	[DB_LAST_UPDATE_TIMESTAMP]      	datetime NOT NULL CONSTRAINT [MFFLCN_DB_LAST_UPDATE_TIMESTAMP_DEF]  DEFAULT (getutcdate()),
	[DB_LAST_UPDATE_USERID]         	nvarchar(30) NOT NULL CONSTRAINT [MFFLCN_DB_LAST_UPDATE_USERID_DEF]  DEFAULT (user_name()),
	CONSTRAINT [MFFLCN_PK] PRIMARY KEY CLUSTERED([MANAGEMENT_FILE_CONTACT_ID])
 ON [PRIMARY])
GO
EXEC sp_addextendedproperty 
...
GO
EXEC sp_addextendedproperty 
	@name = N'MS_Description', @value = N'Foreign key to_PIMS_MANAGEMENT_FILE table.' , 
	@level0type = N'Schema', @level0name = N'dbo', 
	@level1type = N'Table', @level1name = N'PIMS_MANAGEMENT_FILE_CONTACT', 
	@level2type = N'Column', @level2name = N'MANAGEMENT_FILE_ID'
GO
...
GO
EXEC sp_addextendedproperty 
	@name = N'MS_Description', @value = N'Defines the contacts that are associated with this management file.' , 
	@level0type = N'Schema', @level0name = N'dbo', 
	@level1type = N'Table', @level1name = N'PIMS_MANAGEMENT_FILE_CONTACT'
GO
IF @@ERROR <> 0 SET NOEXEC ON
...
-- Create sequence dbo.PIMS_MANAGEMENT_ACTIVITY_PROPERTY_ID_SEQ
PRINT N'Create sequence dbo.PIMS_MANAGEMENT_ACTIVITY_PROPERTY_ID_SEQ'
GO
CREATE SEQUENCE [dbo].[PIMS_MANAGEMENT_ACTIVITY_PROPERTY_ID_SEQ]
	AS bigint
	START WITH 1
...
-- Create table dbo.PIMS_MANAGEMENT_ACTIVITY_PROPERTY
PRINT N'Create table dbo.PIMS_MANAGEMENT_ACTIVITY_PROPERTY'
GO
CREATE TABLE [dbo].[PIMS_MANAGEMENT_ACTIVITY_PROPERTY]  ( 
	[MANAGEMENT_ACTIVITY_PROPERTY_ID]	bigint NOT NULL CONSTRAINT [MAACPR_MANAGEMENT_ACTIVITY_PROPERTY_ID_DEF]  DEFAULT (NEXT VALUE FOR [PIMS_MANAGEMENT_ACTIVITY_PROPERTY_ID_SEQ]),
	[PROPERTY_ID]                    	bigint NOT NULL,
	[PIMS_MANAGEMENT_ACTIVITY_ID]    	bigint NOT NULL,
	[CONCURRENCY_CONTROL_NUMBER]     	bigint NOT NULL CONSTRAINT [MAACPR_CONCURRENCY_CONTROL_NUMBER_DEF]  DEFAULT ((1)),
	[APP_CREATE_TIMESTAMP]           	datetime NOT NULL CONSTRAINT [MAACPR_APP_CREATE_TIMESTAMP_DEF]  DEFAULT (getutcdate()),
	[APP_CREATE_USERID]              	nvarchar(30) NOT NULL CONSTRAINT [MAACPR_APP_CREATE_USERID_DEF]  DEFAULT (user_name()),
	[APP_CREATE_USER_GUID]           	uniqueidentifier NULL,
	[APP_CREATE_USER_DIRECTORY]      	nvarchar(30) NOT NULL CONSTRAINT [MAACPR_APP_CREATE_USER_DIRECTORY_DEF]  DEFAULT (user_name()),
	[APP_LAST_UPDATE_TIMESTAMP]      	datetime NOT NULL CONSTRAINT [MAACPR_APP_LAST_UPDATE_TIMESTAMP_DEF]  DEFAULT (getutcdate()),
	[APP_LAST_UPDATE_USERID]         	nvarchar(30) NOT NULL CONSTRAINT [MAACPR_APP_LAST_UPDATE_USERID_DEF]  DEFAULT (user_name()),
	[APP_LAST_UPDATE_USER_GUID]      	uniqueidentifier NULL,
	[APP_LAST_UPDATE_USER_DIRECTORY] 	nvarchar(30) NOT NULL CONSTRAINT [MAACPR_APP_LAST_UPDATE_USER_DIRECTORY_DEF]  DEFAULT (user_name()),
	[DB_CREATE_TIMESTAMP]            	datetime NOT NULL CONSTRAINT [MAACPR_DB_CREATE_TIMESTAMP_DEF]  DEFAULT (getutcdate()),
	[DB_CREATE_USERID]               	nvarchar(30) NOT NULL CONSTRAINT [MAACPR_DB_CREATE_USERID_DEF]  DEFAULT (user_name()),
	[DB_LAST_UPDATE_TIMESTAMP]       	datetime NOT NULL CONSTRAINT [MAACPR_DB_LAST_UPDATE_TIMESTAMP_DEF]  DEFAULT (getutcdate()),
	[DB_LAST_UPDATE_USERID]          	nvarchar(30) NOT NULL CONSTRAINT [MAACPR_DB_LAST_UPDATE_USERID_DEF]  DEFAULT (user_name()),
	CONSTRAINT [MAACPR_PK] PRIMARY KEY CLUSTERED([MANAGEMENT_ACTIVITY_PROPERTY_ID])
 ON [PRIMARY])
GO
EXEC sp_addextendedproperty 
...
GO
EXEC dbo.sp_rename N'dbo.PIMS_PROP_ACT_INVOLVED_PARTY.PIMS_PROPERTY_ACTIVITY_ID' , N'PIMS_MANAGEMENT_ACTIVITY_ID', 'COLUMN'
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
EXEC dbo.sp_rename N'dbo.PIMS_PROP_ACT_MIN_CONTACT.PIMS_PROPERTY_ACTIVITY_ID' , N'PIMS_MANAGEMENT_ACTIVITY_ID', 'COLUMN'
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
EXEC dbo.sp_rename N'dbo.PIMS_PROP_ACTIVITY_MGMT_ACTIVITY.PIMS_PROPERTY_ACTIVITY_ID' , N'PIMS_MANAGEMENT_ACTIVITY_ID', 'COLUMN'
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
EXEC dbo.sp_rename N'dbo.PIMS_PROPERTY_ACTIVITY_INVOICE_HIST.PIMS_PROPERTY_ACTIVITY_ID' , N'PIMS_MANAGEMENT_ACTIVITY_ID', 'COLUMN'
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
EXEC dbo.sp_rename N'dbo.PIMS_PROP_ACTIVITY_MGMT_ACTIVITY_HIST.PIMS_PROPERTY_ACTIVITY_ID' , N'PIMS_MANAGEMENT_ACTIVITY_ID', 'COLUMN'
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
EXEC dbo.sp_rename N'dbo.PIMS_PROP_ACT_MIN_CONTACT_HIST.PIMS_PROPERTY_ACTIVITY_ID' , N'PIMS_MANAGEMENT_ACTIVITY_ID', 'COLUMN'
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
EXEC dbo.sp_rename N'dbo.PIMS_PROPERTY_ACTIVITY_DOCUMENT_HIST.PIMS_PROPERTY_ACTIVITY_ID' , N'PIMS_MANAGEMENT_ACTIVITY_ID', 'COLUMN'
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
EXEC dbo.sp_rename N'dbo.PIMS_PROP_ACT_INVOLVED_PARTY_HIST.PIMS_PROPERTY_ACTIVITY_ID' , N'PIMS_MANAGEMENT_ACTIVITY_ID', 'COLUMN'
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Create sequence dbo.PIMS_MANAGEMENT_ACTIVITY_PROPERTY_H_ID_SEQ
PRINT N'Create sequence dbo.PIMS_MANAGEMENT_ACTIVITY_PROPERTY_H_ID_SEQ'
GO
CREATE SEQUENCE [dbo].[PIMS_MANAGEMENT_ACTIVITY_PROPERTY_H_ID_SEQ]
	AS bigint
	START WITH 1
...
-- Create table dbo.PIMS_MANAGEMENT_ACTIVITY_PROPERTY_HIST
PRINT N'Create table dbo.PIMS_MANAGEMENT_ACTIVITY_PROPERTY_HIST'
GO
CREATE TABLE [dbo].[PIMS_MANAGEMENT_ACTIVITY_PROPERTY_HIST]  ( 
	[_MANAGEMENT_ACTIVITY_PROPERTY_HIST_ID]	bigint NOT NULL DEFAULT (NEXT VALUE FOR [PIMS_MANAGEMENT_ACTIVITY_PROPERTY_H_ID_SEQ]),
	[EFFECTIVE_DATE_HIST]                  	datetime NOT NULL DEFAULT (getutcdate()),
	[END_DATE_HIST]                        	datetime NULL,
	[MANAGEMENT_ACTIVITY_PROPERTY_ID]      	bigint NOT NULL,
	[PROPERTY_ID]                          	bigint NOT NULL,
	[PIMS_MANAGEMENT_ACTIVITY_ID]          	bigint NOT NULL,
	...
	CONSTRAINT [PIMS_MAACPR_H_PK] PRIMARY KEY CLUSTERED([_MANAGEMENT_ACTIVITY_PROPERTY_HIST_ID])
 ON [PRIMARY])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Create unique constraint dbo.PIMS_MAACPR_H_UK
PRINT N'Create unique constraint dbo.PIMS_MAACPR_H_UK'
GO
ALTER TABLE [dbo].[PIMS_MANAGEMENT_ACTIVITY_PROPERTY_HIST]
	ADD CONSTRAINT [PIMS_MAACPR_H_UK]
	UNIQUE ([_MANAGEMENT_ACTIVITY_PROPERTY_HIST_ID], [END_DATE_HIST]) 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
-- Create sequence dbo.PIMS_MANAGEMENT_ACTIVITY_H_ID_SEQ
PRINT N'Create sequence dbo.PIMS_MANAGEMENT_ACTIVITY_H_ID_SEQ'
GO
CREATE SEQUENCE [dbo].[PIMS_MANAGEMENT_ACTIVITY_H_ID_SEQ]
	AS bigint
	START WITH 1
...
-- Create table dbo.PIMS_MANAGEMENT_ACTIVITY_HIST
PRINT N'Create table dbo.PIMS_MANAGEMENT_ACTIVITY_HIST'
GO
CREATE TABLE [dbo].[PIMS_MANAGEMENT_ACTIVITY_HIST]  ( 
	[_MANAGEMENT_ACTIVITY_HIST_ID]       	bigint NOT NULL DEFAULT (NEXT VALUE FOR [PIMS_MANAGEMENT_ACTIVITY_H_ID_SEQ]),
	[EFFECTIVE_DATE_HIST]                	datetime NOT NULL DEFAULT (getutcdate()),
	[END_DATE_HIST]                      	datetime NULL,
	[PIMS_MANAGEMENT_ACTIVITY_ID]        	bigint NOT NULL,
	...
	CONSTRAINT [PIMS_MGMTAC_H_PK] PRIMARY KEY CLUSTERED([_MANAGEMENT_ACTIVITY_HIST_ID])
 ON [PRIMARY])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Create unique constraint dbo.PIMS_MGMTAC_H_UK
PRINT N'Create unique constraint dbo.PIMS_MGMTAC_H_UK'
GO
ALTER TABLE [dbo].[PIMS_MANAGEMENT_ACTIVITY_HIST]
	ADD CONSTRAINT [PIMS_MGMTAC_H_UK]
	UNIQUE ([_MANAGEMENT_ACTIVITY_HIST_ID], [END_DATE_HIST]) 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
-- Create sequence dbo.PIMS_MANAGEMENT_FILE_CONTACT_H_ID_SEQ
PRINT N'Create sequence dbo.PIMS_MANAGEMENT_FILE_CONTACT_H_ID_SEQ'
GO
CREATE SEQUENCE [dbo].[PIMS_MANAGEMENT_FILE_CONTACT_H_ID_SEQ]
	AS bigint
	START WITH 1
...
-- Create table dbo.PIMS_MANAGEMENT_FILE_CONTACT_HIST
PRINT N'Create table dbo.PIMS_MANAGEMENT_FILE_CONTACT_HIST'
GO
CREATE TABLE [dbo].[PIMS_MANAGEMENT_FILE_CONTACT_HIST]  ( 
	[_MANAGEMENT_FILE_CONTACT_HIST_ID]	bigint NOT NULL DEFAULT (NEXT VALUE FOR [PIMS_MANAGEMENT_FILE_CONTACT_H_ID_SEQ]),
	[EFFECTIVE_DATE_HIST]             	datetime NOT NULL DEFAULT (getutcdate()),
	[END_DATE_HIST]                   	datetime NULL,
	[MANAGEMENT_FILE_CONTACT_ID]      	bigint NOT NULL,
	[MANAGEMENT_FILE_ID]              	bigint NULL,
	[PERSON_ID]                       	bigint NULL,
	[ORGANIZATION_ID]                 	bigint NULL,
	[PRIMARY_CONTACT_ID]              	bigint NULL,
	...
	[DB_LAST_UPDATE_TIMESTAMP]        	datetime NOT NULL,
	[DB_LAST_UPDATE_USERID]           	nvarchar(30) NOT NULL,
	CONSTRAINT [PIMS_MFFLCN_H_PK] PRIMARY KEY CLUSTERED([_MANAGEMENT_FILE_CONTACT_HIST_ID])
 ON [PRIMARY])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Create unique constraint dbo.PIMS_MFFLCN_H_UK
PRINT N'Create unique constraint dbo.PIMS_MFFLCN_H_UK'
GO
ALTER TABLE [dbo].[PIMS_MANAGEMENT_FILE_CONTACT_HIST]
	ADD CONSTRAINT [PIMS_MFFLCN_H_UK]
	UNIQUE ([_MANAGEMENT_FILE_CONTACT_HIST_ID], [END_DATE_HIST]) 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_CONTACT] DROP CONSTRAINT IF EXISTS [DF__PIMS_PROP__APP_L__4341E1B1]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_CONTACT] ADD CONSTRAINT [PRPCNT_APP_LAST_UPDATE_USERID_DEF] DEFAULT (user_name()) FOR [APP_LAST_UPDATE_USERID]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC sp_addextendedproperty 
...
-- Create index dbo.MFFLCN_PRIMARY_CONTACT_ID_IDX
PRINT N'Create index dbo.MFFLCN_PRIMARY_CONTACT_ID_IDX'
GO
CREATE NONCLUSTERED INDEX [MFFLCN_PRIMARY_CONTACT_ID_IDX]
	ON [dbo].[PIMS_MANAGEMENT_FILE_CONTACT]([PRIMARY_CONTACT_ID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Create index dbo.MFFLCN_ORGANIZATION_ID_IDX
PRINT N'Create index dbo.MFFLCN_ORGANIZATION_ID_IDX'
GO
CREATE NONCLUSTERED INDEX [MFFLCN_ORGANIZATION_ID_IDX]
	ON [dbo].[PIMS_MANAGEMENT_FILE_CONTACT]([ORGANIZATION_ID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Create index dbo.MFFLCN_PERSON_ID_IDX
PRINT N'Create index dbo.MFFLCN_PERSON_ID_IDX'
GO
CREATE NONCLUSTERED INDEX [MFFLCN_PERSON_ID_IDX]
	ON [dbo].[PIMS_MANAGEMENT_FILE_CONTACT]([PERSON_ID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Create index dbo.MGMTAC_MANAGEMENT_FILE_ID_IDX
PRINT N'Create index dbo.MGMTAC_MANAGEMENT_FILE_ID_IDX'
GO
CREATE NONCLUSTERED INDEX [MGMTAC_MANAGEMENT_FILE_ID_IDX]
	ON [dbo].[PIMS_MANAGEMENT_ACTIVITY]([MANAGEMENT_FILE_ID])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Create trigger dbo.PIMS_MFFLCN_I_S_U_TR
PRINT N'Create trigger dbo.PIMS_MFFLCN_I_S_U_TR'
GO
CREATE TRIGGER [dbo].[PIMS_MFFLCN_I_S_U_TR] ON PIMS_MANAGEMENT_FILE_CONTACT INSTEAD OF UPDATE AS
SET NOCOUNT ON
BEGIN TRY
  ...
  if exists (select 1 from inserted, deleted where inserted.CONCURRENCY_CONTROL_NUMBER != deleted.CONCURRENCY_CONTROL_NUMBER+1 AND inserted.MANAGEMENT_FILE_CONTACT_ID = deleted.MANAGEMENT_FILE_CONTACT_ID)
    raiserror('CONCURRENCY FAILURE.',16,1)


  -- update statement
  update PIMS_MANAGEMENT_FILE_CONTACT
    set "MANAGEMENT_FILE_CONTACT_ID" = inserted."MANAGEMENT_FILE_CONTACT_ID",
    ...
    inner join inserted
    on (PIMS_MANAGEMENT_FILE_CONTACT.MANAGEMENT_FILE_CONTACT_ID = inserted.MANAGEMENT_FILE_CONTACT_ID);
...
-- Create trigger dbo.PIMS_MFFLCN_A_S_IUD_TR
PRINT N'Create trigger dbo.PIMS_MFFLCN_A_S_IUD_TR'
GO
CREATE TRIGGER [dbo].[PIMS_MFFLCN_A_S_IUD_TR] ON PIMS_MANAGEMENT_FILE_CONTACT FOR INSERT, UPDATE, DELETE AS
SET NOCOUNT ON
BEGIN TRY
DECLARE @curr_date datetime;
SET @curr_date = getutcdate();
  ...
  -- historical
  IF EXISTS(SELECT * FROM deleted)
    update PIMS_MANAGEMENT_FILE_CONTACT_HIST set END_DATE_HIST = @curr_date where MANAGEMENT_FILE_CONTACT_ID in (select MANAGEMENT_FILE_CONTACT_ID from deleted) and END_DATE_HIST is null;
  
  IF EXISTS(SELECT * FROM inserted)
    insert into PIMS_MANAGEMENT_FILE_CONTACT_HIST ([MANAGEMENT_FILE_CONTACT_ID], [MANAGEMENT_FILE_ID], [PERSON_ID], [ORGANIZATION_ID], [PRIMARY_CONTACT_ID], [PURPOSE], [CONCURRENCY_CONTROL_NUMBER], [APP_CREATE_TIMESTAMP], [APP_CREATE_USERID], [APP_CREATE_USER_GUID], [APP_CREATE_USER_DIRECTORY], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USERID], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USER_DIRECTORY], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], _MANAGEMENT_FILE_CONTACT_HIST_ID, END_DATE_HIST, EFFECTIVE_DATE_HIST)
      select [MANAGEMENT_FILE_CONTACT_ID], [MANAGEMENT_FILE_ID], [PERSON_ID], [ORGANIZATION_ID], [PRIMARY_CONTACT_ID], [PURPOSE], [CONCURRENCY_CONTROL_NUMBER], [APP_CREATE_TIMESTAMP], [APP_CREATE_USERID], [APP_CREATE_USER_GUID], [APP_CREATE_USER_DIRECTORY], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USERID], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USER_DIRECTORY], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], (next value for [dbo].[PIMS_MANAGEMENT_FILE_CONTACT_H_ID_SEQ]) as [_MANAGEMENT_FILE_CONTACT_HIST_ID], null as [END_DATE_HIST], @curr_date as [EFFECTIVE_DATE_HIST] from inserted;
...
-- Create trigger dbo.PIMS_MFFLCN_I_S_I_TR
PRINT N'Create trigger dbo.PIMS_MFFLCN_I_S_I_TR'
GO
CREATE TRIGGER [dbo].[PIMS_MFFLCN_I_S_I_TR] ON PIMS_MANAGEMENT_FILE_CONTACT INSTEAD OF INSERT AS
SET NOCOUNT ON
BEGIN TRY
  IF NOT EXISTS(SELECT * FROM inserted) 
    RETURN;
  ...
  insert into PIMS_MANAGEMENT_FILE_CONTACT ("MANAGEMENT_FILE_CONTACT_ID",
      "MANAGEMENT_FILE_ID",
      "PERSON_ID",
      "ORGANIZATION_ID",
      "PRIMARY_CONTACT_ID",
      ...
      "APP_LAST_UPDATE_USER_GUID",
      "APP_LAST_UPDATE_USER_DIRECTORY")
    select "MANAGEMENT_FILE_CONTACT_ID",
      "MANAGEMENT_FILE_ID",
      "PERSON_ID",
      "ORGANIZATION_ID",
      "PRIMARY_CONTACT_ID",
...
-- Create foreign key constraint dbo.PIM_MGMTFL_PIM_MGMTAC_FK
PRINT N'Create foreign key constraint dbo.PIM_MGMTFL_PIM_MGMTAC_FK'
GO
ALTER TABLE [dbo].[PIMS_MANAGEMENT_ACTIVITY]
	ADD CONSTRAINT [PIM_MGMTFL_PIM_MGMTAC_FK]
...
-- Create foreign key constraint dbo.PIM_ORG_PIM_MFFLCN_FK
PRINT N'Create foreign key constraint dbo.PIM_ORG_PIM_MFFLCN_FK'
GO
ALTER TABLE [dbo].[PIMS_MANAGEMENT_FILE_CONTACT]
	ADD CONSTRAINT [PIM_ORG_PIM_MFFLCN_FK]
...
-- Create foreign key constraint dbo.PIM_PERSON_PIM_MFFLCN_PE_FK
PRINT N'Create foreign key constraint dbo.PIM_PERSON_PIM_MFFLCN_PE_FK'
GO
ALTER TABLE [dbo].[PIMS_MANAGEMENT_FILE_CONTACT]
	ADD CONSTRAINT [PIM_PERSON_PIM_MFFLCN_PE_FK]
...
-- Create foreign key constraint dbo.PIM_PERSON_PIM_MFFLCN_PC_FK
PRINT N'Create foreign key constraint dbo.PIM_PERSON_PIM_MFFLCN_PC_FK'
GO
ALTER TABLE [dbo].[PIMS_MANAGEMENT_FILE_CONTACT]
	ADD CONSTRAINT [PIM_PERSON_PIM_MFFLCN_PC_FK]
