...
-- Create foreign key constraint dbo.PIM_MGMTFL_PIM_MFFLCN_FK
PRINT N'Create foreign key constraint dbo.PIM_MGMTFL_PIM_MFFLCN_FK'
GO
ALTER TABLE [dbo].[PIMS_MANAGEMENT_FILE_CONTACT]
	ADD CONSTRAINT [PIM_MGMTFL_PIM_MFFLCN_FK]
