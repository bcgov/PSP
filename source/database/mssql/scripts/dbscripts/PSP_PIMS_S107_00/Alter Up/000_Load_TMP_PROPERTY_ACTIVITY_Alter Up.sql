...
-- Migrate the PIMS_PROPERTY_ACTIVITY data to the TMP_PROPERTY_ACTIVITY table
PRINT N'Migrate the PIMS_PROPERTY_ACTIVITY data to the TMP_PROPERTY_ACTIVITY table'
GO
