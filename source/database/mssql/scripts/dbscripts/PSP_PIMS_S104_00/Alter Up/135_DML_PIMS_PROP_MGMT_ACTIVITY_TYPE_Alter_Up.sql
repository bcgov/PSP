...
-- Add/Enable the "CONSULTATION" type
PRINT N'Add/Enable the "CONSULTATION" type'
GO
...
ELSE
  ...
  VALUES (N'CONSULTATION', N'Consultation (other)');  
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Add/Enable the "TRAILMTC" type
PRINT N'Add/Enable the "TRAILMTC" type'
GO
DECLARE @CurrCd NVARCHAR(20)
...
ELSE
  INSERT INTO PIMS_PROP_MGMT_ACTIVITY_TYPE (PROP_MGMT_ACTIVITY_TYPE_CODE, DESCRIPTION)
  VALUES (N'TRAILMTC', N'Trail Maintenance');
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
