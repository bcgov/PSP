-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Wed Sep 29 13:24:44 PDT 2021
-- Execute this script on:
-- 		PIMS_S11_00/dbo - This database/schema will be modified
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_IMPROVEMENT]
	DROP CONSTRAINT [PIM_PIMPRT_PIM_PIMPRV_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop foreign key constraint dbo.PIM_PIMPRU_PIM_PIMPRV_FK
PRINT N'Drop foreign key constraint dbo.PIM_PIMPRU_PIM_PIMPRV_FK'
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_IMPROVEMENT]
...
-- Drop foreign key constraint dbo.PIM_PRPRTY_PIM_PRPTAX_FK
PRINT N'Drop foreign key constraint dbo.PIM_PRPRTY_PIM_PRPTAX_FK'
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_TAX]
	DROP CONSTRAINT [PIM_PRPRTY_PIM_PRPTAX_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop foreign key constraint dbo.PIM_PTRMTT_PIM_PRPTAX_FK
PRINT N'Drop foreign key constraint dbo.PIM_PTRMTT_PIM_PRPTAX_FK'
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_TAX]
	DROP CONSTRAINT [PIM_PTRMTT_PIM_PRPTAX_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Drop foreign key constraint dbo.PIM_SPDCLT_PIM_PRPRTY_FK
PRINT N'Drop foreign key constraint dbo.PIM_SPDCLT_PIM_PRPRTY_FK'
GO
ALTER TABLE [dbo].[PIMS_PROPERTY]
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY]
	DROP CONSTRAINT [PIM_PERSON_PIM_PRPRTY_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Drop index dbo.CLMTYP_KEYCLOAK_ROLE_ID_IDX
PRINT N'Drop index dbo.CLMTYP_KEYCLOAK_ROLE_ID_IDX'
GO
...
-- Drop index dbo.CLMTYP_CLAIM_UID_IDX
PRINT N'Drop index dbo.CLMTYP_CLAIM_UID_IDX'
GO
...
-- Drop index dbo.PRPTAX_PROPERTY_TAX_REMIT_TYPE_CODE_IDX
PRINT N'Drop index dbo.PRPTAX_PROPERTY_TAX_REMIT_TYPE_CODE_IDX'
GO
DROP INDEX [dbo].[PIMS_PROPERTY_TAX].[PRPTAX_PROPERTY_TAX_REMIT_TYPE_CODE_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop index dbo.PRPTAX_PROPERTY_ID_IDX
PRINT N'Drop index dbo.PRPTAX_PROPERTY_ID_IDX'
GO
DROP INDEX [dbo].[PIMS_PROPERTY_TAX].[PRPTAX_PROPERTY_ID_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Drop index dbo.PRPRTY_SURPLUS_DECLARATION_TYPE_CODE_IDX
PRINT N'Drop index dbo.PRPRTY_SURPLUS_DECLARATION_TYPE_CODE_IDX'
GO
...
GO
DROP INDEX [dbo].[PIMS_PROPERTY].[PRPRTY_PROPERTY_MANAGER_ID_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP INDEX [dbo].[PIMS_PROPERTY].[PRPRTY_PROP_MGMT_ORG_ID_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Drop index dbo.USER_GUID_IDENTIFIER_VALUE_IDX
PRINT N'Drop index dbo.USER_GUID_IDENTIFIER_VALUE_IDX'
GO
...
-- Drop index dbo.USER_BUSINESS_IDENTIFIER_VALUE_IDX
PRINT N'Drop index dbo.USER_BUSINESS_IDENTIFIER_VALUE_IDX'
GO
...
-- Drop index dbo.ROLE_KEYCLOAK_GROUP_ID_IDX
PRINT N'Drop index dbo.ROLE_KEYCLOAK_GROUP_ID_IDX'
GO
...
-- Drop unique constraint dbo.PIMS_SDRTRN_H_UK
PRINT N'Drop unique constraint dbo.PIMS_SDRTRN_H_UK'
GO
ALTER TABLE [dbo].[PIMS_SECURITY_DEPOSIT_RETURN_HIST]
	DROP CONSTRAINT [PIMS_SDRTRN_H_UK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop primary key constraint dbo.PIMS_SDRTRN_H_PK
PRINT N'Drop primary key constraint dbo.PIMS_SDRTRN_H_PK'
GO
ALTER TABLE [dbo].[PIMS_SECURITY_DEPOSIT_RETURN_HIST]
	DROP CONSTRAINT [PIMS_SDRTRN_H_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
PRINT N'Drop table dbo.PIMS_SECURITY_DEPOSIT_RETURN'
GO
DROP TABLE [dbo].[PIMS_SECURITY_DEPOSIT_RETURN]
GO
IF @@ERROR <> 0 SET NOEXEC ON
...
-- Drop unique constraint dbo.PIMS_SECDEP_H_UK
PRINT N'Drop unique constraint dbo.PIMS_SECDEP_H_UK'
GO
ALTER TABLE [dbo].[PIMS_SECURITY_DEPOSIT_HIST]
	DROP CONSTRAINT [PIMS_SECDEP_H_UK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop primary key constraint dbo.PIMS_SECDEP_H_PK
PRINT N'Drop primary key constraint dbo.PIMS_SECDEP_H_PK'
GO
ALTER TABLE [dbo].[PIMS_SECURITY_DEPOSIT_HIST]
	DROP CONSTRAINT [PIMS_SECDEP_H_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
PRINT N'Drop table dbo.PIMS_SECURITY_DEPOSIT'
GO
DROP TABLE [dbo].[PIMS_SECURITY_DEPOSIT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
...
-- Drop primary key constraint dbo.SECDPT_PK
PRINT N'Drop primary key constraint dbo.SECDPT_PK'
GO
ALTER TABLE [dbo].[PIMS_SECURITY_DEPOSIT_TYPE]
	DROP CONSTRAINT [SECDPT_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Drop unique constraint dbo.PIMS_PIMPRV_H_UK
PRINT N'Drop unique constraint dbo.PIMS_PIMPRV_H_UK'
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_IMPROVEMENT_HIST]
	DROP CONSTRAINT [PIMS_PIMPRV_H_UK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop primary key constraint dbo.PIMS_PIMPRV_H_PK
PRINT N'Drop primary key constraint dbo.PIMS_PIMPRV_H_PK'
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_IMPROVEMENT_HIST]
	DROP CONSTRAINT [PIMS_PIMPRV_H_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_IMPROVEMENT]
	DROP CONSTRAINT [PIMPRV_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop table dbo.PIMS_PROPERTY_IMPROVEMENT
PRINT N'Drop table dbo.PIMS_PROPERTY_IMPROVEMENT'
GO
DROP TABLE [dbo].[PIMS_PROPERTY_IMPROVEMENT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
...
-- Drop primary key constraint dbo.PIMPRU_PK
PRINT N'Drop primary key constraint dbo.PIMPRU_PK'
GO
...
-- Drop primary key constraint dbo.PIMPRT_PK
PRINT N'Drop primary key constraint dbo.PIMPRT_PK'
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_IMPROVEMENT_TYPE]
	DROP CONSTRAINT [PIMPRT_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Drop unique constraint dbo.PIMS_PRPTAX_H_UK
PRINT N'Drop unique constraint dbo.PIMS_PRPTAX_H_UK'
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_TAX_HIST]
	DROP CONSTRAINT [PIMS_PRPTAX_H_UK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop primary key constraint dbo.PIMS_PRPTAX_H_PK
PRINT N'Drop primary key constraint dbo.PIMS_PRPTAX_H_PK'
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_TAX_HIST]
	DROP CONSTRAINT [PIMS_PRPTAX_H_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop primary key constraint dbo.PRPTAX_PK
PRINT N'Drop primary key constraint dbo.PRPTAX_PK'
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_TAX]
	DROP CONSTRAINT [PRPTAX_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop table dbo.PIMS_PROPERTY_TAX
PRINT N'Drop table dbo.PIMS_PROPERTY_TAX'
GO
DROP TABLE [dbo].[PIMS_PROPERTY_TAX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
...
-- Drop primary key constraint dbo.PTRMTT_PK
PRINT N'Drop primary key constraint dbo.PTRMTT_PK'
GO
ALTER TABLE [dbo].[PIMS_PROPERTY_TAX_REMIT_TYPE]
	DROP CONSTRAINT [PTRMTT_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Drop primary key constraint dbo.SPDCLT_PK
PRINT N'Drop primary key constraint dbo.SPDCLT_PK'
GO
ALTER TABLE [dbo].[PIMS_SURPLUS_DECLARATION_TYPE]
	DROP CONSTRAINT [SPDCLT_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
ALTER TABLE [dbo].[PIMS_LEASE_TENANT_HIST]
	DROP CONSTRAINT [PIMS_TENANT_H_UK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_LEASE_TENANT_HIST]
	DROP CONSTRAINT [PIMS_TENANT_H_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Drop primary key constraint dbo.LSSRTY_PK
PRINT N'Drop primary key constraint dbo.LSSRTY_PK'
GO
ALTER TABLE [dbo].[PIMS_LESSOR_TYPE]
	DROP CONSTRAINT [LSSRTY_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop unique constraint dbo.PIMS_INSRNC_H_UK
PRINT N'Drop unique constraint dbo.PIMS_INSRNC_H_UK'
GO
ALTER TABLE [dbo].[PIMS_INSURANCE_HIST]
	DROP CONSTRAINT [PIMS_INSRNC_H_UK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop primary key constraint dbo.PIMS_INSRNC_H_PK
PRINT N'Drop primary key constraint dbo.PIMS_INSRNC_H_PK'
GO
ALTER TABLE [dbo].[PIMS_INSURANCE_HIST]
	DROP CONSTRAINT [PIMS_INSRNC_H_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
PRINT N'Drop table dbo.PIMS_INSURANCE'
GO
DROP TABLE [dbo].[PIMS_INSURANCE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
...
-- Drop primary key constraint dbo.INSPYT_PK
PRINT N'Drop primary key constraint dbo.INSPYT_PK'
GO
ALTER TABLE [dbo].[PIMS_INSURANCE_TYPE]
	DROP CONSTRAINT [INSPYT_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Drop primary key constraint dbo.LELIST_PK
PRINT N'Drop primary key constraint dbo.LELIST_PK'
GO
ALTER TABLE [dbo].[PIMS_LEASE_LICENSE_TYPE]
	DROP CONSTRAINT [LELIST_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Drop primary key constraint dbo.LPRPTY_PK
PRINT N'Drop primary key constraint dbo.LPRPTY_PK'
GO
ALTER TABLE [dbo].[PIMS_LEASE_PURPOSE_TYPE]
	DROP CONSTRAINT [LPRPTY_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
PRINT N'Drop sequence dbo.PIMS_LEASE_PAYMENT_ID_SEQ'
GO
DROP SEQUENCE [dbo].[PIMS_LEASE_PAYMENT_ID_SEQ]
GO
IF @@ERROR <> 0 SET NOEXEC ON
...
GO
ALTER TABLE [dbo].[PIMS_LEASE_PMT_FREQ_TYPE] ALTER COLUMN [LEASE_PMT_FREQ_TYPE_CODE] nvarchar(40) NOT NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Create primary key constraint dbo.LSPMTF_PK
PRINT N'Create primary key constraint dbo.LSPMTF_PK'
GO
ALTER TABLE [dbo].[PIMS_LEASE_PMT_FREQ_TYPE]
	ADD PRIMARY KEY CLUSTERED ([LEASE_PMT_FREQ_TYPE_CODE]) 
	WITH (
...
GO
ALTER TABLE [dbo].[PIMS_LEASE_PROGRAM_TYPE] ALTER COLUMN [LEASE_PROGRAM_TYPE_CODE] nvarchar(40) NOT NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Create primary key constraint dbo.LSPRGT_PK
PRINT N'Create primary key constraint dbo.LSPRGT_PK'
GO
ALTER TABLE [dbo].[PIMS_LEASE_PROGRAM_TYPE]
	ADD PRIMARY KEY CLUSTERED ([LEASE_PROGRAM_TYPE_CODE]) 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
GO
ALTER TABLE [dbo].[PIMS_LEASE_PURPOSE_TYPE] ALTER COLUMN [LEASE_PURPOSE_TYPE_CODE] smallint NOT NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_LEASE_PURPOSE_TYPE]
	ADD CONSTRAINT [LSPRTY_PK]
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1632946420862]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1632946420862]([ADDRESS_ID], [ADDRESS_USAGE_TYPE_CODE], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [COUNTRY_ID], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [DISTRICT_CODE], [LATITUDE], [LONGITUDE], [MUNICIPALITY_NAME], [POSTAL_CODE], [PROVINCE_STATE_ID], [REGION_CODE], [STREET_ADDRESS_1], [STREET_ADDRESS_2], [STREET_ADDRESS_3]) 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1632946420862]', N'PIMS_ADDRESS', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1632946420861]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1632946420861]([ADDRESS_ID], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [DISTRICT_CODE], [IS_DISABLED], [ORG_IDENTIFIER_TYPE_CODE], [ORGANIZATION_ID], [ORGANIZATION_IDENTIFIER], [ORGANIZATION_NAME], [ORGANIZATION_TYPE_CODE], [PRNT_ORGANIZATION_ID], [REGION_CODE], [WEBSITE]) 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1632946420861]', N'PIMS_ORGANIZATION', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1632946420863]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1632946420863]([ADDRESS_ID], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [BIRTH_DATE], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [FIRST_NAME], [IS_DISABLED], [MIDDLE_NAMES], [NAME_SUFFIX], [PERSON_ID], [SURNAME]) 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1632946420863]', N'PIMS_PERSON', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_LEASE]
DROP CONSTRAINT [LEASE_RENEWAL_COUNT_DEF]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[PIMS_LEASE]
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1632946420834]  ( 
	[APP_CREATE_TIMESTAMP]          	datetime NOT NULL DEFAULT (getutcdate()),
...
EXEC sp_addextendedproperty 
	...
	@level1type = N'Table', @level1name = N'ADS_SSDATA_1632946420834', 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1632946420834]([APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [EXPIRED], [EXPIRY_DATE], [HAS_DIGITAL_FILE], [HAS_DIGITAL_LICENSE], [HAS_PHYSICAL_FILE], [HAS_PHYSICIAL_LICENSE], [INSPECTION_DATE], [INSPECTION_NOTES], [INSURANCE_END_DATE], [INSURANCE_START_DATE], [L_FILE_NO], [LEASE_AMOUNT], [LEASE_ID], [LEASE_NOTES], [LEASE_PMT_FREQ_TYPE_CODE], [LEASE_PROGRAM_TYPE_CODE], [LEASE_PURPOSE_SUBTYPE_CODE], [LEASE_PURPOSE_TYPE_CODE], [LEASE_STATUS_TYPE_CODE], [PROP_MGMT_ORG_ID], [PROPERTY_MANAGER_ID], [PS_FILE_NO], [RENEWAL_DATE], [SECURITY_END_DATE], [SECURITY_START_DATE], [START_DATE], [TENANT_ID], [TFA_FILE_NO], [UNIT]) 
	SELECT [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [IS_EXPIRED], [ORIG_EXPIRY_DATE], [HAS_DIGITAL_FILE], [HAS_DIGITAL_LICENSE], [HAS_PHYSICAL_FILE], [HAS_PHYSICIAL_LICENSE], [INSPECTION_DATE], [INSPECTION_NOTES], [TERM_EXPIRY_DATE], [TERM_RENEWAL_DATE], [L_FILE_NO], [LEASE_AMOUNT], [LEASE_ID], [LEASE_NOTES], [LEASE_PMT_FREQ_TYPE_CODE], [LEASE_PROGRAM_TYPE_CODE], [RENEWAL_COUNT], [LEASE_PURPOSE_TYPE_CODE], [LEASE_CATEGORY_TYPE_CODE], [INCLUDED_RENEWALS], [IS_ORIG_EXPIRY_REQUIRED], [PS_FILE_NO], [TERM_START_DATE], [ORIG_START_DATE], [LEASE_LICENSE_TYPE_CODE], [LEASE_PAY_RVBL_TYPE_CODE], [MOTI_NAME_ID], [TFA_FILE_NO], SUBSTRING(LEASE_DESCRIPTION,1,2000) 
	FROM [dbo].[PIMS_LEASE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1632946420834]', N'PIMS_LEASE', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1632946420870]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1632946420870]', N'PIMS_ACCESS_REQUEST', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1632946420867]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1632946420867]([ACCESS_REQUEST_ID], [ACCESS_REQUEST_ORGANIZATION_ID], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [IS_DISABLED], [ORGANIZATION_ID]) 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1632946420867]', N'PIMS_ACCESS_REQUEST_ORGANIZATION', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1632946420866]  ( 
	[APP_CREATE_TIMESTAMP]          	datetime NOT NULL DEFAULT (getutcdate()),
	[APP_CREATE_USER_DIRECTORY]     	nvarchar(30) NOT NULL,
	[APP_CREATE_USER_GUID]          	uniqueidentifier NULL,
	[APP_CREATE_USERID]             	nvarchar(30) NOT NULL,
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1632946420866]([APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [CONTACT_METHOD_ID], [CONTACT_METHOD_TYPE_CODE], [CONTACT_METHOD_VALUE], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [IS_PREFERRED_METHOD], [ORGANIZATION_ID], [PERSON_ID]) 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1632946420866]', N'PIMS_CONTACT_METHOD', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1632946420868]  ( 
	[APP_CREATE_TIMESTAMP]          	datetime NOT NULL DEFAULT (getutcdate()),
	[APP_CREATE_USER_DIRECTORY]     	nvarchar(30) NOT NULL,
	[APP_CREATE_USER_GUID]          	uniqueidentifier NULL,
	[APP_CREATE_USERID]             	nvarchar(30) NOT NULL,
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1632946420868]', N'PIMS_PERSON_ORGANIZATION', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_PROPERTY]
	DROP COLUMN [PROP_MGMT_ORG_ID], [PROPERTY_MANAGER_ID], [SURPLUS_DECLARATION_COMMENT], [SURPLUS_DECLARATION_DATE], [SURPLUS_DECLARATION_TYPE_CODE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
CREATE TABLE [dbo].[ADS_SSDATA_1632946420835]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1632946420835]([_LEASE_HIST_ID], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [EFFECTIVE_DATE_HIST], [END_DATE_HIST], [EXPIRED], [EXPIRY_DATE], [HAS_DIGITAL_FILE], [HAS_DIGITAL_LICENSE], [HAS_PHYSICAL_FILE], [HAS_PHYSICIAL_LICENSE], [INSPECTION_DATE], [INSPECTION_NOTES], [INSURANCE_END_DATE], [INSURANCE_START_DATE], [L_FILE_NO], [LEASE_AMOUNT], [LEASE_ID], [LEASE_NOTES], [LEASE_PMT_FREQ_TYPE_CODE], [LEASE_PROGRAM_TYPE_CODE], [LEASE_PURPOSE_SUBTYPE_CODE], [LEASE_PURPOSE_TYPE_CODE], [LEASE_STATUS_TYPE_CODE], [PROP_MGMT_ORG_ID], [PROPERTY_MANAGER_ID], [PS_FILE_NO], [RENEWAL_DATE], [SECURITY_END_DATE], [SECURITY_START_DATE], [START_DATE], [TENANT_ID], [TFA_FILE_NO], [UNIT]) 
	SELECT [_LEASE_HIST_ID], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [EFFECTIVE_DATE_HIST], [END_DATE_HIST], [IS_EXPIRED], [ORIG_EXPIRY_DATE], [HAS_DIGITAL_FILE], [HAS_DIGITAL_LICENSE], [HAS_PHYSICAL_FILE], [HAS_PHYSICIAL_LICENSE], [INSPECTION_DATE], [INSPECTION_NOTES], [TERM_EXPIRY_DATE], [TERM_RENEWAL_DATE], [L_FILE_NO], [LEASE_AMOUNT], [LEASE_ID], [LEASE_NOTES], [LEASE_PMT_FREQ_TYPE_CODE], [LEASE_PROGRAM_TYPE_CODE], [RENEWAL_COUNT], [LEASE_PURPOSE_TYPE_CODE], [LEASE_CATEGORY_TYPE_CODE], [INCLUDED_RENEWALS], [IS_ORIG_EXPIRY_REQUIRED], [PS_FILE_NO], [TERM_START_DATE], [ORIG_START_DATE], [LEASE_LICENSE_TYPE_CODE], [LEASE_PAY_RVBL_TYPE_CODE], [MOTI_NAME_ID], [TFA_FILE_NO], SUBSTRING(LEASE_DESCRIPTION,1,2000) 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1632946420835]', N'PIMS_LEASE_HIST', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Alter table dbo.PIMS_TASK_TEMPLATE_TYPE
PRINT N'Alter table dbo.PIMS_TASK_TEMPLATE_TYPE'
GO
ALTER TABLE [dbo].[PIMS_TASK_TEMPLATE_TYPE] ALTER COLUMN [TASK_TEMPLATE_TYPE_CODE] nvarchar(40) NOT NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Create primary key constraint dbo.TSKTMT_PK
PRINT N'Create primary key constraint dbo.TSKTMT_PK'
GO
ALTER TABLE [dbo].[PIMS_TASK_TEMPLATE_TYPE]
	ADD PRIMARY KEY CLUSTERED ([TASK_TEMPLATE_TYPE_CODE]) 
	WITH (
		DATA_COMPRESSION = NONE
	) ON [PRIMARY]
GO
...
-- Alter table dbo.PIMS_TASK_TEMPLATE
PRINT N'Alter table dbo.PIMS_TASK_TEMPLATE'
GO
ALTER TABLE [dbo].[PIMS_TASK_TEMPLATE] ALTER COLUMN [TASK_TEMPLATE_TYPE_CODE] nvarchar(40) NOT NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_TASK_TEMPLATE_HIST] ALTER COLUMN [TASK_TEMPLATE_TYPE_CODE] nvarchar(40) NOT NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1632946420871]  ( 
	[APP_CREATE_TIMESTAMP]          	datetime NOT NULL DEFAULT (getutcdate()),
	[APP_CREATE_USER_DIRECTORY]     	nvarchar(30) NOT NULL,
	[APP_CREATE_USER_GUID]          	uniqueidentifier NULL,
	[APP_CREATE_USERID]             	nvarchar(30) NOT NULL,
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1632946420871]([APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CLAIM_ID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [IS_DISABLED], [ROLE_CLAIM_ID], [ROLE_ID]) 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1632946420871]', N'PIMS_ROLE_CLAIM', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1632946420873]  ( 
	[APP_CREATE_TIMESTAMP]           	datetime NOT NULL DEFAULT (getutcdate()),
	[APP_CREATE_USER_DIRECTORY]      	nvarchar(30) NOT NULL,
	[APP_CREATE_USER_GUID]           	uniqueidentifier NULL,
	[APP_CREATE_USERID]              	nvarchar(30) NOT NULL,
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1632946420873]', N'PIMS_PROPERTY_SERVICE_FILE', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1632946420872]  ( 
	[APP_CREATE_TIMESTAMP]             	datetime NOT NULL DEFAULT (getutcdate()),
	[APP_CREATE_USER_DIRECTORY]        	nvarchar(30) NOT NULL,
	[APP_CREATE_USER_GUID]             	uniqueidentifier NULL,
	[APP_CREATE_USERID]                	nvarchar(30) NOT NULL,
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1632946420872]([APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [IS_DISABLED], [PROPERTY_ID], [PROPERTY_PROPERTY_SERVICE_FILE_ID], [PROPERTY_SERVICE_FILE_ID]) 
	SELECT [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [IS_DISABLED], [PROPERTY_ID], [PROPERTY_PROPERTY_SERVICE_FILE_ID], [PROPERTY_SERVICE_FILE_ID] 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1632946420872]', N'PIMS_PROPERTY_PROPERTY_SERVICE_FILE', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1632946420874]  ( 
	[APP_CREATE_TIMESTAMP]          	datetime NOT NULL DEFAULT (getutcdate()),
	[APP_CREATE_USER_DIRECTORY]     	nvarchar(30) NOT NULL,
	[APP_CREATE_USER_GUID]          	uniqueidentifier NULL,
	[APP_CREATE_USERID]             	nvarchar(30) NOT NULL,
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1632946420874]([APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [IS_DISABLED], [WORKFLOW_MODEL_ID], [WORKFLOW_MODEL_TYPE_CODE]) 
	SELECT [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [IS_DISABLED], [WORKFLOW_MODEL_ID], [WORKFLOW_MODEL_TYPE_CODE] 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1632946420874]', N'PIMS_WORKFLOW_MODEL', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1632946420876]  ( 
	[APP_CREATE_TIMESTAMP]          	datetime NOT NULL DEFAULT (getutcdate()),
	[APP_CREATE_USER_DIRECTORY]     	nvarchar(30) NOT NULL,
	[APP_CREATE_USER_GUID]          	uniqueidentifier NULL,
	[APP_CREATE_USERID]             	nvarchar(30) NOT NULL,
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1632946420876]([APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [PROJECT_ID], [PROJECT_RISK_TYPE_CODE], [PROJECT_STATUS_TYPE_CODE], [PROJECT_TIER_TYPE_CODE], [PROJECT_TYPE_CODE]) 
	SELECT [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [PROJECT_ID], [PROJECT_RISK_TYPE_CODE], [PROJECT_STATUS_TYPE_CODE], [PROJECT_TIER_TYPE_CODE], [PROJECT_TYPE_CODE] 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1632946420876]', N'PIMS_PROJECT', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1632946420875]  ( 
	[APP_CREATE_TIMESTAMP]          	datetime NOT NULL DEFAULT (getutcdate()),
	[APP_CREATE_USER_DIRECTORY]     	nvarchar(30) NOT NULL,
	[APP_CREATE_USER_GUID]          	uniqueidentifier NULL,
	[APP_CREATE_USERID]             	nvarchar(30) NOT NULL,
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1632946420875]([APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [IS_DISABLED], [PROJECT_ID], [PROJECT_WORKFLOW_MODEL_ID], [WORKFLOW_MODEL_ID]) 
	SELECT [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [IS_DISABLED], [PROJECT_ID], [PROJECT_WORKFLOW_MODEL_ID], [WORKFLOW_MODEL_ID] 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1632946420875]', N'PIMS_PROJECT_WORKFLOW_MODEL', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1632946420880]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1632946420880]([ACTIVITY_MODEL_ID], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [DESCRIPTION], [IS_DISABLED]) 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1632946420880]', N'PIMS_ACTIVITY_MODEL', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1632946420877]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1632946420877]([ACTIVITY_ID], [ACTIVITY_MODEL_ID], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [PROJECT_ID], [WORKFLOW_ID]) 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1632946420877]', N'PIMS_ACTIVITY', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1632946420878]  ( 
	[APP_CREATE_TIMESTAMP]          	datetime NOT NULL DEFAULT (getutcdate()),
	[APP_CREATE_USER_DIRECTORY]     	nvarchar(30) NOT NULL,
	[APP_CREATE_USER_GUID]          	uniqueidentifier NULL,
	[APP_CREATE_USERID]             	nvarchar(30) NOT NULL,
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1632946420878]', N'PIMS_PROJECT_NOTE', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1632946420879]  ( 
	[APP_CREATE_TIMESTAMP]          	datetime NOT NULL DEFAULT (getutcdate()),
	[APP_CREATE_USER_DIRECTORY]     	nvarchar(30) NOT NULL,
	[APP_CREATE_USER_GUID]          	uniqueidentifier NULL,
	[APP_CREATE_USERID]             	nvarchar(30) NOT NULL,
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1632946420879]([APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [IS_DISABLED], [PROJECT_ID], [PROJECT_PROPERTY_ID], [PROPERTY_ID]) 
	SELECT [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [IS_DISABLED], [PROJECT_ID], [PROJECT_PROPERTY_ID], [PROPERTY_ID] 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1632946420879]', N'PIMS_PROJECT_PROPERTY', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1632946420883]  ( 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1632946420883]([ACTIVITY_ID], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [IS_DISABLED], [PROPERTY_ACTIVITY_ID], [PROPERTY_ID]) 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1632946420883]', N'PIMS_PROPERTY_ACTIVITY', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1632946420882]  ( 
	[ACTIVITY_ID]                   	bigint NULL,
	[APP_CREATE_TIMESTAMP]          	datetime NOT NULL DEFAULT (getutcdate()),
	[APP_CREATE_USER_DIRECTORY]     	nvarchar(30) NOT NULL,
	[APP_CREATE_USER_GUID]          	uniqueidentifier NULL,
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1632946420882]([ACTIVITY_ID], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [TASK_ID], [TASK_TEMPLATE_ID], [USER_ID]) 
	SELECT [ACTIVITY_ID], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [TASK_ID], [TASK_TEMPLATE_ID], [USER_ID] 
	FROM [dbo].[PIMS_TASK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1632946420882]', N'PIMS_TASK', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1632946420884]  ( 
	[APP_CREATE_TIMESTAMP]          	datetime NOT NULL DEFAULT (getutcdate()),
	[APP_CREATE_USER_DIRECTORY]     	nvarchar(30) NOT NULL,
	[APP_CREATE_USER_GUID]          	uniqueidentifier NULL,
	[APP_CREATE_USERID]             	nvarchar(30) NOT NULL,
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1632946420884]', N'PIMS_PROPERTY_EVALUATION', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1632946420869]  ( 
	[APP_CREATE_TIMESTAMP]          	datetime NOT NULL DEFAULT (getutcdate()),
	[APP_CREATE_USER_DIRECTORY]     	nvarchar(30) NOT NULL DEFAULT (user_name()),
	[APP_CREATE_USER_GUID]          	uniqueidentifier NULL,
	[APP_CREATE_USERID]             	nvarchar(30) NOT NULL DEFAULT (user_name()),
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1632946420869]', N'PIMS_PROPERTY_LEASE', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1632946420864]  ( 
	[APP_CREATE_TIMESTAMP]          	datetime NOT NULL DEFAULT (getutcdate()),
	[APP_CREATE_USER_DIRECTORY]     	nvarchar(30) NOT NULL,
	[APP_CREATE_USER_GUID]          	uniqueidentifier NULL,
	[APP_CREATE_USERID]             	nvarchar(30) NOT NULL,
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1632946420864]([APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [IS_DISABLED], [ORGANIZATION_ID], [PROPERTY_ID], [PROPERTY_ORGANIZATION_ID]) 
	SELECT [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [IS_DISABLED], [ORGANIZATION_ID], [PROPERTY_ID], [PROPERTY_ORGANIZATION_ID] 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1632946420864]', N'PIMS_PROPERTY_ORGANIZATION', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1632946420865]  ( 
	[APP_CREATE_TIMESTAMP]          	datetime NOT NULL DEFAULT (getutcdate()),
	[APP_CREATE_USER_DIRECTORY]     	nvarchar(30) NOT NULL,
	[APP_CREATE_USER_GUID]          	uniqueidentifier NULL,
	[APP_CREATE_USERID]             	nvarchar(30) NOT NULL,
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1632946420865]([APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [IS_DISABLED], [ORGANIZATION_ID], [ROLE_ID], [USER_ID], [USER_ORGANIZATION_ID]) 
	SELECT [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [IS_DISABLED], [ORGANIZATION_ID], [ROLE_ID], [USER_ID], [USER_ORGANIZATION_ID] 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1632946420865]', N'PIMS_USER_ORGANIZATION', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1632946420881]  ( 
	[ACTIVITY_MODEL_ID]              	bigint NOT NULL,
	[APP_CREATE_TIMESTAMP]           	datetime NOT NULL DEFAULT (getutcdate()),
	[APP_CREATE_USER_DIRECTORY]      	nvarchar(30) NOT NULL,
	[APP_CREATE_USER_GUID]           	uniqueidentifier NULL,
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1632946420881]', N'PIMS_TASK_TEMPLATE_ACTIVITY_MODEL', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
CREATE TABLE [dbo].[ADS_SSDATA_1632946420885]  ( 
	[APP_CREATE_TIMESTAMP]          	datetime NOT NULL DEFAULT (getutcdate()),
	[APP_CREATE_USER_DIRECTORY]     	nvarchar(30) NOT NULL,
	[APP_CREATE_USER_GUID]          	uniqueidentifier NULL,
	[APP_CREATE_USERID]             	nvarchar(30) NOT NULL,
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
INSERT INTO [dbo].[ADS_SSDATA_1632946420885]([APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [IS_DISABLED], [ROLE_ID], [USER_ID], [USER_ROLE_ID]) 
	SELECT [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_DIRECTORY], [APP_CREATE_USER_GUID], [APP_CREATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_DIRECTORY], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USERID], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_TIMESTAMP], [DB_CREATE_USERID], [DB_LAST_UPDATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [IS_DISABLED], [ROLE_ID], [USER_ID], [USER_ROLE_ID] 
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC dbo.sp_rename N'[dbo].[ADS_SSDATA_1632946420885]', N'PIMS_USER_ROLE', [OBJECT]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
PRINT N'Drop table dbo.PIMS_SECURITY_DEPOSIT_RETURN_HIST'
GO
DROP TABLE [dbo].[PIMS_SECURITY_DEPOSIT_RETURN_HIST]
GO
IF @@ERROR <> 0 SET NOEXEC ON
...
PRINT N'Drop sequence dbo.PIMS_SECURITY_DEPOSIT_RETURN_H_ID_SEQ'
GO
DROP SEQUENCE [dbo].[PIMS_SECURITY_DEPOSIT_RETURN_H_ID_SEQ]
GO
IF @@ERROR <> 0 SET NOEXEC ON
...
PRINT N'Drop sequence dbo.PIMS_SECURITY_DEPOSIT_RETURN_ID_SEQ'
GO
DROP SEQUENCE [dbo].[PIMS_SECURITY_DEPOSIT_RETURN_ID_SEQ]
GO
IF @@ERROR <> 0 SET NOEXEC ON
...
PRINT N'Drop table dbo.PIMS_SECURITY_DEPOSIT_HIST'
GO
DROP TABLE [dbo].[PIMS_SECURITY_DEPOSIT_HIST]
GO
IF @@ERROR <> 0 SET NOEXEC ON
...
PRINT N'Drop sequence dbo.PIMS_SECURITY_DEPOSIT_H_ID_SEQ'
GO
DROP SEQUENCE [dbo].[PIMS_SECURITY_DEPOSIT_H_ID_SEQ]
GO
IF @@ERROR <> 0 SET NOEXEC ON
...
PRINT N'Drop sequence dbo.PIMS_SECURITY_DEPOSIT_ID_SEQ'
GO
DROP SEQUENCE [dbo].[PIMS_SECURITY_DEPOSIT_ID_SEQ]
GO
IF @@ERROR <> 0 SET NOEXEC ON
...
PRINT N'Drop table dbo.PIMS_SECURITY_DEPOSIT_TYPE'
GO
DROP TABLE [dbo].[PIMS_SECURITY_DEPOSIT_TYPE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
...
PRINT N'Drop table dbo.PIMS_PROPERTY_IMPROVEMENT_HIST'
GO
DROP TABLE [dbo].[PIMS_PROPERTY_IMPROVEMENT_HIST]
GO
IF @@ERROR <> 0 SET NOEXEC ON
...
PRINT N'Drop sequence dbo.PIMS_PROPERTY_IMPROVEMENT_H_ID_SEQ'
GO
DROP SEQUENCE [dbo].[PIMS_PROPERTY_IMPROVEMENT_H_ID_SEQ]
GO
IF @@ERROR <> 0 SET NOEXEC ON
...
PRINT N'Drop sequence dbo.PIMS_PROPERTY_IMPROVEMENT_ID_SEQ'
GO
DROP SEQUENCE [dbo].[PIMS_PROPERTY_IMPROVEMENT_ID_SEQ]
GO
IF @@ERROR <> 0 SET NOEXEC ON
...
PRINT N'Drop table dbo.PIMS_PROPERTY_IMPROVEMENT_TYPE'
GO
DROP TABLE [dbo].[PIMS_PROPERTY_IMPROVEMENT_TYPE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
...
PRINT N'Drop table dbo.PIMS_PROPERTY_TAX_HIST'
GO
DROP TABLE [dbo].[PIMS_PROPERTY_TAX_HIST]
GO
IF @@ERROR <> 0 SET NOEXEC ON
...
PRINT N'Drop sequence dbo.PIMS_PROPERTY_TAX_H_ID_SEQ'
GO
DROP SEQUENCE [dbo].[PIMS_PROPERTY_TAX_H_ID_SEQ]
GO
IF @@ERROR <> 0 SET NOEXEC ON
...
PRINT N'Drop table dbo.PIMS_PROPERTY_TAX_REMIT_TYPE'
GO
DROP TABLE [dbo].[PIMS_PROPERTY_TAX_REMIT_TYPE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
...
PRINT N'Drop table dbo.PIMS_SURPLUS_DECLARATION_TYPE'
GO
DROP TABLE [dbo].[PIMS_SURPLUS_DECLARATION_TYPE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
...
PRINT N'Drop table dbo.PIMS_LESSOR_TYPE'
GO
DROP TABLE [dbo].[PIMS_LESSOR_TYPE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
...
PRINT N'Drop table dbo.PIMS_INSURANCE_HIST'
GO
DROP TABLE [dbo].[PIMS_INSURANCE_HIST]
GO
IF @@ERROR <> 0 SET NOEXEC ON
...
PRINT N'Drop sequence dbo.PIMS_INSURANCE_H_ID_SEQ'
GO
DROP SEQUENCE [dbo].[PIMS_INSURANCE_H_ID_SEQ]
GO
IF @@ERROR <> 0 SET NOEXEC ON
...
PRINT N'Drop table dbo.PIMS_INSURANCE_TYPE'
GO
DROP TABLE [dbo].[PIMS_INSURANCE_TYPE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
...
PRINT N'Drop sequence dbo.PIMS_INSURANCE_ID_SEQ'
GO
DROP SEQUENCE [dbo].[PIMS_INSURANCE_ID_SEQ]
GO
IF @@ERROR <> 0 SET NOEXEC ON
...
PRINT N'Drop table dbo.PIMS_LEASE_PAY_RVBL_TYPE'
GO
DROP TABLE [dbo].[PIMS_LEASE_PAY_RVBL_TYPE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
...
PRINT N'Drop table dbo.PIMS_LEASE_LICENSE_TYPE'
GO
DROP TABLE [dbo].[PIMS_LEASE_LICENSE_TYPE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
