-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Fri Feb 24 13:35:09 PST 2023
...
-- Drop foreign key constraint dbo.PIM_PROJCT_PIM_PRJNOT_FK
PRINT N'Drop foreign key constraint dbo.PIM_PROJCT_PIM_PRJNOT_FK'
GO
ALTER TABLE [dbo].[PIMS_PROJECT_NOTE]
	DROP CONSTRAINT IF EXISTS [PIM_PROJCT_PIM_PRJNOT_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop foreign key constraint dbo.PIM_NOTE_PIM_PRJNOT_FK
PRINT N'Drop foreign key constraint dbo.PIM_NOTE_PIM_PRJNOT_FK'
GO
ALTER TABLE [dbo].[PIMS_PROJECT_NOTE]
	DROP CONSTRAINT IF EXISTS [PIM_NOTE_PIM_PRJNOT_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop foreign key constraint dbo.PIM_TKTYPE_PIM_TAKE_FK
PRINT N'Drop foreign key constraint dbo.PIM_TKTYPE_PIM_TAKE_FK'
GO
ALTER TABLE [dbo].[PIMS_TAKE]
	DROP CONSTRAINT IF EXISTS [PIM_TKTYPE_PIM_TAKE_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop foreign key constraint dbo.PIM_TKCONT_PIM_TAKE_FK
PRINT N'Drop foreign key constraint dbo.PIM_TKCONT_PIM_TAKE_FK'
GO
ALTER TABLE [dbo].[PIMS_TAKE]
	DROP CONSTRAINT IF EXISTS [PIM_TKCONT_PIM_TAKE_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop foreign key constraint dbo.PIM_PRACQF_PIM_TAKE_FK
PRINT N'Drop foreign key constraint dbo.PIM_PRACQF_PIM_TAKE_FK'
GO
ALTER TABLE [dbo].[PIMS_TAKE]
	DROP CONSTRAINT IF EXISTS [PIM_PRACQF_PIM_TAKE_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop foreign key constraint dbo.PIM_TKSTST_PIM_TAKE_FK
PRINT N'Drop foreign key constraint dbo.PIM_TKSTST_PIM_TAKE_FK'
GO
ALTER TABLE [dbo].[PIMS_TAKE]
	DROP CONSTRAINT IF EXISTS [PIM_TKSTST_PIM_TAKE_FK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Drop index dbo.PRJNOT_PROJECT_ID_IDX
PRINT N'Drop index dbo.PRJNOT_PROJECT_ID_IDX'
GO
DROP INDEX IF EXISTS [dbo].[PIMS_PROJECT_NOTE].[PRJNOT_PROJECT_ID_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop index dbo.PRJNOT_NOTE_ID_IDX
PRINT N'Drop index dbo.PRJNOT_NOTE_ID_IDX'
GO
DROP INDEX IF EXISTS [dbo].[PIMS_PROJECT_NOTE].[PRJNOT_NOTE_ID_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Drop index dbo.TAKE_TAKE_STATUS_TYPE_CODE_IDX
PRINT N'Drop index dbo.TAKE_TAKE_STATUS_TYPE_CODE_IDX'
GO
DROP INDEX IF EXISTS [dbo].[PIMS_TAKE].[TAKE_TAKE_STATUS_TYPE_CODE_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP INDEX IF EXISTS [dbo].[PIMS_TAKE].[TAKE_TAKE_SITE_CONTAM_TYPE_CODE_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop index dbo.TAKE_PROPERTY_ACQUISITION_FILE_ID_IDX
PRINT N'Drop index dbo.TAKE_PROPERTY_ACQUISITION_FILE_ID_IDX'
GO
DROP INDEX IF EXISTS [dbo].[PIMS_TAKE].[TAKE_PROPERTY_ACQUISITION_FILE_ID_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
DROP INDEX IF EXISTS [dbo].[PIMS_ADDRESS].[ADDRSS_PROVINCE_STATE_ID_IDX]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
PRINT N'Drop table dbo.PIMS_PROJECT_DOCUMENT'
GO
...
-- Drop unique constraint dbo.PIMS_PRJDOC_H_UK
PRINT N'Drop unique constraint dbo.PIMS_PRJDOC_H_UK'
GO
ALTER TABLE [dbo].[PIMS_PROJECT_DOCUMENT_HIST]
	DROP CONSTRAINT IF EXISTS [PIMS_PRJDOC_H_UK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop primary key constraint dbo.PIMS_PRJDOC_H_PK
PRINT N'Drop primary key constraint dbo.PIMS_PRJDOC_H_PK'
GO
ALTER TABLE [dbo].[PIMS_PROJECT_DOCUMENT_HIST]
	DROP CONSTRAINT IF EXISTS [PIMS_PRJDOC_H_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop unique constraint dbo.PRJNOT_PROJECT_NOTE_TUC
PRINT N'Drop unique constraint dbo.PRJNOT_PROJECT_NOTE_TUC'
GO
ALTER TABLE [dbo].[PIMS_PROJECT_NOTE]
	DROP CONSTRAINT IF EXISTS [PRJNOT_PROJECT_NOTE_TUC]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop primary key constraint dbo.PRJNOT_PK
PRINT N'Drop primary key constraint dbo.PRJNOT_PK'
GO
ALTER TABLE [dbo].[PIMS_PROJECT_NOTE]
	DROP CONSTRAINT IF EXISTS [PRJNOT_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Drop unique constraint dbo.PIMS_PRJNOT_H_UK
PRINT N'Drop unique constraint dbo.PIMS_PRJNOT_H_UK'
GO
ALTER TABLE [dbo].[PIMS_PROJECT_NOTE_HIST]
	DROP CONSTRAINT IF EXISTS [PIMS_PRJNOT_H_UK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop primary key constraint dbo.PIMS_PRJNOT_H_PK
PRINT N'Drop primary key constraint dbo.PIMS_PRJNOT_H_PK'
GO
ALTER TABLE [dbo].[PIMS_PROJECT_NOTE_HIST]
	DROP CONSTRAINT IF EXISTS [PIMS_PRJNOT_H_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
-- Drop unique constraint dbo.PIMS_TAKE_H_UK
PRINT N'Drop unique constraint dbo.PIMS_TAKE_H_UK'
GO
ALTER TABLE [dbo].[PIMS_TAKE_HIST]
	DROP CONSTRAINT IF EXISTS [PIMS_TAKE_H_UK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop primary key constraint dbo.PIMS_TAKE_H_PK
PRINT N'Drop primary key constraint dbo.PIMS_TAKE_H_PK'
GO
ALTER TABLE [dbo].[PIMS_TAKE_HIST]
	DROP CONSTRAINT IF EXISTS [PIMS_TAKE_H_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop primary key constraint dbo.TAKE_PK
PRINT N'Drop primary key constraint dbo.TAKE_PK'
GO
ALTER TABLE [dbo].[PIMS_TAKE]
	DROP CONSTRAINT IF EXISTS [TAKE_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop table dbo.PIMS_TAKE
PRINT N'Drop table dbo.PIMS_TAKE'
GO
DROP TABLE IF EXISTS [dbo].[PIMS_TAKE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop primary key constraint dbo.TKCONT_PK
PRINT N'Drop primary key constraint dbo.TKCONT_PK'
GO
ALTER TABLE [dbo].[PIMS_TAKE_SITE_CONTAM_TYPE]
	DROP CONSTRAINT IF EXISTS [TKCONT_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop primary key constraint dbo.TKSTST_PK
PRINT N'Drop primary key constraint dbo.TKSTST_PK'
GO
ALTER TABLE [dbo].[PIMS_TAKE_STATUS_TYPE]
	DROP CONSTRAINT IF EXISTS [TKSTST_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop primary key constraint dbo.TKTYPE_PK
PRINT N'Drop primary key constraint dbo.TKTYPE_PK'
GO
ALTER TABLE [dbo].[PIMS_TAKE_TYPE]
	DROP CONSTRAINT IF EXISTS [TKTYPE_PK]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_ADDRESS_HIST] ALTER COLUMN [PROVINCE_STATE_ID] smallint NOT NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [dbo].[PIMS_ADDRESS] ALTER COLUMN [PROVINCE_STATE_ID] smallint NOT NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
PRINT N'Drop sequence dbo.PIMS_PROJECT_DOCUMENT_ID_SEQ'
GO
DROP SEQUENCE IF EXISTS [dbo].[PIMS_PROJECT_DOCUMENT_ID_SEQ]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop table dbo.PIMS_PROJECT_DOCUMENT_HIST
PRINT N'Drop table dbo.PIMS_PROJECT_DOCUMENT_HIST'
GO
DROP TABLE IF EXISTS [dbo].[PIMS_PROJECT_DOCUMENT_HIST]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop sequence dbo.PIMS_PROJECT_DOCUMENT_H_ID_SEQ
PRINT N'Drop sequence dbo.PIMS_PROJECT_DOCUMENT_H_ID_SEQ'
GO
DROP SEQUENCE IF EXISTS [dbo].[PIMS_PROJECT_DOCUMENT_H_ID_SEQ]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop table dbo.PIMS_TAKE_HIST
PRINT N'Drop table dbo.PIMS_TAKE_HIST'
GO
DROP TABLE IF EXISTS [dbo].[PIMS_TAKE_HIST]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop sequence dbo.PIMS_TAKE_H_ID_SEQ
PRINT N'Drop sequence dbo.PIMS_TAKE_H_ID_SEQ'
GO
DROP SEQUENCE IF EXISTS [dbo].[PIMS_TAKE_H_ID_SEQ]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop table dbo.PIMS_TAKE_SITE_CONTAM_TYPE
PRINT N'Drop table dbo.PIMS_TAKE_SITE_CONTAM_TYPE'
GO
DROP TABLE IF EXISTS [dbo].[PIMS_TAKE_SITE_CONTAM_TYPE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop sequence dbo.PIMS_TAKE_ID_SEQ
PRINT N'Drop sequence dbo.PIMS_TAKE_ID_SEQ'
GO
DROP SEQUENCE IF EXISTS [dbo].[PIMS_TAKE_ID_SEQ]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop table dbo.PIMS_TAKE_STATUS_TYPE
PRINT N'Drop table dbo.PIMS_TAKE_STATUS_TYPE'
GO
DROP TABLE IF EXISTS [dbo].[PIMS_TAKE_STATUS_TYPE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO

-- Drop table dbo.PIMS_TAKE_TYPE
PRINT N'Drop table dbo.PIMS_TAKE_TYPE'
GO
DROP TABLE IF EXISTS [dbo].[PIMS_TAKE_TYPE]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
